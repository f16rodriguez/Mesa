...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:s9,depthTest:!1,depthWrite:!1})}function gY(){return new P9({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:g$(),fragmentShader:`
		...
		`,blending:s9,depthTest:!1,depthWrite:!1})}function pY(){return new P9({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:g$(),fragmentShader:`
