...
`)+`
`+E;let k=P+R+X,V=P+E+Y,z=u5(K,K.VERTEX_SHADER,k),w=u5(K,K.FRAGMENT_SHADER,V);if(K.attachShader(B,z),K.attachShader(B,w),Q.index0AttributeName!==void 0)K.bindAttribLocation(B,0,Q.index0AttributeName);else if(Q.hasPositionAttribute===!0)K.bindAttribLocation(B,0,"position");K.linkProgram(B);function D(b){if(J.debug.checkShaderErrors){let l=K.getProgramInfoLog(B)||"",r=K.getShaderInfoLog(z)||"",v=K.getShaderInfoLog(w)||"",y=l.trim(),x=r.trim(),f=v.trim(),o=!0,g=!0;if(K.getProgramParameter(B,K.LINK_STATUS)===!1)if(o=!1,typeof J.debug.onShaderError==="function")J.debug.onShaderError(K,B,z,w);else{let a=c5(K,z,"vertex"),j=c5(K,w,"fragment");Z9("WebGLProgram: Shader Error "+K.getError()+" - VALIDATE_STATUS "+K.getProgramParameter(B,K.VALIDATE_STATUS)+`
