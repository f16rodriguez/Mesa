...
void main() {
	...
	`}class XH extends J8{constructor(J=1,Q={}){super(J,J,Q);this.isWebGLCubeRenderTarget=!0;let $={width:J,height:J,depth:1},W=[$,$,$,$,$,$];this.texture=new MW(W),this._setTextureOptions(Q),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(J,Q){this.texture.type=Q.type,this.texture.colorSpace=Q.colorSpace,this.texture.generateMipmaps=Q.generateMipmaps,this.texture.minFilter=Q.minFilter,this.texture.magFilter=Q.magFilter;let $={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),E=new I0(U,N),G=new i9(-1,1,1,-1,0,1),F=null,R=null,D=!1,O,q=null,V=[],M=!1;this.setSize=function(L,P){if(H.setSize(L,P),Y!==null)Y.setSize(L,P);if(X!==null)X.setSize(L,P);for(let I=0;I<V.length;I++){let S=V[I];if(S.setSize)S.setSize(L,P)}},this.setEffects=function(L){V=L,M=V.length>0&&V[0].isRenderPass===!0;let{width:P,height:I}=H;if(V.length>0&&Y===null)Y=new J8(P,I,{type:F8,depthBuffer:!1,stencilBuffer:!1}),X=new J8(P,I,{type:F8,depthBuffer:!1,stencilBuffer:!1});for(let S=0;S<V.length;S++){let k=V[S];if(k.setSize)k.setSize(P,I)}},this.begin=function(L,P){if(D)return!1;if(L.toneMapping===U9&&V.length===0)return!1;if(q=P,P!==null){let{width:I,height:S}=P;if(H.width!==I||H.height!==S)this.setSize(I,S)}if(M===!1)L.setRenderTarget(H);return O=L.toneMapping,L.toneMapping=U9,!0},this.hasRenderPass=function(){return M},this.end=function(L,P){L.toneMapping=O,D=!0;let I=H,S=Y;for(let k=0;k<V.length;k++){let A=V[k];if(A.enabled===!1)continue;if(A.render(L,S,I,P),A.needsSwap!==!1)I=S,S=S===Y?X:Y}if(F!==L.outputColorSpace||R!==L.toneMapping){if(F=L.outputColorSpace,R=L.toneMapping,N.defines={},GJ.getTransfer(F)===pJ)N.defines.SRGB_TRANSFER="";let k=N1[R];if(k)N.defines[k]="";N.needsUpdate=!0}N.uniforms.tDiffuse.value=I.texture,L.setRenderTarget(q),L.render(E,G),q=null,D=!1},this.isCompositing=function(){return D},this.dispose=function(){if(H.dispose(),Y!==null)Y.dispose();if(X!==null)X.dispose();U.dispose(),N.dispose()}}var RU=new eJ,HH=new d7(1,1),LU=new OW,VU=new SK,DU=new MW,rX=[],tX=[],eX=new Float32Array(16),JU=new Float32Array(9),QU=new Float32Array(4);function r6(J,Q,$){let W=J[0];if(W<=0||W>0)return J;let Z=Q*$,K=rX[Z];if(K===void 0)K=new Float32Array(Z),rX[Z]=K;if(Q!==0){W.toArray(K,0);for(let H=1,Y=0;H!==Q;++H)Y+=$,J[H].toArray(K,Y)}return K}function Y8(J,Q){if(J.length!==Q.length)return!1;for(let $=0,W=J.length;$<W;$++)if(J[$]!==Q[$])return!1;return!0}function X8(J,Q){for(let $=0,W=Q.length;$<W;$++)J[$]=Q[$]}function pW(J,Q){let $=tX[Q];if($===void 0)$=new Int32Array(Q),tX[Q]=$;for(let W=0;W!==Q;++W)$[W]=J.allocateTextureUnit();return $}function E1(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1f(this.addr,Q),$[0]=Q}function F1(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2f(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(Y8($,Q))return;J.uniform2fv(this.addr,Q),X8($,Q)}}function q1(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3f(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else if(Q.r!==void 0){if($[0]!==Q.r||$[1]!==Q.g||$[2]!==Q.b)J.uniform3f(this.addr,Q.r,Q.g,Q.b),$[0]=Q.r,$[1]=Q.g,$[2]=Q.b}else{if(Y8($,Q))return;J.uniform3fv(this.addr,Q),X8($,Q)}}function O1(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4f(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(Y8($,Q))return;J.uniform4fv(this.addr,Q),X8($,Q)}}function R1(J,Q){let $=this.cache,W=Q.elements;if(W===void 0){if(Y8($,Q))return;J.uniformMatrix2fv(this.addr,!1,Q),X8($,Q)}else{if(Y8($,W))return;QU.set(W),J.uniformMatrix2fv(this.addr,!1,QU),X8($,W)}}function L1(J,Q){let $=this.cache,W=Q.elements;if(W===void 0){if(Y8($,Q))return;J.uniformMatrix3fv(this.addr,!1,Q),X8($,Q)}else{if(Y8($,W))return;JU.set(W),J.uniformMatrix3fv(this.addr,!1,JU),X8($,W)}}function V1(J,Q){let $=this.cache,W=Q.elements;if(W===void 0){if(Y8($,Q))return;J.uniformMatrix4fv(this.addr,!1,Q),X8($,Q)}else{if(Y8($,W))return;eX.set(W),J.uniformMatrix4fv(this.addr,!1,eX),X8($,W)}}function D1(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1i(this.addr,Q),$[0]=Q}function B1(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2i(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(Y8($,Q))return;J.uniform2iv(this.addr,Q),X8($,Q)}}function k1(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3i(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else{if(Y8($,Q))return;J.uniform3iv(this.addr,Q),X8($,Q)}}function M1(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4i(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(Y8($,Q))return;J.uniform4iv(this.addr,Q),X8($,Q)}}function C1(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1ui(this.addr,Q),$[0]=Q}function P1(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2ui(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(Y8($,Q))return;J.uniform2uiv(this.addr,Q),X8($,Q)}}function I1(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3ui(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else{if(Y8($,Q))return;J.uniform3uiv(this.addr,Q),X8($,Q)}}function z1(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4ui(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(Y8($,Q))return;J.uniform4uiv(this.addr,Q),X8($,Q)}}function A1(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;let K;if(this.type===J.SAMPLER_2D_SHADOW)HH.compareFunction=$.isReversedDepthBuffer()?qW:FW,K=HH;else K=RU;$.setTexture2D(Q||K,Z)}function _1(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;$.setTexture3D(Q||VU,Z)}function T1(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;$.setTextureCube(Q||DU,Z)}function S1(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;$.setTexture2DArray(Q||LU,Z)}function w1(J){switch(J){case 5126:return E1;case 35664:return F1;case 35665:return q1;case 35666:return O1;case 35674:return R1;case 35675:return L1;case 35676:return V1;case 5124:case 35670:return D1;case 35667:case 35671:return B1;case 35668:case 35672:return k1;case 35669:case 35673:return M1;case 5125:return C1;case 36294:return P1;case 36295:return I1;case 36296:return z1;case 35678:case 36198:case 36298:case 36306:case 35682:return A1;case 35679:case 36299:case 36307:return _1;case 35680:case 36300:case 36308:case 36293:return T1;case 36289:case 36303:case 36311:case 36292:return S1}}function j1(J,Q){J.uniform1fv(this.addr,Q)}function y1(J,Q){let $=r6(Q,this.size,2);J.uniform2fv(this.addr,$)}function v1(J,Q){let $=r6(Q,this.size,3);J.uniform3fv(this.addr,$)}function f1(J,Q){let $=r6(Q,this.size,4);J.uniform4fv(this.addr,$)}function h1(J,Q){let $=r6(Q,this.size,4);J.uniformMatrix2fv(this.addr,!1,$)}function b1(J,Q){let $=r6(Q,this.size,9);J.uniformMatrix3fv(this.addr,!1,$)}function x1(J,Q){let $=r6(Q,this.size,16);J.uniformMatrix4fv(this.addr,!1,$)}function g1(J,Q){J.uniform1iv(this.addr,Q)}function p1(J,Q){J.uniform2iv(this.addr,Q)}function l1(J,Q){J.uniform3iv(this.addr,Q)}function m1(J,Q){J.uniform4iv(this.addr,Q)}function u1(J,Q){J.uniform1uiv(this.addr,Q)}function d1(J,Q){J.uniform2uiv(this.addr,Q)}function c1(J,Q){J.uniform3uiv(this.addr,Q)}function n1(J,Q){J.uniform4uiv(this.addr,Q)}function s1(J,Q,$){let W=this.cache,Z=Q.length,K=pW($,Z);if(!Y8(W,K))J.uniform1iv(this.addr,K),X8(W,K);let H;if(this.type===J.SAMPLER_2D_SHADOW)H=HH;else H=RU;for(let Y=0;Y!==Z;++Y)$.setTexture2D(Q[Y]||H,K[Y])}function i1(J,Q,$){let W=this.cache,Z=Q.length,K=pW($,Z);if(!Y8(W,K))J.uniform1iv(this.addr,K),X8(W,K);for(let H=0;H!==Z;++H)$.setTexture3D(Q[H]||VU,K[H])}function o1(J,Q,$){let W=this.cache,Z=Q.length,K=pW($,Z);if(!Y8(W,K))J.uniform1iv(this.addr,K),X8(W,K);for(let H=0;H!==Z;++H)$.setTextureCube(Q[H]||DU,K[H])}function a1(J,Q,$){let W=this.cache,Z=Q.length,K=pW($,Z);if(!Y8(W,K))J.uniform1iv(this.addr,K),X8(W,K);for(let H=0;H!==Z;++H)$.setTexture2DArray(Q[H]||LU,K[H])}function r1(J){switch(J){case 5126:return j1;case 35664:return y1;case 35665:return v1;case 35666:return f1;case 35674:return h1;case 35675:return b1;case 35676:return x1;case 5124:case 35670:return g1;case 35667:case 35671:return p1;case 35668:case 35672:return l1;case 35669:case 35673:return m1;case 5125:return u1;case 36294:return d1;case 36295:return c1;case 36296:return n1;case 35678:case 36198:case 36298:case 36306:case 35682:return s1;case 35679:case 36299:case 36307:return i1;case 35680:case 36300:case 36308:case 36293:return o1;case 36289:case 36303:case 36311:case 36292:return a1}}class BU{constructor(J,Q,$){this.id=J,this.addr=$,this.cache=[],this.type=Q.type,this.setValue=w1(Q.type)}}class kU{constructor(J,Q,$){this.id=J,this.addr=$,this.cache=[],this.type=Q.type,this.size=Q.size,this.setValue=r1(Q.type)}}class MU{constructor(J){this.id=J,this.seq=[],this.map={}}setValue(J,Q,$){let W=this.seq;for(let Z=0,K=W.length;Z!==K;++Z){let H=W[Z];H.setValue(J,Q[H.id],$)}}}var ZH=/(\w+)(\])?(\[|\.)?/g;function $U(J,Q){J.seq.push(Q),J.map[Q.id]=Q}function t1(J,Q,$){let W=J.name,Z=W.length;ZH.lastIndex=0;while(!0){let K=ZH.exec(W),H=ZH.lastIndex,Y=K[1],X=K[2]==="]",U=K[3];if(X)Y=Y|0;if(U===void 0||U==="["&&H+2===Z){$U($,U===void 0?new BU(Y,J,Q):new kU(Y,J,Q));break}else{let E=$.map[Y];if(E===void 0)E=new MU(Y),$U($,E);$=E}}}class K${constructor(J,Q){this.seq=[],this.map={};let $=J.getProgramParameter(Q,J.ACTIVE_UNIFORMS);for(let K=0;K<$;++K){let H=J.getActiveUniform(Q,K),Y=J.getUniformLocation(Q,H.name);t1(H,Y,this)}let W=[],Z=[];for(let K of this.seq)if(K.type===J.SAMPLER_2D_SHADOW||K.type===J.SAMPLER_CUBE_SHADOW||K.type===J.SAMPLER_2D_ARRAY_SHADOW)W.push(K);else Z.push(K);if(W.length>0)this.seq=W.concat(Z)}setValue(J,Q,$,W){let Z=this.map[Q];if(Z!==void 0)Z.setValue(J,$,W)}setOptional(J,Q,$){let W=Q[$];if(W!==void 0)this.setValue(J,$,W)}static upload(J,Q,$,W){for(let Z=0,K=Q.length;Z!==K;++Z){let H=Q[Z],Y=$[H.id];if(Y.needsUpdate!==!1)H.setValue(J,Y.value,W)}}static seqWithValue(J,Q){let $=[];for(let W=0,Z=J.length;W!==Z;++W){let K=J[W];if(K.id in Q)$.push(K)}return $}}function WU(J,Q,$){let W=J.createShader(Q);return J.shaderSource(W,$),J.compileShader(W),W}var e1=37297,Jq=0;function Qq(J,Q){let $=J.split(`
...
`)}var Zq={[wQ]:"Linear",[jQ]:"Reinhard",[yQ]:"Cineon",[v7]:"ACESFilmic",[fQ]:"AgX",[hQ]:"Neutral",[vQ]:"Custom"};function Kq(J,Q){let $=Zq[Q];if($===void 0)return o0("WebGLProgram: Unsupported toneMapping:",Q),"vec3 "+J+"( vec3 color ) { return LinearToneMapping( color ); }";return"vec3 "+J+"( vec3 color ) { return "+$+"ToneMapping( color ); }"}var xW=new T;function Hq(){GJ.getLuminanceCoefficients(xW);let J=xW.x.toFixed(4),Q=xW.y.toFixed(4),$=xW.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${J}, ${Q}, ${$} );`,"\treturn dot( weights, rgb );","}"].join(`
...
`)+`
`+q;let M=V+O+H,L=V+q+Y,P=WU(Z,Z.VERTEX_SHADER,M),I=WU(Z,Z.FRAGMENT_SHADER,L);if(Z.attachShader(D,P),Z.attachShader(D,I),$.index0AttributeName!==void 0)Z.bindAttribLocation(D,0,$.index0AttributeName);else if($.hasPositionAttribute===!0)Z.bindAttribLocation(D,0,"position");Z.linkProgram(D);function S(h){if(J.debug.checkShaderErrors){let g=Z.getProgramInfoLog(D)||"",Z0=Z.getShaderInfoLog(P)||"",f=Z.getShaderInfoLog(I)||"",o=g.trim(),s=Z0.trim(),p=f.trim(),X0=!0,a=!0;if(Z.getProgramParameter(D,Z.LINK_STATUS)===!1)if(X0=!1,typeof J.debug.onShaderError==="function")J.debug.onShaderError(Z,D,P,I);else{let Y0=KU(Z,P,"vertex"),F0=KU(Z,I,"fragment");$J("WebGLProgram: Shader Error "+Z.getError()+" - VALIDATE_STATUS "+Z.getProgramParameter(D,Z.VALIDATE_STATUS)+`
...
void main() {
   ...
   void main(){vec3 d=normalize(vP);float h=d.y;
    ...
    #include <tonemapping_fragment>
    #include <colorspace_fragment>
   }`}));$.renderOrder=-10,Q.add($);let W=220,Z=new Float32Array(W*3),K=new Float32Array(W*3);for(let U=0;U<W;U++){let N=C8(),E=C8()*Math.PI*2,G=0.45+N*0.55,F=Math.sqrt(1-G*G),R=0.25+0.55*C8()*G;Z.set([Math.cos(E)*F*75,G*75,Math.sin(E)*F*75],U*3),K.set([R*0.85,R*0.9,R],U*3)}let H=new lJ;H.setAttribute("position",new tJ(Z,3)),H.setAttribute("color",new tJ(K,3)),Q.add(new c6(H,new u7({size:1.3,sizeAttenuation:!1,vertexColors:!0,fog:!1,depthWrite:!1,transparent:!0,opacity:0.45})));let Y=new I0(new F7(2.1,40),new nJ({color:"#f6e7cc",fog:!1}));Y.position.set(26,11,58),Y.lookAt(0,1,0),Q.add(Y);let X=new u6(new m7({map:A5("255,226,200"),fog:!1,transparent:!0,opacity:0.28,depthWrite:!1,blending:I9}));return X.scale.setScalar(13),X.position.copy(Y.position),Q.add(X),J.add(Q),Q}function QR(J){let Q=new Map,$=(E,G=0,F=0)=>{let R=E+G+F;if(!Q.has(R))Q.set(R,{m:new s0({color:G?E:new b0(E).multiplyScalar(0.85),roughness:0.9,emissive:G||"#000",emissiveIntensity:F}),g:[]});return Q.get(R)},W=(E,G,F,R,D,O=0)=>{E.rotateY(O),E.translate(F,R,D),G.g.push(E)},Z=["#c98a64","#d8b46a","#6fa9a0","#c48d95","#a3b777","#dca16a","#86a3bf","#e2d3b0"],K=-20;while(K<20){let E=3.4+C8()*2.6,G=3+C8()*2.8,F=10.5+C8()*0.8,R=Z[Math.floor(C8()*Z.length)];W(new dJ(E,G,2.4),$(R),K+E/2,G/2,F+1.2),W(new dJ(E+0.12,0.18,2.6),$("#d9d2bf"),K+E/2,G+0.09,F+1.2);let D=Math.max(1,Math.floor(E/1.5));for(let O=0;O<D;O++){let q=K+(O+0.5)*E/D,V=C8()<0.4,M=C8()<0.2,L=V?$(M?"#9fc3ff":"#ffd08a",M?"#6f9cff":"#ffb35a",M?1.6:2.2):$("#2a3436");if(W(new zJ(0.75,0.95),L,q,1.55,F-0.005,Math.PI),G>4.2)W(new zJ(0.7,0.8),C8()<0.35?$("#ffd08a","#ffb35a",1.5):$("#2a3436"),q,G-1.1,F-0.005,Math.PI);W(new dJ(0.9,0.06,0.12),$("#2c3432"),q,2.08,F-0.06)}for(let O=0;O<Math.floor(E/0.22);O++)W(new dJ(0.018,0.9,0.018),$("#1b2224"),K+0.11+O*0.22,0.45,F-0.55);W(new dJ(E,0.04,0.04),$("#1b2224"),K+E/2,0.9,F-0.55),K+=E+0.15}W(new dJ(44,0.16,1.8),$("#8a8578"),0,0.08,9.6);let H=[-14,-4,6,16];for(let E of H)W(new AJ(0.09,0.12,7,8),$("#6b6457"),E,3.5,9.2),W(new dJ(1.6,0.08,0.08),$("#4f4a40"),E,6.6,9.2);for(let E=0;E<H.length-1;E++)for(let G of[0,-0.25,0.3]){let F=new T(H[E],6.6+G,9.2),R=new T(H[E+1],6.6+G,9.2),D=F.clone().lerp(R,0.5);D.y-=0.55,W(new i8(new F9(F,D,R),16,0.012,4),$("#101517"),0,0,0)}for(let[E,G,F]of[[-9,12.8,7.5],[11,13.1,8.4],[2.5,13.4,6.4]]){let R=new c7([new T(E,0,G),new T(E+0.3,F*0.5,G),new T(E+0.8,F,G-0.2)]);W(new i8(R,12,0.16,6),$("#5d5445"),0,0,0);for(let D=0;D<9;D++){let O=D/9*Math.PI*2,q=new sQ(0.28,2.6,4,1);q.rotateZ(Math.PI/2+0.55),q.translate(1.3,0,0),q.rotateY(O),W(q,$("#34503a"),E+0.8,F,G-0.2)}}let Y=[];for(let{m:E,g:G}of Q.values()){let F=lW(G,!1);if(G.forEach((D)=>D.dispose()),!F)continue;let R=new I0(F,E);R.receiveShadow=!0,J.add(R),Y.push(R)}let X=new s9("#ffa35c",6,14,1.8);X.position.set(6,5.9,8.6),J.add(X);let U=new I0(new k8(0.14,12,8),new s0({color:"#ffcf94",emissive:"#ff9a45",emissiveIntensity:5}));U.position.copy(X.position),J.add(U);let N=new I0(new AJ(0.03,0.03,1.3,6),new s0({color:"#4f4a40"}));return N.rotation.z=Math.PI/2,N.position.set(6,6.05,8.9),J.add(N),{merged:Y,farol:X}}function $R(J,Q){let $=new fJ;$.position.copy(Q),J.add($);let W=new I0(new k8(0.038,16,12),new s0({color:"#fff4d6",emissive:"#ffd08a",emissiveIntensity:9}));W.scale.y=1.25,$.add(W);let Z=new I0(new AJ(0.018,0.02,0.05,10),new s0({color:"#2b2a26",roughness:0.6}));Z.position.y=0.065,$.add(Z);let K=new I0(new AJ(0.004,0.004,1.1,5),new s0({color:"#15181a"}));K.position.y=0.64,$.add(K);let H=new u6(new m7({map:A5(),transparent:!0,opacity:0.55,depthWrite:!1,blending:I9}));H.scale.setScalar(0.75),$.add(H);let Y=[],X=new m7({color:"#3b3026",transparent:!0,opacity:0.85,depthWrite:!1});for(let U=0;U<6;U++){let N=new u6(X);N.scale.setScalar(0.012+C8()*0.008),$.add(N),Y.push({s:N,r:0.07+C8()*0.12,w:2+C8()*4,f:C8()*6,y:0.05+C8()*0.08,k:1.3+C8()})}return{g:$,halo:H,polillas:Y}}function WR(){let J=new l6;J.add(new I0(new k8(10,24,12),new rJ({side:L8,uniforms:{uSol:{value:_5}},vertexShader:"varying vec3 vP;void main(){vP=normalize(position);gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}",fragmentShader:"varying vec3 vP;uniform vec3 uSol;void main(){float l=dot(normalize(vP.xz+vec2(1e-4)),normalize(uSol.xz))*.5+.5;vec3 hor=mix(vec3(.3,.25,.36),vec3(.85,.45,.25),pow(l,2.5));gl_FragColor=vec4(mix(hor,vec3(.05,.07,.17),smoothstep(-.05,.7,vP.y))*mix(.35,1.,smoothstep(-.3,0.,vP.y)),1.);}"})));let Q=($,W,Z,K,H,Y)=>{let X=new I0(new zJ(Z,K),new nJ({color:new b0($).multiplyScalar(W),side:sJ}));X.position.set(...H),X.lookAt(...Y),J.add(X)};return Q("#ffcf94",6,1.2,1.2,[0,6,0],[0,0,0]),Q("#dff3ea",2,5,2,[0,2.5,-8],[0,1,0]),J}function T5({scene:J,renderer:Q,camera:$,controls:W,software:Z,bulbLight:K}){function H(){let s=new H$(Q),p=WR(),X0=s.fromScene(p,0.02);J.environment?.dispose?.(),J.environment=X0.texture,J.environmentIntensity=0.75,s.dispose(),p.traverse((a)=>{a.geometry?.dispose(),a.material?.dispose()})}H(),J.background=new b0("#2a2d4a"),J.fog=new l7("#5a5670",0.017);let Y=JR(J),X=QR(J),U=new T(0,R0.surfaceY+1.3,0),N=$R(J,U),E=hH((s,p,X0)=>{let a=s.createRadialGradient(p/2,X0*0.62,0,p/2,X0*0.62,p/2);a.addColorStop(0,"rgba(255,196,110,.95)"),a.addColorStop(0.45,"rgba(255,170,80,.35)"),a.addColorStop(1,"rgba(255,150,60,0)"),s.fillStyle=a,s.fillRect(0,0,p,X0)},256,128),G=new I0(new zJ(0.62,0.26),new nJ({map:E,transparent:!0,opacity:0,depthWrite:!1,blending:I9,toneMapped:!1}));G.rotation.x=-Math.PI/2,G.position.y=R0.surfaceY+0.0012,G.renderOrder=3,J.add(G);let F={i:-1,ang:0,alfa:0,objetivo:0,pos:new T},R=(s)=>hH((p,X0,a)=>{p.strokeStyle=`rgba(${s},1)`,p.lineWidth=X0*0.09,p.beginPath(),p.arc(X0/2,a/2,X0*0.36,0,Math.PI*2),p.stroke();let Y0=p.createRadialGradient(X0/2,a/2,0,X0/2,a/2,X0/2);Y0.addColorStop(0,`rgba(${s},.5)`),Y0.addColorStop(1,`rgba(${s},0)`),p.fillStyle=Y0,p.fillRect(0,0,X0,a)},128,128),D=["227,174,85","111,183,201"].map((s)=>{let p=new I0(new zJ(0.036,0.036),new nJ({map:R(s),transparent:!0,opacity:0,depthWrite:!1,blending:I9,toneMapped:!1}));return p.rotation.x=-Math.PI/2,p.position.y=R0.surfaceY+0.0015,p.renderOrder=3,J.add(p),p}),O=null,q=$.clone(),V=new T,M=new T,L=null,P=null,I=null,S=!1;function k(){if(L)return;let s=Q.getDrawingBufferSize(new U0),p=new J8(s.x,s.y,{type:F8,samples:4});L=new yH(Q,p),L.addPass(new vH(J,q)),P=new W6(new U0(s.x/2,s.y/2),0.4,0.5,2),L.addPass(P),I=new q$({uniforms:{tDiffuse:{value:null},uTiempo:{value:0},uVineta:{value:0.34},uGrano:{value:0.018}},vertexShader:"varying vec2 vUv;void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}",fragmentShader:`uniform sampler2D tDiffuse;uniform float uTiempo,uVineta,uGrano;varying vec2 vUv;
    ...
    void main(){vec4 c=texture2D(tDiffuse,vUv);
     ...
     gl_FragColor=c;}`}),L.addPass(I),L.addPass(new fH)}function A(s){if(S=!Z&&s==="high",S)k();N.halo.visible=!0,X.farol.visible=s==="high"}function d(s,p){if(L)L.setPixelRatio(Q.getPixelRatio()),L.setSize(s,p);q.aspect=$.aspect,q.updateProjectionMatrix()}let h=K?K.position.clone():null,g=new T;function Z0(s,p,{reduced:X0,view:a,ends:Y0,temblor:F0=0}){if(q.copy($),!X0){if(V.set(Math.sin(s*0.11)*0.012+Math.sin(s*0.037)*0.008,Math.sin(s*0.083+1)*0.007,Math.cos(s*0.097)*0.01),F0)V.add(M.set(Math.sin(s*97)*F0,Math.sin(s*113)*F0*0.6,Math.cos(s*89)*F0));q.position.add(V),M.copy(W.target).addScaledVector(V,0.35),q.lookAt(M)}if(!X0){let T0=0.012*Math.sin(s*2.86),x0=0.008*Math.sin(s*2.3+1.3);if(g.set(Math.sin(T0)*1.1,0,Math.sin(x0)*1.1),N.g.position.copy(U).add(g),N.g.rotation.set(x0,0,-T0),K)K.position.copy(h).add(g)}if(q.updateMatrixWorld(),N.halo.material.opacity=0.5+0.05*Math.sin(s*23)*Math.sin(s*1.7)+(X0?0:0.03*Math.sin(s*3.1)),!X0)for(let T0 of N.polillas){let x0=s*T0.w+T0.f;T0.s.position.set(Math.cos(x0)*T0.r,T0.y+Math.sin(x0*T0.k)*0.05,Math.sin(x0*1.3)*T0.r)}let r0=a?.phase==="playing";if(r0&&a.turn!=null){let[T0,x0,e0]=q9[a.turn],J0=R0.boardLimit+0.075;if(F.i!==a.turn)F.i=a.turn,F.destino=new T(T0*J0/R0.seatDistance,0,x0*J0/R0.seatDistance),F.angDestino=e0;F.pos.lerp(F.destino,1-Math.exp(-p*6));let w=F.angDestino-F.ang;w=Math.atan2(Math.sin(w),Math.cos(w)),F.ang+=w*(1-Math.exp(-p*6)),F.objetivo=0.8+(X0?0:0.12*Math.sin(s*2.2))}else F.objetivo=0;F.alfa+=(F.objetivo-F.alfa)*(1-Math.exp(-p*4)),G.material.opacity=F.alfa,G.visible=F.alfa>0.01,G.position.set(F.pos.x,R0.surfaceY+0.0012,F.pos.z),G.rotation.set(-Math.PI/2,0,F.ang);for(let T0=0;T0<2;T0++){let x0=D[T0],e0=r0&&Y0?Y0[T0]:null;if(!e0){x0.material.opacity=Math.max(0,x0.material.opacity-p*3),x0.visible=x0.material.opacity>0.01;continue}x0.visible=!0,x0.position.set(e0.x,R0.surfaceY+0.0015,e0.z);let J0=X0?1:1+0.12*Math.sin(s*3.4+T0*1.3);x0.scale.setScalar(J0),x0.material.opacity=Math.min(0.9,x0.material.opacity+p*3)}if(I)I.uniforms.uTiempo.value=s%100}function f(){if(S&&L)L.render();else Q.render(J,q)}function o(){L?.dispose()}return{vista:q,frame:Z0,render:f,resize:d,calidad:A,dispose:o,bulbPos:U,entorno:H}}var Z6=Math.PI*2,WJ=(J=0,Q=0,$=0)=>new T(J,Q,$),ZR=[[],[4],[0,8],[0,4,8],[0,2,6,8],[0,2,4,6,8],[0,2,3,5,6,8]];async function KB(J,{onProgress:Q=()=>{}}={}){let $=new l6;$.background=new b0("#2a2d4a"),$.fog=new l7("#5a5670",0.017);let W=new H8(42,innerWidth/innerHeight,0.08,90);W.position.set(3.1,2.65,4.2);let Z;try{Z=new UH({antialias:!0,alpha:!1,powerPreference:"high-performance"})}catch{throw Error("This device could not start WebGL. Try a recent desktop browser.")}let K=new URLSearchParams(location.search).has("hq"),H=!K&&/SwiftShader|llvmpipe|Software/i.test((()=>{let _=Z.getContext(),m=_.getExtension("WEBGL_debug_renderer_info");return m?_.getParameter(m.UNMASKED_RENDERER_WEBGL):""})());Z.setSize(innerWidth,innerHeight),Z.setPixelRatio(H?0.65:Math.min(devicePixelRatio,1.5,1920/innerWidth)),Z.outputColorSpace=q8,Z.toneMapping=v7,Z.toneMappingExposure=1.24,Z.shadowMap.enabled=!H,Z.shadowMap.type=y7,Z.info.autoReset=!1,J.appendChild(Z.domElement);let Y=new kH(W,Z.domElement);Y.target.set(0,0.8,-0.15),Y.enableDamping=!0,Y.dampingFactor=0.065,Y.enablePan=!1,Y.minDistance=0.8,Y.maxDistance=8,Y.minPolarAngle=0.25,Y.maxPolarAngle=Math.PI*0.48,Y.update();let X=0.5,U=new wW("#a3a8d8","#6a4e3c",X);$.add(U);let N=new i6("#ffa06a",0.55);N.position.set(-6,2.6,-9),$.add(N);let E=new s6("#ffc98a",5.2,7,Math.PI*0.32,0.6,2);E.position.set(0,R0.surfaceY+1.26,0),E.target.position.set(0,0,0);let G=new s9("#ffc07a",0.45,3.2,2);G.position.set(0,R0.surfaceY+1.2,0),$.add(G),E.castShadow=!0,E.shadow.mapSize.set(H?1024:2048,H?1024:2048),E.shadow.focus=0.52,E.shadow.bias=-0.0002,E.shadow.normalBias=0.004,E.shadow.radius=3,E.shadow.camera.near=0.2,E.shadow.camera.far=4,$.add(E,E.target);let F=new s9("#cfeee0",13,9,2);F.position.set(0,2.5,-3.5),$.add(F);{let _=new I0(new dJ(1.2,0.03,0.03),new s0({color:"#e6fff4",emissive:"#e6fff4",emissiveIntensity:4}));_.position.set(0,3.12,-3.6),$.add(_)}let R=new Map,D=new Map;function O(_,m=0.85,Q0=0){let u=_+","+m+","+Q0;if(!R.has(u))R.set(u,new s0({color:_,roughness:m,metalness:Q0}));return R.get(u)}function q(_,m,Q0,u=[0,0,0],E0=[1,1,1]){let K0=m.uuid;if(!D.has(K0))D.set(K0,{material:m,geos:[]});let C0=new QJ().compose(WJ(...Q0),new IJ().setFromEuler(new X9(...u)),WJ(...E0));_.applyMatrix4(C0),D.get(K0).geos.push(_)}function V(_,m,Q0,u,E0,K0,C0,p0=0){q(new dJ(u,E0,K0),typeof C0==="string"?O(C0):C0,[_,m,Q0],[0,p0,0])}function M(_,m,Q0,u,E0,K0,C0,p0=10,m0=[0,0,0]){q(new AJ(u,E0,K0,p0),typeof C0==="string"?O(C0):C0,[_,m,Q0],m0)}function L(_,m=512,Q0=512){let u=document.createElement("canvas");u.width=m,u.height=Q0,_(u.getContext("2d"),m,Q0);let E0=new T9(u);return E0.colorSpace=q8,E0.anisotropy=Math.min(8,Z.capabilities.getMaxAnisotropy()),E0}let P=191,I=()=>{return P=Math.imul(P,1664525)+1013904223>>>0,P/4294967296},S=L((_,m,Q0)=>{_.fillStyle="#65432b",_.fillRect(0,0,m,Q0);for(let u=0;u<700;u++){_.strokeStyle=`rgba(${I()>0.5?"170,122,70":"35,22,14"},${0.08+I()*0.2})`,_.lineWidth=0.3+I()*2,_.beginPath();let E0=I()*Q0;_.moveTo(0,E0);for(let K0=0;K0<m;K0+=20)_.lineTo(K0,E0+Math.sin(K0*0.013+u)*3);_.stroke()}}),k=new s0({map:S,roughness:0.65,color:"#e7bc8c"}),A=O("#4c3022",0.75),d=O("#287770"),h=O("#d2c5a2"),g=O("#3d938e"),Z0=L((_,m,Q0)=>{let u=m/2;for(let m0=0;m0<2;m0++)for(let G0=0;G0<2;G0++){let h0=G0*u,UJ=m0*u;_.save(),_.beginPath(),_.rect(h0,UJ,u,u),_.clip(),_.fillStyle="#c4b99f",_.fillRect(h0,UJ,u,u);for(let[DJ,I8]of[[h0,UJ],[h0+u,UJ],[h0,UJ+u],[h0+u,UJ+u]])_.strokeStyle="#8d6450",_.lineWidth=u*0.04,_.beginPath(),_.arc(DJ,I8,u*0.42,0,Math.PI*2),_.stroke(),_.fillStyle="#4f6763",_.beginPath(),_.arc(DJ,I8,u*0.13,0,Math.PI*2),_.fill(),_.strokeStyle="#c4b99f",_.lineWidth=u*0.02,_.beginPath(),_.arc(DJ,I8,u*0.11,0,Math.PI*2),_.stroke();let JJ=h0+u/2,VJ=UJ+u/2,vJ=(DJ,I8)=>{_.fillStyle=I8,_.beginPath(),_.moveTo(JJ,VJ-DJ),_.lineTo(JJ+DJ,VJ),_.lineTo(JJ,VJ+DJ),_.lineTo(JJ-DJ,VJ),_.closePath(),_.fill()};vJ(u*0.2,"#8d6450"),vJ(u*0.13,"#c4b99f"),vJ(u*0.07,"#3a3630"),_.restore(),_.strokeStyle="#7e7563",_.lineWidth=3,_.strokeRect(h0+1.5,UJ+1.5,u-3,u-3)}for(let m0=0;m0<9000;m0++)_.fillStyle=I()>0.5?"rgba(235,228,205,.07)":"rgba(30,28,24,.09)",_.fillRect(I()*m,I()*Q0,1+I()*2,1+I()*2);for(let m0=0;m0<40;m0++){let G0=_.createRadialGradient(0,0,0,0,0,1),h0=I()*m,UJ=I()*Q0,JJ=20+I()*90;_.save(),_.translate(h0,UJ),_.scale(JJ,JJ),G0.addColorStop(0,"rgba(40,34,26,.10)"),G0.addColorStop(1,"rgba(40,34,26,0)"),_.fillStyle=G0,_.fillRect(-1,-1,2,2),_.restore()}},1024,1024);Z0.wrapS=Z0.wrapT=U7,Z0.repeat.set(22.88888888888889,27.77777777777778),V(-5.7,-0.1,-4.575,20.6,0.2,15.85,new s0({map:Z0,roughness:0.86,color:"#9d937f"})),V(0,-0.2,8.5,40,0.1,10.3,"#2b3133"),V(0,-0.075,3.45,40,0.15,0.2,"#a8a391");for(let _=-10;_<11;_++)V(_*1.8,-0.146,6.3,0.7,0.008,0.06,"#b9ad83");V(0,1.6,-5.1,7.5,3.4,0.2,d),V(-3.8,1.6,-3.85,0.2,3.4,2.7,d),V(3.8,1.6,-3.85,0.2,3.4,2.7,d),V(-3.48,1.1,-2.52,0.7,2.3,0.32,d),V(3.45,1.1,-2.52,0.8,2.3,0.32,d),V(0,2.95,-2.52,7.5,0.42,0.35,g),V(0,3.24,-3.7,8,0.12,4.4,"#435451");for(let _=0;_<30;_++)V(-4+_*0.276,3.15,-3.7,0.028,0.055,4.6,"#82928a");V(0,0.7,-4.24,3.9,1.4,0.62,k),V(0,1.43,-4.2,4.08,0.1,0.78,k);for(let _=0;_<3;_++)V(-0.6,1.58+_*0.48,-4.78,5.8,0.065,0.38,k),V(-0.6,1.84+_*0.48,-4.98,5.8,0.48,0.065,"#443e30");V(2.95,1.02,-4.55,1.02,2.1,0.8,"#d0ceb8"),V(2.95,1.12,-4.11,0.84,1.55,0.035,"#254c51");let f=[];for(let _=0;_<29;_++)f.push({pos:[-3.18+_*0.182,2.095,-4.69],scale:0.7+_%5*0.07,color:["#566641","#b0762a","#2e5a45","#7a3024","#c9b36a","#3b4f7a"][_*7%6]});let o=new q7([new U0(0,0),new U0(0.036,0),new U0(0.043,0.025),new U0(0.043,0.17),new U0(0.019,0.205),new U0(0.017,0.285),new U0(0.021,0.29),new U0(0.021,0.305),new U0(0,0.31)],12);f.forEach((_)=>q(o.clone(),O(_.color,0.3),_.pos,[0,0,0],[_.scale,_.scale,_.scale]));for(let[_,m,Q0]of[[-3.1,-1.9,"#a8483a"]])for(let u=0;u<3;u++){V(_,0.19+u*0.34,m,0.52,0.3,0.4,Q0);for(let E0=0;E0<5;E0++)V(_-0.2+E0*0.1,0.18+u*0.34,m+0.204,0.055,0.16,0.015,"#2c3025")}for(let _=0;_<5;_++){let m=-7-_*3.5;V(m,1.5,-3,3.1,3,3.2,["#d9a35c","#7fb1a4","#d8c7a2","#c98d7c","#a6bf8e"][_]),V(m,2.2,-1.38,1,0.8,0.045,"#b59961"),V(m,2.2,-1.35,0.045,0.86,0.055,"#273e37"),V(m,0.98,-1.38,0.9,1.9,0.04,"#354e49")}for(let _=0;_<4;_++)M(-5-_*5,2.3,-1,0.08,0.09,4.6,"#665443"),V(-5-_*5,4.2,-1,1.8,0.09,0.09,"#514b3d");function s(_,m,Q0,u="#202d28"){let E0=new F9(WJ(..._),WJ(...Q0),WJ(...m));q(new i8(E0,20,0.008,4,!1),O(u),[0,0,0])}let p=[];for(let _ of[-1.95,1.95])M(_,1.45,2.55,0.035,0.045,2.9,"#5b4a38",8);for(let[_,m,Q0]of[[[-2.7,2.9,-2.45],[-1.95,2.85,2.55],0.5],[[2.7,2.9,-2.45],[1.95,2.85,2.55],0.5],[[-1.95,2.85,2.55],[1.95,2.85,2.55],0.32]]){let u=WJ(..._),E0=WJ(...m),K0=u.clone().lerp(E0,0.5);K0.y-=Q0*2;let C0=new F9(u,K0,E0);q(new i8(C0,24,0.006,4,!1),O("#1c2320"),[0,0,0]);let p0=Math.round(u.distanceTo(E0)/0.42);for(let m0=1;m0<p0;m0++){let G0=C0.getPointAt(m0/p0);p.push(G0.setY(G0.y-0.035))}}{let _=new k8(0.022,10,8);_.scale(1,1.3,1);let m=["#ffd89a","#ffc27a","#ffe3a8"],Q0=new _9(_,new nJ({color:new b0(4.5,4.5,4.5)}),p.length),u=new TJ;p.forEach((E0,K0)=>{u.position.copy(E0),u.updateMatrix(),Q0.setMatrixAt(K0,u.matrix),Q0.setColorAt(K0,new b0(m[K0%m.length]))}),$.add(Q0)}s([0,3.22,-1.6],[0,3.19,0],[0,3.02,-0.8]);let X0=new fJ;X0.position.set(4.3,0,-1.7),$.add(X0);let a=new I0(new AJ(0.1,0.15,4.5,9),O("#696047"));a.position.y=2.25,X0.add(a);for(let _=0;_<9;_++){let m=new I0(new k8(1,10,5),O(_%2?"#4a654c":"#344e3d"));m.scale.set(0.27,0.075,1.5),m.position.set(Math.sin(_*Z6/9)*0.72,4.35,Math.cos(_*Z6/9)*0.72),m.rotation.set(0.23,_*Z6/9,0),X0.add(m)}let Y0=new O8({map:S,color:"#d9a877",roughness:0.5,clearcoat:0.55,clearcoatRoughness:0.28}),F0=new I0(new _8(R0.tableWidth,R0.tableThickness,R0.tableWidth,3,0.035),Y0);F0.position.y=R0.tableCenterY,F0.castShadow=!0,F0.receiveShadow=!0,$.add(F0);let r0=L((_,m,Q0)=>{_.fillStyle="#2f5b47",_.fillRect(0,0,m,Q0);for(let E0=0;E0<Q0;E0+=2)for(let K0=0;K0<m;K0+=2){let C0=(I()-0.5)*14,p0=((K0>>1)+(E0>>1))%2?4:-4;_.fillStyle=`rgb(${47+C0+p0},${91+C0+p0},${71+C0+p0})`,_.fillRect(K0,E0,2,2)}for(let E0=0;E0<4;E0++){let K0=E0*Math.PI/2,C0=m/2+Math.sin(K0)*m*0.36,p0=Q0/2+Math.cos(K0)*Q0*0.36,m0=_.createRadialGradient(C0,p0,0,C0,p0,m*0.2);m0.addColorStop(0,"rgba(120,150,120,.16)"),m0.addColorStop(1,"rgba(120,150,120,0)"),_.fillStyle=m0,_.fillRect(0,0,m,Q0)}let u=_.createRadialGradient(m/2,Q0/2,m*0.1,m/2,Q0/2,m*0.62);u.addColorStop(0,"rgba(0,0,0,0)"),u.addColorStop(1,"rgba(0,0,0,.28)"),_.fillStyle=u,_.fillRect(0,0,m,Q0)},512,512),T0=new I0(new _8(R0.feltWidth,0.012,R0.feltWidth,2,0.02),new O8({map:r0,roughness:0.97,sheen:0.8,sheenRoughness:0.55,sheenColor:new b0("#9fc7a8")}));T0.position.y=R0.feltCenterY,T0.receiveShadow=!0,$.add(T0);let x0=R0.tableWidth/2-0.07;for(let _ of[-x0,x0])for(let m of[-x0,x0])V(_,0.35,m,0.075,0.68,0.075,A);let e0=["#C8402F","#6FB7C9"];for(let _=0;_<4;_++){let[m,Q0,u]=q9[_],E0=R0.feltWidth/2-0.012,K0=new I0(new zJ(R0.feltWidth*0.72,0.009),new s0({color:e0[_%2],roughness:0.9}));K0.rotation.set(-Math.PI/2,0,u),K0.position.set(m*E0/R0.seatDistance,R0.surfaceY+0.0006,Q0*E0/R0.seatDistance),K0.receiveShadow=!0,$.add(K0)}let J0=new s0({roughness:0.92,map:L((_,m,Q0)=>{_.fillStyle="#8f7446",_.fillRect(0,0,m,Q0);let u=12,E0=m/u;for(let K0=0;K0<u;K0++)for(let C0=0;C0<u;C0++){let p0=(C0+K0)%2===0;for(let m0=0;m0<3;m0++){let G0=150+I()*45|0;_.fillStyle=`rgb(${G0+30},${G0+8},${G0-45})`;let h0=m0*E0/3+E0*0.04,UJ=E0/3-E0*0.08;if(p0)_.fillRect(C0*E0+1,K0*E0+h0,E0-2,UJ);else _.fillRect(C0*E0+h0,K0*E0+1,UJ,E0-2)}}_.fillStyle="rgba(40,28,14,.18)";for(let K0=0;K0<=u;K0++)_.fillRect(K0*E0-1,0,2,Q0),_.fillRect(0,K0*E0-1,m,2)},256,256)});for(let _=0;_<4;_++){let[m,Q0,u]=q9[_],E0=new fJ;E0.position.set(m,0,Q0),E0.rotation.y=u,$.add(E0);let K0=O(_%2?"#5e9fb2":"#b53f2e",0.62),C0=(p0,m0,G0,h0,UJ,JJ,VJ=K0,vJ=0.008)=>{let DJ=WJ(h0,UJ,JJ).applyAxisAngle(WJ(0,1,0),u).add(WJ(m,0,Q0));q(new _8(p0,m0,G0,2,vJ),VJ,DJ.toArray(),[0,u,0])};C0(R0.chairSeatWidth-0.04,0.035,0.5,0,R0.chairSeatY,0,J0,0.01);for(let p0 of[-1,1])C0(0.04,0.05,0.54,p0*(R0.chairSeatWidth/2-0.02),R0.chairSeatY-0.005,0);for(let p0 of[-1,1])C0(R0.chairSeatWidth,0.05,0.04,0,R0.chairSeatY-0.005,p0*0.25);for(let p0 of[-0.24,0.24])for(let m0 of[-0.21,0.21])C0(0.04,R0.chairSeatY,0.04,p0,R0.chairSeatY/2,m0);for(let p0 of[-0.24,0.24])C0(0.024,0.024,0.42,p0,0.15,0);C0(0.48,0.024,0.024,0,0.15,0.21);for(let p0 of[-0.24,0.24])C0(0.04,0.52,0.04,p0,R0.chairSeatY+0.26,-0.23);for(let p0 of[0.2,0.33,0.46])C0(0.46,p0===0.46?0.07:0.045,0.022,0,R0.chairSeatY+p0,-0.23)}function w(_,m,Q0,u,E0,K0=60){let C0=L((p0,m0,G0)=>{p0.fillStyle=u,p0.fillRect(0,0,m0,G0),p0.fillStyle=E0,p0.textAlign="center",p0.textBaseline="middle",p0.font=`bold ${K0}px Georgia`,p0.fillText(_,m0/2,G0/2)},1024,256);return new I0(new zJ(m,Q0),new nJ({map:C0}))}let x=w("COLMADO  LA ESQUINA",4.8,0.38,"#a05d42","#f8e8b9",64);x.position.set(0,2.94,-2.33),$.add(x);let l=w("MESA",0.11,0.029,"#284e3e","#81906b",77);l.material=new s0({map:l.material.map,roughness:1}),l.rotation.x=-Math.PI/2,l.position.set(0,R0.surfaceY+0.001,0.3),$.add(l);let e=new fJ;e.position.set(-0.9,2.62,-3.45),e.rotation.x=-Math.PI/2,$.add(e),M(-0.9,2.9,-3.45,0.015,0.015,0.56,"#777a68",8),M(-0.9,3.16,-3.45,0.075,0.075,0.025,"#767763",12);let t=new I0(new k8(0.075,12,8),O("#41493d"));e.add(t);for(let _=0;_<5;_++){let m=new I0(new dJ(0.13,0.5,0.025),O("#85856e",0.88,0.05));m.position.set(Math.sin(_*Z6/5)*0.285,Math.cos(_*Z6/5)*0.285,0),m.rotation.z=-_*Z6/5,e.add(m)}let D0=new fJ;D0.position.set(-12,0.05,5.2),$.add(D0);for(let _ of[-0.36,0.36]){let m=new I0(new S9(0.19,0.038,7,14),O("#182221"));m.position.set(_,0.2,0),D0.add(m)}let L0=new I0(new _8(0.65,0.17,0.2,2,0.04),O("#823e2f",0.45,0.25));L0.position.y=0.49,D0.add(L0);let N0=new I0(new dJ(0.35,0.06,0.22),O("#202725"));N0.position.set(-0.08,0.61,0),D0.add(N0);let g0=new I0(new AJ(0.015,0.015,0.45,6),O("#8c9c96",0.4,0.5));g0.position.set(0.32,0.59,0),g0.rotation.z=-0.3,D0.add(g0);let c0=M5({scene:$,texture:L,mat:O,box:V,cylinder:M,random:I,teal:d,wood:k,storeSign:x}),kJ=C5({scene:$,texture:L,mat:O,box:V,cylinder:M,staticGeo:q,random:I,renderer:Z});for(let{material:_,geos:m}of D.values()){let Q0=lW(m.some((u)=>!u.index)?m.map((u)=>u.index?u.toNonIndexed():u):m,!1);if(Q0){let u=new I0(Q0,_);u.receiveShadow=!0,Q0.computeBoundingBox(),u.castShadow=Q0.boundingBox.distanceToPoint(WJ(0,0.8,0))<1.6&&Q0.boundingBox.getSize(WJ()).length()<8,$.add(u)}m.forEach((u)=>u.dispose())}let j0=new fJ,MJ=new fJ;$.add(j0,MJ);let _J=new _8(R0.tileLength,R0.tileThickness,R0.tileWidth,3,0.0024),hJ=new O8({color:"#f4eee0",roughness:0.36,clearcoat:0.85,clearcoatRoughness:0.22}),y=new O8({color:"#e2dac6",roughness:0.42,clearcoat:0.7,clearcoatRoughness:0.3}),cJ=new s0({color:"#b98b3e",roughness:0.28,metalness:1}),XJ=new AJ(0.0019,0.0019,0.0009,12),RJ=new s0({color:"#0b0a09",roughness:0.55}),z=new s0({color:"#2a2622",roughness:0.6}),B=new AJ(R0.pipRadius,R0.pipRadius,0.0007,14),j=new dJ(0.0014,0.0005,R0.tileWidth*0.8),i=new Set([_J,B,j,XJ]),q0=new Set([hJ,y,RJ,z,cJ]),B0=[Y0,T0.material,hJ,y].map((_)=>[_,{clearcoat:_.clearcoat,sheen:_.sheen}]);function z0(_,m,Q0=!1){let u=new fJ,E0=new I0(_J,Q0?y:hJ);if(E0.castShadow=!0,E0.receiveShadow=!0,u.add(E0),!Q0){let K0=[];if([_,m].forEach((m0,G0)=>ZR[m0].forEach((h0)=>K0.push(WJ((G0===0?-1:1)*R0.tileLength/4+(h0%3-1)*R0.pipColumnSpacing,R0.tileThickness/2+0.0005,(Math.floor(h0/3)-1)*R0.pipRowSpacing)))),K0.length){let m0=new _9(B,RJ,K0.length),G0=new QJ;K0.forEach((h0,UJ)=>m0.setMatrixAt(UJ,G0.makeTranslation(h0.x,h0.y,h0.z))),u.add(m0)}let C0=new I0(j,z);C0.position.y=R0.tileThickness/2+0.0002,u.add(C0);let p0=new I0(XJ,cJ);p0.position.y=R0.tileThickness/2+0.0004,u.add(p0)}return u}function $0(_){return WJ(_.x,R0.surfaceY+R0.tileThickness/2+0.001,_.z)}let H0=new I0(new S9(0.2,0.006,5,38),new nJ({color:"#e8bf70",transparent:!0,opacity:0.7}));H0.rotation.x=-Math.PI/2,H0.position.y=0.027,$.add(H0);let k0=[],n0=[],M0=[],V0=[],t0=new LH,a0=0,CJ=4,b=[];V0.push(...P5($));let A0=WJ(),W0=WJ(),P0=WJ(),v0=WJ(),O0=new QJ,S0=WJ(),ZJ=WJ();function uJ(_){let m=null;if(_.root.traverse((JJ)=>{if(JJ.isSkinnedMesh&&JJ.morphTargetDictionary&&!m)m=JJ}),!m||m.morphTargetDictionary.parpadeo==null)return;_.cara={mesh:m,iP:m.morphTargetDictionary.parpadeo,iS:m.morphTargetDictionary.sonrisa};let Q0=m.geometry.attributes.position,u=m.userData?.boca;if(u){let JJ=1e9,VJ=0;for(let vJ=0;vJ<Q0.count;vJ++){let DJ=(Q0.getX(vJ)-u[0])**2+(Q0.getY(vJ)-u[1])**2+(Q0.getZ(vJ)-u[2])**2;if(DJ<JJ)JJ=DJ,VJ=vJ}_.bocaMundo=(vJ)=>{return m.skeleton.update(),m.getVertexPosition(VJ,vJ).applyMatrix4(m.matrixWorld)}}let E0=m.userData?.ojos,K0=m.userData?.parpado;if(!E0||!K0)return;let C0=m.geometry.attributes.position,p0=(JJ)=>{let VJ=1e9,vJ=0;for(let DJ=0;DJ<C0.count;DJ++){let I8=(C0.getX(DJ)-JJ[0])**2+(C0.getY(DJ)-JJ[1])**2+(C0.getZ(DJ)-JJ[2])**2;if(I8<VJ)VJ=I8,vJ=DJ}return vJ},m0=new zJ(0.027,0.0125,8,4);m0.translate(0,-0.00625,0);let G0=m0.attributes.position,h0=[];for(let JJ=0;JJ<G0.count;JJ++){let VJ=G0.getX(JJ)/0.0135,vJ=-G0.getY(JJ)/0.0125;G0.setZ(JJ,0.0032*Math.cos(VJ*Math.PI/2)*(0.5+0.5*vJ));let DJ=vJ>0.85?0.45:1;h0.push(DJ,DJ,DJ)}m0.setAttribute("color",new qJ(h0,3)),m0.computeVertexNormals();let UJ=new s0({color:new b0().setRGB(...K0,q8),roughness:0.7,vertexColors:!0});_.parpados=E0.map((JJ)=>{let VJ=new I0(m0,UJ);return VJ.visible=!1,VJ.frustumCulled=!1,$.add(VJ),{m:VJ,k:p0(JJ)}})}function SJ(_){let m=_.parpados;if(!m||!_.cara)return;let Q0=_.parpadeo||0;if(Q0<0.03){for(let C0 of m)C0.m.visible=!1;return}let u=_.cara.mesh;u.skeleton.update();let E0=u.getVertexPosition(m[0].k,A0).applyMatrix4(u.matrixWorld).clone(),K0=u.getVertexPosition(m[1].k,A0).applyMatrix4(u.matrixWorld).clone();if(_.head.getWorldPosition(S0),_.front.getWorldPosition(ZJ),v0.subVectors(ZJ,S0).normalize(),W0.subVectors(K0,E0).normalize(),P0.crossVectors(v0,W0).normalize(),P0.y<0)P0.negate();W0.crossVectors(P0,v0).normalize(),O0.makeBasis(W0,P0,v0);for(let[C0,p0]of[[m[0],E0],[m[1],K0]])C0.m.visible=!0,C0.m.quaternion.setFromRotationMatrix(O0),C0.m.position.copy(p0).addScaledVector(P0,0.0052).addScaledVector(v0,0.0024),C0.m.scale.set(1,Q0,1)}async function l8(_,m){try{Q(`Seating ${["Don Rafa","Marisol","Luis","Carmen"][_]}…`,a0/CJ);let Q0=await t0.loadAsync(`/models/${m}.glb`);n0[_]=Q0;let u=Q0.scene,E0=new fJ;E0.add(u);let K0=new J$(u);if(Q0.animations[0])K0.clipAction(Q0.animations.find((JJ)=>JJ.name==="Seated")||Q0.animations[0]).play();K0.setTime(R0.neutralPoseTime),u.updateMatrixWorld(!0),u.traverse((JJ)=>{if(JJ.isSkinnedMesh)JJ.computeBoundingBox();if(JJ.isMesh)JJ.castShadow=!0,JJ.receiveShadow=!0,JJ.frustumCulled=!1,JJ.material.roughness=0.83});let C0=new A8().setFromObject(u),p0=u.getObjectByName("Hips"),m0=p0?.getWorldPosition(WJ())||C0.getCenter(WJ());u.position.set(-m0.x,-C0.min.y,-m0.z);let[G0,h0,UJ]=q9[_];if(E0.position.set(G0,0,h0),E0.rotation.y=UJ,$.add(E0),k0[_]={root:u,holder:E0,index:_,pose:wH(u),head:u.getObjectByName("Head"),neck:u.getObjectByName("neck"),front:u.getObjectByName("headfront"),chest:u.getObjectByName("Spine"),hips:u.getObjectByName("Hips"),lomo:u.getObjectByName("Spine02"),muslos:[u.getObjectByName("LeftUpLeg"),u.getObjectByName("RightUpLeg")],hombros:[[1,u.getObjectByName("LeftShoulder")],[-1,u.getObjectByName("RightShoulder")]],spine:u.getObjectByName("Spine01"),reaction:null,brazos:["Left","Right"].map((JJ)=>({lado:JJ,hombro:u.getObjectByName(JJ+"Shoulder"),brazo:u.getObjectByName(JJ+"Arm"),antebrazo:u.getObjectByName(JJ+"ForeArm"),mano:u.getObjectByName(JJ+"Hand")}))},k0[_].bebida=V0.find((JJ)=>JJ.index===_),uJ(k0[_]),a0++,Q(a0===4?"The table is ready.":`${a0} of 4 seats ready`,a0/CJ),M0.length===0&&k9>0)X6(k9)}catch(Q0){b.push(m),console.error("Character load failed",m,Q0),Q(`Could not load ${m}. Reload to retry.`,a0/CJ)}}let Q9=Promise.all(["rafa-upright","marisol","luis-upright","carmen"].map((_,m)=>l8(m,_))),R$=null,K6=null,H6="",ZQ=null,R8=T5({scene:$,renderer:Z,camera:W,controls:Y,software:H,bulbLight:E});R8.calidad("high");let Y6=new Set,B9=new Map,KQ=[0,1,2,3].map(()=>WJ()),HQ=(_)=>{let m=_.detail||{};if(m.active)Y6.add(m.seat),B9.set(m.seat,m.type);else Y6.delete(m.seat)};window.addEventListener("mesa:botvoice",HQ);let M7=null,k9=0,eW="",C7=0,L$="attract",Z8=null,$9=[],JZ=0,V$=0;function YQ(_){while(_.children.length){let m=_.children.pop();m.parent=null,m.traverse((Q0)=>{if(Q0.isMesh&&!i.has(Q0.geometry))Q0.geometry.dispose();if(Q0.isMesh&&!q0.has(Q0.material))Q0.material.dispose()})}}function X6(_){k9=_;let m=Math.min(8,_);for(let Q0=M0.length-1;Q0>=m;Q0--)$.remove(M0[Q0].holder),M0.pop();while(M0.length<m&&n0.filter(Boolean).length){let Q0=M0.length,u=n0[Q0%4]||n0.find(Boolean),E0=mW(u.scene),K0=new fJ;K0.add(E0);let C0=new J$(E0);if(u.animations[0])C0.clipAction(u.animations.find((h0)=>h0.name==="Seated")||u.animations[0]).play();C0.setTime(R0.neutralPoseTime),E0.updateMatrixWorld(!0),E0.traverse((h0)=>{if(h0.isSkinnedMesh)h0.computeBoundingBox();if(h0.isMesh)h0.castShadow=!1,h0.frustumCulled=!1});let p0=new A8().setFromObject(E0),m0=E0.getObjectByName("Hips")?.getWorldPosition(WJ())||p0.getCenter(WJ());E0.position.x-=m0.x,E0.position.y-=p0.min.y,E0.position.z-=m0.z,K0.position.set(-2.5+Q0%4*1.66,0,-2.5-Math.floor(Q0/4)*0.65),K0.rotation.y=0,$.add(K0);let G0=new I0(new dJ(0.56,0.06,0.54),h);G0.position.set(0,R0.chairSeatY,0),K0.add(G0),M0.push({root:E0,holder:K0,pose:wH(E0),head:E0.getObjectByName("Head"),neck:E0.getObjectByName("neck"),front:E0.getObjectByName("headfront"),chest:E0.getObjectByName("Spine"),spine:E0.getObjectByName("Spine01"),index:Q0+4})}}let C=-1,v=null,r=Y.minDistance;function n(_,m,Q0){if(document.documentElement.classList.contains("reduced"))return;let u=WJ(1,0,1).normalize(),E0=-9;for(let[C0,p0]of[[1,1],[1,-1],[-1,1],[-1,-1]]){let m0=WJ(C0,0,p0).normalize(),G0=m0.x*_.x+m0.z*_.z;if(G0>E0)E0=G0,u=m0}let K0=_.clone().addScaledVector(u,0.3);if(K0.x=G7.clamp(K0.x,-0.4,0.4),K0.z=G7.clamp(K0.z,-0.4,0.4),K0.y=R0.surfaceY+(Q0?0.12:0.19),!v)r=Y.minDistance;Y.minDistance=0.1,v={pos:v?.pos||W.position.clone(),target:v?.target||Y.target.clone(),at:FJ.elapsedTime+3.4},Z8={from:W.position.clone(),to:K0,fromTarget:Y.target.clone(),toTarget:_.clone().setY(_.y+0.01),t:0,dur:0.45}}function c(_="table"){if(Y.minDistance=_==="seat"||_==="close"?0.3:0.7,Y.minPolarAngle=_==="overhead"?0.01:0.25,W.aspect<0.95&&_==="table")_="overhead";let m,Q0=WJ(0,0.8,0);if(_==="attract")m=WJ(0.75,1.3,4.4),Q0=WJ(-1,1.4,-1.2);else if(_==="overhead")m=WJ(0.001,1.86,0.34),Q0=WJ(0,R0.surfaceY,0.02);else if(_==="seat")m=WJ(0,1.36,0.74),Q0=WJ(0,0.82,-0.12);else if(_==="close")m=WJ(0.62,1.3,1),Q0=WJ(-0.03,0.85,-0.08);else m=WJ(0.85,1.66,1.5),Q0=WJ(0,0.85,-0.14);if(_!=="attract"&&_!=="seat"&&W.aspect<1.3){let u=Math.min(2.4,Math.pow(1.6/W.aspect,0.8));m=Q0.clone().add(m.clone().sub(Q0).multiplyScalar(u))}if(k0[0])k0[0].root.visible=_!=="seat";v=null,Y.minDistance=Math.min(Y.minDistance,r),Z8={from:W.position.clone(),to:m,fromTarget:Y.target.clone(),toTarget:Q0,t:0}}let _0=WJ(0,1,0),l0=new IJ().setFromAxisAngle(WJ(1,0,0),0.12),w0=new IJ().setFromAxisAngle(_0,Math.PI/2),d0=new IJ().setFromAxisAngle(WJ(0,0,1),Math.PI/2),i0=R0.tableCenterY+R0.tableThickness/2+R0.tileLength/2*Math.cos(0.12)+R0.tileThickness/2*Math.sin(0.12)+0.001;function HJ(_,m,Q0){let u=q9[_][2];return Q0.quaternion.setFromAxisAngle(_0,u).multiply(l0).multiply(w0).multiply(d0),Q0.position.set(m,i0,-R0.rackRadius).applyAxisAngle(_0,u),Q0}let KJ=new _9(_J,y,28);KJ.count=0,KJ.castShadow=!0,KJ.receiveShadow=!0,KJ.frustumCulled=!1,MJ.add(KJ);let u0=[[],[],[],[]],EJ=new TJ,iJ=[0,0,0,0],bJ="",jJ=new Set;function N8(_){let m=0;for(let Q0=0;Q0<4;Q0++){let u=jJ.has(Q0)?0:iJ[Q0],E0=u0[Q0];while(E0.length<u)E0.push((E0.length-(u-1)/2)*R0.rackSpacing);E0.length=u;for(let K0=0;K0<u;K0++){let C0=(K0-(u-1)/2)*R0.rackSpacing;E0[K0]+=(C0-E0[K0])*(1-Math.exp(-_*10)),HJ(Q0,E0[K0],EJ),EJ.updateMatrix(),KJ.setMatrixAt(m++,EJ.matrix)}}KJ.count=m,KJ.instanceMatrix.needsUpdate=!0}let f0=new fJ;$.add(f0);let K8=new Map,PJ="",P8="";function m8(){for(let _=0;_<28;_++){let m=z0(0,0,!0);m.position.set((_*37%23-11)*0.016,R0.surfaceY+R0.tileThickness*(0.55+_%3*0.9),(_*13%19-9)*0.016),m.rotation.y=_*1.73,j0.add(m)}}let V8=(_)=>_*_*(3-2*_),r9=new IJ().setFromAxisAngle(WJ(1,0,0),Math.PI),yJ=new IJ().setFromAxisAngle(_0,-Math.PI/2);function oJ(_,m){_.revealed.forEach((Q0,u)=>{let E0=Q0.length,K0=q9[u][2];Q0.forEach((C0,p0)=>{let m0=(p0-(E0-1)/2)*R0.rackSpacing,G0=z0(C0.a,C0.b);HJ(u,m0,EJ);let h0=EJ.quaternion.clone().multiply(r9),UJ=EJ.position.clone(),JJ=WJ(m0,R0.surfaceY+R0.tileThickness/2+0.001,-R0.rackRadius+0.047).applyAxisAngle(_0,K0),VJ=new IJ().setFromAxisAngle(_0,K0).multiply(yJ);G0.position.copy(UJ),G0.quaternion.copy(h0),G0.visible=!1,j0.add(G0),$9.push({obj:G0,from:UJ,to:JJ,qFrom:h0,qTo:VJ,elapsed:-(m+u*0.3+p0*0.055),duration:0.42,revela:u,ultima:p0===E0-1})})})}function W9(_,m=0){M7=_;{let K0=_&&(_.phase==="handEnd"||_.phase==="seriesEnd")&&_.result,C0=K0?_.handNo+":"+_.phase:"";if(C0&&C0!==H6)K6={t:FJ.elapsedTime+0.5,team:_.result.team??null};if(!K0)K6=null;H6=C0}if(k9!==m)X6(m);let Q0=!_||_.phase==="lobby"?"pila":"mano"+_.handNo;if(Q0!==PJ){PJ=Q0,YQ(j0),K8.clear(),$9=$9.filter((K0)=>K0.reparto);for(let K0 of k0)if(K0)K0.jugada=null;if(Q0==="pila")m8()}if(_&&_.chain?.length){let K0=X5(_.chain,_.moves),C0=_.event,p0=["domino","capicua","tranque"].includes(C0?.type),m0=_.moves[_.moves.length-1],G0=C0?.type==="domino"||C0?.type==="capicua",h0=C0?.type==="play"?C0.tile:p0&&m0?.type==="play"?m0.tile:null;_.chain.forEach((UJ,JJ)=>{if(K8.has(UJ.id))return;let VJ=z0(UJ.x,UJ.y),vJ=$0(K0[JJ]);if(VJ.position.copy(vJ),VJ.rotation.y=K0[JJ].yaw,VJ.updateMatrix(),j0.add(VJ),K8.set(UJ.id,VJ),UJ.id!==h0||UJ.seat==null)return;HJ(UJ.seat,0,EJ);let DJ={obj:VJ,from:EJ.position.clone(),to:vJ.clone(),qFrom:EJ.quaternion.clone(),qTo:VJ.quaternion.clone(),elapsed:0,duration:G0?0.7:0.55,golpe:G0};if(VJ.position.copy(DJ.from),VJ.quaternion.copy(DJ.qFrom),$9.push(DJ),p0)n(vJ,UJ.seat,G0);JZ=performance.now();let I8=k0[UJ.seat];if(R$={p:vJ.clone(),t:FJ.elapsedTime+DJ.duration},I8)I8.reaction={time:FJ.elapsedTime},I8.jugada={t0:FJ.elapsedTime,obj:VJ,anim:DJ,hasta:vJ.clone()}})}if(_?.phase==="playing"&&_.handNo!==C7&&_.moves.length===0){C7=_.handNo,YQ(f0),$9=$9.filter((K0)=>!K0.reparto),V$=performance.now()+3300;for(let K0=0;K0<4;K0++)u0[K0]=Array.from({length:7},(C0,p0)=>(p0-3)*R0.rackSpacing);for(let K0=0;K0<28;K0++){let C0=K0%4,p0=Math.floor(K0/4),m0=z0(0,0,!0),G0=WJ((K0*37%23-11)*0.015,R0.surfaceY+0.012,(K0*13%19-9)*0.015);m0.position.copy(G0),m0.rotation.y=K0*1.73,f0.add(m0);let h0=HJ(C0,(p0-3)*R0.rackSpacing,new TJ);$9.push({obj:m0,from:G0,to:h0.position.clone(),qFrom:m0.quaternion.clone(),qTo:h0.quaternion.clone(),elapsed:-K0*0.065,duration:1.1,reparto:!0})}}let u=_?.moves?.[_.moves.length-1],E0=_?_.handNo+":"+_.moves.length:"";if(u?.type==="pass"&&P8!==E0){P8=E0;let K0=k0[u.seat];if(K0)K0.toque={t0:FJ.elapsedTime}}{let K0=_&&(_.phase==="handEnd"||_.phase==="seriesEnd")&&_.revealed,C0=K0?"r"+_.handNo:"";if(!K0)bJ="",jJ.clear();else if(C0!==bJ){bJ=C0;let p0=_.result?.type;oJ(_,p0==="domino"||p0==="capicua"?3.4:p0==="tranque"?2.5:1.2)}}iJ=[0,1,2,3].map((K0)=>!_||_.phase==="lobby"?0:_.counts[K0]??0),H0.visible=!1,ZQ=_?.phase==="playing"&&_.chain?.length?U5(_.chain,_.moves):null}let FJ=new fW,S8=0,M9=0,P7=0,XQ=60,bH=!1,D$=!1,UQ=null,U6="high",xH=null,B$=performance.now(),k$=0,gH=!1,S5=new URLSearchParams(location.search).has("debug"),pH=E.intensity,I7=WJ(),w5=WJ(0,R0.surfaceY,0);function QZ(){if(bH||D$){UQ=null;return}UQ=requestAnimationFrame(QZ);let _=FJ.getDelta(),m=Math.min(_,0.06),Q0=xH??FJ.elapsedTime,u=performance.now();if(M9++,P7+=_,P7>1){if(XQ=M9/P7,M9=0,P7=0,!K&&!k$&&U6==="high"&&u-B$>9000&&u-B$<30000&&XQ<30)k$=u,$Z.quality("low"),dispatchEvent(new CustomEvent("mesa:calidad",{detail:"low"}));else if(!K&&U6==="low"&&!gH&&u-(k$||B$)>9000&&u-(k$||B$)<40000&&XQ<20)gH=!0,$Z.quality("min"),dispatchEvent(new CustomEvent("mesa:calidad",{detail:"min"}))}S8++,Z.info.reset();let E0=document.documentElement.classList.contains("reduced");if(v&&FJ.elapsedTime>v.at)Z8={from:W.position.clone(),to:v.pos,fromTarget:Y.target.clone(),toTarget:v.target,t:0,dur:1.2},v=null,Y.minDistance=r;let K0=0;if(C>=0){let G0=FJ.elapsedTime-C;if(G0<0.5){let h0=0.0045*Math.exp(-G0*8)*Math.sin(G0*Z6*18);j0.position.y=h0,MJ.position.y=h0,K0=E0?0:0.004*Math.exp(-G0*9),E.intensity=pH*(1+0.35*Math.exp(-G0*14))}else C=-1,j0.position.y=0,MJ.position.y=0,E.intensity=pH}if(Z8){Z8.t=Math.min(1,Z8.t+m/(Z8.dur||1.1));let G0=V8(Z8.t);if(W.position.lerpVectors(Z8.from,Z8.to,G0),Y.target.lerpVectors(Z8.fromTarget,Z8.toTarget,G0),Z8.t===1)Z8=null}if(!E0)e.rotation.z=Q0*3.5,X0.rotation.z=Math.sin(Q0*0.47)*0.009,c0.update(Q0),kJ.update(Q0);let C0=M7,p0={dt:m,jugando:C0?.phase==="playing",turno:C0?.turn,habla:Y6,hablaTipo:B9,foco:R$,fin:K6,cabezas:k0.map((G0,h0)=>G0?.head?G0.head.getWorldPosition(KQ[h0]):null)};for(let G0 of k0){if(!G0)continue;rW(G0,Q0,E0,p0),SJ(G0)}for(let G0=0;G0<M0.length;G0++)if((S8+G0)%2===0)rW(M0[G0],Q0,E0,p0);$9=$9.filter((G0)=>{if(G0.elapsed+=m,G0.elapsed<0)return!0;let h0=Math.min(1,G0.elapsed/G0.duration);if(G0.revela!=null){G0.obj.visible=!0,jJ.add(G0.revela);let UJ=V8(h0);if(G0.obj.quaternion.slerpQuaternions(G0.qFrom,G0.qTo,UJ),G0.obj.position.lerpVectors(G0.from,G0.to,UJ),G0.obj.position.y+=Math.sin(h0*Math.PI)*0.012,h0>=1&&G0.ultima)dispatchEvent(new CustomEvent("mesa:aterriza",{detail:{revela:!0}}));return h0<1}if(G0.reparto)return G0.obj.position.lerpVectors(G0.from,G0.to,V8(h0)),G0.obj.position.y+=Math.sin(h0*Math.PI)*0.035,G0.obj.quaternion.slerpQuaternions(G0.qFrom,G0.qTo,V8(Math.min(1,Math.max(0,(h0-0.3)/0.7)))),h0<1;if(G0.obj.quaternion.slerpQuaternions(G0.qFrom,G0.qTo,V8(Math.min(1,h0/0.4))),G0.golpe){let UJ=Math.min(1,h0/0.62);G0.obj.position.lerpVectors(G0.from,G0.to,V8(UJ)),G0.obj.position.y+=h0<0.62?Math.sin(UJ*Math.PI/2)*0.17:0.17*(1-((h0-0.62)/0.38)**2)}else G0.obj.position.lerpVectors(G0.from,G0.to,V8(h0)),G0.obj.position.y+=Math.sin(h0*Math.PI)*0.07;if(h0>=1&&!G0.sono){if(G0.sono=!0,G0.golpe)C=FJ.elapsedTime;dispatchEvent(new CustomEvent("mesa:aterriza",{detail:{golpe:!!G0.golpe}}))}return h0<1});let m0=u<V$;if(MJ.visible=!m0,!m0&&f0.children.length)YQ(f0);if(N8(m),Y.update(),R8.frame(Q0,m,{reduced:E0,view:C0,ends:ZQ,temblor:K0}),R8.render(),S8%2===0)for(let G0 of document.querySelectorAll("[data-seatlabel]")){let h0=Number(G0.dataset.seatlabel),[UJ,JJ]=q9[h0],VJ=k0[h0]?.head,vJ=VJ&&VJ.getWorldPosition(I7).distanceTo(R8.vista.position)<w5.distanceTo(R8.vista.position)-0.2;if(vJ)I7.y-=0.3;else if(VJ)I7.y+=0.23;else I7.set(UJ,1.45,JJ);let DJ=I7.project(R8.vista),I8=!1;if(!vJ&&DJ.y>0.8&&VJ)VJ.getWorldPosition(I7).y-=0.1,DJ=I7.project(R8.vista),I8=!0;let j5=Math.min(DJ.y,0.8);G0.style.transform=`translate(${(DJ.x*0.5+0.5)*innerWidth}px,${(-j5*0.5+0.5)*innerHeight}px) translate(-50%,${vJ?"-50%":I8?"0":"-100%"})`,G0.style.visibility=DJ.z>1||Math.abs(DJ.x)>1.1||DJ.y<-1.15?"hidden":"visible"}if(S8%30===0||S8===1){if(window.mesaDiagnostics={fps:Math.round(XQ),drawCalls:Z.info.render.calls,triangles:Z.info.render.triangles,characters:a0,crowd:k9,visibleCrowd:M0.length,boardTiles:M7?.chain.length||0,quality:U6,modelErrors:b},S5){window.mesaRigDebug=k0.filter(Boolean).map((h0)=>({index:h0.index,head:h0.head?.getWorldPosition(WJ()).toArray(),hip:h0.hips?.getWorldPosition(WJ()).toArray(),rootScale:h0.root.scale.toArray()}));let G0=document.querySelector("#perf");if(G0)G0.textContent=`${Math.round(XQ)} fps · ${Z.info.render.calls} draws`}}}window.mesaCamara=(_,m)=>{Z8=null,v=null,Y.minDistance=0.1,W.position.set(..._),Y.target.set(...m),Y.update()},window.mesaCara=(_,m,Q0)=>{let u=k0[_];if(u)u.caraFija=m==null?null:{p:m,s:Q0??0}},window.mesaBeber=(_,m)=>{let Q0=k0[_];if(Q0&&Q0.bebida&&!Q0.jugada)Q0.trago={t0:FJ.elapsedTime,fijo:m}},W9(null),QZ();let lH=()=>{if(W.aspect<0.95)W.setViewOffset(innerWidth,innerHeight*1.24,0,innerHeight*0.24,innerWidth,innerHeight);else W.clearViewOffset();W.updateProjectionMatrix()},mH=()=>H?0.65:U6==="min"?Math.min(devicePixelRatio,1)*0.55:U6==="low"?Math.min(devicePixelRatio,1)*0.8:Math.min(devicePixelRatio,1.5,1920/innerWidth),uH=()=>{W.aspect=innerWidth/innerHeight,lH(),Z.setPixelRatio(mH()),Z.setSize(innerWidth,innerHeight),R8.resize(innerWidth,innerHeight)};lH(),window.addEventListener("resize",uH),Y.addEventListener("start",()=>{Z8=null,v=null}),Z.domElement.addEventListener("webglcontextrestored",()=>R8.entorno?.());let $Z={update:W9,setCrowd:X6,setCamera:c,ready:Q9,sampleTime(_){xH=_;for(let m of[...k0.filter(Boolean),...M0])rW(m,_,!1);R8.frame(_,0,{reduced:!1,view:M7,ends:ZQ}),R8.render()},setMode(_){L$=_,c(_==="attract"?"attract":"table")},quality(_){U6=_;let m=_!=="high";E.castShadow=!m&&!H;for(let[Q0,u]of B0){let E0=m?0:u.clearcoat,K0=m?0:u.sheen;if(Q0.clearcoat!==E0||Q0.sheen!==K0)Q0.clearcoat=E0,Q0.sheen=K0,Q0.needsUpdate=!0}G.visible=!m,U.intensity=m?X+0.1:X,Z.setPixelRatio(mH()),R8.calidad(_),R8.resize(innerWidth,innerHeight)},pause(){D$=!0},resume(){if(!D$)return;if(D$=!1,FJ.getDelta(),!UQ)QZ()},dispose(){if(bH=!0,R8.dispose(),window.removeEventListener("mesa:botvoice",HQ),UQ)cancelAnimationFrame(UQ);window.removeEventListener("resize",uH),Y.dispose(),Z.dispose(),J.replaceChildren()}};return $Z}export{KB as createWorld};
