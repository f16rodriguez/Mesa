...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:W8,depthTest:!1,depthWrite:!1})}function Eq(J,$,Q){return new J6({name:"SphericalGaussianBlur",defines:{SAMPLES:Hq,CUBEUV_TEXEL_WIDTH:1/$,CUBEUV_TEXEL_HEIGHT:1/Q,CUBEUV_MAX_MIP:`${J}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:NK(),fragmentShader:`
		...
		`,blending:W8,depthTest:!1,depthWrite:!1})}function g5(){return new J6({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:NK(),fragmentShader:`
		...
		`,blending:W8,depthTest:!1,depthWrite:!1})}function p5(){return new J6({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:NK(),fragmentShader:`
...
`)}var OO={[i$]:"Linear",[o$]:"Reinhard",[a$]:"Cineon",[s7]:"ACESFilmic",[t$]:"AgX",[e$]:"Neutral",[r$]:"Custom"};function RO(J,$){let Q=OO[$];if(Q===void 0)return r0("WebGLProgram: Unsupported toneMapping:",$),"vec3 "+J+"( vec3 color ) { return LinearToneMapping( color ); }";return"vec3 "+J+"( vec3 color ) { return "+Q+"ToneMapping( color ); }"}var UK=new S;function LO(){R9.getLuminanceCoefficients(UK);let J=UK.x.toFixed(4),$=UK.y.toFixed(4),Q=UK.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${J}, ${$}, ${Q} );`,"\treturn dot( weights, rgb );","}"].join(`
...
`].filter(BQ).join(`
`);if(X=gX(X),X=a5(X,Q),X=r5(X,Q),Y=gX(Y),Y=a5(Y,Q),Y=r5(Y,Q),X=t5(X),Y=t5(Y),Q.isRawShaderMaterial!==!0)P=`#version 300 es
...
`)+`
`+E;let k=P+R+X,V=P+E+Y,A=s5(K,K.VERTEX_SHADER,k),w=s5(K,K.FRAGMENT_SHADER,V);if(K.attachShader(B,A),K.attachShader(B,w),Q.index0AttributeName!==void 0)K.bindAttribLocation(B,0,Q.index0AttributeName);else if(Q.hasPositionAttribute===!0)K.bindAttribLocation(B,0,"position");K.linkProgram(B);function D(b){if(J.debug.checkShaderErrors){let u=K.getProgramInfoLog(B)||"",e=K.getShaderInfoLog(A)||"",v=K.getShaderInfoLog(w)||"",j=u.trim(),g=e.trim(),f=v.trim(),o=!0,p=!0;if(K.getProgramParameter(B,K.LINK_STATUS)===!1)if(o=!1,typeof J.debug.onShaderError==="function")J.debug.onShaderError(K,B,A,w);else{let r=o5(K,A,"vertex"),X0=o5(K,w,"fragment");Z9("WebGLProgram: Shader Error "+K.getError()+" - VALIDATE_STATUS "+K.getProgramParameter(B,K.VALIDATE_STATUS)+`
...
Program Info Log: `+j+`
`+r+`
`+X0)}else if(j!=="")r0("WebGLProgram: Program Info Log:",j);else if(g===""||f==="")p=!1;if(p)b.diagnostics={runnable:o,programLog:j,vertexShader:{log:g,prefix:R},fragmentShader:{log:f,prefix:E}}}K.deleteShader(A),K.deleteShader(w),L=new DQ(K,B),M=DO(K,B)}let L;this.getUniforms=function(){if(L===void 0)D(this);return L};let M;this.getAttributes=function(){if(M===void 0)D(this);return M};let s=Q.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){if(s===!1)s=K.getProgramParameter(B,NO);return s},this.destroy=function(){Z.releaseStatesOfProgram(this),K.deleteProgram(B),this.program=void 0},this.type=Q.shaderType,this.name=Q.shaderName,this.id=GO++,this.cacheKey=$,this.usedTimes=1,this.program=B,this.vertexShader=A,this.fragmentShader=w,this}var bO=0;class EU{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(J,$,Q){let Z=this._getShaderCacheForMaterial(J);if(Z.has($)===!1)Z.add($),$.usedTimes++;if(Z.has(Q)===!1)Z.add(Q),Q.usedTimes++;return this}remove(J){let $=this.materialCache.get(J);for(let Q of $)if(Q.usedTimes--,Q.usedTimes===0)this.shaderCache.delete(Q.code);return this.materialCache.delete(J),this}getVertexShaderStage(J){return this._getShaderStage(J.vertexShader)}getFragmentShaderStage(J){return this._getShaderStage(J.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(J){let $=this.materialCache,Q=$.get(J);if(Q===void 0)Q=new Set,$.set(J,Q);return Q}_getShaderStage(J){let $=this.shaderCache,Q=$.get(J);if(Q===void 0)Q=new qU(J),$.set(J,Q);return Q}}class qU{constructor(J){this.id=bO++,this.code=J,this.usedTimes=0}}function hO(J){return J===t7||J===vZ||J===fZ}function xO(J,$,Q,Z,K,W){let X=new pZ,Y=new EU,H=new Set,U=[],G=new Map,F=Z.logarithmicDepthBuffer,N=Z.precision,q={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function O(L){if(H.add(L),L===0)return"uv";return`uv${L}`}function B(L,M,s,b,u,e){let v=b.fog,j=u.geometry,g=L.isMeshStandardMaterial||L.isMeshLambertMaterial||L.isMeshPhongMaterial?b.environment:null,f=L.isMeshStandardMaterial||L.isMeshLambertMaterial&&!L.envMap||L.isMeshPhongMaterial&&!L.envMap,o=$.get(L.envMap||g,f),p=!!o&&o.mapping===JQ?o.image.height:null,r=q[L.type];if(L.precision!==null){if(N=Z.getMaxPrecision(L.precision),N!==L.precision)r0("WebGLProgram.getParameters:",L.precision,"not supported, using",N,"instead.")}let X0=j.morphAttributes.position||j.morphAttributes.normal||j.morphAttributes.color,M0=X0!==void 0?X0.length:0,y=0;if(j.morphAttributes.position!==void 0)y=1;if(j.morphAttributes.normal!==void 0)y=2;if(j.morphAttributes.color!==void 0)y=3;let a,U0,h,I;if(r){let s9=p8[r];a=s9.vertexShader,U0=s9.fragmentShader}else{a=L.vertexShader,U0=L.fragmentShader;let s9=Y.getVertexShaderStage(L),j9=Y.getFragmentShaderStage(L);Y.update(L,s9,j9),h=s9.id,I=j9.id}let x=J.getRenderTarget(),d=J.state.buffers.depth.getReversed(),K0=u.isInstancedMesh===!0,t=u.isBatchedMesh===!0,D0=!!L.map,R0=!!L.matcap,P0=!!o,L0=!!L.aoMap,l0=!!L.lightMap,W9=!!L.bumpMap&&L.wireframe===!1,t0=!!L.normalMap,X9=!!L.displacementMap,k9=!!L.emissiveMap,L9=!!L.metalnessMap,m=!!L.roughnessMap,m9=L.anisotropy>0,z9=L.clearcoat>0,A9=L.dispersion>0,T=L.retroreflectivity>0,C=L.iridescence>0,l=L.sheen>0,Q0=L.transmission>0,V0=m9&&!!L.anisotropyMap,I0=z9&&!!L.clearcoatMap,v0=z9&&!!L.clearcoatNormalMap,H0=z9&&!!L.clearcoatRoughnessMap,E0=C&&!!L.iridescenceMap,h0=C&&!!L.iridescenceThicknessMap,y0=l&&!!L.sheenColorMap,z0=l&&!!L.sheenRoughnessMap,A0=!!L.specularMap,a0=!!L.specularColorMap,J9=!!L.specularIntensityMap,_9=Q0&&!!L.transmissionMap,i=Q0&&!!L.thicknessMap,S0=!!L.gradientMap,N0=!!L.alphaMap,w0=L.alphaTest>0,u0=!!L.alphaHash,k0=!!L.extensions,f0=B8;if(L.toneMapped){if(x===null||x.isXRRenderTarget===!0)f0=J.toneMapping}let Y9={shaderID:r,shaderType:L.type,shaderName:L.name,vertexShader:a,fragmentShader:U0,defines:L.defines,customVertexShaderID:h,customFragmentShaderID:I,isRawShaderMaterial:L.isRawShaderMaterial===!0,glslVersion:L.glslVersion,precision:N,batching:t,batchingColor:t&&u._colorsTexture!==null,instancing:K0,instancingColor:K0&&u.instanceColor!==null,instancingMorph:K0&&u.morphTexture!==null,outputColorSpace:x===null?J.outputColorSpace:x.isXRRenderTarget===!0?x.texture.colorSpace:R9.workingColorSpace,alphaToCoverage:!!L.alphaToCoverage,map:D0,matcap:R0,envMap:P0,envMapMode:P0&&o.mapping,envMapCubeUVHeight:p,aoMap:L0,lightMap:l0,bumpMap:W9,normalMap:t0,displacementMap:X9,emissiveMap:k9,normalMapObjectSpace:t0&&L.normalMapType===F5,normalMapTangentSpace:t0&&L.normalMapType===$X,packedNormalMap:t0&&L.normalMapType===$X&&hO(L.normalMap.format),metalnessMap:L9,roughnessMap:m,anisotropy:m9,anisotropyMap:V0,clearcoat:z9,clearcoatMap:I0,clearcoatNormalMap:v0,clearcoatRoughnessMap:H0,dispersion:A9,retroreflection:T,iridescence:C,iridescenceMap:E0,iridescenceThicknessMap:h0,sheen:l,sheenColorMap:y0,sheenRoughnessMap:z0,specularMap:A0,specularColorMap:a0,specularIntensityMap:J9,transmission:Q0,transmissionMap:_9,thicknessMap:i,gradientMap:S0,opaque:L.transparent===!1&&L.blending===s$&&L.alphaToCoverage===!1,alphaMap:N0,alphaTest:w0,alphaHash:u0,combine:L.combine,mapUv:D0&&O(L.map.channel),aoMapUv:L0&&O(L.aoMap.channel),lightMapUv:l0&&O(L.lightMap.channel),bumpMapUv:W9&&O(L.bumpMap.channel),normalMapUv:t0&&O(L.normalMap.channel),displacementMapUv:X9&&O(L.displacementMap.channel),emissiveMapUv:k9&&O(L.emissiveMap.channel),metalnessMapUv:L9&&O(L.metalnessMap.channel),roughnessMapUv:m&&O(L.roughnessMap.channel),anisotropyMapUv:V0&&O(L.anisotropyMap.channel),clearcoatMapUv:I0&&O(L.clearcoatMap.channel),clearcoatNormalMapUv:v0&&O(L.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:H0&&O(L.clearcoatRoughnessMap.channel),iridescenceMapUv:E0&&O(L.iridescenceMap.channel),iridescenceThicknessMapUv:h0&&O(L.iridescenceThicknessMap.channel),sheenColorMapUv:y0&&O(L.sheenColorMap.channel),sheenRoughnessMapUv:z0&&O(L.sheenRoughnessMap.channel),specularMapUv:A0&&O(L.specularMap.channel),specularColorMapUv:a0&&O(L.specularColorMap.channel),specularIntensityMapUv:J9&&O(L.specularIntensityMap.channel),transmissionMapUv:_9&&O(L.transmissionMap.channel),thicknessMapUv:i&&O(L.thicknessMap.channel),alphaMapUv:N0&&O(L.alphaMap.channel),vertexTangents:!!j.attributes.tangent&&(t0||m9),vertexNormals:!!j.attributes.normal,vertexColors:L.vertexColors,vertexAlphas:L.vertexColors===!0&&!!j.attributes.color&&j.attributes.color.itemSize===4,pointsUvs:u.isPoints===!0&&!!j.attributes.uv&&(D0||N0),fog:!!v,useFog:L.fog===!0,fogExp2:!!v&&v.isFogExp2,flatShading:L.wireframe===!1&&(L.flatShading===!0||j.attributes.normal===void 0&&t0===!1&&(L.isMeshLambertMaterial||L.isMeshPhongMaterial||L.isMeshStandardMaterial||L.isMeshPhysicalMaterial)),sizeAttenuation:L.sizeAttenuation===!0,logarithmicDepthBuffer:F,reversedDepthBuffer:d,skinning:u.isSkinnedMesh===!0,hasPositionAttribute:j.attributes.position!==void 0,morphTargets:j.morphAttributes.position!==void 0,morphNormals:j.morphAttributes.normal!==void 0,morphColors:j.morphAttributes.color!==void 0,morphTargetsCount:M0,morphTextureStride:y,numSunLights:M.sun.length,numDirLights:M.directional.length,numPointLights:M.point.length,numSpotLights:M.spot.length,numSpotLightMaps:M.spotLightMap.length,numRectAreaLights:M.rectArea.length,numHemiLights:M.hemi.length,numSunLightShadows:M.sunShadowMap.length,numDirLightShadows:M.directionalShadowMap.length,numPointLightShadows:M.pointShadowMap.length,numSpotLightShadows:M.spotShadowMap.length,numSpotLightShadowsWithMaps:M.numSpotLightShadowsWithMaps,numLightProbes:M.numLightProbes,numLightProbeGrids:e.length,numClippingPlanes:W.numPlanes,numClipIntersection:W.numIntersection,dithering:L.dithering,shadowMapEnabled:J.shadowMap.enabled&&s.length>0,shadowMapType:J.shadowMap.type,toneMapping:f0,decodeVideoTexture:D0&&L.map.isVideoTexture===!0&&R9.getTransfer(L.map.colorSpace)===c9,decodeVideoTextureEmissive:k9&&L.emissiveMap.isVideoTexture===!0&&R9.getTransfer(L.emissiveMap.colorSpace)===c9,premultipliedAlpha:L.premultipliedAlpha,doubleSided:L.side===i9,flipSided:L.side===I6,useDepthPacking:L.depthPacking>=0,depthPacking:L.depthPacking||0,index0AttributeName:L.index0AttributeName,extensionClipCullDistance:k0&&L.extensions.clipCullDistance===!0&&Q.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(k0&&L.extensions.multiDraw===!0||t)&&Q.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:Q.has("KHR_parallel_shader_compile"),customProgramCacheKey:L.customProgramCacheKey()};return Y9.vertexUv1s=H.has(1),Y9.vertexUv2s=H.has(2),Y9.vertexUv3s=H.has(3),H.clear(),Y9}function R(L){let M=[];if(L.shaderID)M.push(L.shaderID);else M.push(L.customVertexShaderID),M.push(L.customFragmentShaderID);if(L.defines!==void 0)for(let s in L.defines)M.push(s),M.push(L.defines[s]);if(L.isRawShaderMaterial===!1)E(M,L),P(M,L),M.push(J.outputColorSpace);return M.push(L.customProgramCacheKey),M.join()}function E(L,M){L.push(M.precision),L.push(M.outputColorSpace),L.push(M.envMapMode),L.push(M.envMapCubeUVHeight),L.push(M.mapUv),L.push(M.alphaMapUv),L.push(M.lightMapUv),L.push(M.aoMapUv),L.push(M.bumpMapUv),L.push(M.normalMapUv),L.push(M.displacementMapUv),L.push(M.emissiveMapUv),L.push(M.metalnessMapUv),L.push(M.roughnessMapUv),L.push(M.anisotropyMapUv),L.push(M.clearcoatMapUv),L.push(M.clearcoatNormalMapUv),L.push(M.clearcoatRoughnessMapUv),L.push(M.iridescenceMapUv),L.push(M.iridescenceThicknessMapUv),L.push(M.sheenColorMapUv),L.push(M.sheenRoughnessMapUv),L.push(M.specularMapUv),L.push(M.specularColorMapUv),L.push(M.specularIntensityMapUv),L.push(M.transmissionMapUv),L.push(M.thicknessMapUv),L.push(M.combine),L.push(M.fogExp2),L.push(M.sizeAttenuation),L.push(M.morphTargetsCount),L.push(M.morphAttributeCount),L.push(M.numSunLights),L.push(M.numDirLights),L.push(M.numPointLights),L.push(M.numSpotLights),L.push(M.numSpotLightMaps),L.push(M.numHemiLights),L.push(M.numRectAreaLights),L.push(M.numSunLightShadows),L.push(M.numDirLightShadows),L.push(M.numPointLightShadows),L.push(M.numSpotLightShadows),L.push(M.numSpotLightShadowsWithMaps),L.push(M.numLightProbes),L.push(M.shadowMapType),L.push(M.toneMapping),L.push(M.numClippingPlanes),L.push(M.numClipIntersection),L.push(M.depthPacking)}function P(L,M){if(X.disableAll(),M.instancing)X.enable(0);if(M.instancingColor)X.enable(1);if(M.instancingMorph)X.enable(2);if(M.matcap)X.enable(3);if(M.envMap)X.enable(4);if(M.normalMapObjectSpace)X.enable(5);if(M.normalMapTangentSpace)X.enable(6);if(M.clearcoat)X.enable(7);if(M.iridescence)X.enable(8);if(M.alphaTest)X.enable(9);if(M.vertexColors)X.enable(10);if(M.vertexAlphas)X.enable(11);if(M.vertexUv1s)X.enable(12);if(M.vertexUv2s)X.enable(13);if(M.vertexUv3s)X.enable(14);if(M.vertexTangents)X.enable(15);if(M.anisotropy)X.enable(16);if(M.alphaHash)X.enable(17);if(M.batching)X.enable(18);if(M.dispersion)X.enable(19);if(M.retroreflection)X.enable(24);if(M.batchingColor)X.enable(20);if(M.gradientMap)X.enable(21);if(M.packedNormalMap)X.enable(22);if(M.vertexNormals)X.enable(23);if(L.push(X.mask),X.disableAll(),M.fog)X.enable(0);if(M.useFog)X.enable(1);if(M.flatShading)X.enable(2);if(M.logarithmicDepthBuffer)X.enable(3);if(M.reversedDepthBuffer)X.enable(4);if(M.skinning)X.enable(5);if(M.morphTargets)X.enable(6);if(M.morphNormals)X.enable(7);if(M.morphColors)X.enable(8);if(M.premultipliedAlpha)X.enable(9);if(M.shadowMapEnabled)X.enable(10);if(M.doubleSided)X.enable(11);if(M.flipSided)X.enable(12);if(M.useDepthPacking)X.enable(13);if(M.dithering)X.enable(14);if(M.transmission)X.enable(15);if(M.sheen)X.enable(16);if(M.opaque)X.enable(17);if(M.pointsUvs)X.enable(18);if(M.decodeVideoTexture)X.enable(19);if(M.decodeVideoTextureEmissive)X.enable(20);if(M.alphaToCoverage)X.enable(21);if(M.numLightProbeGrids>0)X.enable(22);if(M.hasPositionAttribute)X.enable(23);L.push(X.mask)}function k(L){let M=q[L.type],s;if(M){let b=p8[M];s=Q7.clone(b.uniforms)}else s=L.uniforms;return s}function V(L,M){let s=G.get(M);if(s!==void 0)++s.usedTimes;else s=new fO(J,M,L,K),U.push(s),G.set(M,s);return s}function A(L){if(--L.usedTimes===0){let M=U.indexOf(L);U[M]=U[U.length-1],U.pop(),G.delete(L.cacheKey),L.destroy()}}function w(L){Y.remove(L)}function D(){Y.dispose()}return{getParameters:B,getProgramCacheKey:R,getUniforms:k,acquireProgram:V,releaseProgram:A,releaseShaderCache:w,programs:U,dispose:D}}function gO(){let J=new WeakMap;function $(X){return J.has(X)}function Q(X){let Y=J.get(X);if(Y===void 0)Y={},J.set(X,Y);return Y}function Z(X){J.delete(X)}function K(X,Y,H){J.get(X)[Y]=H}function W(){J=new WeakMap}return{has:$,get:Q,remove:Z,update:K,dispose:W}}function pO(J,$){if(J.groupOrder!==$.groupOrder)return J.groupOrder-$.groupOrder;else if(J.renderOrder!==$.renderOrder)return J.renderOrder-$.renderOrder;else if(J.material.id!==$.material.id)return J.material.id-$.material.id;else if(J.materialVariant!==$.materialVariant)return J.materialVariant-$.materialVariant;else if(J.z!==$.z)return J.z-$.z;else return J.id-$.id}function JU(J,$){if(J.groupOrder!==$.groupOrder)return J.groupOrder-$.groupOrder;else if(J.renderOrder!==$.renderOrder)return J.renderOrder-$.renderOrder;else if(J.z!==$.z)return $.z-J.z;else return J.id-$.id}function $U(){let J=[],$=0,Q=[],Z=[],K=[];function W(){$=0,Q.length=0,Z.length=0,K.length=0}function X(N){let q=0;if(N.isInstancedMesh)q+=2;if(N.isSkinnedMesh)q+=1;return q}function Y(N,q,O,B,R,E){let P=J[$];if(P===void 0)P={id:N.id,object:N,geometry:q,material:O,materialVariant:X(N),groupOrder:B,renderOrder:N.renderOrder,z:R,group:E},J[$]=P;else P.id=N.id,P.object=N,P.geometry=q,P.material=O,P.materialVariant=X(N),P.groupOrder=B,P.renderOrder=N.renderOrder,P.z=R,P.group=E;return $++,P}function H(N,q,O,B,R,E,P){if(P.reversedDepth===!0)R=-R;let k=Y(N,q,O,B,R,E);if(O.transmission>0)Z.push(k);else if(O.transparent===!0)K.push(k);else Q.push(k)}function U(N,q,O,B,R,E){let P=Y(N,q,O,B,R,E);if(O.transmission>0)Z.unshift(P);else if(O.transparent===!0)K.unshift(P);else Q.unshift(P)}function G(N,q){if(Q.length>1)Q.sort(N||pO);if(Z.length>1)Z.sort(q||JU);if(K.length>1)K.sort(q||JU)}function F(){for(let N=$,q=J.length;N<q;N++){let O=J[N];if(O.id===null)break;O.id=null,O.object=null,O.geometry=null,O.material=null,O.group=null}}return{opaque:Q,transmissive:Z,transparent:K,init:W,push:H,unshift:U,finish:F,sort:G}}function mO(){let J=new WeakMap;function $(Z,K){let W=J.get(Z),X;if(W===void 0)X=new $U,J.set(Z,[X]);else if(K>=W.length)X=new $U,W.push(X);else X=W[K];return X}function Q(){J=new WeakMap}return{get:$,dispose:Q}}function lO(){let J={};return{get:function($){if(J[$.id]!==void 0)return J[$.id];let Q;switch($.type){case"SunLight":case"DirectionalLight":Q={direction:new S,color:new b0};break;case"SpotLight":Q={position:new S,direction:new S,color:new b0,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":Q={position:new S,color:new b0,distance:0,decay:0};break;case"HemisphereLight":Q={direction:new S,skyColor:new b0,groundColor:new b0};break;case"RectAreaLight":Q={color:new b0,position:new S,halfWidth:new S,halfHeight:new S};break}return J[$.id]=Q,Q}}}function uO(){let J={};return{get:function($){if(J[$.id]!==void 0)return J[$.id];let Q;switch($.type){case"SunLight":case"DirectionalLight":Q={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new O0};break;case"SpotLight":Q={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new O0};break;case"PointLight":Q={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new O0,shadowCameraNear:1,shadowCameraFar:1000};break}return J[$.id]=Q,Q}}}var dO=0;function cO(J,$){return($.castShadow?2:0)-(J.castShadow?2:0)+($.map?1:0)-(J.map?1:0)}function nO(J){let $=new lO,Q=uO(),Z={version:0,hash:{sunLength:-1,directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numSunShadows:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],sun:[],sunShadow:[],sunShadowMap:[],sunShadowMatrix:[],sunShadowCascade:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let U=0;U<9;U++)Z.probe.push(new S);let K=new S,W=new $9,X=new $9;function Y(U){let G=0,F=0,N=0;for(let u=0;u<9;u++)Z.probe[u].set(0,0,0);let q=0,O=0,B=0,R=0,E=0,P=0,k=0,V=0,A=0,w=0,D=0,L=0,M=0,s=0;U.sort(cO);for(let u=0,e=U.length;u<e;u++){let v=U[u],j=v.color,g=v.intensity,f=v.distance,o=null;if(v.shadow&&v.shadow.map)if(v.shadow.map.texture.format===t7)o=v.shadow.map.texture;else o=v.shadow.map.depthTexture||v.shadow.map.texture;if(v.isAmbientLight)G+=j.r*g,F+=j.g*g,N+=j.b*g;else if(v.isLightProbe){for(let p=0;p<9;p++)Z.probe[p].addScaledVector(v.sh.coefficients[p],g);s++}else if(v.isSunLight){let p=$.get(v);if(p.color.copy(v.color).multiplyScalar(v.intensity),v.castShadow){let r=v.shadow,X0=Q.get(v);X0.shadowIntensity=r.intensity,X0.shadowBias=r.bias,X0.shadowNormalBias=r.normalBias,X0.shadowRadius=r.radius,X0.shadowMapSize.copy(r.mapSize).multiply(r.getFrameExtents()),Z.sunShadow[O]=X0,Z.sunShadowMap[O]=o;let M0=r.getViewportCount();for(let y=0;y<M0;y++)Z.sunShadowMatrix[B+y]=r.getMatrix(y),Z.sunShadowCascade[B+y]=r._cascadeData[y];B+=M0,O++}Z.sun[q]=p,q++}else if(v.isDirectionalLight){let p=$.get(v);if(p.color.copy(v.color).multiplyScalar(v.intensity),v.castShadow){let r=v.shadow,X0=Q.get(v);X0.shadowIntensity=r.intensity,X0.shadowBias=r.bias,X0.shadowNormalBias=r.normalBias,X0.shadowRadius=r.radius,X0.shadowMapSize=r.mapSize,Z.directionalShadow[R]=X0,Z.directionalShadowMap[R]=o,Z.directionalShadowMatrix[R]=v.shadow.matrix,A++}Z.directional[R]=p,R++}else if(v.isSpotLight){let p=$.get(v);p.position.setFromMatrixPosition(v.matrixWorld),p.color.copy(j).multiplyScalar(g),p.distance=f,p.coneCos=Math.cos(v.angle),p.penumbraCos=Math.cos(v.angle*(1-v.penumbra)),p.decay=v.decay,Z.spot[P]=p;let r=v.shadow;if(v.map){if(Z.spotLightMap[L]=v.map,L++,r.updateMatrices(v),v.castShadow)M++}if(Z.spotLightMatrix[P]=r.matrix,v.castShadow){let X0=Q.get(v);X0.shadowIntensity=r.intensity,X0.shadowBias=r.bias,X0.shadowNormalBias=r.normalBias,X0.shadowRadius=r.radius,X0.shadowMapSize=r.mapSize,Z.spotShadow[P]=X0,Z.spotShadowMap[P]=o,D++}P++}else if(v.isRectAreaLight){let p=$.get(v);p.color.copy(j).multiplyScalar(g),p.halfWidth.set(v.width*0.5,0,0),p.halfHeight.set(0,v.height*0.5,0),Z.rectArea[k]=p,k++}else if(v.isPointLight){let p=$.get(v);if(p.color.copy(v.color).multiplyScalar(v.intensity),p.distance=v.distance,p.decay=v.decay,v.castShadow){let r=v.shadow,X0=Q.get(v);X0.shadowIntensity=r.intensity,X0.shadowBias=r.bias,X0.shadowNormalBias=r.normalBias,X0.shadowRadius=r.radius,X0.shadowMapSize=r.mapSize,X0.shadowCameraNear=r.camera.near,X0.shadowCameraFar=r.camera.far,Z.pointShadow[E]=X0,Z.pointShadowMap[E]=o,Z.pointShadowMatrix[E]=v.shadow.matrix,w++}Z.point[E]=p,E++}else if(v.isHemisphereLight){let p=$.get(v);p.skyColor.copy(v.color).multiplyScalar(g),p.groundColor.copy(v.groundColor).multiplyScalar(g),Z.hemi[V]=p,V++}}if(k>0)if(J.has("OES_texture_float_linear")===!0)Z.rectAreaLTC1=p0.LTC_FLOAT_1,Z.rectAreaLTC2=p0.LTC_FLOAT_2;else Z.rectAreaLTC1=p0.LTC_HALF_1,Z.rectAreaLTC2=p0.LTC_HALF_2;Z.ambient[0]=G,Z.ambient[1]=F,Z.ambient[2]=N;let b=Z.hash;if(b.sunLength!==q||b.directionalLength!==R||b.pointLength!==E||b.spotLength!==P||b.rectAreaLength!==k||b.hemiLength!==V||b.numSunShadows!==O||b.numDirectionalShadows!==A||b.numPointShadows!==w||b.numSpotShadows!==D||b.numSpotMaps!==L||b.numLightProbes!==s)Z.sun.length=q,Z.directional.length=R,Z.spot.length=P,Z.rectArea.length=k,Z.point.length=E,Z.hemi.length=V,Z.sunShadow.length=O,Z.sunShadowMap.length=O,Z.sunShadowMatrix.length=B,Z.sunShadowCascade.length=B,Z.directionalShadow.length=A,Z.directionalShadowMap.length=A,Z.directionalShadowMatrix.length=A,Z.pointShadow.length=w,Z.pointShadowMap.length=w,Z.pointShadowMatrix.length=w,Z.spotShadow.length=D,Z.spotShadowMap.length=D,Z.spotLightMatrix.length=D+L-M,Z.spotLightMap.length=L,Z.numSpotLightShadowsWithMaps=M,Z.numLightProbes=s,b.sunLength=q,b.directionalLength=R,b.pointLength=E,b.spotLength=P,b.rectAreaLength=k,b.hemiLength=V,b.numSunShadows=O,b.numDirectionalShadows=A,b.numPointShadows=w,b.numSpotShadows=D,b.numSpotMaps=L,b.numLightProbes=s,Z.version=dO++}function H(U,G){let F=0,N=0,q=0,O=0,B=0,R=0,E=G.matrixWorldInverse;for(let P=0,k=U.length;P<k;P++){let V=U[P];if(V.isSunLight){let A=Z.sun[F];A.direction.setFromMatrixPosition(V.matrixWorld),A.direction.transformDirection(E),F++}else if(V.isDirectionalLight){let A=Z.directional[N];A.direction.setFromMatrixPosition(V.matrixWorld),K.setFromMatrixPosition(V.target.matrixWorld),A.direction.sub(K),A.direction.transformDirection(E),N++}else if(V.isSpotLight){let A=Z.spot[O];A.position.setFromMatrixPosition(V.matrixWorld),A.position.applyMatrix4(E),A.direction.setFromMatrixPosition(V.matrixWorld),K.setFromMatrixPosition(V.target.matrixWorld),A.direction.sub(K),A.direction.transformDirection(E),O++}else if(V.isRectAreaLight){let A=Z.rectArea[B];A.position.setFromMatrixPosition(V.matrixWorld),A.position.applyMatrix4(E),X.identity(),W.copy(V.matrixWorld),W.premultiply(E),X.extractRotation(W),A.halfWidth.set(V.width*0.5,0,0),A.halfHeight.set(0,V.height*0.5,0),A.halfWidth.applyMatrix4(X),A.halfHeight.applyMatrix4(X),B++}else if(V.isPointLight){let A=Z.point[q];A.position.setFromMatrixPosition(V.matrixWorld),A.position.applyMatrix4(E),q++}else if(V.isHemisphereLight){let A=Z.hemi[R];A.direction.setFromMatrixPosition(V.matrixWorld),A.direction.transformDirection(E),R++}}}return{setup:Y,setupView:H,state:Z}}function QU(J){let $=new nO(J),Q=[],Z=[],K=[];function W(N){F.camera=N,Q.length=0,Z.length=0,K.length=0}function X(N){Q.push(N)}function Y(N){Z.push(N)}function H(N){K.push(N)}function U(){$.setup(Q)}function G(N){$.setupView(Q,N)}let F={lightsArray:Q,shadowsArray:Z,lightProbeGridArray:K,camera:null,lights:$,transmissionRenderTarget:{},textureUnits:0};return{init:W,state:F,setupLights:U,setupLightsView:G,pushLight:X,pushShadow:Y,pushLightProbeGrid:H}}function sO(J){let $=new WeakMap;function Q(K,W=0){let X=$.get(K),Y;if(X===void 0)Y=new QU(J),$.set(K,[Y]);else if(W>=X.length)Y=new QU(J),X.push(Y);else Y=X[W];return Y}function Z(){$=new WeakMap}return{get:Q,dispose:Z}}var iO=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,aO=[new S(1,0,0),new S(-1,0,0),new S(0,1,0),new S(0,-1,0),new S(0,0,1),new S(0,0,-1)],rO=[new S(0,-1,0),new S(0,-1,0),new S(0,0,1),new S(0,0,-1),new S(0,-1,0),new S(0,-1,0)],ZU=new $9,VQ=new S,hX=new S;function tO(J,$,Q){let Z=new QJ,K=new O0,W=new O0,X=new d9,Y=new RX,H=new LX,U={},G=Q.maxTextureSize,F={[V7]:I6,[I6]:V7,[i9]:i9},N=new J6({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new O0},radius:{value:4}},vertexShader:iO,fragmentShader:oO}),q=N.clone();q.defines.HORIZONTAL_PASS=1;let O=new g9;O.setAttribute("position",new t9(new Float32Array([-1,-1,0.5,3,-1,0.5,-1,3,0.5]),3));let B=new _0(O,N),R=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=n7;let E=this.type;this.render=function(w,D,L){if(R.enabled===!1)return;if(R.autoUpdate===!1&&R.needsUpdate===!1)return;if(w.length===0)return;if(this.type===_H)r0("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=n7;let M=J.getRenderTarget(),s=J.getActiveCubeFace(),b=J.getActiveMipmapLevel(),u=J.state;if(u.setBlending(W8),u.buffers.depth.getReversed()===!0)u.buffers.color.setClear(0,0,0,0);else u.buffers.color.setClear(1,1,1,1);u.buffers.depth.setTest(!0),u.setScissorTest(!1);let e=E!==this.type;if(e)D.traverse(function(v){if(v.material)if(Array.isArray(v.material))v.material.forEach((j)=>j.needsUpdate=!0);else v.material.needsUpdate=!0});for(let v=0,j=w.length;v<j;v++){let g=w[v],f=g.shadow;if(f===void 0){r0("WebGLShadowMap:",g,"has no shadow.");continue}if(f.autoUpdate===!1&&f.needsUpdate===!1)continue;K.copy(f.mapSize);let o=f.getFrameExtents();if(K.multiply(o),W.copy(f.mapSize),K.x>G||K.y>G){if(K.x>G)W.x=Math.floor(G/o.x),K.x=W.x*o.x,f.mapSize.x=W.x;if(K.y>G)W.y=Math.floor(G/o.y),K.y=W.y*o.y,f.mapSize.y=W.y}let p=J.state.buffers.depth.getReversed();if(f.camera._reversedDepth=p,f.map===null||e===!0){if(f.map!==null){if(f.map.depthTexture!==null)f.map.depthTexture.dispose(),f.map.depthTexture=null;f.map.dispose()}if(this.type===oJ){if(g.isPointLight){r0("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}f.map=new X6(K.x,K.y,{format:t7,type:B6,minFilter:V6,magFilter:V6,generateMipmaps:!1}),f.map.texture.name=g.name+".shadowMap",f.map.depthTexture=new KJ(K.x,K.y,e8),f.map.depthTexture.name=g.name+".shadowMapDepth",f.map.depthTexture.format=a7,f.map.depthTexture.compareFunction=null,f.map.depthTexture.minFilter=D8,f.map.depthTexture.magFilter=D8}else{if(g.isPointLight)f.map=new pX(K.x),f.map.depthTexture=new UX(K.x,D7);else f.map=new X6(K.x,K.y),f.map.depthTexture=new KJ(K.x,K.y,D7);if(f.map.depthTexture.name=g.name+".shadowMap",f.map.depthTexture.format=a7,this.type===n7)f.map.depthTexture.compareFunction=p?xZ:hZ,f.map.depthTexture.minFilter=V6,f.map.depthTexture.magFilter=V6;else f.map.depthTexture.compareFunction=null,f.map.depthTexture.minFilter=D8,f.map.depthTexture.magFilter=D8}f.camera.updateProjectionMatrix()}if(f.map.isWebGLCubeRenderTarget!==!0&&(f.map.width!==K.x||f.map.height!==K.y))f.map.setSize(K.x,K.y);let r=f.map.isWebGLCubeRenderTarget?6:f.getViewportCount();if(g.isPointLight!==!0)f.updateMatrices(g,L);for(let X0=0;X0<r;X0++){let M0=f.getCamera(X0);if(g.isPointLight){let{camera:y,matrix:a}=f,U0=g.distance||y.far;if(U0!==y.far)y.far=U0,y.updateProjectionMatrix();VQ.setFromMatrixPosition(g.matrixWorld),y.position.copy(VQ),hX.copy(y.position),hX.add(aO[X0]),y.up.copy(rO[X0]),y.lookAt(hX),y.updateMatrixWorld(),a.makeTranslation(-VQ.x,-VQ.y,-VQ.z),ZU.multiplyMatrices(y.projectionMatrix,y.matrixWorldInverse),f._frustum.setFromProjectionMatrix(ZU,y.coordinateSystem,y.reversedDepth)}if(f.map.isWebGLCubeRenderTarget)J.setRenderTarget(f.map,X0),J.clear();else{if(X0===0)J.setRenderTarget(f.map),J.clear();let y=f.getViewport(X0);X.set(W.x*y.x,W.y*y.y,W.x*y.z,W.y*y.w),u.viewport(X)}Z=f.getFrustum(X0),V(D,L,M0,g,this.type)}if(f.isPointLightShadow!==!0&&this.type===oJ)P(f,L);f.needsUpdate=!1}E=this.type,R.needsUpdate=!1,J.setRenderTarget(M,s,b)};function P(w,D){let L=$.update(B);if(N.defines.VSM_SAMPLES!==w.blurSamples)N.defines.VSM_SAMPLES=w.blurSamples,q.defines.VSM_SAMPLES=w.blurSamples,N.needsUpdate=!0,q.needsUpdate=!0;if(w.mapPass===null)w.mapPass=new X6(K.x,K.y,{format:t7,type:B6});else if(w.mapPass.width!==w.map.width||w.mapPass.height!==w.map.height)w.mapPass.setSize(w.map.width,w.map.height);N.uniforms.shadow_pass.value=w.map.depthTexture,N.uniforms.resolution.value.set(w.map.width,w.map.height),N.uniforms.radius.value=w.radius,J.setRenderTarget(w.mapPass),J.clear(),J.renderBufferDirect(D,null,L,N,B,null),q.uniforms.shadow_pass.value=w.mapPass.texture,q.uniforms.resolution.value.set(w.map.width,w.map.height),q.uniforms.radius.value=w.radius,J.setRenderTarget(w.map),J.clear(),J.renderBufferDirect(D,null,L,q,B,null)}function k(w,D,L,M){let s=null,b=L.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(b!==void 0)s=b;else if(s=L.isPointLight===!0?H:Y,J.localClippingEnabled&&D.clipShadows===!0&&Array.isArray(D.clippingPlanes)&&D.clippingPlanes.length!==0||D.displacementMap&&D.displacementScale!==0||D.alphaMap&&D.alphaTest>0||D.map&&D.alphaTest>0||D.alphaToCoverage===!0){let u=s.uuid,e=D.uuid,v=U[u];if(v===void 0)v={},U[u]=v;let j=v[e];if(j===void 0)j=s.clone(),v[e]=j,D.addEventListener("dispose",A);s=j}if(s.visible=D.visible,s.wireframe=D.wireframe,M===oJ)s.side=D.shadowSide!==null?D.shadowSide:D.side;else s.side=D.shadowSide!==null?D.shadowSide:F[D.side];if(s.alphaMap=D.alphaMap,s.alphaTest=D.alphaToCoverage===!0?0.5:D.alphaTest,s.map=D.map,s.clipShadows=D.clipShadows,s.clippingPlanes=D.clippingPlanes,s.clipIntersection=D.clipIntersection,s.displacementMap=D.displacementMap,s.displacementScale=D.displacementScale,s.displacementBias=D.displacementBias,s.wireframeLinewidth=D.wireframeLinewidth,s.linewidth=D.linewidth,L.isPointLight===!0&&s.isMeshDistanceMaterial===!0){let u=J.properties.get(s);u.light=L}return s}function V(w,D,L,M,s){if(w.visible===!1)return;if(w.layers.test(D.layers)&&(w.isMesh||w.isLine||w.isPoints)){if((w.castShadow||w.receiveShadow&&s===oJ)&&(!w.frustumCulled||w.intersectsFrustum(Z))){w.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,w.matrixWorld);let e=$.update(w),v=w.material;if(Array.isArray(v)){let j=e.groups;for(let g=0,f=j.length;g<f;g++){let o=j[g],p=v[o.materialIndex];if(p&&p.visible){let r=k(w,p,M,s);w.onBeforeShadow(J,w,D,L,e,r,o),J.renderBufferDirect(L,null,e,r,w,o),w.onAfterShadow(J,w,D,L,e,r,o)}}}else if(v.visible){let j=k(w,v,M,s);w.onBeforeShadow(J,w,D,L,e,j,null),J.renderBufferDirect(L,null,e,j,w,null),w.onAfterShadow(J,w,D,L,e,j,null)}}}let u=w.children;for(let e=0,v=u.length;e<v;e++)V(u[e],D,L,M,s)}function A(w){w.target.removeEventListener("dispose",A);for(let L in U){let M=U[L],s=w.target.uuid;if(s in M)M[s].dispose(),delete M[s]}}}function eO(J,$){function Q(){let i=!1,S0=new d9,N0=null,w0=new d9(0,0,0,0);return{setMask:function(u0){if(N0!==u0&&!i)J.colorMask(u0,u0,u0,u0),N0=u0},setLocked:function(u0){i=u0},setClear:function(u0,k0,f0,Y9,s9){if(s9===!0)u0*=Y9,k0*=Y9,f0*=Y9;if(S0.set(u0,k0,f0,Y9),w0.equals(S0)===!1)J.clearColor(u0,k0,f0,Y9),w0.copy(S0)},reset:function(){i=!1,N0=null,w0.set(-1,0,0,0)}}}function Z(){let i=!1,S0=!1,N0=null,w0=null,u0=null;return{setReversed:function(k0){if(S0!==k0){let f0=$.get("EXT_clip_control");if(k0)f0.clipControlEXT(f0.LOWER_LEFT_EXT,f0.ZERO_TO_ONE_EXT);else f0.clipControlEXT(f0.LOWER_LEFT_EXT,f0.NEGATIVE_ONE_TO_ONE_EXT);S0=k0;let Y9=u0;u0=null,this.setClear(Y9)}},getReversed:function(){return S0},setTest:function(k0){if(k0)x(J.DEPTH_TEST);else d(J.DEPTH_TEST)},setMask:function(k0){if(N0!==k0&&!i)J.depthMask(k0),N0=k0},setFunc:function(k0){if(S0)k0=M5[k0];if(w0!==k0){switch(k0){case oH:J.depthFunc(J.NEVER);break;case aH:J.depthFunc(J.ALWAYS);break;case rH:J.depthFunc(J.LESS);break;case OW:J.depthFunc(J.LEQUAL);break;case tH:J.depthFunc(J.EQUAL);break;case eH:J.depthFunc(J.GEQUAL);break;case J5:J.depthFunc(J.GREATER);break;case $5:J.depthFunc(J.NOTEQUAL);break;default:J.depthFunc(J.LEQUAL)}w0=k0}},setLocked:function(k0){i=k0},setClear:function(k0){if(u0!==k0){if(u0=k0,S0)k0=1-k0;J.clearDepth(k0)}},reset:function(){i=!1,N0=null,w0=null,u0=null,S0=!1}}}function K(){let i=!1,S0=null,N0=null,w0=null,u0=null,k0=null,f0=null,Y9=null,s9=null;return{setTest:function(j9){if(!i)if(j9)x(J.STENCIL_TEST);else d(J.STENCIL_TEST)},setMask:function(j9){if(S0!==j9&&!i)J.stencilMask(j9),S0=j9},setFunc:function(j9,M6,u6){if(N0!==j9||w0!==M6||u0!==u6)J.stencilFunc(j9,M6,u6),N0=j9,w0=M6,u0=u6},setOp:function(j9,M6,u6){if(k0!==j9||f0!==M6||Y9!==u6)J.stencilOp(j9,M6,u6),k0=j9,f0=M6,Y9=u6},setLocked:function(j9){i=j9},setClear:function(j9){if(s9!==j9)J.clearStencil(j9),s9=j9},reset:function(){i=!1,S0=null,N0=null,w0=null,u0=null,k0=null,f0=null,Y9=null,s9=null}}}let W=new Q,X=new Z,Y=new K,H=new WeakMap,U=new WeakMap,G={},F={},N={},q=new WeakMap,O=[],B=null,R=!1,E=null,P=null,k=null,V=null,A=null,w=null,D=null,L=new b0(0,0,0),M=0,s=!1,b=null,u=null,e=null,v=null,j=null,g=J.getParameter(J.MAX_COMBINED_TEXTURE_IMAGE_UNITS),f=!1,o=0,p=J.getParameter(J.VERSION);if(p.indexOf("WebGL")!==-1)o=parseFloat(/^WebGL (\d)/.exec(p)[1]),f=o>=1;else if(p.indexOf("OpenGL ES")!==-1)o=parseFloat(/^OpenGL ES (\d)/.exec(p)[1]),f=o>=2;let r=null,X0={},M0=J.getParameter(J.SCISSOR_BOX),y=J.getParameter(J.VIEWPORT),a=new d9().fromArray(M0),U0=new d9().fromArray(y);function h(i,S0,N0,w0){let u0=new Uint8Array(4),k0=J.createTexture();J.bindTexture(i,k0),J.texParameteri(i,J.TEXTURE_MIN_FILTER,J.NEAREST),J.texParameteri(i,J.TEXTURE_MAG_FILTER,J.NEAREST);for(let f0=0;f0<N0;f0++)if(i===J.TEXTURE_3D||i===J.TEXTURE_2D_ARRAY)J.texImage3D(S0,0,J.RGBA,1,1,w0,0,J.RGBA,J.UNSIGNED_BYTE,u0);else J.texImage2D(S0+f0,0,J.RGBA,1,1,0,J.RGBA,J.UNSIGNED_BYTE,u0);return k0}let I={};I[J.TEXTURE_2D]=h(J.TEXTURE_2D,J.TEXTURE_2D,1),I[J.TEXTURE_CUBE_MAP]=h(J.TEXTURE_CUBE_MAP,J.TEXTURE_CUBE_MAP_POSITIVE_X,6),I[J.TEXTURE_2D_ARRAY]=h(J.TEXTURE_2D_ARRAY,J.TEXTURE_2D_ARRAY,1,1),I[J.TEXTURE_3D]=h(J.TEXTURE_3D,J.TEXTURE_3D,1,1),W.setClear(0,0,0,1),X.setClear(1),Y.setClear(0),x(J.DEPTH_TEST),X.setFunc(OW),W9(!1),t0(FW),x(J.CULL_FACE),L0(W8);function x(i){if(G[i]!==!0)J.enable(i),G[i]=!0}function d(i){if(G[i]!==!1)J.disable(i),G[i]=!1}function K0(i,S0){if(N[i]!==S0){if(J.bindFramebuffer(i,S0),N[i]=S0,i===J.DRAW_FRAMEBUFFER)N[J.FRAMEBUFFER]=S0;if(i===J.FRAMEBUFFER)N[J.DRAW_FRAMEBUFFER]=S0;return!0}return!1}function t(i,S0){let N0=O,w0=!1;if(i){if(N0=q.get(S0),N0===void 0)N0=[],q.set(S0,N0);let u0=i.textures;if(N0.length!==u0.length||N0[0]!==J.COLOR_ATTACHMENT0){for(let k0=0,f0=u0.length;k0<f0;k0++)N0[k0]=J.COLOR_ATTACHMENT0+k0;N0.length=u0.length,w0=!0}}else if(N0[0]!==J.BACK)N0[0]=J.BACK,w0=!0;if(w0)J.drawBuffers(N0)}function D0(i){if(B!==i)return J.useProgram(i),B=i,!0;return!1}let R0={[aJ]:J.FUNC_ADD,[SH]:J.FUNC_SUBTRACT,[wH]:J.FUNC_REVERSE_SUBTRACT};R0[jH]=J.MIN,R0[yH]=J.MAX;let P0={[vH]:J.ZERO,[fH]:J.ONE,[bH]:J.SRC_COLOR,[xH]:J.SRC_ALPHA,[dH]:J.SRC_ALPHA_SATURATE,[lH]:J.DST_COLOR,[pH]:J.DST_ALPHA,[hH]:J.ONE_MINUS_SRC_COLOR,[gH]:J.ONE_MINUS_SRC_ALPHA,[uH]:J.ONE_MINUS_DST_COLOR,[mH]:J.ONE_MINUS_DST_ALPHA,[cH]:J.CONSTANT_COLOR,[nH]:J.ONE_MINUS_CONSTANT_COLOR,[sH]:J.CONSTANT_ALPHA,[iH]:J.ONE_MINUS_CONSTANT_ALPHA};function L0(i,S0,N0,w0,u0,k0,f0,Y9,s9,j9){if(i===W8){if(R===!0)d(J.BLEND),R=!1;return}if(R===!1)x(J.BLEND),R=!0;if(i!==TH){if(i!==E||j9!==s){if(P!==aJ||A!==aJ)J.blendEquation(J.FUNC_ADD),P=aJ,A=aJ;if(j9)switch(i){case s$:J.blendFuncSeparate(J.ONE,J.ONE_MINUS_SRC_ALPHA,J.ONE,J.ONE_MINUS_SRC_ALPHA);break;case y8:J.blendFunc(J.ONE,J.ONE);break;case EW:J.blendFuncSeparate(J.ZERO,J.ONE_MINUS_SRC_COLOR,J.ZERO,J.ONE);break;case qW:J.blendFuncSeparate(J.DST_COLOR,J.ONE_MINUS_SRC_ALPHA,J.ZERO,J.ONE);break;default:Z9("WebGLState: Invalid blending: ",i);break}else switch(i){case s$:J.blendFuncSeparate(J.SRC_ALPHA,J.ONE_MINUS_SRC_ALPHA,J.ONE,J.ONE_MINUS_SRC_ALPHA);break;case y8:J.blendFuncSeparate(J.SRC_ALPHA,J.ONE,J.ONE,J.ONE);break;case EW:Z9("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case qW:Z9("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Z9("WebGLState: Invalid blending: ",i);break}k=null,V=null,w=null,D=null,L.set(0,0,0),M=0,E=i,s=j9}return}if(u0=u0||S0,k0=k0||N0,f0=f0||w0,S0!==P||u0!==A)J.blendEquationSeparate(R0[S0],R0[u0]),P=S0,A=u0;if(N0!==k||w0!==V||k0!==w||f0!==D)J.blendFuncSeparate(P0[N0],P0[w0],P0[k0],P0[f0]),k=N0,V=w0,w=k0,D=f0;if(Y9.equals(L)===!1||s9!==M)J.blendColor(Y9.r,Y9.g,Y9.b,s9),L.copy(Y9),M=s9;E=i,s=!1}function l0(i,S0){i.side===i9?d(J.CULL_FACE):x(J.CULL_FACE);let N0=i.side===I6;if(S0)N0=!N0;W9(N0),i.blending===s$&&i.transparent===!1?L0(W8):L0(i.blending,i.blendEquation,i.blendSrc,i.blendDst,i.blendEquationAlpha,i.blendSrcAlpha,i.blendDstAlpha,i.blendColor,i.blendAlpha,i.premultipliedAlpha),X.setFunc(i.depthFunc),X.setTest(i.depthTest),X.setMask(i.depthWrite),W.setMask(i.colorWrite);let w0=i.stencilWrite;if(Y.setTest(w0),w0)Y.setMask(i.stencilWriteMask),Y.setFunc(i.stencilFunc,i.stencilRef,i.stencilFuncMask),Y.setOp(i.stencilFail,i.stencilZFail,i.stencilZPass);k9(i.polygonOffset,i.polygonOffsetFactor,i.polygonOffsetUnits),i.alphaToCoverage===!0?x(J.SAMPLE_ALPHA_TO_COVERAGE):d(J.SAMPLE_ALPHA_TO_COVERAGE)}function W9(i){if(b!==i){if(i)J.frontFace(J.CW);else J.frontFace(J.CCW);b=i}}function t0(i){if(i!==zH){if(x(J.CULL_FACE),i!==u)if(i===FW)J.cullFace(J.BACK);else if(i===AH)J.cullFace(J.FRONT);else J.cullFace(J.FRONT_AND_BACK)}else d(J.CULL_FACE);u=i}function X9(i){if(i!==e){if(f)J.lineWidth(i);e=i}}function k9(i,S0,N0){if(i){if(x(J.POLYGON_OFFSET_FILL),v!==S0||j!==N0){if(v=S0,j=N0,X.getReversed())S0=-S0;J.polygonOffset(S0,N0)}}else d(J.POLYGON_OFFSET_FILL)}function L9(i){if(i)x(J.SCISSOR_TEST);else d(J.SCISSOR_TEST)}function m(i){if(i===void 0)i=J.TEXTURE0+g-1;if(r!==i)J.activeTexture(i),r=i}function m9(i,S0,N0){if(N0===void 0)if(r===null)N0=J.TEXTURE0+g-1;else N0=r;let w0=X0[N0];if(w0===void 0)w0={type:void 0,texture:void 0},X0[N0]=w0;if(w0.type!==i||w0.texture!==S0){if(r!==N0)J.activeTexture(N0),r=N0;J.bindTexture(i,S0||I[i]),w0.type=i,w0.texture=S0}}function z9(){let i=X0[r];if(i!==void 0&&i.type!==void 0)J.bindTexture(i.type,null),i.type=void 0,i.texture=void 0}function A9(){try{J.compressedTexImage2D(...arguments)}catch(i){Z9("WebGLState:",i)}}function T(){try{J.compressedTexImage3D(...arguments)}catch(i){Z9("WebGLState:",i)}}function C(){try{J.texSubImage2D(...arguments)}catch(i){Z9("WebGLState:",i)}}function l(){try{J.texSubImage3D(...arguments)}catch(i){Z9("WebGLState:",i)}}function Q0(){try{J.compressedTexSubImage2D(...arguments)}catch(i){Z9("WebGLState:",i)}}function V0(){try{J.compressedTexSubImage3D(...arguments)}catch(i){Z9("WebGLState:",i)}}function I0(){try{J.texStorage2D(...arguments)}catch(i){Z9("WebGLState:",i)}}function v0(){try{J.texStorage3D(...arguments)}catch(i){Z9("WebGLState:",i)}}function H0(){try{J.texImage2D(...arguments)}catch(i){Z9("WebGLState:",i)}}function E0(){try{J.texImage3D(...arguments)}catch(i){Z9("WebGLState:",i)}}function h0(i){if(F[i]!==void 0)return F[i];else return J.getParameter(i)}function y0(i,S0){if(F[i]!==S0)J.pixelStorei(i,S0),F[i]=S0}function z0(i){if(a.equals(i)===!1)J.scissor(i.x,i.y,i.z,i.w),a.copy(i)}function A0(i){if(U0.equals(i)===!1)J.viewport(i.x,i.y,i.z,i.w),U0.copy(i)}function a0(i,S0){let N0=U.get(S0);if(N0===void 0)N0=new WeakMap,U.set(S0,N0);let w0=N0.get(i);if(w0===void 0)w0=J.getUniformBlockIndex(S0,i.name),N0.set(i,w0)}function J9(i,S0){let w0=U.get(S0).get(i);if(H.get(S0)!==w0)J.uniformBlockBinding(S0,w0,i.__bindingPointIndex),H.set(S0,w0)}function _9(){J.disable(J.BLEND),J.disable(J.CULL_FACE),J.disable(J.DEPTH_TEST),J.disable(J.POLYGON_OFFSET_FILL),J.disable(J.SCISSOR_TEST),J.disable(J.STENCIL_TEST),J.disable(J.SAMPLE_ALPHA_TO_COVERAGE),J.blendEquation(J.FUNC_ADD),J.blendFunc(J.ONE,J.ZERO),J.blendFuncSeparate(J.ONE,J.ZERO,J.ONE,J.ZERO),J.blendColor(0,0,0,0),J.colorMask(!0,!0,!0,!0),J.clearColor(0,0,0,0),J.depthMask(!0),J.depthFunc(J.LESS),X.setReversed(!1),J.clearDepth(1),J.stencilMask(4294967295),J.stencilFunc(J.ALWAYS,0,4294967295),J.stencilOp(J.KEEP,J.KEEP,J.KEEP),J.clearStencil(0),J.cullFace(J.BACK),J.frontFace(J.CCW),J.polygonOffset(0,0),J.activeTexture(J.TEXTURE0),J.bindFramebuffer(J.FRAMEBUFFER,null),J.bindFramebuffer(J.DRAW_FRAMEBUFFER,null),J.bindFramebuffer(J.READ_FRAMEBUFFER,null),J.useProgram(null),J.lineWidth(1),J.scissor(0,0,J.canvas.width,J.canvas.height),J.viewport(0,0,J.canvas.width,J.canvas.height),J.pixelStorei(J.PACK_ALIGNMENT,4),J.pixelStorei(J.UNPACK_ALIGNMENT,4),J.pixelStorei(J.UNPACK_FLIP_Y_WEBGL,!1),J.pixelStorei(J.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),J.pixelStorei(J.UNPACK_COLORSPACE_CONVERSION_WEBGL,J.BROWSER_DEFAULT_WEBGL),J.pixelStorei(J.PACK_ROW_LENGTH,0),J.pixelStorei(J.PACK_SKIP_PIXELS,0),J.pixelStorei(J.PACK_SKIP_ROWS,0),J.pixelStorei(J.UNPACK_ROW_LENGTH,0),J.pixelStorei(J.UNPACK_IMAGE_HEIGHT,0),J.pixelStorei(J.UNPACK_SKIP_PIXELS,0),J.pixelStorei(J.UNPACK_SKIP_ROWS,0),J.pixelStorei(J.UNPACK_SKIP_IMAGES,0),G={},F={},r=null,X0={},N={},q=new WeakMap,O=[],B=null,R=!1,E=null,P=null,k=null,V=null,A=null,w=null,D=null,L=new b0(0,0,0),M=0,s=!1,b=null,u=null,e=null,v=null,j=null,a.set(0,0,J.canvas.width,J.canvas.height),U0.set(0,0,J.canvas.width,J.canvas.height),W.reset(),X.reset(),Y.reset()}return{buffers:{color:W,depth:X,stencil:Y},enable:x,disable:d,bindFramebuffer:K0,drawBuffers:t,useProgram:D0,setBlending:L0,setMaterial:l0,setFlipSided:W9,setCullFace:t0,setLineWidth:X9,setPolygonOffset:k9,setScissorTest:L9,activeTexture:m,bindTexture:m9,unbindTexture:z9,compressedTexImage2D:A9,compressedTexImage3D:T,texImage2D:H0,texImage3D:E0,pixelStorei:y0,getParameter:h0,updateUBOMapping:a0,uniformBlockBinding:J9,texStorage2D:I0,texStorage3D:v0,texSubImage2D:C,texSubImage3D:l,compressedTexSubImage2D:Q0,compressedTexSubImage3D:V0,scissor:z0,viewport:A0,reset:_9}}function JR(J,$,Q,Z,K,W,X){let Y=$.has("WEBGL_multisampled_render_to_texture")?$.get("WEBGL_multisampled_render_to_texture"):null,H=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),U=new O0,G=new WeakMap,F=new Set,N,q=new WeakMap,O=!1;try{O=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch(T){}function B(T,C){return O?new OffscreenCanvas(T,C):cJ("canvas")}function R(T,C,l){let Q0=1,V0=A9(T);if(V0.width>l||V0.height>l)Q0=l/Math.max(V0.width,V0.height);if(Q0<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){let I0=Math.floor(Q0*V0.width),v0=Math.floor(Q0*V0.height);if(N===void 0)N=B(I0,v0);let H0=C?B(I0,v0):N;return H0.width=I0,H0.height=v0,H0.getContext("2d").drawImage(T,0,0,I0,v0),r0("WebGLRenderer: Texture has been resized from ("+V0.width+"x"+V0.height+") to ("+I0+"x"+v0+")."),H0}else{if("data"in T)r0("WebGLRenderer: Image in DataTexture is too big ("+V0.width+"x"+V0.height+").");return T}return T}function E(T){return T.generateMipmaps}function P(T){J.generateMipmap(T)}function k(T){if(T.isWebGLCubeRenderTarget)return J.TEXTURE_CUBE_MAP;if(T.isWebGL3DRenderTarget)return J.TEXTURE_3D;if(T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture)return J.TEXTURE_2D_ARRAY;return J.TEXTURE_2D}function V(T,C,l,Q0,V0,I0=!1){if(T!==null){if(J[T]!==void 0)return J[T];r0("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let v0;if(Q0){if(v0=$.get("EXT_texture_norm16"),!v0)r0("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension")}let H0=C;if(C===J.RED){if(l===J.FLOAT)H0=J.R32F;if(l===J.HALF_FLOAT)H0=J.R16F;if(l===J.UNSIGNED_BYTE)H0=J.R8;if(l===J.UNSIGNED_SHORT&&v0)H0=v0.R16_EXT;if(l===J.SHORT&&v0)H0=v0.R16_SNORM_EXT}if(C===J.RED_INTEGER){if(l===J.UNSIGNED_BYTE)H0=J.R8UI;if(l===J.UNSIGNED_SHORT)H0=J.R16UI;if(l===J.UNSIGNED_INT)H0=J.R32UI;if(l===J.BYTE)H0=J.R8I;if(l===J.SHORT)H0=J.R16I;if(l===J.INT)H0=J.R32I}if(C===J.RG){if(l===J.FLOAT)H0=J.RG32F;if(l===J.HALF_FLOAT)H0=J.RG16F;if(l===J.UNSIGNED_BYTE)H0=J.RG8;if(l===J.UNSIGNED_SHORT&&v0)H0=v0.RG16_EXT;if(l===J.SHORT&&v0)H0=v0.RG16_SNORM_EXT}if(C===J.RG_INTEGER){if(l===J.UNSIGNED_BYTE)H0=J.RG8UI;if(l===J.UNSIGNED_SHORT)H0=J.RG16UI;if(l===J.UNSIGNED_INT)H0=J.RG32UI;if(l===J.BYTE)H0=J.RG8I;if(l===J.SHORT)H0=J.RG16I;if(l===J.INT)H0=J.RG32I}if(C===J.RGB_INTEGER){if(l===J.UNSIGNED_BYTE)H0=J.RGB8UI;if(l===J.UNSIGNED_SHORT)H0=J.RGB16UI;if(l===J.UNSIGNED_INT)H0=J.RGB32UI;if(l===J.BYTE)H0=J.RGB8I;if(l===J.SHORT)H0=J.RGB16I;if(l===J.INT)H0=J.RGB32I}if(C===J.RGBA_INTEGER){if(l===J.UNSIGNED_BYTE)H0=J.RGBA8UI;if(l===J.UNSIGNED_SHORT)H0=J.RGBA16UI;if(l===J.UNSIGNED_INT)H0=J.RGBA32UI;if(l===J.BYTE)H0=J.RGBA8I;if(l===J.SHORT)H0=J.RGBA16I;if(l===J.INT)H0=J.RGBA32I}if(C===J.RGB){if(l===J.UNSIGNED_SHORT&&v0)H0=v0.RGB16_EXT;if(l===J.SHORT&&v0)H0=v0.RGB16_SNORM_EXT;if(l===J.UNSIGNED_INT_5_9_9_9_REV)H0=J.RGB9_E5;if(l===J.UNSIGNED_INT_10F_11F_11F_REV)H0=J.R11F_G11F_B10F}if(C===J.RGBA){let E0=I0?QX:R9.getTransfer(V0);if(l===J.FLOAT)H0=J.RGBA32F;if(l===J.HALF_FLOAT)H0=J.RGBA16F;if(l===J.UNSIGNED_BYTE)H0=E0===c9?J.SRGB8_ALPHA8:J.RGBA8;if(l===J.UNSIGNED_SHORT&&v0)H0=v0.RGBA16_EXT;if(l===J.SHORT&&v0)H0=v0.RGBA16_SNORM_EXT;if(l===J.UNSIGNED_SHORT_4_4_4_4)H0=J.RGBA4;if(l===J.UNSIGNED_SHORT_5_5_5_1)H0=J.RGB5_A1}if(H0===J.R16F||H0===J.R32F||H0===J.RG16F||H0===J.RG32F||H0===J.RGBA16F||H0===J.RGBA32F)$.get("EXT_color_buffer_float");return H0}function A(T,C){let l;if(T){if(C===null||C===D7||C===J$)l=J.DEPTH24_STENCIL8;else if(C===e8)l=J.DEPTH32F_STENCIL8;else if(C===$Q)l=J.DEPTH24_STENCIL8,r0("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")}else if(C===null||C===D7||C===J$)l=J.DEPTH_COMPONENT24;else if(C===e8)l=J.DEPTH_COMPONENT32F;else if(C===$Q)l=J.DEPTH_COMPONENT16;return l}function w(T,C){if(E(T)===!0||T.isFramebufferTexture&&T.minFilter!==D8&&T.minFilter!==V6)return Math.log2(Math.max(C.width,C.height))+1;else if(T.mipmaps!==void 0&&T.mipmaps.length>0)return T.mipmaps.length;else if(T.isCompressedTexture&&Array.isArray(T.image))return C.mipmaps.length;else return 1}function D(T){let C=T.target;if(C.removeEventListener("dispose",D),M(C),C.isVideoTexture)G.delete(C);if(C.isHTMLTexture)F.delete(C)}function L(T){let C=T.target;C.removeEventListener("dispose",L),b(C)}function M(T){let C=Z.get(T);if(C.__webglInit===void 0)return;let l=T.source,Q0=q.get(l);if(Q0){let V0=Q0[C.__cacheKey];if(V0.usedTimes--,V0.usedTimes===0)s(T);if(Object.keys(Q0).length===0)q.delete(l)}Z.remove(T)}function s(T){let C=Z.get(T);J.deleteTexture(C.__webglTexture);let l=T.source,Q0=q.get(l);delete Q0[C.__cacheKey],X.memory.textures--}function b(T){let C=Z.get(T);if(T.depthTexture)T.depthTexture.dispose(),Z.remove(T.depthTexture);if(T.isWebGLCubeRenderTarget)for(let Q0=0;Q0<6;Q0++){if(Array.isArray(C.__webglFramebuffer[Q0]))for(let V0=0;V0<C.__webglFramebuffer[Q0].length;V0++)J.deleteFramebuffer(C.__webglFramebuffer[Q0][V0]);else J.deleteFramebuffer(C.__webglFramebuffer[Q0]);if(C.__webglDepthbuffer)J.deleteRenderbuffer(C.__webglDepthbuffer[Q0])}else{if(Array.isArray(C.__webglFramebuffer))for(let Q0=0;Q0<C.__webglFramebuffer.length;Q0++)J.deleteFramebuffer(C.__webglFramebuffer[Q0]);else J.deleteFramebuffer(C.__webglFramebuffer);if(C.__webglDepthbuffer)J.deleteRenderbuffer(C.__webglDepthbuffer);if(C.__webglMultisampledFramebuffer)J.deleteFramebuffer(C.__webglMultisampledFramebuffer);if(C.__webglColorRenderbuffer){for(let Q0=0;Q0<C.__webglColorRenderbuffer.length;Q0++)if(C.__webglColorRenderbuffer[Q0])J.deleteRenderbuffer(C.__webglColorRenderbuffer[Q0])}if(C.__webglDepthRenderbuffer)J.deleteRenderbuffer(C.__webglDepthRenderbuffer)}let l=T.textures;for(let Q0=0,V0=l.length;Q0<V0;Q0++){let I0=Z.get(l[Q0]);if(I0.__webglTexture)J.deleteTexture(I0.__webglTexture),X.memory.textures--;Z.remove(l[Q0])}Z.remove(T)}let u=0;function e(){u=0}function v(){return u}function j(T){u=T}function g(){let T=u;if(T>=K.maxTextures)r0("WebGLTextures: Trying to use "+(T+1)+" texture units while this GPU supports only "+K.maxTextures);return u+=1,T}function f(T){let C=[];return C.push(T.wrapS),C.push(T.wrapT),C.push(T.wrapR||0),C.push(T.magFilter),C.push(T.minFilter),C.push(T.anisotropy),C.push(T.internalFormat),C.push(T.format),C.push(T.type),C.push(T.generateMipmaps),C.push(T.premultiplyAlpha),C.push(T.flipY),C.push(T.unpackAlignment),C.push(T.colorSpace),C.join()}function o(T,C){let l=Z.get(T);if(T.isVideoTexture)m9(T);if(T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&l.__version!==T.version){let Q0=T.image;if(Q0===null)r0("WebGLRenderer: Texture marked for update but no image data found.");else if(Q0.complete===!1)r0("WebGLRenderer: Texture marked for update but image is incomplete");else{d(l,T,C);return}}else if(T.isExternalTexture)l.__webglTexture=T.sourceTexture?T.sourceTexture:null;Q.bindTexture(J.TEXTURE_2D,l.__webglTexture,J.TEXTURE0+C)}function p(T,C){let l=Z.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&l.__version!==T.version){d(l,T,C);return}else if(T.isExternalTexture)l.__webglTexture=T.sourceTexture?T.sourceTexture:null;Q.bindTexture(J.TEXTURE_2D_ARRAY,l.__webglTexture,J.TEXTURE0+C)}function r(T,C){let l=Z.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&l.__version!==T.version){d(l,T,C);return}Q.bindTexture(J.TEXTURE_3D,l.__webglTexture,J.TEXTURE0+C)}function X0(T,C){let l=Z.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&l.__version!==T.version){K0(l,T,C);return}Q.bindTexture(J.TEXTURE_CUBE_MAP,l.__webglTexture,J.TEXTURE0+C)}let M0={[B7]:J.REPEAT,[tJ]:J.CLAMP_TO_EDGE,[_Z]:J.MIRRORED_REPEAT},y={[D8]:J.NEAREST,[TZ]:J.NEAREST_MIPMAP_NEAREST,[o7]:J.NEAREST_MIPMAP_LINEAR,[V6]:J.LINEAR,[eJ]:J.LINEAR_MIPMAP_NEAREST,[v8]:J.LINEAR_MIPMAP_LINEAR},a={[E5]:J.NEVER,[V5]:J.ALWAYS,[q5]:J.LESS,[hZ]:J.LEQUAL,[O5]:J.EQUAL,[xZ]:J.GEQUAL,[R5]:J.GREATER,[L5]:J.NOTEQUAL};function U0(T,C){if(C.type===e8&&$.has("OES_texture_float_linear")===!1&&(C.magFilter===V6||C.magFilter===eJ||C.magFilter===o7||C.magFilter===v8||C.minFilter===V6||C.minFilter===eJ||C.minFilter===o7||C.minFilter===v8))r0("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device.");if(J.texParameteri(T,J.TEXTURE_WRAP_S,M0[C.wrapS]),J.texParameteri(T,J.TEXTURE_WRAP_T,M0[C.wrapT]),T===J.TEXTURE_3D||T===J.TEXTURE_2D_ARRAY)J.texParameteri(T,J.TEXTURE_WRAP_R,M0[C.wrapR]);if(J.texParameteri(T,J.TEXTURE_MAG_FILTER,y[C.magFilter]),J.texParameteri(T,J.TEXTURE_MIN_FILTER,y[C.minFilter]),C.compareFunction)J.texParameteri(T,J.TEXTURE_COMPARE_MODE,J.COMPARE_REF_TO_TEXTURE),J.texParameteri(T,J.TEXTURE_COMPARE_FUNC,a[C.compareFunction]);if($.has("EXT_texture_filter_anisotropic")===!0){if(C.magFilter===D8)return;if(C.minFilter!==o7&&C.minFilter!==v8)return;if(C.type===e8&&$.has("OES_texture_float_linear")===!1)return;if(C.anisotropy>1||Z.get(C).__currentAnisotropy){let l=$.get("EXT_texture_filter_anisotropic");J.texParameterf(T,l.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(C.anisotropy,K.getMaxAnisotropy())),Z.get(C).__currentAnisotropy=C.anisotropy}}}function h(T,C){let l=!1;if(T.__webglInit===void 0)T.__webglInit=!0,C.addEventListener("dispose",D);let Q0=C.source,V0=q.get(Q0);if(V0===void 0)V0={},q.set(Q0,V0);let I0=f(C);if(I0!==T.__cacheKey){if(V0[I0]===void 0)V0[I0]={texture:J.createTexture(),usedTimes:0},X.memory.textures++,l=!0;V0[I0].usedTimes++;let v0=V0[T.__cacheKey];if(v0!==void 0){if(V0[T.__cacheKey].usedTimes--,v0.usedTimes===0)s(C)}T.__cacheKey=I0,T.__webglTexture=V0[I0].texture}return l}function I(T,C,l){return Math.floor(Math.floor(T/l)/C)}function x(T,C,l,Q0){let I0=T.updateRanges;if(I0.length===0)Q.texSubImage2D(J.TEXTURE_2D,0,0,0,C.width,C.height,l,Q0,C.data);else{I0.sort((y0,z0)=>y0.start-z0.start);let v0=0;for(let y0=1;y0<I0.length;y0++){let z0=I0[v0],A0=I0[y0],a0=z0.start+z0.count,J9=I(A0.start,C.width,4),_9=I(z0.start,C.width,4);if(A0.start<=a0+1&&J9===_9&&I(A0.start+A0.count-1,C.width,4)===J9)z0.count=Math.max(z0.count,A0.start+A0.count-z0.start);else++v0,I0[v0]=A0}I0.length=v0+1;let H0=Q.getParameter(J.UNPACK_ROW_LENGTH),E0=Q.getParameter(J.UNPACK_SKIP_PIXELS),h0=Q.getParameter(J.UNPACK_SKIP_ROWS);Q.pixelStorei(J.UNPACK_ROW_LENGTH,C.width);for(let y0=0,z0=I0.length;y0<z0;y0++){let A0=I0[y0],a0=Math.floor(A0.start/4),J9=Math.ceil(A0.count/4),_9=a0%C.width,i=Math.floor(a0/C.width),S0=J9,N0=1;Q.pixelStorei(J.UNPACK_SKIP_PIXELS,_9),Q.pixelStorei(J.UNPACK_SKIP_ROWS,i),Q.texSubImage2D(J.TEXTURE_2D,0,_9,i,S0,1,l,Q0,C.data)}T.clearUpdateRanges(),Q.pixelStorei(J.UNPACK_ROW_LENGTH,H0),Q.pixelStorei(J.UNPACK_SKIP_PIXELS,E0),Q.pixelStorei(J.UNPACK_SKIP_ROWS,h0)}}function d(T,C,l){let Q0=J.TEXTURE_2D;if(C.isDataArrayTexture||C.isCompressedArrayTexture)Q0=J.TEXTURE_2D_ARRAY;if(C.isData3DTexture)Q0=J.TEXTURE_3D;let V0=h(T,C),I0=C.source;Q.bindTexture(Q0,T.__webglTexture,J.TEXTURE0+l);let v0=Z.get(I0);if(I0.version!==v0.__version||V0===!0){if(Q.activeTexture(J.TEXTURE0+l),(typeof ImageBitmap<"u"&&C.image instanceof ImageBitmap)===!1){let N0=R9.getPrimaries(R9.workingColorSpace),w0=C.colorSpace===e7?null:R9.getPrimaries(C.colorSpace),u0=C.colorSpace===e7||N0===w0?J.NONE:J.BROWSER_DEFAULT_WEBGL;Q.pixelStorei(J.UNPACK_FLIP_Y_WEBGL,C.flipY),Q.pixelStorei(J.UNPACK_PREMULTIPLY_ALPHA_WEBGL,C.premultiplyAlpha),Q.pixelStorei(J.UNPACK_COLORSPACE_CONVERSION_WEBGL,u0)}Q.pixelStorei(J.UNPACK_ALIGNMENT,C.unpackAlignment);let E0=R(C.image,!1,K.maxTextureSize);E0=z9(C,E0);let h0=W.convert(C.format,C.colorSpace),y0=W.convert(C.type),z0=V(C.internalFormat,h0,y0,C.normalized,C.colorSpace,C.isVideoTexture);U0(Q0,C);let A0,a0=C.mipmaps,J9=C.isVideoTexture!==!0,_9=v0.__version===void 0||V0===!0,i=I0.dataReady,S0=w(C,E0);if(C.isDepthTexture){if(z0=A(C.format===r7,C.type),_9)if(J9)Q.texStorage2D(J.TEXTURE_2D,1,z0,E0.width,E0.height);else Q.texImage2D(J.TEXTURE_2D,0,z0,E0.width,E0.height,0,h0,y0,null)}else if(C.isDataTexture)if(a0.length>0){if(J9&&_9)Q.texStorage2D(J.TEXTURE_2D,S0,z0,a0[0].width,a0[0].height);for(let N0=0,w0=a0.length;N0<w0;N0++)if(A0=a0[N0],J9){if(i)Q.texSubImage2D(J.TEXTURE_2D,N0,0,0,A0.width,A0.height,h0,y0,A0.data)}else Q.texImage2D(J.TEXTURE_2D,N0,z0,A0.width,A0.height,0,h0,y0,A0.data);C.generateMipmaps=!1}else if(J9){if(_9)Q.texStorage2D(J.TEXTURE_2D,S0,z0,E0.width,E0.height);if(i)x(C,E0,h0,y0)}else Q.texImage2D(J.TEXTURE_2D,0,z0,E0.width,E0.height,0,h0,y0,E0.data);else if(C.isCompressedTexture)if(C.isCompressedArrayTexture){if(J9&&_9)Q.texStorage3D(J.TEXTURE_2D_ARRAY,S0,z0,a0[0].width,a0[0].height,E0.depth);for(let N0=0,w0=a0.length;N0<w0;N0++)if(A0=a0[N0],C.format!==f8)if(h0!==null)if(J9){if(i)if(C.layerUpdates.size>0){let u0=wX(A0.width,A0.height,C.format,C.type);for(let k0 of C.layerUpdates){let f0=A0.data.subarray(k0*u0/A0.data.BYTES_PER_ELEMENT,(k0+1)*u0/A0.data.BYTES_PER_ELEMENT);Q.compressedTexSubImage3D(J.TEXTURE_2D_ARRAY,N0,0,0,k0,A0.width,A0.height,1,h0,f0)}}else Q.compressedTexSubImage3D(J.TEXTURE_2D_ARRAY,N0,0,0,0,A0.width,A0.height,E0.depth,h0,A0.data)}else Q.compressedTexImage3D(J.TEXTURE_2D_ARRAY,N0,z0,A0.width,A0.height,E0.depth,0,A0.data,0,0);else r0("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else if(J9){if(i)Q.texSubImage3D(J.TEXTURE_2D_ARRAY,N0,0,0,0,A0.width,A0.height,E0.depth,h0,y0,A0.data)}else Q.texImage3D(J.TEXTURE_2D_ARRAY,N0,z0,A0.width,A0.height,E0.depth,0,h0,y0,A0.data);if(C.layerUpdates.size>0)C.clearLayerUpdates()}else{if(J9&&_9)Q.texStorage2D(J.TEXTURE_2D,S0,z0,a0[0].width,a0[0].height);for(let N0=0,w0=a0.length;N0<w0;N0++)if(A0=a0[N0],C.format!==f8)if(h0!==null)if(J9){if(i)Q.compressedTexSubImage2D(J.TEXTURE_2D,N0,0,0,A0.width,A0.height,h0,A0.data)}else Q.compressedTexImage2D(J.TEXTURE_2D,N0,z0,A0.width,A0.height,0,A0.data);else r0("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else if(J9){if(i)Q.texSubImage2D(J.TEXTURE_2D,N0,0,0,A0.width,A0.height,h0,y0,A0.data)}else Q.texImage2D(J.TEXTURE_2D,N0,z0,A0.width,A0.height,0,h0,y0,A0.data)}else if(C.isDataArrayTexture)if(J9){if(_9)Q.texStorage3D(J.TEXTURE_2D_ARRAY,S0,z0,E0.width,E0.height,E0.depth);if(i)if(C.layerUpdates.size>0){let N0=wX(E0.width,E0.height,C.format,C.type);for(let w0 of C.layerUpdates){let u0=E0.data.subarray(w0*N0/E0.data.BYTES_PER_ELEMENT,(w0+1)*N0/E0.data.BYTES_PER_ELEMENT);Q.texSubImage3D(J.TEXTURE_2D_ARRAY,0,0,0,w0,E0.width,E0.height,1,h0,y0,u0)}C.clearLayerUpdates()}else Q.texSubImage3D(J.TEXTURE_2D_ARRAY,0,0,0,0,E0.width,E0.height,E0.depth,h0,y0,E0.data)}else Q.texImage3D(J.TEXTURE_2D_ARRAY,0,z0,E0.width,E0.height,E0.depth,0,h0,y0,E0.data);else if(C.isData3DTexture)if(J9){if(_9)Q.texStorage3D(J.TEXTURE_3D,S0,z0,E0.width,E0.height,E0.depth);if(i)Q.texSubImage3D(J.TEXTURE_3D,0,0,0,0,E0.width,E0.height,E0.depth,h0,y0,E0.data)}else Q.texImage3D(J.TEXTURE_3D,0,z0,E0.width,E0.height,E0.depth,0,h0,y0,E0.data);else if(C.isFramebufferTexture){if(_9)if(J9)Q.texStorage2D(J.TEXTURE_2D,S0,z0,E0.width,E0.height);else{let{width:N0,height:w0}=E0;for(let u0=0;u0<S0;u0++)Q.texImage2D(J.TEXTURE_2D,u0,z0,N0,w0,0,h0,y0,null),N0>>=1,w0>>=1}}else if(C.isHTMLTexture){if("texElementImage2D"in J){let N0=J.canvas;if(!N0.hasAttribute("layoutsubtree"))N0.setAttribute("layoutsubtree","true");if(E0.parentNode!==N0){N0.appendChild(E0),F.add(C),N0.onpaint=(w0)=>{let u0=w0.changedElements;for(let k0 of F)if(u0.includes(k0.image))k0.needsUpdate=!0},N0.requestPaint();return}if(J.texElementImage2D.length===3)J.texElementImage2D(J.TEXTURE_2D,J.RGBA8,E0);else{let{RGBA:u0,RGBA:k0,UNSIGNED_BYTE:f0}=J;J.texElementImage2D(J.TEXTURE_2D,0,u0,k0,f0,E0)}J.texParameteri(J.TEXTURE_2D,J.TEXTURE_MIN_FILTER,J.LINEAR),J.texParameteri(J.TEXTURE_2D,J.TEXTURE_WRAP_S,J.CLAMP_TO_EDGE),J.texParameteri(J.TEXTURE_2D,J.TEXTURE_WRAP_T,J.CLAMP_TO_EDGE)}}else if(a0.length>0){if(J9&&_9){let N0=A9(a0[0]);Q.texStorage2D(J.TEXTURE_2D,S0,z0,N0.width,N0.height)}for(let N0=0,w0=a0.length;N0<w0;N0++)if(A0=a0[N0],J9){if(i)Q.texSubImage2D(J.TEXTURE_2D,N0,0,0,h0,y0,A0)}else Q.texImage2D(J.TEXTURE_2D,N0,z0,h0,y0,A0);C.generateMipmaps=!1}else if(J9){if(_9){let N0=A9(E0);Q.texStorage2D(J.TEXTURE_2D,S0,z0,N0.width,N0.height)}if(i)Q.texSubImage2D(J.TEXTURE_2D,0,0,0,h0,y0,E0)}else Q.texImage2D(J.TEXTURE_2D,0,z0,h0,y0,E0);if(E(C))P(Q0);if(v0.__version=I0.version,C.onUpdate)C.onUpdate(C)}T.__version=C.version}function K0(T,C,l){if(C.image.length!==6)return;let Q0=h(T,C),V0=C.source;Q.bindTexture(J.TEXTURE_CUBE_MAP,T.__webglTexture,J.TEXTURE0+l);let I0=Z.get(V0);if(V0.version!==I0.__version||Q0===!0){Q.activeTexture(J.TEXTURE0+l);let v0=R9.getPrimaries(R9.workingColorSpace),H0=C.colorSpace===e7?null:R9.getPrimaries(C.colorSpace),E0=C.colorSpace===e7||v0===H0?J.NONE:J.BROWSER_DEFAULT_WEBGL;Q.pixelStorei(J.UNPACK_FLIP_Y_WEBGL,C.flipY),Q.pixelStorei(J.UNPACK_PREMULTIPLY_ALPHA_WEBGL,C.premultiplyAlpha),Q.pixelStorei(J.UNPACK_ALIGNMENT,C.unpackAlignment),Q.pixelStorei(J.UNPACK_COLORSPACE_CONVERSION_WEBGL,E0);let h0=C.isCompressedTexture||C.image[0].isCompressedTexture,y0=C.image[0]&&C.image[0].isDataTexture,z0=[];for(let k0=0;k0<6;k0++){if(!h0&&!y0)z0[k0]=R(C.image[k0],!0,K.maxCubemapSize);else z0[k0]=y0?C.image[k0].image:C.image[k0];z0[k0]=z9(C,z0[k0])}let A0=z0[0],a0=W.convert(C.format,C.colorSpace),J9=W.convert(C.type),_9=V(C.internalFormat,a0,J9,C.normalized,C.colorSpace),i=C.isVideoTexture!==!0,S0=I0.__version===void 0||Q0===!0,N0=V0.dataReady,w0=w(C,A0);U0(J.TEXTURE_CUBE_MAP,C);let u0;if(h0){if(i&&S0)Q.texStorage2D(J.TEXTURE_CUBE_MAP,w0,_9,A0.width,A0.height);for(let k0=0;k0<6;k0++){u0=z0[k0].mipmaps;for(let f0=0;f0<u0.length;f0++){let Y9=u0[f0];if(C.format!==f8)if(a0!==null)if(i){if(N0)Q.compressedTexSubImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+k0,f0,0,0,Y9.width,Y9.height,a0,Y9.data)}else Q.compressedTexImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+k0,f0,_9,Y9.width,Y9.height,0,Y9.data);else r0("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()");else if(i){if(N0)Q.texSubImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+k0,f0,0,0,Y9.width,Y9.height,a0,J9,Y9.data)}else Q.texImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+k0,f0,_9,Y9.width,Y9.height,0,a0,J9,Y9.data)}}}else{if(u0=C.mipmaps,i&&S0){if(u0.length>0)w0++;let k0=A9(z0[0]);Q.texStorage2D(J.TEXTURE_CUBE_MAP,w0,_9,k0.width,k0.height)}for(let k0=0;k0<6;k0++)if(y0){if(i){if(N0)Q.texSubImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+k0,0,0,0,z0[k0].width,z0[k0].height,a0,J9,z0[k0].data)}else Q.texImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+k0,0,_9,z0[k0].width,z0[k0].height,0,a0,J9,z0[k0].data);for(let f0=0;f0<u0.length;f0++){let s9=u0[f0].image[k0].image;if(i){if(N0)Q.texSubImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+k0,f0+1,0,0,s9.width,s9.height,a0,J9,s9.data)}else Q.texImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+k0,f0+1,_9,s9.width,s9.height,0,a0,J9,s9.data)}}else{if(i){if(N0)Q.texSubImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+k0,0,0,0,a0,J9,z0[k0])}else Q.texImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+k0,0,_9,a0,J9,z0[k0]);for(let f0=0;f0<u0.length;f0++){let Y9=u0[f0];if(i){if(N0)Q.texSubImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+k0,f0+1,0,0,a0,J9,Y9.image[k0])}else Q.texImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+k0,f0+1,_9,a0,J9,Y9.image[k0])}}}if(E(C))P(J.TEXTURE_CUBE_MAP);if(I0.__version=V0.version,C.onUpdate)C.onUpdate(C)}T.__version=C.version}function t(T,C,l,Q0,V0,I0){let v0=W.convert(l.format,l.colorSpace),H0=W.convert(l.type),E0=V(l.internalFormat,v0,H0,l.normalized,l.colorSpace),h0=Z.get(C),y0=Z.get(l);if(y0.__renderTarget=C,!h0.__hasExternalTextures){let z0=Math.max(1,C.width>>I0),A0=Math.max(1,C.height>>I0);if(V0===J.TEXTURE_3D||V0===J.TEXTURE_2D_ARRAY)Q.texImage3D(V0,I0,E0,z0,A0,C.depth,0,v0,H0,null);else Q.texImage2D(V0,I0,E0,z0,A0,0,v0,H0,null)}if(Q.bindFramebuffer(J.FRAMEBUFFER,T),m(C))Y.framebufferTexture2DMultisampleEXT(J.FRAMEBUFFER,Q0,V0,y0.__webglTexture,0,L9(C));else if(V0===J.TEXTURE_2D||V0>=J.TEXTURE_CUBE_MAP_POSITIVE_X&&V0<=J.TEXTURE_CUBE_MAP_NEGATIVE_Z)J.framebufferTexture2D(J.FRAMEBUFFER,Q0,V0,y0.__webglTexture,I0);Q.bindFramebuffer(J.FRAMEBUFFER,null)}function D0(T,C,l){if(J.bindRenderbuffer(J.RENDERBUFFER,T),C.depthBuffer){let Q0=C.depthTexture,V0=Q0&&Q0.isDepthTexture?Q0.type:null,I0=A(C.stencilBuffer,V0),v0=C.stencilBuffer?J.DEPTH_STENCIL_ATTACHMENT:J.DEPTH_ATTACHMENT;if(m(C))Y.renderbufferStorageMultisampleEXT(J.RENDERBUFFER,L9(C),I0,C.width,C.height);else if(l)J.renderbufferStorageMultisample(J.RENDERBUFFER,L9(C),I0,C.width,C.height);else J.renderbufferStorage(J.RENDERBUFFER,I0,C.width,C.height);J.framebufferRenderbuffer(J.FRAMEBUFFER,v0,J.RENDERBUFFER,T)}else{let Q0=C.textures;for(let V0=0;V0<Q0.length;V0++){let I0=Q0[V0],v0=W.convert(I0.format,I0.colorSpace),H0=W.convert(I0.type),E0=V(I0.internalFormat,v0,H0,I0.normalized,I0.colorSpace);if(m(C))Y.renderbufferStorageMultisampleEXT(J.RENDERBUFFER,L9(C),E0,C.width,C.height);else if(l)J.renderbufferStorageMultisample(J.RENDERBUFFER,L9(C),E0,C.width,C.height);else J.renderbufferStorage(J.RENDERBUFFER,E0,C.width,C.height)}}J.bindRenderbuffer(J.RENDERBUFFER,null)}function R0(T,C,l){let Q0=C.isWebGLCubeRenderTarget===!0;if(Q.bindFramebuffer(J.FRAMEBUFFER,T),!(C.depthTexture&&C.depthTexture.isDepthTexture))throw Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let V0=Z.get(C.depthTexture);if(V0.__renderTarget=C,!V0.__webglTexture||C.depthTexture.image.width!==C.width||C.depthTexture.image.height!==C.height)C.depthTexture.image.width=C.width,C.depthTexture.image.height=C.height,C.depthTexture.needsUpdate=!0;if(Q0){if(V0.__webglInit===void 0)V0.__webglInit=!0,C.depthTexture.addEventListener("dispose",D);if(V0.__webglTexture===void 0){V0.__webglTexture=J.createTexture(),Q.bindTexture(J.TEXTURE_CUBE_MAP,V0.__webglTexture),U0(J.TEXTURE_CUBE_MAP,C.depthTexture);let h0=W.convert(C.depthTexture.format),y0=W.convert(C.depthTexture.type),z0;if(C.depthTexture.format===a7)z0=J.DEPTH_COMPONENT24;else if(C.depthTexture.format===r7)z0=J.DEPTH24_STENCIL8;for(let A0=0;A0<6;A0++)J.texImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+A0,0,z0,C.width,C.height,0,h0,y0,null)}}else o(C.depthTexture,0);let I0=V0.__webglTexture,v0=L9(C),H0=Q0?J.TEXTURE_CUBE_MAP_POSITIVE_X+l:J.TEXTURE_2D,E0=C.depthTexture.format===r7?J.DEPTH_STENCIL_ATTACHMENT:J.DEPTH_ATTACHMENT;if(C.depthTexture.format===a7)if(m(C))Y.framebufferTexture2DMultisampleEXT(J.FRAMEBUFFER,E0,H0,I0,0,v0);else J.framebufferTexture2D(J.FRAMEBUFFER,E0,H0,I0,0);else if(C.depthTexture.format===r7)if(m(C))Y.framebufferTexture2DMultisampleEXT(J.FRAMEBUFFER,E0,H0,I0,0,v0);else J.framebufferTexture2D(J.FRAMEBUFFER,E0,H0,I0,0);else throw Error("THREE.WebGLTextures: Unknown depthTexture format.")}function P0(T){let C=Z.get(T),l=T.isWebGLCubeRenderTarget===!0;if(C.__boundDepthTexture!==T.depthTexture){let Q0=T.depthTexture;if(C.__depthDisposeCallback)C.__depthDisposeCallback();if(Q0){let V0=()=>{delete C.__boundDepthTexture,delete C.__depthDisposeCallback,Q0.removeEventListener("dispose",V0)};Q0.addEventListener("dispose",V0),C.__depthDisposeCallback=V0}C.__boundDepthTexture=Q0}if(T.depthTexture&&!C.__autoAllocateDepthBuffer)if(l)for(let Q0=0;Q0<6;Q0++)R0(C.__webglFramebuffer[Q0],T,Q0);else{let Q0=T.texture.mipmaps;if(Q0&&Q0.length>0)R0(C.__webglFramebuffer[0],T,0);else R0(C.__webglFramebuffer,T,0)}else if(l){C.__webglDepthbuffer=[];for(let Q0=0;Q0<6;Q0++)if(Q.bindFramebuffer(J.FRAMEBUFFER,C.__webglFramebuffer[Q0]),C.__webglDepthbuffer[Q0]===void 0)C.__webglDepthbuffer[Q0]=J.createRenderbuffer(),D0(C.__webglDepthbuffer[Q0],T,!1);else{let V0=T.stencilBuffer?J.DEPTH_STENCIL_ATTACHMENT:J.DEPTH_ATTACHMENT,I0=C.__webglDepthbuffer[Q0];J.bindRenderbuffer(J.RENDERBUFFER,I0),J.framebufferRenderbuffer(J.FRAMEBUFFER,V0,J.RENDERBUFFER,I0)}}else{let Q0=T.texture.mipmaps;if(Q0&&Q0.length>0)Q.bindFramebuffer(J.FRAMEBUFFER,C.__webglFramebuffer[0]);else Q.bindFramebuffer(J.FRAMEBUFFER,C.__webglFramebuffer);if(C.__webglDepthbuffer===void 0)C.__webglDepthbuffer=J.createRenderbuffer(),D0(C.__webglDepthbuffer,T,!1);else{let V0=T.stencilBuffer?J.DEPTH_STENCIL_ATTACHMENT:J.DEPTH_ATTACHMENT,I0=C.__webglDepthbuffer;J.bindRenderbuffer(J.RENDERBUFFER,I0),J.framebufferRenderbuffer(J.FRAMEBUFFER,V0,J.RENDERBUFFER,I0)}}Q.bindFramebuffer(J.FRAMEBUFFER,null)}function L0(T,C,l){let Q0=Z.get(T);if(C!==void 0)t(Q0.__webglFramebuffer,T,T.texture,J.COLOR_ATTACHMENT0,J.TEXTURE_2D,0);if(l!==void 0)P0(T)}function l0(T){let C=T.texture,l=Z.get(T),Q0=Z.get(C);T.addEventListener("dispose",L);let V0=T.textures,I0=T.isWebGLCubeRenderTarget===!0,v0=V0.length>1;if(!v0){if(Q0.__webglTexture===void 0)Q0.__webglTexture=J.createTexture();Q0.__version=C.version,X.memory.textures++}if(I0){l.__webglFramebuffer=[];for(let H0=0;H0<6;H0++)if(C.mipmaps&&C.mipmaps.length>0){l.__webglFramebuffer[H0]=[];for(let E0=0;E0<C.mipmaps.length;E0++)l.__webglFramebuffer[H0][E0]=J.createFramebuffer()}else l.__webglFramebuffer[H0]=J.createFramebuffer()}else{if(C.mipmaps&&C.mipmaps.length>0){l.__webglFramebuffer=[];for(let H0=0;H0<C.mipmaps.length;H0++)l.__webglFramebuffer[H0]=J.createFramebuffer()}else l.__webglFramebuffer=J.createFramebuffer();if(v0)for(let H0=0,E0=V0.length;H0<E0;H0++){let h0=Z.get(V0[H0]);if(h0.__webglTexture===void 0)h0.__webglTexture=J.createTexture(),X.memory.textures++}if(T.samples>0&&m(T)===!1){l.__webglMultisampledFramebuffer=J.createFramebuffer(),l.__webglColorRenderbuffer=[],Q.bindFramebuffer(J.FRAMEBUFFER,l.__webglMultisampledFramebuffer);for(let H0=0;H0<V0.length;H0++){let E0=V0[H0];l.__webglColorRenderbuffer[H0]=J.createRenderbuffer(),J.bindRenderbuffer(J.RENDERBUFFER,l.__webglColorRenderbuffer[H0]);let h0=W.convert(E0.format,E0.colorSpace),y0=W.convert(E0.type),z0=V(E0.internalFormat,h0,y0,E0.normalized,E0.colorSpace,T.isXRRenderTarget===!0),A0=L9(T);J.renderbufferStorageMultisample(J.RENDERBUFFER,A0,z0,T.width,T.height),J.framebufferRenderbuffer(J.FRAMEBUFFER,J.COLOR_ATTACHMENT0+H0,J.RENDERBUFFER,l.__webglColorRenderbuffer[H0])}if(J.bindRenderbuffer(J.RENDERBUFFER,null),T.depthBuffer)l.__webglDepthRenderbuffer=J.createRenderbuffer(),D0(l.__webglDepthRenderbuffer,T,!0);Q.bindFramebuffer(J.FRAMEBUFFER,null)}}if(I0){Q.bindTexture(J.TEXTURE_CUBE_MAP,Q0.__webglTexture),U0(J.TEXTURE_CUBE_MAP,C);for(let H0=0;H0<6;H0++)if(C.mipmaps&&C.mipmaps.length>0)for(let E0=0;E0<C.mipmaps.length;E0++)t(l.__webglFramebuffer[H0][E0],T,C,J.COLOR_ATTACHMENT0,J.TEXTURE_CUBE_MAP_POSITIVE_X+H0,E0);else t(l.__webglFramebuffer[H0],T,C,J.COLOR_ATTACHMENT0,J.TEXTURE_CUBE_MAP_POSITIVE_X+H0,0);if(E(C))P(J.TEXTURE_CUBE_MAP);Q.unbindTexture()}else if(v0){for(let H0=0,E0=V0.length;H0<E0;H0++){let h0=V0[H0],y0=Z.get(h0),z0=J.TEXTURE_2D;if(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)z0=T.isWebGL3DRenderTarget?J.TEXTURE_3D:J.TEXTURE_2D_ARRAY;if(Q.bindTexture(z0,y0.__webglTexture),U0(z0,h0),t(l.__webglFramebuffer,T,h0,J.COLOR_ATTACHMENT0+H0,z0,0),E(h0))P(z0)}Q.unbindTexture()}else{let H0=J.TEXTURE_2D;if(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)H0=T.isWebGL3DRenderTarget?J.TEXTURE_3D:J.TEXTURE_2D_ARRAY;if(Q.bindTexture(H0,Q0.__webglTexture),U0(H0,C),C.mipmaps&&C.mipmaps.length>0)for(let E0=0;E0<C.mipmaps.length;E0++)t(l.__webglFramebuffer[E0],T,C,J.COLOR_ATTACHMENT0,H0,E0);else t(l.__webglFramebuffer,T,C,J.COLOR_ATTACHMENT0,H0,0);if(E(C))P(H0);Q.unbindTexture()}if(T.depthBuffer)P0(T)}function W9(T){let C=T.textures;for(let l=0,Q0=C.length;l<Q0;l++){let V0=C[l];if(E(V0)){let I0=k(T),v0=Z.get(V0).__webglTexture;Q.bindTexture(I0,v0),P(I0),Q.unbindTexture()}}}let t0=[],X9=[];function k9(T){if(T.samples>0){if(m(T)===!1){let{textures:C,width:l,height:Q0}=T,V0=J.COLOR_BUFFER_BIT,I0=T.stencilBuffer?J.DEPTH_STENCIL_ATTACHMENT:J.DEPTH_ATTACHMENT,v0=Z.get(T),H0=C.length>1;if(H0)for(let h0=0;h0<C.length;h0++)Q.bindFramebuffer(J.FRAMEBUFFER,v0.__webglMultisampledFramebuffer),J.framebufferRenderbuffer(J.FRAMEBUFFER,J.COLOR_ATTACHMENT0+h0,J.RENDERBUFFER,null),Q.bindFramebuffer(J.FRAMEBUFFER,v0.__webglFramebuffer),J.framebufferTexture2D(J.DRAW_FRAMEBUFFER,J.COLOR_ATTACHMENT0+h0,J.TEXTURE_2D,null,0);Q.bindFramebuffer(J.READ_FRAMEBUFFER,v0.__webglMultisampledFramebuffer);let E0=T.texture.mipmaps;if(E0&&E0.length>0)Q.bindFramebuffer(J.DRAW_FRAMEBUFFER,v0.__webglFramebuffer[0]);else Q.bindFramebuffer(J.DRAW_FRAMEBUFFER,v0.__webglFramebuffer);for(let h0=0;h0<C.length;h0++){if(T.resolveDepthBuffer){if(T.depthBuffer)V0|=J.DEPTH_BUFFER_BIT;if(T.stencilBuffer&&T.resolveStencilBuffer)V0|=J.STENCIL_BUFFER_BIT}if(H0){J.framebufferRenderbuffer(J.READ_FRAMEBUFFER,J.COLOR_ATTACHMENT0,J.RENDERBUFFER,v0.__webglColorRenderbuffer[h0]);let y0=Z.get(C[h0]).__webglTexture;J.framebufferTexture2D(J.DRAW_FRAMEBUFFER,J.COLOR_ATTACHMENT0,J.TEXTURE_2D,y0,0)}if(J.blitFramebuffer(0,0,l,Q0,0,0,l,Q0,V0,J.NEAREST),H===!0){if(t0.length=0,X9.length=0,t0.push(J.COLOR_ATTACHMENT0+h0),T.depthBuffer&&T.storeMultisampledDepthBuffer===!1)t0.push(I0),X9.push(I0),J.invalidateFramebuffer(J.DRAW_FRAMEBUFFER,X9);J.invalidateFramebuffer(J.READ_FRAMEBUFFER,t0)}}if(Q.bindFramebuffer(J.READ_FRAMEBUFFER,null),Q.bindFramebuffer(J.DRAW_FRAMEBUFFER,null),H0)for(let h0=0;h0<C.length;h0++){Q.bindFramebuffer(J.FRAMEBUFFER,v0.__webglMultisampledFramebuffer),J.framebufferRenderbuffer(J.FRAMEBUFFER,J.COLOR_ATTACHMENT0+h0,J.RENDERBUFFER,v0.__webglColorRenderbuffer[h0]);let y0=Z.get(C[h0]).__webglTexture;Q.bindFramebuffer(J.FRAMEBUFFER,v0.__webglFramebuffer),J.framebufferTexture2D(J.DRAW_FRAMEBUFFER,J.COLOR_ATTACHMENT0+h0,J.TEXTURE_2D,y0,0)}Q.bindFramebuffer(J.DRAW_FRAMEBUFFER,v0.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.storeMultisampledDepthBuffer===!1&&H){let C=T.stencilBuffer?J.DEPTH_STENCIL_ATTACHMENT:J.DEPTH_ATTACHMENT;J.invalidateFramebuffer(J.DRAW_FRAMEBUFFER,[C])}}}function L9(T){return Math.min(K.maxSamples,T.samples)}function m(T){let C=Z.get(T);return T.samples>0&&$.has("WEBGL_multisampled_render_to_texture")===!0&&C.__useRenderToTexture!==!1}function m9(T){let C=X.render.frame;if(G.get(T)!==C)G.set(T,C),T.update()}function z9(T,C){let{colorSpace:l,format:Q0,type:V0}=T;if(T.isCompressedTexture===!0||T.isVideoTexture===!0)return C;if(l!==o6&&l!==e7)if(R9.getTransfer(l)===c9){if(Q0!==f8||V0!==k8)r0("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.")}else Z9("WebGLTextures: Unsupported texture color space:",l);return C}function A9(T){if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement)U.width=T.naturalWidth||T.width,U.height=T.naturalHeight||T.height;else if(typeof VideoFrame<"u"&&T instanceof VideoFrame)U.width=T.displayWidth,U.height=T.displayHeight;else U.width=T.width,U.height=T.height;return U}this.allocateTextureUnit=g,this.resetTextureUnits=e,this.getTextureUnits=v,this.setTextureUnits=j,this.setTexture2D=o,this.setTexture2DArray=p,this.setTexture3D=r,this.setTextureCube=X0,this.rebindTextures=L0,this.setupRenderTarget=l0,this.updateRenderTargetMipmap=W9,this.updateMultisampleRenderTarget=k9,this.setupDepthRenderbuffer=P0,this.setupFrameBufferTexture=t,this.useMultisampledRTT=m,this.isReversedDepthBuffer=function(){return Q.buffers.depth.getReversed()}}function $R(J,$){function Q(Z,K=e7){let W,X=R9.getTransfer(K);if(Z===k8)return J.UNSIGNED_BYTE;if(Z===LW)return J.UNSIGNED_SHORT_4_4_4_4;if(Z===VW)return J.UNSIGNED_SHORT_5_5_5_1;if(Z===Y5)return J.UNSIGNED_INT_5_9_9_9_REV;if(Z===H5)return J.UNSIGNED_INT_10F_11F_11F_REV;if(Z===W5)return J.BYTE;if(Z===X5)return J.SHORT;if(Z===$Q)return J.UNSIGNED_SHORT;if(Z===RW)return J.INT;if(Z===D7)return J.UNSIGNED_INT;if(Z===e8)return J.FLOAT;if(Z===B6)return J.HALF_FLOAT;if(Z===U5)return J.ALPHA;if(Z===N5)return J.RGB;if(Z===f8)return J.RGBA;if(Z===a7)return J.DEPTH_COMPONENT;if(Z===r7)return J.DEPTH_STENCIL;if(Z===G5)return J.RED;if(Z===BW)return J.RED_INTEGER;if(Z===t7)return J.RG;if(Z===DW)return J.RG_INTEGER;if(Z===kW)return J.RGBA_INTEGER;if(Z===SZ||Z===wZ||Z===jZ||Z===yZ)if(X===c9)if(W=$.get("WEBGL_compressed_texture_s3tc_srgb"),W!==null){if(Z===SZ)return W.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(Z===wZ)return W.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(Z===jZ)return W.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(Z===yZ)return W.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(W=$.get("WEBGL_compressed_texture_s3tc"),W!==null){if(Z===SZ)return W.COMPRESSED_RGB_S3TC_DXT1_EXT;if(Z===wZ)return W.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(Z===jZ)return W.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(Z===yZ)return W.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(Z===MW||Z===CW||Z===PW||Z===IW)if(W=$.get("WEBGL_compressed_texture_pvrtc"),W!==null){if(Z===MW)return W.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(Z===CW)return W.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(Z===PW)return W.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(Z===IW)return W.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(Z===zW||Z===AW||Z===_W||Z===TW||Z===SW||Z===vZ||Z===wW)if(W=$.get("WEBGL_compressed_texture_etc"),W!==null){if(Z===zW||Z===AW)return X===c9?W.COMPRESSED_SRGB8_ETC2:W.COMPRESSED_RGB8_ETC2;if(Z===_W)return X===c9?W.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:W.COMPRESSED_RGBA8_ETC2_EAC;if(Z===TW)return W.COMPRESSED_R11_EAC;if(Z===SW)return W.COMPRESSED_SIGNED_R11_EAC;if(Z===vZ)return W.COMPRESSED_RG11_EAC;if(Z===wW)return W.COMPRESSED_SIGNED_RG11_EAC}else return null;if(Z===jW||Z===yW||Z===vW||Z===fW||Z===bW||Z===hW||Z===xW||Z===gW||Z===pW||Z===mW||Z===lW||Z===uW||Z===dW||Z===cW)if(W=$.get("WEBGL_compressed_texture_astc"),W!==null){if(Z===jW)return X===c9?W.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:W.COMPRESSED_RGBA_ASTC_4x4_KHR;if(Z===yW)return X===c9?W.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:W.COMPRESSED_RGBA_ASTC_5x4_KHR;if(Z===vW)return X===c9?W.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:W.COMPRESSED_RGBA_ASTC_5x5_KHR;if(Z===fW)return X===c9?W.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:W.COMPRESSED_RGBA_ASTC_6x5_KHR;if(Z===bW)return X===c9?W.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:W.COMPRESSED_RGBA_ASTC_6x6_KHR;if(Z===hW)return X===c9?W.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:W.COMPRESSED_RGBA_ASTC_8x5_KHR;if(Z===xW)return X===c9?W.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:W.COMPRESSED_RGBA_ASTC_8x6_KHR;if(Z===gW)return X===c9?W.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:W.COMPRESSED_RGBA_ASTC_8x8_KHR;if(Z===pW)return X===c9?W.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:W.COMPRESSED_RGBA_ASTC_10x5_KHR;if(Z===mW)return X===c9?W.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:W.COMPRESSED_RGBA_ASTC_10x6_KHR;if(Z===lW)return X===c9?W.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:W.COMPRESSED_RGBA_ASTC_10x8_KHR;if(Z===uW)return X===c9?W.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:W.COMPRESSED_RGBA_ASTC_10x10_KHR;if(Z===dW)return X===c9?W.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:W.COMPRESSED_RGBA_ASTC_12x10_KHR;if(Z===cW)return X===c9?W.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:W.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(Z===nW||Z===sW||Z===iW)if(W=$.get("EXT_texture_compression_bptc"),W!==null){if(Z===nW)return X===c9?W.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:W.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(Z===sW)return W.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(Z===iW)return W.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(Z===oW||Z===aW||Z===fZ||Z===rW)if(W=$.get("EXT_texture_compression_rgtc"),W!==null){if(Z===oW)return W.COMPRESSED_RED_RGTC1_EXT;if(Z===aW)return W.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(Z===fZ)return W.COMPRESSED_RED_GREEN_RGTC2_EXT;if(Z===rW)return W.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;if(Z===J$)return J.UNSIGNED_INT_24_8;return J[Z]!==void 0?J[Z]:null}return{convert:Q}}var QR=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`;class OU{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(J,$){if(this.texture===null){let Q=new sZ(J.texture);if(J.depthNear!==$.depthNear||J.depthFar!==$.depthFar)this.depthNear=J.depthNear,this.depthFar=J.depthFar;this.texture=Q}}getMesh(J){if(this.texture!==null){if(this.mesh===null){let $=J.cameras[0].viewport,Q=new J6({vertexShader:QR,fragmentShader:ZR,uniforms:{depthColor:{value:this.texture},depthWidth:{value:$.z},depthHeight:{value:$.w}}});this.mesh=new _0(new B9(20,20),Q)}}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class RU extends M8{constructor(J,$){super();let Q=this,Z=null,K=1,W=null,X="local-floor",Y=1,H=null,U=null,G=null,F=null,N=null,q=null,O=typeof XRWebGLBinding<"u",B=new OU,R={},E=$.getContextAttributes(),P=null,k=null,V=[],A=[],w=new O0,D=null,L=null,M=new G6;M.viewport=new d9;let s=new G6;s.viewport=new d9;let b=[M,s],u=new IX,e=null,v=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(h){let I=V[h];if(I===void 0)I=new KQ,V[h]=I;return I.getTargetRaySpace()},this.getControllerGrip=function(h){let I=V[h];if(I===void 0)I=new KQ,V[h]=I;return I.getGripSpace()},this.getHand=function(h){let I=V[h];if(I===void 0)I=new KQ,V[h]=I;return I.getHandSpace()};function j(h){let I=A.indexOf(h.inputSource);if(I===-1)return;let x=V[I];if(x!==void 0)x.update(h.inputSource,h.frame,H||W),x.dispatchEvent({type:h.type,data:h.inputSource})}function g(){Z.removeEventListener("select",j),Z.removeEventListener("selectstart",j),Z.removeEventListener("selectend",j),Z.removeEventListener("squeeze",j),Z.removeEventListener("squeezestart",j),Z.removeEventListener("squeezeend",j),Z.removeEventListener("end",g),Z.removeEventListener("inputsourceschange",f);for(let h=0;h<V.length;h++){let I=A[h];if(I===null)continue;A[h]=null,V[h].disconnect(I)}e=null,v=null,B.reset();for(let h in R)delete R[h];if(J.setRenderTarget(P),N=null,F=null,G=null,Z=null,k=null,U0.stop(),Q.isPresenting=!1,J.setPixelRatio(D),J.setSize(w.width,w.height,!1),L!==null){let h=L.camera;h.fov=L.fov,h.zoom=L.zoom,h.updateProjectionMatrix(),L=null}Q.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(h){if(K=h,Q.isPresenting===!0)r0("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(h){if(X=h,Q.isPresenting===!0)r0("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return H||W},this.setReferenceSpace=function(h){H=h},this.getBaseLayer=function(){return F!==null?F:N},this.getBinding=function(){if(G===null&&O)G=new XRWebGLBinding(Z,$);return G},this.getFrame=function(){return q},this.getSession=function(){return Z},this.setSession=async function(h){if(Z=h,Z!==null){if(P=J.getRenderTarget(),Z.addEventListener("select",j),Z.addEventListener("selectstart",j),Z.addEventListener("selectend",j),Z.addEventListener("squeeze",j),Z.addEventListener("squeezestart",j),Z.addEventListener("squeezeend",j),Z.addEventListener("end",g),Z.addEventListener("inputsourceschange",f),E.xrCompatible!==!0)await $.makeXRCompatible();if(D=J.getPixelRatio(),J.getSize(w),!(O&&("createProjectionLayer"in XRWebGLBinding.prototype))){let x={antialias:E.antialias,alpha:!0,depth:E.depth,stencil:E.stencil,framebufferScaleFactor:K};N=new XRWebGLLayer(Z,$,x),Z.updateRenderState({baseLayer:N}),J.setPixelRatio(1),J.setSize(N.framebufferWidth,N.framebufferHeight,!1),k=new X6(N.framebufferWidth,N.framebufferHeight,{format:f8,type:k8,colorSpace:J.outputColorSpace,stencilBuffer:E.stencil,resolveDepthBuffer:N.ignoreDepthValues===!1,resolveStencilBuffer:N.ignoreDepthValues===!1,storeMultisampledDepthBuffer:N.ignoreDepthValues===!1,storeMultisampledStencilBuffer:N.ignoreDepthValues===!1})}else{let x=null,d=null,K0=null;if(E.depth)K0=E.stencil?$.DEPTH24_STENCIL8:$.DEPTH_COMPONENT24,x=E.stencil?r7:a7,d=E.stencil?J$:D7;let t={colorFormat:$.RGBA8,depthFormat:K0,scaleFactor:K};G=this.getBinding(),F=G.createProjectionLayer(t),Z.updateRenderState({layers:[F]}),J.setPixelRatio(1),J.setSize(F.textureWidth,F.textureHeight,!1),k=new X6(F.textureWidth,F.textureHeight,{format:f8,type:k8,depthTexture:new KJ(F.textureWidth,F.textureHeight,d,void 0,void 0,void 0,void 0,void 0,void 0,x),stencilBuffer:E.stencil,colorSpace:J.outputColorSpace,samples:E.antialias?4:0,resolveDepthBuffer:F.ignoreDepthValues===!1,resolveStencilBuffer:F.ignoreDepthValues===!1,storeMultisampledDepthBuffer:F.ignoreDepthValues===!1,storeMultisampledStencilBuffer:F.ignoreDepthValues===!1})}k.isXRRenderTarget=!0,this.setFoveation(Y),H=null,W=await Z.requestReferenceSpace(X),U0.setContext(Z),U0.start(),Q.isPresenting=!0,Q.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(Z!==null)return Z.environmentBlendMode},this.getDepthTexture=function(){return B.getDepthTexture()};function f(h){for(let I=0;I<h.removed.length;I++){let x=h.removed[I],d=A.indexOf(x);if(d>=0)A[d]=null,V[d].disconnect(x)}for(let I=0;I<h.added.length;I++){let x=h.added[I],d=A.indexOf(x);if(d===-1){for(let t=0;t<V.length;t++)if(t>=A.length){A.push(x),d=t;break}else if(A[t]===null){A[t]=x,d=t;break}if(d===-1)break}let K0=V[d];if(K0)K0.connect(x)}}let o=new S,p=new S;function r(h,I,x){o.setFromMatrixPosition(I.matrixWorld),p.setFromMatrixPosition(x.matrixWorld);let d=o.distanceTo(p),K0=I.projectionMatrix.elements,t=x.projectionMatrix.elements,D0=K0[14]/(K0[10]-1),R0=K0[14]/(K0[10]+1),P0=(K0[9]+1)/K0[5],L0=(K0[9]-1)/K0[5],l0=(K0[8]-1)/K0[0],W9=(t[8]+1)/t[0],t0=D0*l0,X9=D0*W9,k9=d/(-l0+W9),L9=k9*-l0;if(I.matrixWorld.decompose(h.position,h.quaternion,h.scale),h.translateX(L9),h.translateZ(k9),h.matrixWorld.compose(h.position,h.quaternion,h.scale),h.matrixWorldInverse.copy(h.matrixWorld).invert(),K0[10]===-1)h.projectionMatrix.copy(I.projectionMatrix),h.projectionMatrixInverse.copy(I.projectionMatrixInverse);else{let m=D0+k9,m9=R0+k9,z9=t0-L9,A9=X9+(d-L9),T=P0*R0/m9*m,C=L0*R0/m9*m;h.projectionMatrix.makePerspective(z9,A9,T,C,m,m9),h.projectionMatrixInverse.copy(h.projectionMatrix).invert()}}function X0(h,I){if(I===null)h.matrixWorld.copy(h.matrix);else h.matrixWorld.multiplyMatrices(I.matrixWorld,h.matrix);h.matrixWorldInverse.copy(h.matrixWorld).invert()}this.updateCamera=function(h){if(Z===null)return;let{near:I,far:x}=h;if(B.texture!==null){if(B.depthNear>0)I=B.depthNear;if(B.depthFar>0)x=B.depthFar}if(u.near=s.near=M.near=I,u.far=s.far=M.far=x,e!==u.near||v!==u.far)Z.updateRenderState({depthNear:u.near,depthFar:u.far}),e=u.near,v=u.far;u.layers.mask=h.layers.mask|6,M.layers.mask=u.layers.mask&-5,s.layers.mask=u.layers.mask&-3;let d=h.parent,K0=u.cameras;X0(u,d);for(let t=0;t<K0.length;t++)X0(K0[t],d);if(K0.length===2)r(u,M,s);else u.projectionMatrix.copy(M.projectionMatrix);if(L===null&&h.isPerspectiveCamera)L={camera:h,fov:h.fov,zoom:h.zoom};M0(h,u,d)};function M0(h,I,x){if(x===null)h.matrix.copy(I.matrixWorld);else h.matrix.copy(x.matrixWorld),h.matrix.invert(),h.matrix.multiply(I.matrixWorld);if(h.matrix.decompose(h.position,h.quaternion,h.scale),h.updateMatrixWorld(!0),h.projectionMatrix.copy(I.projectionMatrix),h.projectionMatrixInverse.copy(I.projectionMatrixInverse),h.isPerspectiveCamera)h.fov=d7*2*Math.atan(1/h.projectionMatrix.elements[5]),h.zoom=1}this.getCamera=function(){return u},this.getFoveation=function(){if(F===null&&N===null)return;return Y},this.setFoveation=function(h){if(Y=h,F!==null)F.fixedFoveation=h;if(N!==null&&N.fixedFoveation!==void 0)N.fixedFoveation=h},this.hasDepthSensing=function(){return B.texture!==null},this.getDepthSensingMesh=function(){return B.getMesh(u)},this.getCameraTexture=function(h){return R[h]};let y=null;function a(h,I){if(U=I.getViewerPose(H||W),q=I,U!==null){let x=U.views;if(N!==null)J.setRenderTargetFramebuffer(k,N.framebuffer),J.setRenderTarget(k);let d=!1;if(x.length!==u.cameras.length)u.cameras.length=0,d=!0;for(let R0=0;R0<x.length;R0++){let P0=x[R0],L0=null;if(N!==null)L0=N.getViewport(P0);else{let W9=G.getViewSubImage(F,P0);if(L0=W9.viewport,R0===0)J.setRenderTargetTextures(k,W9.colorTexture,W9.depthStencilTexture),J.setRenderTarget(k)}let l0=b[R0];if(l0===void 0)l0=new G6,l0.layers.enable(R0),l0.viewport=new d9,b[R0]=l0;if(l0.matrix.fromArray(P0.transform.matrix),l0.matrix.decompose(l0.position,l0.quaternion,l0.scale),l0.projectionMatrix.fromArray(P0.projectionMatrix),l0.projectionMatrixInverse.copy(l0.projectionMatrix).invert(),l0.viewport.set(L0.x,L0.y,L0.width,L0.height),R0===0)u.matrix.copy(l0.matrix),u.matrix.decompose(u.position,u.quaternion,u.scale);if(d===!0)u.cameras.push(l0)}let K0=Z.enabledFeatures;if(K0&&K0.includes("depth-sensing")&&Z.depthUsage=="gpu-optimized"&&O){G=Q.getBinding();let R0=G.getDepthInformation(x[0]);if(R0&&R0.isValid&&R0.texture)B.init(R0,Z.renderState)}if(K0&&K0.includes("camera-access")&&O){J.state.unbindTexture(),G=Q.getBinding();for(let R0=0;R0<x.length;R0++){let P0=x[R0].camera;if(P0){let L0=R[P0];if(!L0)L0=new sZ,R[P0]=L0;let l0=G.getCameraImage(P0);L0.sourceTexture=l0}}}}for(let x=0;x<V.length;x++){let d=A[x],K0=V[x];if(d!==null&&K0!==void 0)K0.update(d,I,H||W)}if(y)y(h,I);if(I.detectedPlanes)Q.dispatchEvent({type:"planesdetected",data:I});q=null}let U0=new KU;U0.setAnimationLoop(a),this.setAnimationLoop=function(h){y=h},this.dispose=function(){}}}var KR=new $9,LU=new U9;LU.set(-1,0,0,0,1,0,0,0,1);function WR(J,$){function Q(R,E){if(R.matrixAutoUpdate===!0)R.updateMatrix();E.value.copy(R.matrix)}function Z(R,E){if(E.color.getRGB(R.fogColor.value,OX(J)),E.isFog)R.fogNear.value=E.near,R.fogFar.value=E.far;else if(E.isFogExp2)R.fogDensity.value=E.density}function K(R,E,P,k,V){if(E.isNodeMaterial)E.uniformsNeedUpdate=!1;else if(E.isMeshBasicMaterial)W(R,E);else if(E.isMeshLambertMaterial){if(W(R,E),E.envMap)R.envMapIntensity.value=E.envMapIntensity}else if(E.isMeshToonMaterial)W(R,E),F(R,E);else if(E.isMeshPhongMaterial){if(W(R,E),G(R,E),E.envMap)R.envMapIntensity.value=E.envMapIntensity}else if(E.isMeshStandardMaterial){if(W(R,E),N(R,E),E.isMeshPhysicalMaterial)q(R,E,V)}else if(E.isMeshMatcapMaterial)W(R,E),O(R,E);else if(E.isMeshDepthMaterial)W(R,E);else if(E.isMeshDistanceMaterial)W(R,E),B(R,E);else if(E.isMeshNormalMaterial)W(R,E);else if(E.isLineBasicMaterial){if(X(R,E),E.isLineDashedMaterial)Y(R,E)}else if(E.isPointsMaterial)H(R,E,P,k);else if(E.isSpriteMaterial)U(R,E);else if(E.isShadowMaterial)R.color.value.copy(E.color),R.opacity.value=E.opacity;else if(E.isShaderMaterial)E.uniformsNeedUpdate=!1}function W(R,E){if(R.opacity.value=E.opacity,E.color)R.diffuse.value.copy(E.color);if(E.emissive)R.emissive.value.copy(E.emissive).multiplyScalar(E.emissiveIntensity);if(E.map)R.map.value=E.map,Q(E.map,R.mapTransform);if(E.alphaMap)R.alphaMap.value=E.alphaMap,Q(E.alphaMap,R.alphaMapTransform);if(E.bumpMap){if(R.bumpMap.value=E.bumpMap,Q(E.bumpMap,R.bumpMapTransform),R.bumpScale.value=E.bumpScale,E.side===I6)R.bumpScale.value*=-1}if(E.normalMap){if(R.normalMap.value=E.normalMap,Q(E.normalMap,R.normalMapTransform),R.normalScale.value.copy(E.normalScale),E.side===I6)R.normalScale.value.negate()}if(E.displacementMap)R.displacementMap.value=E.displacementMap,Q(E.displacementMap,R.displacementMapTransform),R.displacementScale.value=E.displacementScale,R.displacementBias.value=E.displacementBias;if(E.emissiveMap)R.emissiveMap.value=E.emissiveMap,Q(E.emissiveMap,R.emissiveMapTransform);if(E.specularMap)R.specularMap.value=E.specularMap,Q(E.specularMap,R.specularMapTransform);if(E.alphaTest>0)R.alphaTest.value=E.alphaTest;let P=$.get(E),k=P.envMap,V=P.envMapRotation;if(k){if(R.envMap.value=k,R.envMapRotation.value.setFromMatrix4(KR.makeRotationFromEuler(V)).transpose(),k.isCubeTexture&&k.isRenderTargetTexture===!1)R.envMapRotation.value.premultiply(LU);R.reflectivity.value=E.reflectivity,R.ior.value=E.ior,R.refractionRatio.value=E.refractionRatio}if(E.lightMap)R.lightMap.value=E.lightMap,R.lightMapIntensity.value=E.lightMapIntensity,Q(E.lightMap,R.lightMapTransform);if(E.aoMap)R.aoMap.value=E.aoMap,R.aoMapIntensity.value=E.aoMapIntensity,Q(E.aoMap,R.aoMapTransform)}function X(R,E){if(R.diffuse.value.copy(E.color),R.opacity.value=E.opacity,E.map)R.map.value=E.map,Q(E.map,R.mapTransform)}function Y(R,E){R.dashSize.value=E.dashSize,R.totalSize.value=E.dashSize+E.gapSize,R.scale.value=E.scale}function H(R,E,P,k){if(R.diffuse.value.copy(E.color),R.opacity.value=E.opacity,R.size.value=E.size*P,R.scale.value=k*0.5,E.map)R.map.value=E.map,Q(E.map,R.uvTransform);if(E.alphaMap)R.alphaMap.value=E.alphaMap,Q(E.alphaMap,R.alphaMapTransform);if(E.alphaTest>0)R.alphaTest.value=E.alphaTest}function U(R,E){if(R.diffuse.value.copy(E.color),R.opacity.value=E.opacity,R.rotation.value=E.rotation,E.map)R.map.value=E.map,Q(E.map,R.mapTransform);if(E.alphaMap)R.alphaMap.value=E.alphaMap,Q(E.alphaMap,R.alphaMapTransform);if(E.alphaTest>0)R.alphaTest.value=E.alphaTest}function G(R,E){R.specular.value.copy(E.specular),R.shininess.value=Math.max(E.shininess,0.0001)}function F(R,E){if(E.gradientMap)R.gradientMap.value=E.gradientMap}function N(R,E){if(R.metalness.value=E.metalness,E.metalnessMap)R.metalnessMap.value=E.metalnessMap,Q(E.metalnessMap,R.metalnessMapTransform);if(R.roughness.value=E.roughness,E.roughnessMap)R.roughnessMap.value=E.roughnessMap,Q(E.roughnessMap,R.roughnessMapTransform);if(E.envMap)R.envMapIntensity.value=E.envMapIntensity}function q(R,E,P){if(R.ior.value=E.ior,E.sheen>0){if(R.sheenColor.value.copy(E.sheenColor).multiplyScalar(E.sheen),R.sheenRoughness.value=E.sheenRoughness,E.sheenColorMap)R.sheenColorMap.value=E.sheenColorMap,Q(E.sheenColorMap,R.sheenColorMapTransform);if(E.sheenRoughnessMap)R.sheenRoughnessMap.value=E.sheenRoughnessMap,Q(E.sheenRoughnessMap,R.sheenRoughnessMapTransform)}if(E.clearcoat>0){if(R.clearcoat.value=E.clearcoat,R.clearcoatRoughness.value=E.clearcoatRoughness,E.clearcoatMap)R.clearcoatMap.value=E.clearcoatMap,Q(E.clearcoatMap,R.clearcoatMapTransform);if(E.clearcoatRoughnessMap)R.clearcoatRoughnessMap.value=E.clearcoatRoughnessMap,Q(E.clearcoatRoughnessMap,R.clearcoatRoughnessMapTransform);if(E.clearcoatNormalMap){if(R.clearcoatNormalMap.value=E.clearcoatNormalMap,Q(E.clearcoatNormalMap,R.clearcoatNormalMapTransform),R.clearcoatNormalScale.value.copy(E.clearcoatNormalScale),E.side===I6)R.clearcoatNormalScale.value.negate()}}if(E.dispersion>0)R.dispersion.value=E.dispersion;if(E.retroreflectivity>0)R.retroreflectivity.value=E.retroreflectivity;if(E.iridescence>0){if(R.iridescence.value=E.iridescence,R.iridescenceIOR.value=E.iridescenceIOR,R.iridescenceThicknessMinimum.value=E.iridescenceThicknessRange[0],R.iridescenceThicknessMaximum.value=E.iridescenceThicknessRange[1],E.iridescenceMap)R.iridescenceMap.value=E.iridescenceMap,Q(E.iridescenceMap,R.iridescenceMapTransform);if(E.iridescenceThicknessMap)R.iridescenceThicknessMap.value=E.iridescenceThicknessMap,Q(E.iridescenceThicknessMap,R.iridescenceThicknessMapTransform)}if(E.transmission>0){if(R.transmission.value=E.transmission,R.transmissionSamplerMap.value=P.texture,R.transmissionSamplerSize.value.set(P.width,P.height),E.transmissionMap)R.transmissionMap.value=E.transmissionMap,Q(E.transmissionMap,R.transmissionMapTransform);if(R.thickness.value=E.thickness,E.thicknessMap)R.thicknessMap.value=E.thicknessMap,Q(E.thicknessMap,R.thicknessMapTransform);R.attenuationDistance.value=E.attenuationDistance,R.attenuationColor.value.copy(E.attenuationColor)}if(E.anisotropy>0){if(R.anisotropyVector.value.set(E.anisotropy*Math.cos(E.anisotropyRotation),E.anisotropy*Math.sin(E.anisotropyRotation)),E.anisotropyMap)R.anisotropyMap.value=E.anisotropyMap,Q(E.anisotropyMap,R.anisotropyMapTransform)}if(R.specularIntensity.value=E.specularIntensity,R.specularColor.value.copy(E.specularColor),E.specularColorMap)R.specularColorMap.value=E.specularColorMap,Q(E.specularColorMap,R.specularColorMapTransform);if(E.specularIntensityMap)R.specularIntensityMap.value=E.specularIntensityMap,Q(E.specularIntensityMap,R.specularIntensityMapTransform)}function O(R,E){if(E.matcap)R.matcap.value=E.matcap}function B(R,E){let P=$.get(E).light;R.referencePosition.value.setFromMatrixPosition(P.matrixWorld),R.nearDistance.value=P.shadow.camera.near,R.farDistance.value=P.shadow.camera.far}return{refreshFogUniforms:Z,refreshMaterialUniforms:K}}function XR(J,$,Q,Z){let K={},W={},X=[],Y=J.getParameter(J.MAX_UNIFORM_BUFFER_BINDINGS);function H(V,A){let w=A.program;Z.uniformBlockBinding(V,w)}function U(V,A){let w=K[V.id];if(w===void 0)R(V),w=G(V),K[V.id]=w,V.addEventListener("dispose",P);let D=A.program;Z.updateUBOMapping(V,D);let L=$.render.frame;if(W[V.id]!==L)N(V),W[V.id]=L}function G(V){let A=F();V.__bindingPointIndex=A;let w=J.createBuffer(),D=V.__size,L=V.usage;return J.bindBuffer(J.UNIFORM_BUFFER,w),J.bufferData(J.UNIFORM_BUFFER,D,L),J.bindBuffer(J.UNIFORM_BUFFER,null),J.bindBufferBase(J.UNIFORM_BUFFER,A,w),w}function F(){for(let V=0;V<Y;V++)if(X.indexOf(V)===-1)return X.push(V),V;return Z9("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function N(V){let A=K[V.id],w=V.uniforms,D=V.__cache;J.bindBuffer(J.UNIFORM_BUFFER,A);for(let L=0,M=w.length;L<M;L++){let s=w[L];if(Array.isArray(s))for(let b=0,u=s.length;b<u;b++)q(s[b],L,b,D);else q(s,L,0,D)}J.bindBuffer(J.UNIFORM_BUFFER,null)}function q(V,A,w,D){if(B(V,A,w,D)===!0){let{__offset:L,value:M}=V;if(Array.isArray(M)){let s=0;for(let b=0;b<M.length;b++){let u=M[b],e=E(u);if(O(u,V.__data,s),typeof u!=="number"&&typeof u!=="boolean"&&!u.isMatrix3&&!ArrayBuffer.isView(u))s+=e.storage/Float32Array.BYTES_PER_ELEMENT}}else O(M,V.__data,0);J.bufferSubData(J.UNIFORM_BUFFER,L,V.__data)}}function O(V,A,w){if(typeof V==="number"||typeof V==="boolean")A[0]=V;else if(V.isMatrix3)A[0]=V.elements[0],A[1]=V.elements[1],A[2]=V.elements[2],A[3]=0,A[4]=V.elements[3],A[5]=V.elements[4],A[6]=V.elements[5],A[7]=0,A[8]=V.elements[6],A[9]=V.elements[7],A[10]=V.elements[8],A[11]=0;else if(ArrayBuffer.isView(V))A.set(new V.constructor(V.buffer,V.byteOffset,A.length));else V.toArray(A,w)}function B(V,A,w,D){let L=V.value,M=A+"_"+w;if(D[M]===void 0){if(typeof L==="number"||typeof L==="boolean")D[M]=L;else if(ArrayBuffer.isView(L))D[M]=L.slice();else D[M]=L.clone();return!0}else{let s=D[M];if(typeof L==="number"||typeof L==="boolean"){if(s!==L)return D[M]=L,!0}else if(ArrayBuffer.isView(L))return!0;else if(s.equals(L)===!1)return s.copy(L),!0}return!1}function R(V){let A=V.uniforms,w=0,D=16;for(let M=0,s=A.length;M<s;M++){let b=Array.isArray(A[M])?A[M]:[A[M]];for(let u=0,e=b.length;u<e;u++){let v=b[u],j=Array.isArray(v.value)?v.value:[v.value];for(let g=0,f=j.length;g<f;g++){let o=j[g],p=E(o),r=w%D,X0=r%p.boundary,M0=r+X0;if(w+=X0,M0!==0&&D-M0<p.storage)w+=D-M0;v.__data=new Float32Array(p.storage/Float32Array.BYTES_PER_ELEMENT),v.__offset=w,w+=p.storage}}}let L=w%D;if(L>0)w+=D-L;return V.__size=w,V.__cache={},this}function E(V){let A={boundary:0,storage:0};if(typeof V==="number"||typeof V==="boolean")A.boundary=4,A.storage=4;else if(V.isVector2)A.boundary=8,A.storage=8;else if(V.isVector3||V.isColor)A.boundary=16,A.storage=12;else if(V.isVector4)A.boundary=16,A.storage=16;else if(V.isMatrix3)A.boundary=48,A.storage=48;else if(V.isMatrix4)A.boundary=64,A.storage=64;else if(V.isTexture)r0("WebGLRenderer: Texture samplers can not be part of an uniforms group.");else if(ArrayBuffer.isView(V))A.boundary=16,A.storage=V.byteLength;else r0("WebGLRenderer: Unsupported uniform value type.",V);return A}function P(V){let A=V.target;A.removeEventListener("dispose",P);let w=X.indexOf(A.__bindingPointIndex);X.splice(w,1),J.deleteBuffer(K[A.id]),delete K[A.id],delete W[A.id]}function k(){for(let V in K)J.deleteBuffer(K[V]);X=[],K={},W={}}return{bind:H,update:U,dispose:k}}var YR=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),g8=null;function HR(){if(g8===null)g8=new XQ(YR,16,16,t7,B6),g8.name="DFG_LUT",g8.minFilter=V6,g8.magFilter=V6,g8.wrapS=tJ,g8.wrapT=tJ,g8.generateMipmaps=!1,g8.needsUpdate=!0;return g8}class mX{constructor(J={}){let{canvas:$=B5(),context:Q=null,depth:Z=!0,stencil:K=!1,alpha:W=!1,antialias:X=!1,premultipliedAlpha:Y=!0,preserveDrawingBuffer:H=!1,powerPreference:U="default",failIfMajorPerformanceCaveat:G=!1,reversedDepthBuffer:F=!1,outputBufferType:N=k8}=J;this.isWebGLRenderer=!0;let q;if(Q!==null){if(typeof WebGLRenderingContext<"u"&&Q instanceof WebGLRenderingContext)throw Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");q=Q.getContextAttributes().alpha}else q=W;let O=N,B=new Set([kW,DW,BW]),R=new Set([k8,D7,$Q,J$,LW,VW]),E=new Uint32Array(4),P=new Int32Array(4),k=new S,V=null,A=null,w=[],D=[],L=null;this.domElement=$,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=B8,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let M=this,s=!1,b=null,u=null,e=null,v=null;this._outputColorSpace=W6;let j=0,g=0,f=null,o=-1,p=null,r=new d9,X0=new d9,M0=null,y=new b0(0),a=0,U0=$.width,h=$.height,I=1,x=null,d=null,K0=new d9(0,0,U0,h),t=new d9(0,0,U0,h),D0=!1,R0=new QJ,P0=!1,L0=!1,l0=new $9,W9=new S,t0=new d9,X9={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},k9=!1;function L9(){return f===null?I:1}let m=Q;function m9(z,c){return $.getContext(z,c)}let z9,A9,T,C,l,Q0,V0,I0,v0,H0,E0,h0,y0,z0,A0,a0,J9,_9,i,S0,N0,w0,u0;try{let z={alpha:!0,depth:Z,stencil:K,antialias:X,premultipliedAlpha:Y,preserveDrawingBuffer:H,powerPreference:U,failIfMajorPerformanceCaveat:G};if("setAttribute"in $)$.setAttribute("data-engine",`three.js r${IH}`);if($.addEventListener("webglcontextlost",Y9,!1),$.addEventListener("webglcontextrestored",s9,!1),$.addEventListener("webglcontextcreationerror",j9,!1),m===null){if(m=m9("webgl2",z),m===null)if(m9("webgl2"))throw Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.");else throw Error("THREE.WebGLRenderer: Error creating WebGL context.")}k0()}catch(z){throw $.removeEventListener("webglcontextlost",Y9,!1),$.removeEventListener("webglcontextrestored",s9,!1),$.removeEventListener("webglcontextcreationerror",j9,!1),Z9("WebGLRenderer: "+z.message),z}function k0(){if(z9=new Oq(m),z9.init(),N0=new $R(m,z9),A9=new Wq(m,z9,J,N0),T=new eO(m,z9),A9.reversedDepthBuffer&&F)T.buffers.depth.setReversed(!0);u=m.createFramebuffer(),e=m.createFramebuffer(),v=m.createFramebuffer(),C=new Vq(m),l=new gO,Q0=new JR(m,z9,T,l,A9,N0,C),V0=new qq(M),I0=new D1(m),w0=new Zq(m,I0),v0=new Rq(m,I0,C,w0),H0=new Dq(m,v0,I0,w0,C),_9=new Bq(m,A9,Q0),A0=new Xq(l),E0=new xO(M,V0,z9,A9,w0,A0),h0=new WR(M,l),y0=new mO,z0=new sO(z9),J9=new Qq(M,V0,T,H0,q,Y),a0=new tO(M,H0,A9),u0=new XR(m,C,A9,T),i=new Kq(m,z9,C),S0=new Lq(m,z9,C),C.programs=E0.programs,M.capabilities=A9,M.extensions=z9,M.properties=l,M.renderLists=y0,M.shadowMap=a0,M.state=T,M.info=C}if(O!==k8)L=new Mq(O,$.width,$.height,X,Z,K);let f0=new RU(M,m);this.xr=f0,this.getContext=function(){return m},this.getContextAttributes=function(){return m.getContextAttributes()},this.forceContextLoss=function(){let z=z9.get("WEBGL_lose_context");if(z)z.loseContext()},this.forceContextRestore=function(){let z=z9.get("WEBGL_lose_context");if(z)z.restoreContext()},this.getPixelRatio=function(){return I},this.setPixelRatio=function(z){if(z===void 0)return;I=z,this.setSize(U0,h,!1)},this.getSize=function(z){return z.set(U0,h)},this.setSize=function(z,c,Y0=!0){if(f0.isPresenting){r0("WebGLRenderer: Can't change size while VR device is presenting.");return}if(U0=z,h=c,$.width=Math.floor(z*I),$.height=Math.floor(c*I),Y0===!0)$.style.width=z+"px",$.style.height=c+"px";if(L!==null)L.setSize($.width,$.height);this.setViewport(0,0,z,c)},this.getDrawingBufferSize=function(z){return z.set(U0*I,h*I).floor()},this.setDrawingBufferSize=function(z,c,Y0){U0=z,h=c,I=Y0,$.width=Math.floor(z*Y0),$.height=Math.floor(c*Y0),this.setViewport(0,0,z,c)},this.setEffects=function(z){if(O===k8){Z9("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(z){for(let c=0;c<z.length;c++)if(z[c].isOutputPass===!0){r0("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}L.setEffects(z||[])},this.getCurrentViewport=function(z){return z.copy(r)},this.getViewport=function(z){return z.copy(K0)},this.setViewport=function(z,c,Y0,Z0){if(z.isVector4)K0.set(z.x,z.y,z.z,z.w);else K0.set(z,c,Y0,Z0);T.viewport(r.copy(K0).multiplyScalar(I).round())},this.getScissor=function(z){return z.copy(t)},this.setScissor=function(z,c,Y0,Z0){if(z.isVector4)t.set(z.x,z.y,z.z,z.w);else t.set(z,c,Y0,Z0);T.scissor(X0.copy(t).multiplyScalar(I).round())},this.getScissorTest=function(){return D0},this.setScissorTest=function(z){T.setScissorTest(D0=z)},this.setOpaqueSort=function(z){x=z},this.setTransparentSort=function(z){d=z},this.getClearColor=function(z){return z.copy(J9.getClearColor())},this.setClearColor=function(){J9.setClearColor(...arguments)},this.getClearAlpha=function(){return J9.getClearAlpha()},this.setClearAlpha=function(){J9.setClearAlpha(...arguments)},this.clear=function(z=!0,c=!0,Y0=!0){let Z0=0;if(z){let J0=!1;if(f!==null){let x0=f.texture.format;J0=B.has(x0)}if(J0){let x0=f.texture.type,d0=R.has(x0),g0=J9.getClearColor(),i0=J9.getClearAlpha(),m0=g0.r,N9=g0.g,V9=g0.b;if(d0)E[0]=m0,E[1]=N9,E[2]=V9,E[3]=i0,m.clearBufferuiv(m.COLOR,0,E);else P[0]=m0,P[1]=N9,P[2]=V9,P[3]=i0,m.clearBufferiv(m.COLOR,0,P)}else Z0|=m.COLOR_BUFFER_BIT}if(c)Z0|=m.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0);if(Y0)Z0|=m.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295);if(Z0!==0)m.clear(Z0)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(z){z.setRenderer(this),b=z},this.dispose=function(){$.removeEventListener("webglcontextlost",Y9,!1),$.removeEventListener("webglcontextrestored",s9,!1),$.removeEventListener("webglcontextcreationerror",j9,!1),J9.dispose(),y0.dispose(),z0.dispose(),l.dispose(),V0.dispose(),H0.dispose(),w0.dispose(),u0.dispose(),E0.dispose(),f0.dispose(),f0.removeEventListener("sessionstart",k$),f0.removeEventListener("sessionend",CJ),T8.stop()};function Y9(z){z.preventDefault(),u$("WebGLRenderer: Context Lost."),s=!0}function s9(){u$("WebGLRenderer: Context Restored."),s=!1;let z=C.autoReset,c=a0.enabled,Y0=a0.autoUpdate,Z0=a0.needsUpdate,J0=a0.type;k0(),C.autoReset=z,a0.enabled=c,a0.autoUpdate=Y0,a0.needsUpdate=Z0,a0.type=J0}function j9(z){Z9("WebGLRenderer: A WebGL context could not be created. Reason: ",z.statusMessage)}function M6(z){let c=z.target;c.removeEventListener("dispose",M6),u6(c)}function u6(z){gQ(z),l.remove(z)}function gQ(z){let c=l.get(z).programs;if(c!==void 0){if(c.forEach(function(Y0){E0.releaseProgram(Y0)}),z.isShaderMaterial)E0.releaseShaderCache(z)}}this.renderBufferDirect=function(z,c,Y0,Z0,J0,x0){if(c===null)c=X9;let d0=J0.isMesh&&J0.matrixWorld.determinantAffine()<0,g0=mQ(z,c,Y0,Z0,J0);T.setMaterial(Z0,d0);let i0=Y0.index,m0=1;if(Z0.wireframe===!0){if(i0=v0.getWireframeAttribute(Y0),i0===void 0)return;m0=2}let N9=Y0.drawRange,V9=Y0.attributes.position,s0=N9.start*m0,v9=(N9.start+N9.count)*m0;if(x0!==null)s0=Math.max(s0,x0.start*m0),v9=Math.min(v9,(x0.start+x0.count)*m0);if(i0!==null)s0=Math.max(s0,0),v9=Math.min(v9,i0.count);else if(V9!==void 0&&V9!==null)s0=Math.max(s0,0),v9=Math.min(v9,V9.count);let r9=v9-s0;if(r9<0||r9===1/0)return;w0.setup(J0,Z0,g0,Y0,i0);let f9,l9=i;if(i0!==null)f9=I0.get(i0),l9=S0,l9.setIndex(f9);if(J0.isMesh)if(Z0.wireframe===!0)T.setLineWidth(Z0.wireframeLinewidth*L9()),l9.setMode(m.LINES);else l9.setMode(m.TRIANGLES);else if(J0.isLine){let O6=Z0.linewidth;if(O6===void 0)O6=1;if(T.setLineWidth(O6*L9()),J0.isLineSegments)l9.setMode(m.LINES);else if(J0.isLineLoop)l9.setMode(m.LINE_LOOP);else l9.setMode(m.LINE_STRIP)}else if(J0.isPoints)l9.setMode(m.POINTS);else if(J0.isSprite)l9.setMode(m.TRIANGLES);if(J0.isBatchedMesh)if(!z9.get("WEBGL_multi_draw")){let{_multiDrawStarts:O6,_multiDrawCounts:c0,_multiDrawCount:P6}=J0,M9=i0?I0.get(i0).bytesPerElement:1,Z6=l.get(Z0).currentProgram.getUniforms();for(let d6=0;d6<P6;d6++)Z6.setValue(m,"_gl_DrawID",d6),l9.render(O6[d6]/M9,c0[d6])}else l9.renderMultiDraw(J0._multiDrawStarts,J0._multiDrawCounts,J0._multiDrawCount);else if(J0.isInstancedMesh)l9.renderInstances(s0,r9,J0.count);else if(Y0.isInstancedBufferGeometry){let O6=Y0._maxInstanceCount!==void 0?Y0._maxInstanceCount:1/0,c0=Math.min(Y0.instanceCount,O6);l9.renderInstances(s0,r9,c0)}else l9.render(s0,r9)};function D$(z,c,Y0,Z0){if(b!==null&&z.isNodeMaterial)b.setObject(Z0,z);if(P0===!0)A0.setState(z,Y0,!1);if(z.transparent===!0&&z.side===i9&&z.forceSinglePass===!1)z.side=I6,z.needsUpdate=!0,f7(z,c,Z0),z.side=V7,z.needsUpdate=!0,f7(z,c,Z0),z.side=i9;else f7(z,c,Z0)}this.compile=function(z,c,Y0=null){if(Y0===null)Y0=z;if(b!==null)b.renderStart(z,c,Y0);if(A=z0.get(Y0),A.init(c),D.push(A),Y0.traverseVisible(function(J0){if(J0.isLight&&J0.layers.test(c.layers)){if(A.pushLight(J0),J0.castShadow)A.pushShadow(J0)}}),z!==Y0)z.traverseVisible(function(J0){if(J0.isLight&&J0.layers.test(c.layers)){if(A.pushLight(J0),J0.castShadow)A.pushShadow(J0)}});if(A.setupLights(),b!==null)b.updateLights(A.state.lightsArray);if(L0=this.localClippingEnabled,P0=A0.init(this.clippingPlanes,L0),P0===!0)A0.setGlobalState(this.clippingPlanes,c);if(b!==null)a0.render(A.state.shadowsArray,Y0,c);let Z0=new Set;if(z.traverse(function(J0){if(!(J0.isMesh||J0.isPoints||J0.isLine||J0.isSprite))return;let x0=J0.material;if(x0)if(Array.isArray(x0))for(let d0=0;d0<x0.length;d0++){let g0=x0[d0];D$(g0,Y0,c,J0),Z0.add(g0)}else D$(x0,Y0,c,J0),Z0.add(x0)}),A=D.pop(),b!==null)b.renderEnd();return Z0},this.compileAsync=function(z,c,Y0=null){let Z0=this.compile(z,c,Y0);return new Promise((J0)=>{function x0(){if(Z0.forEach(function(d0){let i0=l.get(d0).currentProgram;if(i0===void 0||i0.isReady())Z0.delete(d0)}),Z0.size===0){J0(z);return}setTimeout(x0,10)}if(z9.get("KHR_parallel_shader_compile")!==null)x0();else setTimeout(x0,10)})};let MJ=null;function e6(z){if(MJ)MJ(z)}function k$(){T8.stop()}function CJ(){T8.start()}let T8=new KU;if(T8.setAnimationLoop(e6),typeof self<"u")T8.setContext(self);this.setAnimationLoop=function(z){MJ=z,f0.setAnimationLoop(z),z===null?T8.stop():T8.start()},f0.addEventListener("sessionstart",k$),f0.addEventListener("sessionend",CJ),this.render=function(z,c){if(c!==void 0&&c.isCamera!==!0){Z9("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(s===!0)return;if(b!==null)b.renderStart(z,c);let Y0=f0.enabled===!0&&f0.isPresenting===!0,Z0=L!==null&&(f===null||Y0)&&L.begin(M,f);if(z.matrixWorldAutoUpdate===!0)z.updateMatrixWorld();if(c.parent===null&&c.matrixWorldAutoUpdate===!0)c.updateMatrixWorld();if(f0.enabled===!0&&f0.isPresenting===!0&&(L===null||L.isCompositing()===!1)){if(f0.cameraAutoUpdate===!0)f0.updateCamera(c);c=f0.getCamera()}if(z.isScene===!0)z.onBeforeRender(M,z,c,f);if(A=z0.get(z,D.length),A.init(c),A.state.textureUnits=Q0.getTextureUnits(),D.push(A),l0.multiplyMatrices(c.projectionMatrix,c.matrixWorldInverse),R0.setFromProjectionMatrix(l0,KX,c.reversedDepth),L0=this.localClippingEnabled,P0=A0.init(this.clippingPlanes,L0),V=y0.get(z,w.length),V.init(),w.push(V),f0.enabled===!0&&f0.isPresenting===!0){let d0=M.xr.getDepthSensingMesh();if(d0!==null)j7(d0,c,-1/0,M.sortObjects)}if(j7(z,c,0,M.sortObjects),V.finish(),b!==null)b.updateLights(A.state.lightsArray);if(M.sortObjects===!0)V.sort(x,d);if(k9=f0.enabled===!1||f0.isPresenting===!1||f0.hasDepthSensing()===!1,k9)J9.addToRenderList(V,z);if(this.info.render.frame++,this.info.autoReset===!0)this.info.reset();if(P0===!0)A0.beginShadows();let J0=A.state.shadowsArray;if(a0.render(J0,z,c),P0===!0)A0.endShadows();if((Z0&&L.hasRenderPass())===!1){let{opaque:d0,transmissive:g0}=V;if(A.setupLights(),c.isArrayCamera){let i0=c.cameras;if(g0.length>0)for(let m0=0,N9=i0.length;m0<N9;m0++){let V9=i0[m0];y7(d0,g0,z,V9)}if(k9)J9.render(z);for(let m0=0,N9=i0.length;m0<N9;m0++){let V9=i0[m0];C6(V,z,V9,V9.viewport)}}else{if(g0.length>0)y7(d0,g0,z,c);if(k9)J9.render(z);C6(V,z,c)}}if(f!==null&&g===0)Q0.updateMultisampleRenderTarget(f),Q0.updateRenderTargetMipmap(f);if(Z0)L.end(M);if(z.isScene===!0)z.onAfterRender(M,z,c);if(w0.resetDefaultState(),o=-1,p=null,D.pop(),D.length>0){if(A=D[D.length-1],Q0.setTextureUnits(A.state.textureUnits),P0===!0)A0.setGlobalState(M.clippingPlanes,A.state.camera)}else A=null;if(w.pop(),w.length>0)V=w[w.length-1];else V=null;if(b!==null)b.renderEnd()};function j7(z,c,Y0,Z0){if(z.visible===!1)return;if(z.layers.test(c.layers)){if(z.isGroup)Y0=z.renderOrder;else if(z.isLOD){if(z.autoUpdate===!0)z.update(c)}else if(z.isLightProbeGrid)A.pushLightProbeGrid(z);else if(z.isLight){if(A.pushLight(z),z.castShadow)A.pushShadow(z)}else if(z.isSprite){if(!z.frustumCulled||z.intersectsFrustum(R0)){if(Z0)t0.setFromMatrixPosition(z.matrixWorld).applyMatrix4(l0);let d0=H0.update(z),g0=z.material;if(g0.visible)V.push(z,d0,g0,Y0,t0.z,null,c)}}else if(z.isMesh||z.isLine||z.isPoints){if(!z.frustumCulled||z.intersectsFrustum(R0)){let d0=H0.update(z),g0=z.material;if(Z0){if(z.boundingSphere!==void 0){if(z.boundingSphere===null)z.computeBoundingSphere();t0.copy(z.boundingSphere.center)}else{if(d0.boundingSphere===null)d0.computeBoundingSphere();t0.copy(d0.boundingSphere.center)}t0.applyMatrix4(z.matrixWorld).applyMatrix4(l0)}if(Array.isArray(g0)){let i0=d0.groups;for(let m0=0,N9=i0.length;m0<N9;m0++){let V9=i0[m0],s0=g0[V9.materialIndex];if(s0&&s0.visible)V.push(z,d0,s0,Y0,t0.z,V9,c)}}else if(g0.visible)V.push(z,d0,g0,Y0,t0.z,null,c)}}}let x0=z.children;for(let d0=0,g0=x0.length;d0<g0;d0++)j7(x0[d0],c,Y0,Z0)}function C6(z,c,Y0,Z0){let{opaque:J0,transmissive:x0,transparent:d0}=z;if(A.setupLightsView(Y0),P0===!0)A0.setGlobalState(M.clippingPlanes,Y0);if(Z0)T.viewport(r.copy(Z0));if(J0.length>0)v7(J0,c,Y0);if(x0.length>0)v7(x0,c,Y0);if(d0.length>0)v7(d0,c,Y0);T.buffers.depth.setTest(!0),T.buffers.depth.setMask(!0),T.buffers.color.setMask(!0),T.setPolygonOffset(!1)}function y7(z,c,Y0,Z0){if((Y0.isScene===!0?Y0.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[Z0.id]===void 0){let s0=z9.has("EXT_color_buffer_half_float")||z9.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[Z0.id]=new X6(1,1,{generateMipmaps:!0,type:s0?B6:k8,minFilter:v8,samples:Math.max(4,A9.samples),stencilBuffer:K,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:R9.workingColorSpace})}let x0=A.state.transmissionRenderTarget[Z0.id],d0=Z0.viewport||r;x0.setSize(d0.z*M.transmissionResolutionScale,d0.w*M.transmissionResolutionScale);let g0=M.getRenderTarget(),i0=M.getActiveCubeFace(),m0=M.getActiveMipmapLevel();if(M.setRenderTarget(x0),M.getClearColor(y),a=M.getClearAlpha(),a<1)M.setClearColor(16777215,0.5);if(M.clear(),k9)J9.render(Y0);let N9=M.toneMapping;M.toneMapping=B8;let V9=Z0.viewport;if(Z0.viewport!==void 0)Z0.viewport=void 0;if(A.setupLightsView(Z0),P0===!0)A0.setGlobalState(M.clippingPlanes,Z0);if(v7(z,Y0,Z0),Q0.updateMultisampleRenderTarget(x0),Q0.updateRenderTargetMipmap(x0),z9.has("WEBGL_multisampled_render_to_texture")===!1){let s0=!1;for(let v9=0,r9=c.length;v9<r9;v9++){let f9=c[v9],{object:l9,geometry:O6,material:c0,group:P6}=f9;if(c0.side===i9&&l9.layers.test(Z0.layers)){let M9=c0.side;c0.side=I6,c0.needsUpdate=!0,pQ(l9,Y0,Z0,O6,c0,P6),c0.side=M9,c0.needsUpdate=!0,s0=!0}}if(s0===!0)Q0.updateMultisampleRenderTarget(x0),Q0.updateRenderTargetMipmap(x0)}if(M.setRenderTarget(g0,i0,m0),M.setClearColor(y,a),V9!==void 0)Z0.viewport=V9;M.toneMapping=N9}function v7(z,c,Y0){let Z0=c.isScene===!0?c.overrideMaterial:null;for(let J0=0,x0=z.length;J0<x0;J0++){let d0=z[J0],{object:g0,geometry:i0,group:m0}=d0,N9=d0.material;if(N9.allowOverride===!0&&Z0!==null)N9=Z0;if(g0.layers.test(Y0.layers))pQ(g0,c,Y0,i0,N9,m0)}}function pQ(z,c,Y0,Z0,J0,x0){if(b!==null&&J0.isNodeMaterial)b.setObject(z,J0);if(z.onBeforeRender(M,c,Y0,Z0,J0,x0),z.modelViewMatrix.multiplyMatrices(Y0.matrixWorldInverse,z.matrixWorld),z.normalMatrix.getNormalMatrix(z.modelViewMatrix),J0.onBeforeRender(M,c,Y0,Z0,z,x0),J0.transparent===!0&&J0.side===i9&&J0.forceSinglePass===!1)J0.side=I6,J0.needsUpdate=!0,M.renderBufferDirect(Y0,c,Z0,J0,z,x0),J0.side=V7,J0.needsUpdate=!0,M.renderBufferDirect(Y0,c,Z0,J0,z,x0),J0.side=i9;else M.renderBufferDirect(Y0,c,Z0,J0,z,x0);z.onAfterRender(M,c,Y0,Z0,J0,x0)}function f7(z,c,Y0){if(c.isScene!==!0)c=X9;let Z0=l.get(z),J0=A.state.lights,x0=A.state.shadowsArray,d0=J0.state.version,g0=E0.getParameters(z,J0.state,x0,c,Y0,A.state.lightProbeGridArray),i0=E0.getProgramCacheKey(g0),m0=Z0.programs;Z0.environment=z.isMeshStandardMaterial||z.isMeshLambertMaterial||z.isMeshPhongMaterial?c.environment:null,Z0.fog=c.fog;let N9=z.isMeshStandardMaterial||z.isMeshLambertMaterial&&!z.envMap||z.isMeshPhongMaterial&&!z.envMap;if(Z0.envMap=V0.get(z.envMap||Z0.environment,N9),Z0.envMapRotation=Z0.environment!==null&&z.envMap===null?c.environmentRotation:z.envMapRotation,m0===void 0)z.addEventListener("dispose",M6),m0=new Map,Z0.programs=m0;let V9=m0.get(i0);if(V9!==void 0){if(Z0.currentProgram===V9&&Z0.lightsStateVersion===d0)return E8(z,g0),V9}else{if(g0.uniforms=E0.getUniforms(z),b!==null&&z.isNodeMaterial)b.build(z,Y0,g0);z.onBeforeCompile(g0,M),V9=E0.acquireProgram(g0,i0),m0.set(i0,V9),Z0.uniforms=g0.uniforms}let s0=Z0.uniforms;if(!z.isShaderMaterial&&!z.isRawShaderMaterial||z.clipping===!0)s0.clippingPlanes=A0.uniform;if(E8(z,g0),Z0.needsLights=N6(z),Z0.lightsStateVersion=d0,Z0.needsLights)s0.ambientLightColor.value=J0.state.ambient,s0.lightProbe.value=J0.state.probe,s0.sunLights.value=J0.state.sun,s0.sunLightShadows.value=J0.state.sunShadow,s0.directionalLights.value=J0.state.directional,s0.directionalLightShadows.value=J0.state.directionalShadow,s0.spotLights.value=J0.state.spot,s0.spotLightShadows.value=J0.state.spotShadow,s0.rectAreaLights.value=J0.state.rectArea,s0.ltc_1.value=J0.state.rectAreaLTC1,s0.ltc_2.value=J0.state.rectAreaLTC2,s0.pointLights.value=J0.state.point,s0.pointLightShadows.value=J0.state.pointShadow,s0.hemisphereLights.value=J0.state.hemi,s0.sunShadowMatrix.value=J0.state.sunShadowMatrix,s0.sunShadowCascade.value=J0.state.sunShadowCascade,s0.directionalShadowMatrix.value=J0.state.directionalShadowMatrix,s0.spotLightMatrix.value=J0.state.spotLightMatrix,s0.spotLightMap.value=J0.state.spotLightMap,s0.pointShadowMatrix.value=J0.state.pointShadowMatrix;return Z0.lightProbeGrid=A.state.lightProbeGridArray.length>0,Z0.currentProgram=V9,Z0.uniformsList=null,V9}function b7(z){if(z.uniformsList===null){let c=z.currentProgram.getUniforms();z.uniformsList=DQ.seqWithValue(c.seq,z.uniforms)}return z.uniformsList}function E8(z,c){let Y0=l.get(z);Y0.outputColorSpace=c.outputColorSpace,Y0.batching=c.batching,Y0.batchingColor=c.batchingColor,Y0.instancing=c.instancing,Y0.instancingColor=c.instancingColor,Y0.instancingMorph=c.instancingMorph,Y0.skinning=c.skinning,Y0.morphTargets=c.morphTargets,Y0.morphNormals=c.morphNormals,Y0.morphColors=c.morphColors,Y0.morphTargetsCount=c.morphTargetsCount,Y0.numClippingPlanes=c.numClippingPlanes,Y0.numIntersection=c.numClipIntersection,Y0.vertexAlphas=c.vertexAlphas,Y0.vertexTangents=c.vertexTangents,Y0.toneMapping=c.toneMapping}function PY(z,c){if(z.length===0)return null;if(z.length===1)return z[0].texture!==null?z[0]:null;k.setFromMatrixPosition(c.matrixWorld);for(let Y0=0,Z0=z.length;Y0<Z0;Y0++){let J0=z[Y0];if(J0.texture!==null&&J0.boundingBox.containsPoint(k))return J0}return null}function mQ(z,c,Y0,Z0,J0){if(c.isScene!==!0)c=X9;Q0.resetTextureUnits();let x0=c.fog,d0=Z0.isMeshStandardMaterial||Z0.isMeshLambertMaterial||Z0.isMeshPhongMaterial?c.environment:null,g0=f===null?M.outputColorSpace:f.isXRRenderTarget===!0?f.texture.colorSpace:R9.workingColorSpace,i0=Z0.isMeshStandardMaterial||Z0.isMeshLambertMaterial&&!Z0.envMap||Z0.isMeshPhongMaterial&&!Z0.envMap,m0=V0.get(Z0.envMap||d0,i0),N9=Z0.vertexColors===!0&&!!Y0.attributes.color&&Y0.attributes.color.itemSize===4,V9=!!Y0.attributes.tangent&&(!!Z0.normalMap||Z0.anisotropy>0),s0=!!Y0.morphAttributes.position,v9=!!Y0.morphAttributes.normal,r9=!!Y0.morphAttributes.color,f9=B8;if(Z0.toneMapped){if(f===null||f.isXRRenderTarget===!0)f9=M.toneMapping}let l9=Y0.morphAttributes.position||Y0.morphAttributes.normal||Y0.morphAttributes.color,O6=l9!==void 0?l9.length:0,c0=l.get(Z0),P6=A.state.lights;if(P0===!0){if(L0===!0||z!==p){let h9=z===p&&Z0.id===o;A0.setState(Z0,z,h9)}}let M9=!1;if(Z0.version===c0.__version){if(c0.needsLights&&c0.lightsStateVersion!==P6.state.version)M9=!0;else if(c0.outputColorSpace!==g0)M9=!0;else if(J0.isBatchedMesh&&c0.batching===!1)M9=!0;else if(!J0.isBatchedMesh&&c0.batching===!0)M9=!0;else if(J0.isBatchedMesh&&c0.batchingColor===!0&&J0._colorsTexture===null)M9=!0;else if(J0.isBatchedMesh&&c0.batchingColor===!1&&J0._colorsTexture!==null)M9=!0;else if(J0.isInstancedMesh&&c0.instancing===!1)M9=!0;else if(!J0.isInstancedMesh&&c0.instancing===!0)M9=!0;else if(J0.isSkinnedMesh&&c0.skinning===!1)M9=!0;else if(!J0.isSkinnedMesh&&c0.skinning===!0)M9=!0;else if(J0.isInstancedMesh&&c0.instancingColor===!0&&J0.instanceColor===null)M9=!0;else if(J0.isInstancedMesh&&c0.instancingColor===!1&&J0.instanceColor!==null)M9=!0;else if(J0.isInstancedMesh&&c0.instancingMorph===!0&&J0.morphTexture===null)M9=!0;else if(J0.isInstancedMesh&&c0.instancingMorph===!1&&J0.morphTexture!==null)M9=!0;else if(c0.envMap!==m0)M9=!0;else if(Z0.fog===!0&&c0.fog!==x0)M9=!0;else if(c0.numClippingPlanes!==void 0&&(c0.numClippingPlanes!==A0.numPlanes||c0.numIntersection!==A0.numIntersection))M9=!0;else if(c0.vertexAlphas!==N9)M9=!0;else if(c0.vertexTangents!==V9)M9=!0;else if(c0.morphTargets!==s0)M9=!0;else if(c0.morphNormals!==v9)M9=!0;else if(c0.morphColors!==r9)M9=!0;else if(c0.toneMapping!==f9)M9=!0;else if(c0.morphTargetsCount!==O6)M9=!0;else if(!!c0.lightProbeGrid!==A.state.lightProbeGridArray.length>0)M9=!0}else M9=!0,c0.__version=Z0.version;let Z6=c0.currentProgram;if(M9===!0){if(Z6=f7(Z0,c,J0),b&&Z0.isNodeMaterial)b.onUpdateProgram(Z0,Z6,c0)}let d6=!1,R6=!1,d8=!1,b9=Z6.getUniforms(),a9=c0.uniforms;if(T.useProgram(Z6.program))d6=!0,R6=!0,d8=!0;if(Z0.id!==o)o=Z0.id,R6=!0;if(c0.needsLights){let h9=PY(A.state.lightProbeGridArray,J0);if(c0.lightProbeGrid!==h9)c0.lightProbeGrid=h9,R6=!0}if(d6||p!==z){if(T.buffers.depth.getReversed()&&z.reversedDepth!==!0)z._reversedDepth=!0,z.updateProjectionMatrix();b9.setValue(m,"projectionMatrix",z.projectionMatrix),b9.setValue(m,"viewMatrix",z.matrixWorldInverse);let $8=b9.map.cameraPosition;if($8!==void 0)$8.setValue(m,W9.setFromMatrixPosition(z.matrixWorld));if(A9.logarithmicDepthBuffer)b9.setValue(m,"logDepthBufFC",2/(Math.log(z.far+1)/Math.LN2));if(Z0.isMeshPhongMaterial||Z0.isMeshToonMaterial||Z0.isMeshLambertMaterial||Z0.isMeshBasicMaterial||Z0.isMeshStandardMaterial||Z0.isShaderMaterial)b9.setValue(m,"isOrthographic",z.isOrthographicCamera===!0);if(p!==z)p=z,R6=!0,d8=!0}if(c0.needsLights){if(P6.state.sunShadowMap.length>0)b9.setValue(m,"sunShadowMap",P6.state.sunShadowMap,Q0);if(P6.state.directionalShadowMap.length>0)b9.setValue(m,"directionalShadowMap",P6.state.directionalShadowMap,Q0);if(P6.state.spotShadowMap.length>0)b9.setValue(m,"spotShadowMap",P6.state.spotShadowMap,Q0);if(P6.state.pointShadowMap.length>0)b9.setValue(m,"pointShadowMap",P6.state.pointShadowMap,Q0)}if(J0.isSkinnedMesh){b9.setOptional(m,J0,"bindMatrix"),b9.setOptional(m,J0,"bindMatrixInverse");let h9=J0.skeleton;if(h9){if(h9.boneTexture===null)h9.computeBoneTexture();b9.setValue(m,"boneTexture",h9.boneTexture,Q0)}}if(J0.isBatchedMesh){if(b9.setOptional(m,J0,"batchingTexture"),b9.setValue(m,"batchingTexture",J0._matricesTexture,Q0),b9.setOptional(m,J0,"batchingIdTexture"),b9.setValue(m,"batchingIdTexture",J0._indirectTexture,Q0),b9.setOptional(m,J0,"batchingColorTexture"),J0._colorsTexture!==null)b9.setValue(m,"batchingColorTexture",J0._colorsTexture,Q0)}let S8=Y0.morphAttributes;if(S8.position!==void 0||S8.normal!==void 0||S8.color!==void 0)_9.update(J0,Y0,Z6);if(R6||c0.receiveShadow!==J0.receiveShadow)c0.receiveShadow=J0.receiveShadow,b9.setValue(m,"receiveShadow",J0.receiveShadow);if((Z0.isMeshStandardMaterial||Z0.isMeshLambertMaterial||Z0.isMeshPhongMaterial)&&Z0.envMap===null&&c.environment!==null)a9.envMapIntensity.value=c.environmentIntensity;if(a9.dfgLUT!==void 0)a9.dfgLUT.value=HR();if(R6){if(b9.setValue(m,"toneMappingExposure",M.toneMappingExposure),c0.needsLights)SK(a9,d8);if(x0&&Z0.fog===!0)h0.refreshFogUniforms(a9,x0);if(h0.refreshMaterialUniforms(a9,Z0,I,h,A.state.transmissionRenderTarget[z.id]),c0.needsLights&&c0.lightProbeGrid){let h9=c0.lightProbeGrid;a9.probesSH.value=h9.texture,a9.probesMin.value.copy(h9.boundingBox.min),a9.probesMax.value.copy(h9.boundingBox.max),a9.probesResolution.value.copy(h9.resolution)}DQ.upload(m,b7(c0),a9,Q0)}if(Z0.isShaderMaterial&&Z0.uniformsNeedUpdate===!0)DQ.upload(m,b7(c0),a9,Q0),Z0.uniformsNeedUpdate=!1;if(Z0.isSpriteMaterial)b9.setValue(m,"center",J0.center);if(b9.setValue(m,"modelViewMatrix",J0.modelViewMatrix),b9.setValue(m,"normalMatrix",J0.normalMatrix),b9.setValue(m,"modelMatrix",J0.matrixWorld),Z0.uniformsGroups!==void 0){let h9=Z0.uniformsGroups;for(let $8=0,c8=h9.length;$8<c8;$8++){let M$=h9[$8];u0.update(M$,Z6),u0.bind(M$,Z6)}}return Z6}function SK(z,c){z.ambientLightColor.needsUpdate=c,z.lightProbe.needsUpdate=c,z.sunLights.needsUpdate=c,z.sunLightShadows.needsUpdate=c,z.directionalLights.needsUpdate=c,z.directionalLightShadows.needsUpdate=c,z.pointLights.needsUpdate=c,z.pointLightShadows.needsUpdate=c,z.spotLights.needsUpdate=c,z.spotLightShadows.needsUpdate=c,z.rectAreaLights.needsUpdate=c,z.hemisphereLights.needsUpdate=c}function N6(z){return z.isMeshLambertMaterial||z.isMeshToonMaterial||z.isMeshPhongMaterial||z.isMeshStandardMaterial||z.isShadowMaterial||z.isShaderMaterial&&z.lights===!0}this.getActiveCubeFace=function(){return j},this.getActiveMipmapLevel=function(){return g},this.getRenderTarget=function(){return f},this.setRenderTargetTextures=function(z,c,Y0){let Z0=l.get(z);if(Z0.__autoAllocateDepthBuffer=z.resolveDepthBuffer===!1,Z0.__autoAllocateDepthBuffer===!1)Z0.__useRenderToTexture=!1;l.get(z.texture).__webglTexture=c,l.get(z.depthTexture).__webglTexture=Z0.__autoAllocateDepthBuffer?void 0:Y0,Z0.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(z,c){let Y0=l.get(z);Y0.__webglFramebuffer=c,Y0.__useDefaultFramebuffer=c===void 0},this.setRenderTarget=function(z,c=0,Y0=0){f=z,j=c,g=Y0;let Z0=null,J0=!1,x0=!1;if(z){let g0=l.get(z);if(g0.__useDefaultFramebuffer!==void 0){T.bindFramebuffer(m.FRAMEBUFFER,g0.__webglFramebuffer),r.copy(z.viewport),X0.copy(z.scissor),M0=z.scissorTest,T.viewport(r),T.scissor(X0),T.setScissorTest(M0),o=-1;return}else if(g0.__webglFramebuffer===void 0)Q0.setupRenderTarget(z);else if(g0.__hasExternalTextures)Q0.rebindTextures(z,l.get(z.texture).__webglTexture,l.get(z.depthTexture).__webglTexture);else if(z.depthBuffer){let N9=z.depthTexture;if(g0.__boundDepthTexture!==N9){if(N9!==null&&l.has(N9)&&(z.width!==N9.image.width||z.height!==N9.image.height))throw Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");Q0.setupDepthRenderbuffer(z)}}let i0=z.texture;if(i0.isData3DTexture||i0.isDataArrayTexture||i0.isCompressedArrayTexture)x0=!0;let m0=l.get(z).__webglFramebuffer;if(z.isWebGLCubeRenderTarget){if(Array.isArray(m0[c]))Z0=m0[c][Y0];else Z0=m0[c];J0=!0}else if(z.samples>0&&Q0.useMultisampledRTT(z)===!1)Z0=l.get(z).__webglMultisampledFramebuffer;else if(Array.isArray(m0))Z0=m0[Y0];else Z0=m0;r.copy(z.viewport),X0.copy(z.scissor),M0=z.scissorTest}else r.copy(K0).multiplyScalar(I).floor(),X0.copy(t).multiplyScalar(I).floor(),M0=D0;if(Y0!==0)Z0=u;if(T.bindFramebuffer(m.FRAMEBUFFER,Z0))T.drawBuffers(z,Z0);if(T.viewport(r),T.scissor(X0),T.setScissorTest(M0),J0){let g0=l.get(z.texture);m.framebufferTexture2D(m.FRAMEBUFFER,m.COLOR_ATTACHMENT0,m.TEXTURE_CUBE_MAP_POSITIVE_X+c,g0.__webglTexture,Y0)}else if(x0){let g0=c;for(let i0=0;i0<z.textures.length;i0++){let m0=l.get(z.textures[i0]);m.framebufferTextureLayer(m.FRAMEBUFFER,m.COLOR_ATTACHMENT0+i0,m0.__webglTexture,Y0,g0)}}else if(z!==null&&Y0!==0){let g0=l.get(z.texture);m.framebufferTexture2D(m.FRAMEBUFFER,m.COLOR_ATTACHMENT0,m.TEXTURE_2D,g0.__webglTexture,Y0)}o=-1};function J8(z){let c=l.get(z);if(c.__readFormat!==z.format||c.__readType!==z.type)c.__readFormat=z.format,c.__readType=z.type,c.__formatReadable=A9.textureFormatReadable(z.format),c.__typeReadable=A9.textureTypeReadable(z.type);return c}if(this.readRenderTargetPixels=function(z,c,Y0,Z0,J0,x0,d0,g0=0){if(!(z&&z.isWebGLRenderTarget)){Z9("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let i0=l.get(z).__webglFramebuffer;if(z.isWebGLCubeRenderTarget&&d0!==void 0)i0=i0[d0];if(i0){T.bindFramebuffer(m.FRAMEBUFFER,i0);try{let m0=z.textures[g0],N9=m0.format,V9=m0.type;if(z.textures.length>1)m.readBuffer(m.COLOR_ATTACHMENT0+g0);let s0=J8(m0);if(s0.__formatReadable===!1){Z9("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(s0.__typeReadable===!1){Z9("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}if(c>=0&&c<=z.width-Z0&&(Y0>=0&&Y0<=z.height-J0))m.readPixels(c,Y0,Z0,J0,N0.convert(N9),N0.convert(V9),x0)}finally{let m0=f!==null?l.get(f).__webglFramebuffer:null;T.bindFramebuffer(m.FRAMEBUFFER,m0)}}},this.readRenderTargetPixelsAsync=async function(z,c,Y0,Z0,J0,x0,d0,g0=0){if(!(z&&z.isWebGLRenderTarget))throw Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let i0=l.get(z).__webglFramebuffer;if(z.isWebGLCubeRenderTarget&&d0!==void 0)i0=i0[d0];if(i0)if(c>=0&&c<=z.width-Z0&&(Y0>=0&&Y0<=z.height-J0)){T.bindFramebuffer(m.FRAMEBUFFER,i0);let m0=z.textures[g0],N9=m0.format,V9=m0.type;if(z.textures.length>1)m.readBuffer(m.COLOR_ATTACHMENT0+g0);let s0=J8(m0);if(s0.__formatReadable===!1)throw Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(s0.__typeReadable===!1)throw Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let v9=m.createBuffer();m.bindBuffer(m.PIXEL_PACK_BUFFER,v9),m.bufferData(m.PIXEL_PACK_BUFFER,x0.byteLength,m.STREAM_READ),m.readPixels(c,Y0,Z0,J0,N0.convert(N9),N0.convert(V9),0),m.bindBuffer(m.PIXEL_PACK_BUFFER,null);let r9=f!==null?l.get(f).__webglFramebuffer:null;T.bindFramebuffer(m.FRAMEBUFFER,r9);let f9=m.fenceSync(m.SYNC_GPU_COMMANDS_COMPLETE,0);return m.flush(),await k5(m,f9,4),m.bindBuffer(m.PIXEL_PACK_BUFFER,v9),m.getBufferSubData(m.PIXEL_PACK_BUFFER,0,x0),m.bindBuffer(m.PIXEL_PACK_BUFFER,null),m.deleteBuffer(v9),m.deleteSync(f9),x0}else throw Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(z,c=null,Y0=0){let Z0=Math.pow(2,-Y0),J0=Math.floor(z.image.width*Z0),x0=Math.floor(z.image.height*Z0),d0=c!==null?c.x:0,g0=c!==null?c.y:0;Q0.setTexture2D(z,0),m.copyTexSubImage2D(m.TEXTURE_2D,Y0,0,0,d0,g0,J0,x0),T.unbindTexture()},this.copyTextureToTexture=function(z,c,Y0=null,Z0=null,J0=0,x0=0){let d0,g0,i0,m0,N9,V9,s0,v9,r9,f9=z.isCompressedTexture?z.mipmaps[x0]:z.image;if(Y0!==null)d0=Y0.max.x-Y0.min.x,g0=Y0.max.y-Y0.min.y,i0=Y0.isBox3?Y0.max.z-Y0.min.z:1,m0=Y0.min.x,N9=Y0.min.y,V9=Y0.isBox3?Y0.min.z:0;else{let a9=Math.pow(2,-J0);if(d0=Math.floor(f9.width*a9),g0=Math.floor(f9.height*a9),z.isDataArrayTexture)i0=f9.depth;else if(z.isData3DTexture)i0=Math.floor(f9.depth*a9);else i0=1;m0=0,N9=0,V9=0}if(Z0!==null)s0=Z0.x,v9=Z0.y,r9=Z0.z;else s0=0,v9=0,r9=0;let l9=N0.convert(c.format),O6=N0.convert(c.type),c0;if(c.isData3DTexture)Q0.setTexture3D(c,0),c0=m.TEXTURE_3D;else if(c.isDataArrayTexture||c.isCompressedArrayTexture)Q0.setTexture2DArray(c,0),c0=m.TEXTURE_2D_ARRAY;else Q0.setTexture2D(c,0),c0=m.TEXTURE_2D;T.activeTexture(m.TEXTURE0),T.pixelStorei(m.UNPACK_FLIP_Y_WEBGL,c.flipY),T.pixelStorei(m.UNPACK_PREMULTIPLY_ALPHA_WEBGL,c.premultiplyAlpha),T.pixelStorei(m.UNPACK_ALIGNMENT,c.unpackAlignment);let P6=T.getParameter(m.UNPACK_ROW_LENGTH),M9=T.getParameter(m.UNPACK_IMAGE_HEIGHT),Z6=T.getParameter(m.UNPACK_SKIP_PIXELS),d6=T.getParameter(m.UNPACK_SKIP_ROWS),R6=T.getParameter(m.UNPACK_SKIP_IMAGES);T.pixelStorei(m.UNPACK_ROW_LENGTH,f9.width),T.pixelStorei(m.UNPACK_IMAGE_HEIGHT,f9.height),T.pixelStorei(m.UNPACK_SKIP_PIXELS,m0),T.pixelStorei(m.UNPACK_SKIP_ROWS,N9),T.pixelStorei(m.UNPACK_SKIP_IMAGES,V9);let d8=z.isDataArrayTexture||z.isData3DTexture,b9=c.isDataArrayTexture||c.isData3DTexture;if(z.isDepthTexture){let a9=l.get(z),S8=l.get(c),h9=l.get(a9.__renderTarget),$8=l.get(S8.__renderTarget);T.bindFramebuffer(m.READ_FRAMEBUFFER,h9.__webglFramebuffer),T.bindFramebuffer(m.DRAW_FRAMEBUFFER,$8.__webglFramebuffer);for(let c8=0;c8<i0;c8++){if(d8)m.framebufferTextureLayer(m.READ_FRAMEBUFFER,m.COLOR_ATTACHMENT0,l.get(z).__webglTexture,J0,V9+c8),m.framebufferTextureLayer(m.DRAW_FRAMEBUFFER,m.COLOR_ATTACHMENT0,l.get(c).__webglTexture,x0,r9+c8);m.blitFramebuffer(m0,N9,d0,g0,s0,v9,d0,g0,m.DEPTH_BUFFER_BIT,m.NEAREST)}T.bindFramebuffer(m.READ_FRAMEBUFFER,null),T.bindFramebuffer(m.DRAW_FRAMEBUFFER,null)}else if(J0!==0||z.isRenderTargetTexture||l.has(z)){let a9=l.get(z),S8=l.get(c);T.bindFramebuffer(m.READ_FRAMEBUFFER,e),T.bindFramebuffer(m.DRAW_FRAMEBUFFER,v);for(let h9=0;h9<i0;h9++){if(d8)m.framebufferTextureLayer(m.READ_FRAMEBUFFER,m.COLOR_ATTACHMENT0,a9.__webglTexture,J0,V9+h9);else m.framebufferTexture2D(m.READ_FRAMEBUFFER,m.COLOR_ATTACHMENT0,m.TEXTURE_2D,a9.__webglTexture,J0);if(b9)m.framebufferTextureLayer(m.DRAW_FRAMEBUFFER,m.COLOR_ATTACHMENT0,S8.__webglTexture,x0,r9+h9);else m.framebufferTexture2D(m.DRAW_FRAMEBUFFER,m.COLOR_ATTACHMENT0,m.TEXTURE_2D,S8.__webglTexture,x0);if(J0!==0)m.blitFramebuffer(m0,N9,d0,g0,s0,v9,d0,g0,m.COLOR_BUFFER_BIT,m.NEAREST);else if(b9)m.copyTexSubImage3D(c0,x0,s0,v9,r9+h9,m0,N9,d0,g0);else m.copyTexSubImage2D(c0,x0,s0,v9,m0,N9,d0,g0)}T.bindFramebuffer(m.READ_FRAMEBUFFER,null),T.bindFramebuffer(m.DRAW_FRAMEBUFFER,null)}else if(b9)if(z.isDataTexture||z.isData3DTexture)m.texSubImage3D(c0,x0,s0,v9,r9,d0,g0,i0,l9,O6,f9.data);else if(c.isCompressedArrayTexture)m.compressedTexSubImage3D(c0,x0,s0,v9,r9,d0,g0,i0,l9,f9.data);else m.texSubImage3D(c0,x0,s0,v9,r9,d0,g0,i0,l9,O6,f9);else if(z.isDataTexture)m.texSubImage2D(m.TEXTURE_2D,x0,s0,v9,d0,g0,l9,O6,f9.data);else if(z.isCompressedTexture)m.compressedTexSubImage2D(m.TEXTURE_2D,x0,s0,v9,f9.width,f9.height,l9,f9.data);else m.texSubImage2D(m.TEXTURE_2D,x0,s0,v9,d0,g0,l9,O6,f9);if(T.pixelStorei(m.UNPACK_ROW_LENGTH,P6),T.pixelStorei(m.UNPACK_IMAGE_HEIGHT,M9),T.pixelStorei(m.UNPACK_SKIP_PIXELS,Z6),T.pixelStorei(m.UNPACK_SKIP_ROWS,d6),T.pixelStorei(m.UNPACK_SKIP_IMAGES,R6),x0===0&&c.generateMipmaps)m.generateMipmap(c0);T.unbindTexture()},this.initRenderTarget=function(z){if(l.get(z).__webglFramebuffer===void 0)Q0.setupRenderTarget(z)},this.initTexture=function(z){if(z.isCubeTexture)Q0.setTextureCube(z,0);else if(z.isData3DTexture)Q0.setTexture3D(z,0);else if(z.isDataArrayTexture||z.isCompressedArrayTexture)Q0.setTexture2DArray(z,0);else Q0.setTexture2D(z,0);T.unbindTexture()},this.resetState=function(){j=0,g=0,f=null,T.reset(),w0.reset()},typeof __THREE_DEVTOOLS__<"u")__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return KX}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(J){this._outputColorSpace=J;let $=this.getContext();$.drawingBufferColorSpace=R9._getDrawingBufferColorSpace(J),$.unpackColorSpace=R9._getUnpackColorSpace()}}var VU={type:"change"},uX={type:"start"},DU={type:"end"},FK=new k7,BU=new Z8,UR=Math.cos(70*b8.DEG2RAD),q6=new S,p6=2*Math.PI,n9={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},lX=0.000001;class dX extends YK{constructor(J,$=null){super(J,$);if(this.state=n9.NONE,this.target=new S,this.cursor=new S,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=0.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:R7.ROTATE,MIDDLE:R7.DOLLY,RIGHT:R7.PAN},this.touches={ONE:L7.ROTATE,TWO:L7.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle="auto",this._domElementKeyEvents=null,this._lastPosition=new S,this._lastQuaternion=new K9,this._lastTargetPosition=new S,this._quat=new K9().setFromUnitVectors(J.up,new S(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new RQ,this._sphericalDelta=new RQ,this._scale=1,this._panOffset=new S,this._rotateStart=new O0,this._rotateEnd=new O0,this._rotateDelta=new O0,this._panStart=new O0,this._panEnd=new O0,this._panDelta=new O0,this._dollyStart=new O0,this._dollyEnd=new O0,this._dollyDelta=new O0,this._dollyDirection=new S,this._mouse=new O0,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=GR.bind(this),this._onPointerDown=NR.bind(this),this._onPointerUp=FR.bind(this),this._onContextMenu=BR.bind(this),this._onMouseWheel=OR.bind(this),this._onKeyDown=RR.bind(this),this._onTouchStart=LR.bind(this),this._onTouchMove=VR.bind(this),this._onMouseDown=ER.bind(this),this._onMouseMove=qR.bind(this),this._interceptControlDown=DR.bind(this),this._interceptControlUp=kR.bind(this),this.domElement!==null)this.connect(this.domElement);this.update()}set cursorStyle(J){if(this._cursorStyle=J,J==="grab")this.domElement.style.cursor="grab";else this.domElement.style.cursor="auto"}get cursorStyle(){return this._cursorStyle}connect(J){super.connect(J),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.state=n9.NONE,this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents();let J=this.domElement.getRootNode();J.removeEventListener("keydown",this._interceptControlDown,{capture:!0}),J.removeEventListener("keyup",this._interceptControlUp,{capture:!0}),this._controlActive=!1,this._pointers.length=0,this._pointerPositions={},this.domElement.style.touchAction="",this.domElement.style.cursor="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(J){J.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=J}stopListenToKeyEvents(){if(this._domElementKeyEvents!==null)this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(VU),this.update(),this.state=n9.NONE}pan(J,$){this._pan(J,$),this.update()}dollyIn(J){this._dollyIn(J),this.update()}dollyOut(J){this._dollyOut(J),this.update()}rotateLeft(J){this._rotateLeft(J),this.update()}rotateUp(J){this._rotateUp(J),this.update()}update(J=null){let $=this.object.position;if(q6.copy($).sub(this.target),q6.applyQuaternion(this._quat),this._spherical.setFromVector3(q6),this.autoRotate&&this.state===n9.NONE)this._rotateLeft(this._getAutoRotationAngle(J));if(this.enableDamping)this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor;else this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi;let Q=this.minAzimuthAngle,Z=this.maxAzimuthAngle;if(isFinite(Q)&&isFinite(Z)){if(Q<-Math.PI)Q+=p6;else if(Q>Math.PI)Q-=p6;if(Z<-Math.PI)Z+=p6;else if(Z>Math.PI)Z-=p6;if(Q<=Z)this._spherical.theta=Math.max(Q,Math.min(Z,this._spherical.theta));else this._spherical.theta=this._spherical.theta>(Q+Z)/2?Math.max(Q,this._spherical.theta):Math.min(Z,this._spherical.theta)}if(this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0)this.target.addScaledVector(this._panOffset,this.dampingFactor);else this.target.add(this._panOffset);this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let K=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let W=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),K=W!=this._spherical.radius}if(q6.setFromSpherical(this._spherical),q6.applyQuaternion(this._quatInverse),$.copy(this.target).add(q6),this.object.lookAt(this.target),this.enableDamping===!0)this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor);else this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0);if(this.zoomToCursor&&this._performCursorZoom){let W=null;if(this.object.isPerspectiveCamera){let X=q6.length();W=this._clampDistance(X*this._scale);let Y=X-W;this.object.position.addScaledVector(this._dollyDirection,Y),this.object.updateMatrixWorld(),K=!!Y}else if(this.object.isOrthographicCamera){let X=new S(this._mouse.x,this._mouse.y,0);X.unproject(this.object);let Y=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),K=Y!==this.object.zoom;let H=new S(this._mouse.x,this._mouse.y,0);H.unproject(this.object),this.object.position.sub(H).add(X),this.object.updateMatrixWorld(),W=q6.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;if(W!==null)if(this.screenSpacePanning)this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(W).add(this.object.position);else if(FK.origin.copy(this.object.position),FK.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(FK.direction))<UR)this.object.lookAt(this.target);else BU.setFromNormalAndCoplanarPoint(this.object.up,this.target),FK.intersectPlane(BU,this.target)}else if(this.object.isOrthographicCamera){let W=this.object.zoom;if(this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),W!==this.object.zoom)this.object.updateProjectionMatrix(),K=!0}if(this._scale=1,this._performCursorZoom=!1,K||this._lastPosition.distanceToSquared(this.object.position)>lX||8*(1-this._lastQuaternion.dot(this.object.quaternion))>lX||this._lastTargetPosition.distanceToSquared(this.target)>lX)return this.dispatchEvent(VU),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0;return!1}_getAutoRotationAngle(J){if(J!==null)return p6/60*this.autoRotateSpeed*J;else return p6/60/60*this.autoRotateSpeed}_getZoomScale(J){let $=Math.abs(J*0.01);return Math.pow(0.95,this.zoomSpeed*$)}_rotateLeft(J){this._sphericalDelta.theta-=J}_rotateUp(J){this._sphericalDelta.phi-=J}_panLeft(J,$){q6.setFromMatrixColumn($,0),q6.multiplyScalar(-J),this._panOffset.add(q6)}_panUp(J,$){if(this.screenSpacePanning===!0)q6.setFromMatrixColumn($,1);else q6.setFromMatrixColumn($,0),q6.crossVectors(this.object.up,q6);q6.multiplyScalar(J),this._panOffset.add(q6)}_pan(J,$){let Q=this.domElement;if(this.object.isPerspectiveCamera){let Z=this.object.position;q6.copy(Z).sub(this.target);let K=q6.length();K*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*J*K/Q.clientHeight,this.object.matrix),this._panUp(2*$*K/Q.clientHeight,this.object.matrix)}else if(this.object.isOrthographicCamera)this._panLeft(J*(this.object.right-this.object.left)/this.object.zoom/Q.clientWidth,this.object.matrix),this._panUp($*(this.object.top-this.object.bottom)/this.object.zoom/Q.clientHeight,this.object.matrix);else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1}_dollyOut(J){if(this.object.isPerspectiveCamera||this.object.isOrthographicCamera)this._scale/=J;else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1}_dollyIn(J){if(this.object.isPerspectiveCamera||this.object.isOrthographicCamera)this._scale*=J;else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1}_updateZoomParameters(J,$){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let Q=this.domElement.getBoundingClientRect(),Z=J-Q.left,K=$-Q.top,W=Q.width,X=Q.height;this._mouse.x=Z/W*2-1,this._mouse.y=-(K/X)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(J){return Math.max(this.minDistance,Math.min(this.maxDistance,J))}_handleMouseDownRotate(J){this._rotateStart.set(J.clientX,J.clientY)}_handleMouseDownDolly(J){this._updateZoomParameters(J.clientX,J.clientX),this._dollyStart.set(J.clientX,J.clientY)}_handleMouseDownPan(J){this._panStart.set(J.clientX,J.clientY)}_handleMouseMoveRotate(J){this._rotateEnd.set(J.clientX,J.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let $=this.domElement;this._rotateLeft(p6*this._rotateDelta.x/$.clientHeight),this._rotateUp(p6*this._rotateDelta.y/$.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(J){if(this._dollyEnd.set(J.clientX,J.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0)this._dollyOut(this._getZoomScale(this._dollyDelta.y));else if(this._dollyDelta.y<0)this._dollyIn(this._getZoomScale(this._dollyDelta.y));this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(J){this._panEnd.set(J.clientX,J.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(J){if(this._updateZoomParameters(J.clientX,J.clientY),J.deltaY<0)this._dollyIn(this._getZoomScale(J.deltaY));else if(J.deltaY>0)this._dollyOut(this._getZoomScale(J.deltaY));this.update()}_handleKeyDown(J){let $=!1;switch(J.code){case this.keys.UP:if(J.ctrlKey||J.metaKey||J.shiftKey){if(this.enableRotate)this._rotateUp(p6*this.keyRotateSpeed/this.domElement.clientHeight)}else if(this.enablePan)this._pan(0,this.keyPanSpeed);$=!0;break;case this.keys.BOTTOM:if(J.ctrlKey||J.metaKey||J.shiftKey){if(this.enableRotate)this._rotateUp(-p6*this.keyRotateSpeed/this.domElement.clientHeight)}else if(this.enablePan)this._pan(0,-this.keyPanSpeed);$=!0;break;case this.keys.LEFT:if(J.ctrlKey||J.metaKey||J.shiftKey){if(this.enableRotate)this._rotateLeft(p6*this.keyRotateSpeed/this.domElement.clientHeight)}else if(this.enablePan)this._pan(this.keyPanSpeed,0);$=!0;break;case this.keys.RIGHT:if(J.ctrlKey||J.metaKey||J.shiftKey){if(this.enableRotate)this._rotateLeft(-p6*this.keyRotateSpeed/this.domElement.clientHeight)}else if(this.enablePan)this._pan(-this.keyPanSpeed,0);$=!0;break}if($)J.preventDefault(),this.update()}_handleTouchStartRotate(J){if(this._pointers.length===1)this._rotateStart.set(J.pageX,J.pageY);else{let $=this._getSecondPointerPosition(J),Q=0.5*(J.pageX+$.x),Z=0.5*(J.pageY+$.y);this._rotateStart.set(Q,Z)}}_handleTouchStartPan(J){if(this._pointers.length===1)this._panStart.set(J.pageX,J.pageY);else{let $=this._getSecondPointerPosition(J),Q=0.5*(J.pageX+$.x),Z=0.5*(J.pageY+$.y);this._panStart.set(Q,Z)}}_handleTouchStartDolly(J){let $=this._getSecondPointerPosition(J),Q=J.pageX-$.x,Z=J.pageY-$.y,K=Math.sqrt(Q*Q+Z*Z);this._dollyStart.set(0,K)}_handleTouchStartDollyPan(J){if(this.enableZoom)this._handleTouchStartDolly(J);if(this.enablePan)this._handleTouchStartPan(J)}_handleTouchStartDollyRotate(J){if(this.enableZoom)this._handleTouchStartDolly(J);if(this.enableRotate)this._handleTouchStartRotate(J)}_handleTouchMoveRotate(J){if(this._pointers.length==1)this._rotateEnd.set(J.pageX,J.pageY);else{let Q=this._getSecondPointerPosition(J),Z=0.5*(J.pageX+Q.x),K=0.5*(J.pageY+Q.y);this._rotateEnd.set(Z,K)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let $=this.domElement;this._rotateLeft(p6*this._rotateDelta.x/$.clientHeight),this._rotateUp(p6*this._rotateDelta.y/$.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(J){if(this._pointers.length===1)this._panEnd.set(J.pageX,J.pageY);else{let $=this._getSecondPointerPosition(J),Q=0.5*(J.pageX+$.x),Z=0.5*(J.pageY+$.y);this._panEnd.set(Q,Z)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(J){let $=this._getSecondPointerPosition(J),Q=J.pageX-$.x,Z=J.pageY-$.y,K=Math.sqrt(Q*Q+Z*Z);this._dollyEnd.set(0,K),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let W=(J.pageX+$.x)*0.5,X=(J.pageY+$.y)*0.5;this._updateZoomParameters(W,X)}_handleTouchMoveDollyPan(J){if(this.enableZoom)this._handleTouchMoveDolly(J);if(this.enablePan)this._handleTouchMovePan(J)}_handleTouchMoveDollyRotate(J){if(this.enableZoom)this._handleTouchMoveDolly(J);if(this.enableRotate)this._handleTouchMoveRotate(J)}_addPointer(J){this._pointers.push(J.pointerId)}_removePointer(J){delete this._pointerPositions[J.pointerId];for(let $=0;$<this._pointers.length;$++)if(this._pointers[$]==J.pointerId){this._pointers.splice($,1);return}}_isTrackingPointer(J){for(let $=0;$<this._pointers.length;$++)if(this._pointers[$]==J.pointerId)return!0;return!1}_trackPointer(J){let $=this._pointerPositions[J.pointerId];if($===void 0)$=new O0,this._pointerPositions[J.pointerId]=$;$.set(J.pageX,J.pageY)}_getSecondPointerPosition(J){let $=J.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[$]}_customWheelEvent(J){let $=J.deltaMode,Q={clientX:J.clientX,clientY:J.clientY,deltaY:J.deltaY};switch($){case 1:Q.deltaY*=16;break;case 2:Q.deltaY*=100;break}if(J.ctrlKey&&!this._controlActive)Q.deltaY*=10;return Q}}function NR(J){if(this.enabled===!1)return;if(this._pointers.length===0)this.domElement.setPointerCapture(J.pointerId),this.domElement.ownerDocument.addEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.addEventListener("pointerup",this._onPointerUp);if(this._isTrackingPointer(J))return;if(this._addPointer(J),J.pointerType==="touch")this._onTouchStart(J);else this._onMouseDown(J);if(this._cursorStyle==="grab")this.domElement.style.cursor="grabbing"}function GR(J){if(this.enabled===!1)return;if(J.pointerType==="touch")this._onTouchMove(J);else this._onMouseMove(J)}function FR(J){switch(this._removePointer(J),this._pointers.length){case 0:if(this.domElement.releasePointerCapture(J.pointerId),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(DU),this.state=n9.NONE,this._cursorStyle==="grab")this.domElement.style.cursor="grab";break;case 1:let $=this._pointers[0],Q=this._pointerPositions[$];this._onTouchStart({pointerId:$,pageX:Q.x,pageY:Q.y});break}}function ER(J){let $;switch(J.button){case 0:$=this.mouseButtons.LEFT;break;case 1:$=this.mouseButtons.MIDDLE;break;case 2:$=this.mouseButtons.RIGHT;break;default:$=-1}switch($){case R7.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(J),this.state=n9.DOLLY;break;case R7.ROTATE:if(J.ctrlKey||J.metaKey||J.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(J),this.state=n9.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(J),this.state=n9.ROTATE}break;case R7.PAN:if(J.ctrlKey||J.metaKey||J.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(J),this.state=n9.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(J),this.state=n9.PAN}break;default:this.state=n9.NONE}if(this.state!==n9.NONE)this.dispatchEvent(uX)}function qR(J){switch(this.state){case n9.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(J);break;case n9.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(J);break;case n9.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(J);break}}function OR(J){if(this.enabled===!1||this.enableZoom===!1||this.state!==n9.NONE)return;J.preventDefault(),this.dispatchEvent(uX),this._handleMouseWheel(this._customWheelEvent(J)),this.dispatchEvent(DU)}function RR(J){if(this.enabled===!1)return;this._handleKeyDown(J)}function LR(J){switch(this._trackPointer(J),this._pointers.length){case 1:switch(this.touches.ONE){case L7.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(J),this.state=n9.TOUCH_ROTATE;break;case L7.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(J),this.state=n9.TOUCH_PAN;break;default:this.state=n9.NONE}break;case 2:switch(this.touches.TWO){case L7.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(J),this.state=n9.TOUCH_DOLLY_PAN;break;case L7.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(J),this.state=n9.TOUCH_DOLLY_ROTATE;break;default:this.state=n9.NONE}break;default:this.state=n9.NONE}if(this.state!==n9.NONE)this.dispatchEvent(uX)}function VR(J){switch(this._trackPointer(J),this.state){case n9.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(J),this.update();break;case n9.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(J),this.update();break;case n9.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(J),this.update();break;case n9.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(J),this.update();break;default:this.state=n9.NONE}}function BR(J){if(this.enabled===!1)return;J.preventDefault()}function DR(J){if(J.key==="Control")this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0})}function kR(J){if(J.key==="Control")this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0})}var MQ=new S;function Y8(J,$,Q,Z,K,W){let X=2*Math.PI*K/4,Y=Math.max(W-2*K,0),H=Math.PI/4;MQ.copy($),MQ[Z]=0,MQ.normalize();let U=0.5*X/(X+Y),G=1-MQ.angleTo(J)/H;if(Math.sign(MQ[Q])===1)return G*U;else return Y/(X+Y)+U+U*(1-G)}class f6 extends w9{constructor(J=1,$=1,Q=1,Z=2,K=0.1){let W=Z*2+1;K=Math.min(J/2,$/2,Q/2,K);super(1,1,1,W,W,W);if(this.type="RoundedBoxGeometry",this.parameters={width:J,height:$,depth:Q,segments:Z,radius:K},W===1)return;let X=this.toNonIndexed();this.index=null,this.attributes.position=X.attributes.position,this.attributes.normal=X.attributes.normal,this.attributes.uv=X.attributes.uv;let Y=new S,H=new S,U=new S(J,$,Q).divideScalar(2).subScalar(K),G=this.attributes.position.array,F=this.attributes.normal.array,N=this.attributes.uv.array,q=G.length/6,O=new S,B=0.5/W;for(let R=0,E=0;R<G.length;R+=3,E+=2)switch(Y.fromArray(G,R),H.copy(Y),H.x-=Math.sign(H.x)*B,H.y-=Math.sign(H.y)*B,H.z-=Math.sign(H.z)*B,H.normalize(),G[R+0]=U.x*Math.sign(Y.x)+H.x*K,G[R+1]=U.y*Math.sign(Y.y)+H.y*K,G[R+2]=U.z*Math.sign(Y.z)+H.z*K,F[R+0]=H.x,F[R+1]=H.y,F[R+2]=H.z,Math.floor(R/q)){case 0:O.set(1,0,0),N[E+0]=Y8(O,H,"z","y",K,Q),N[E+1]=1-Y8(O,H,"y","z",K,$);break;case 1:O.set(-1,0,0),N[E+0]=1-Y8(O,H,"z","y",K,Q),N[E+1]=1-Y8(O,H,"y","z",K,$);break;case 2:O.set(0,1,0),N[E+0]=1-Y8(O,H,"x","z",K,J),N[E+1]=Y8(O,H,"z","x",K,Q);break;case 3:O.set(0,-1,0),N[E+0]=1-Y8(O,H,"x","z",K,J),N[E+1]=1-Y8(O,H,"z","x",K,Q);break;case 4:O.set(0,0,1),N[E+0]=1-Y8(O,H,"x","y",K,J),N[E+1]=1-Y8(O,H,"y","x",K,$);break;case 5:O.set(0,0,-1),N[E+0]=Y8(O,H,"x","y",K,J),N[E+1]=1-Y8(O,H,"y","x",K,$);break}}static fromJSON(J){return new f6(J.width,J.height,J.depth,J.segments,J.radius)}}function E$(J,$=!1){let Q=J[0].index!==null,Z=new Set(Object.keys(J[0].attributes)),K=new Set(Object.keys(J[0].morphAttributes)),W={},X={},Y=J[0].morphTargetsRelative,H=new g9,U=0;for(let G=0;G<J.length;++G){let F=J[G],N=0;if(Q!==(F.index!==null))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+G+". All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them."),null;for(let q in F.attributes){if(!Z.has(q))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+G+'. All geometries must have compatible attributes; make sure "'+q+'" attribute exists among all geometries, or in none of them.'),null;if(W[q]===void 0)W[q]=[];W[q].push(F.attributes[q]),N++}if(N!==Z.size)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+G+". Make sure all geometries have the same number of attributes."),null;if(Y!==F.morphTargetsRelative)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+G+". .morphTargetsRelative must be consistent throughout all geometries."),null;for(let q in F.morphAttributes){if(!K.has(q))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+G+".  .morphAttributes must be consistent throughout all geometries."),null;if(X[q]===void 0)X[q]=[];X[q].push(F.morphAttributes[q])}if($){let q;if(Q)q=F.index.count;else if(F.attributes.position!==void 0)q=F.attributes.position.count;else return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+G+". The geometry must have either an index or a position attribute"),null;H.addGroup(U,q,G),U+=q}}if(Q){let G=0,F=[];for(let N=0;N<J.length;++N){let q=J[N].index;for(let O=0;O<q.count;++O)F.push(q.getX(O)+G);G+=J[N].attributes.position.count}H.setIndex(F)}for(let G in W){let F=kU(W[G]);if(!F)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+G+" attribute."),null;H.setAttribute(G,F)}for(let G in X){let F=X[G][0].length;if(F===0)continue;H.morphAttributes=H.morphAttributes||{},H.morphAttributes[G]=[];for(let N=0;N<F;++N){let q=[];for(let B=0;B<X[G].length;++B)q.push(X[G][B][N]);let O=kU(q);if(!O)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+G+" morphAttribute."),null;H.morphAttributes[G].push(O)}}return H}function kU(J){let $,Q,Z,K=-1,W=0;for(let U=0;U<J.length;++U){let G=J[U];if($===void 0)$=G.array.constructor;if($!==G.array.constructor)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes."),null;if(Q===void 0)Q=G.itemSize;if(Q!==G.itemSize)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes."),null;if(Z===void 0)Z=G.normalized;if(Z!==G.normalized)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes."),null;if(K===-1)K=G.gpuType;if(K!==G.gpuType)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes."),null;W+=G.count*Q}let X=new $(W),Y=new t9(X,Q,Z),H=0;for(let U=0;U<J.length;++U){let G=J[U];if(G.isInterleavedBufferAttribute){let F=H/Q;for(let N=0,q=G.count;N<q;N++)for(let O=0;O<Q;O++){let B=G.getComponent(N,O);Y.setComponent(N+F,O,B)}}else X.set(G.array,H);H+=G.count*Q}if(K!==void 0)Y.gpuType=K;return Y}function cX(J,$){if($===JX)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),J;if($===$$||$===QQ){let Q=J.getIndex();if(Q===null){let W=[],X=J.getAttribute("position");if(X!==void 0){for(let Y=0;Y<X.count;Y++)W.push(Y);J.setIndex(W),Q=J.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),J}let Z=Q.count-2,K=[];if($===$$)for(let W=1;W<=Z;W++)K.push(Q.getX(0)),K.push(Q.getX(W)),K.push(Q.getX(W+1));else for(let W=0;W<Z;W++)if(W%2===0)K.push(Q.getX(W)),K.push(Q.getX(W+1)),K.push(Q.getX(W+2));else K.push(Q.getX(W+2)),K.push(Q.getX(W+1)),K.push(Q.getX(W));if(K.length/3!==Z)console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.");return J.setIndex(K),J.clearGroups(),J}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",$),J}function NJ(J){let $=new Map,Q=new Map,Z=J.clone();return MU(J,Z,function(K,W){$.set(W,K),Q.set(K,W)}),Z.traverse(function(K){if(!K.isSkinnedMesh)return;let W=K,X=$.get(K),Y=X.skeleton.bones;W.skeleton=X.skeleton.clone(),W.bindMatrix.copy(X.bindMatrix),W.skeleton.bones=Y.map(function(H){return Q.get(H)}),W.bind(W.skeleton,W.bindMatrix)}),Z}function MU(J,$,Q){Q(J,$);for(let Z=0;Z<J.children.length;Z++)MU(J.children[Z],$.children[Z],Q)}var C0={tableWidth:0.92,tableCenterY:0.724,tableThickness:0.09,feltWidth:0.78,feltCenterY:0.776,surfaceY:0.782,chairSeatY:0.51,chairSeatWidth:0.56,seatDistance:0.77,tileLength:0.054,tileWidth:0.027,tileThickness:0.011,tileGap:0.0016,pipRadius:0.0033,pipColumnSpacing:0.0072,pipRowSpacing:0.0076,rackRadius:0.418,rackSpacing:0.0305,neutralPoseTime:10.25,boardLimit:0.27},z6={tope:1.06,z:-3.89,fondo:0.62,ancho:3.9},C8=[[0,C0.seatDistance,Math.PI],[C0.seatDistance,0,-Math.PI/2],[0,-C0.seatDistance,0],[-C0.seatDistance,0,Math.PI/2]];function sX(J){let $=J.vertical?C0.tileWidth:C0.tileLength,Q=J.vertical?C0.tileLength:C0.tileWidth;return{left:J.x-$/2,right:J.x+$/2,top:J.z-Q/2,bottom:J.z+Q/2}}var MR=C0.boardLimit,CR=C0.feltWidth/2-0.022;function iX(J,$,Q=MR){let Z=sX(J);if(Math.max(Math.abs(Z.left),Math.abs(Z.right),Math.abs(Z.top),Math.abs(Z.bottom))>Q+0.00000001)return!1;return $.every((K)=>{let W=sX(K);return Z.right<=W.left-0.0015||Z.left>=W.right+0.0015||Z.bottom<=W.top-0.0015||Z.top>=W.bottom+0.0015})}function CU(J,$,Q){let{tileLength:Z,tileWidth:K,tileGap:W}=C0,X=$.x===$.y,Y=(X?K:Z)/2,H=J.tile,U=[],G=[[J.dx,J.dz],[J.dz,-J.dx],[-J.dz,J.dx]];for(let F=0;F<G.length;F++){let[N,q]=G[F],O=F!==0,B=(H.isDouble?K:Z)/2,R=(H.isDouble?Z:K)/2,E=H.x+J.dx*(O?H.isDouble?0:Z/4:B),P=H.z+J.dz*(O?H.isDouble?0:Z/4:B),k=O?[0,Z/8,-Z/8]:[0];for(let V of k){let A=Math.atan2(-q,N)+(Q==="left"?Math.PI:0)+(X?Math.PI/2:0);U.push({id:$.id,x:E+N*((O?R:0)+W+Y)+J.dx*V,z:P+q*((O?R:0)+W+Y)+J.dz*V,yaw:A,vertical:Math.abs(Math.sin(A))>0.5,isDouble:X,dx:N,dz:q,side:Q})}}return U}function nX(J,$,Q,Z){let K={id:"future",x:0,y:Z?0:1};return CU({tile:J,dx:J.dx,dz:J.dz},K,Q).some((W)=>iX(W,$))}function PU(J,$=[]){return zU(J,$).placements}function IU(J,$=[]){let Q=zU(J,$);if(!Q.ends)return[];return["left","right"].map((Z)=>{let K=Q.ends[Z],W=K.tile,X=sX(W),Y=Math.abs(K.dx)*(X.right-X.left)/2+Math.abs(K.dz)*(X.bottom-X.top)/2,H=Y+0.013;return{x:W.x+K.dx*H,z:W.z+K.dz*H,dx:K.dx,dz:K.dz}})}function zU(J,$){if(J.length>28)throw Error("A double-six chain has at most 28 tiles.");if(!J.length)return{placements:[],ends:null};let Q=new Map(J.map((N)=>[N.id,N])),Z=$.filter((N)=>N.type==="play"&&N.tile&&Q.has(N.tile)),K=Q.get(Z[0]?.tile||"")||J[0],W=J.findIndex((N)=>N.id===K.id),X=K.x===K.y,Y={id:K.id,x:0,z:0,yaw:X?Math.PI/2:0,vertical:X,isDouble:X,dx:1,dz:0,side:"root"},H=[Y],U=new Map([[Y.id,Y]]),G={left:{tile:Y,dx:-1,dz:0},right:{tile:Y,dx:1,dz:0}},F=Z.length===J.length?Z.slice(1):[...J.slice(0,W).reverse().map((N)=>({type:"play",tile:N.id,side:"left"})),...J.slice(W+1).map((N)=>({type:"play",tile:N.id,side:"right"}))];for(let N of F){let q=Q.get(N.tile);if(U.has(q.id))continue;let O=N.side==="left"?"left":N.side==="right"?"right":J.findIndex((P)=>P.id===q.id)<W?"left":"right",B=CU(G[O],q,O),R=B.filter((P)=>iX(P,H));if(!R.length)R=B.filter((P)=>iX(P,H,CR));let E=R.find((P)=>nX(P,[...H,P],O,!1)&&nX(P,[...H,P],O,!0))||R.find((P)=>nX(P,[...H,P],O,!1))||R[0];if(!E)throw Error(`No safe placement for ${q.id} after ${H.length} tiles`);H.push(E),U.set(q.id,E),G[O]={tile:E,dx:E.dx,dz:E.dz}}return{placements:J.map((N)=>U.get(N.id)),ends:G}}function AU(J,$,Q=!1){if(Q)return{breath:0,headYaw:0,headNod:0};let Z=J*2.173+0.43;return{breath:0.0055*Math.sin($*(0.78+J*0.093)+Z),headYaw:0.087*Math.sin($*(0.213+J*0.037)+Z)+0.028*Math.sin($*(0.487+J*0.029)+Z*1.91),headNod:0.009*Math.sin($*(0.267+J*0.035)+Z*0.71)}}var _U=new S(1,0,0),z8=new S(0,1,0),oX=new K9;function $Y(J){let $=[];return J.traverse((Q)=>{if(Q.isBone)$.push({bone:Q,position:Q.position.clone(),quaternion:Q.quaternion.clone(),scale:Q.scale.clone()})}),$}var m8=new S,I8=new S,l8=new S,GJ=new S,Y7=new S,H8=new S,FJ=new S,EJ=new S,OJ=new K9,A8=new K9,kK=new K9,BK=new K9,_Q=(J)=>Math.min(1,Math.max(-1,J)),RJ=(J,$,Q)=>Math.min(Q,Math.max($,J)),h6=(J)=>J*J*(3-2*J);function Y6(J,$){J.getWorldQuaternion(A8),J.parent.getWorldQuaternion(kK),J.quaternion.copy(kK.invert()).multiply($).multiply(A8),J.updateMatrixWorld(!0)}var b6=new S,N8=new S;function PR(J){J.holder.getWorldQuaternion(BK),b6.set(1,0,0).applyQuaternion(BK),N8.set(0,0,1).applyQuaternion(BK)}function eX(J,$,Q,Z,K){return K.set($,Q,Z).applyMatrix4(J.holder.matrixWorld)}function aX(J,$,Q,Z){return Z.set(J,$,Q).applyQuaternion(BK).normalize()}var IR=0.965;function zR(J,$,Q){let{brazo:Z,antebrazo:K,mano:W}=J;if(!Z||!K||!W||!Z.parent||!K.parent)return;Z.getWorldPosition(m8),K.getWorldPosition(I8),W.getWorldPosition(l8);let X=m8.distanceTo(I8),Y=I8.distanceTo(l8);if(X<0.00001||Y<0.00001)return;let H=RJ(m8.distanceTo($),Math.abs(X-Y)+0.002,(X+Y)*IR);if(Y7.subVectors(I8,m8),H8.subVectors(l8,I8),FJ.crossVectors(Y7,H8),FJ.lengthSq()<0.0000000001)FJ.copy(b6);else FJ.normalize();let U=Math.acos(_Q((X*X+Y*Y-m8.distanceToSquared(l8))/(2*X*Y))),F=Math.acos(_Q((X*X+Y*Y-H*H)/(2*X*Y)))-U;if(Y6(K,OJ.setFromAxisAngle(FJ,F)),W.getWorldPosition(l8),Math.abs(m8.distanceTo(l8)-H)>0.001)Y6(K,OJ.setFromAxisAngle(FJ,-2*F)),W.getWorldPosition(l8);if(Y7.subVectors(l8,m8).normalize(),H8.subVectors($,m8),H8.lengthSq()<0.0000000001)return;if(H8.normalize(),Y6(Z,OJ.setFromUnitVectors(Y7,H8)),!Q)return;if(K.getWorldPosition(I8),EJ.subVectors(I8,m8),EJ.addScaledVector(H8,-EJ.dot(H8)),GJ.subVectors(Q,m8),GJ.addScaledVector(H8,-GJ.dot(H8)),EJ.lengthSq()<0.0000000001||GJ.lengthSq()<0.0000000001)return;EJ.normalize(),GJ.normalize();let N=Math.atan2(FJ.crossVectors(EJ,GJ).dot(H8),_Q(EJ.dot(GJ)));Y6(Z,OJ.setFromAxisAngle(H8,N))}var l6=new S,R$=new S,CQ=new S,AR=new $9,rX=new K9,PQ=new K9;function _R(J,$,Q){let{antebrazo:Z,mano:K}=J;if(!Z||!K||!K.parent)return;if(l6.copy($).normalize(),CQ.crossVectors(l6,Q),CQ.lengthSq()<0.00000001)return;CQ.normalize(),R$.crossVectors(CQ,l6),rX.setFromRotationMatrix(AR.makeBasis(CQ,l6,R$)),Z.getWorldPosition(I8),K.getWorldPosition(l8),Y7.subVectors(l8,I8).normalize(),K.getWorldQuaternion(A8),PQ.copy(rX).multiply(A8.invert());let W=PQ.x*Y7.x+PQ.y*Y7.y+PQ.z*Y7.z,X=2*Math.atan2(W,PQ.w);if(Number.isFinite(X))Y6(Z,OJ.setFromAxisAngle(Y7,RJ(X*0.5,-1.2,1.2)));K.parent.getWorldQuaternion(kK),K.quaternion.copy(kK.invert()).multiply(rX),K.updateMatrixWorld(!0)}var TR=new S;function SR(J,$,Q){let Z=$.lado==="Left"?1:-1,K=J.index*1.7,W=C0.seatDistance-C0.tableWidth/2;return eX(J,Z*(0.225+Math.sin(K)*0.01)+Math.sin(Q*0.23+K)*0.004,C0.surfaceY+0.026,W+(Z>0?0.035:0.06)+Math.cos(K*1.3)*0.012+Math.sin(Q*0.17+K*2)*0.004,TR)}var wR=new S,q$=new S,DK=new S,EK=new S,jR=0.045,yR=0.05,vR=0.12,fR=0.14,bR=0.45,hR=4;function TU(J,$,Q){return EK.subVectors($,J.holder.getWorldPosition(DK)),EK.y=0,EK.normalize(),Q.copy($).addScaledVector(EK,-yR).setY($.y+jR)}function xR(J,$,Q){let Z=J.jugada;if(!Z)return null;if($-Z.t0>hR)return J.jugada=null,null;let K=Z.anim;if(K.elapsed<K.duration)return TU(J,Z.obj.position,q$),q$.lerpVectors(Q,q$,h6(RJ(K.elapsed/vR,0,1)));if(Z.aterrizo==null)Z.aterrizo=$;let W=$-Z.aterrizo;TU(J,Z.hasta,q$);let X=K.golpe?0.7:fR;if(W<X)return q$;let Y=(W-X)/bR;if(Y>=1)return J.jugada=null,null;return q$.lerp(Q,h6(Y))}var F9=[1,2.2,3.5,4.7,5.6],SU=-1e9;function gR(J,$,Q){let Z=J.bebida;if(!Z)return null;if(J.trago){let W=J.trago.fijo??$-J.trago.t0;if(W<0||W>=F9[4]||J.jugada)return J.trago=null,bU(Z),J.sed=$+90+Math.random()*150,null;return W}if(!Q||!Q.dt)return null;if(J.sed==null)return J.sed=$+20+Math.random()*100,null;if($<J.sed||$-SU<20)return null;let K=J.index;if(J.jugada||Q.jugando&&Q.turno===K||Q.habla.has(K)||Q.fin&&$-Q.fin.t<6)return J.sed=$+3+Math.random()*8,null;return SU=$,J.trago={t0:$},0}function bU(J){J.group.position.copy(J.home),J.group.quaternion.identity()}var JY=0.07,P8=new S,qJ=new S,O$=new S,IQ=new S,wU=new S;function jU(J,$,Q,Z){let K=J.bebida;if(O$.copy(N8).addScaledVector(z8,0.25).normalize(),IQ.copy(N8).multiplyScalar(0.55).addScaledVector(z8,0.8).normalize(),qJ.copy(K.home),qJ.y+=K.alto,qJ.addScaledVector(b6,-(K.radio+0.015)).addScaledVector(O$,-JY),J.bocaMundo)J.bocaMundo(P8),P8.addScaledVector(N8,0.006);else J.front.getWorldPosition(P8),P8.y-=0.075,P8.addScaledVector(N8,0.012);let W=K.inclina;wU.copy(z8).multiplyScalar(Math.cos(W)).addScaledVector(N8,-Math.sin(W)),P8.addScaledVector(wU,-K.boca).addScaledVector(b6,-(K.radio+0.015)).addScaledVector(IQ,-JY);let X=J.trago;if(X){if($<F9[2])(X.boca??=new S).copy(P8);else if(X.boca)P8.copy(X.boca)}let Y;if($<F9[0])qK(Q,qJ,0.045,0.5,h6($/F9[0]),Z),Y=O$;else if($<F9[1]){let H=h6(($-F9[0])/(F9[1]-F9[0]));qK(qJ,P8,0.1,0.25,H,Z),Y=O$.lerp(IQ,H).normalize()}else if($<F9[2])Z.copy(P8),Y=IQ;else if($<F9[3]){let H=h6(($-F9[2])/(F9[3]-F9[2]));qK(qJ,P8,0.1,0.25,1-H,Z),Y=IQ.lerp(O$,H).normalize()}else qK(Q,qJ,0.045,0.5,1-h6(($-F9[3])/(F9[4]-F9[3])),Z),Y=O$;return Y}var zQ=new S;function qK(J,$,Q,Z,K,W){zQ.lerpVectors(J,$,Z),zQ.y=Math.max(J.y,$.y*Z+J.y*(1-Z))+Q;let X=1-K;return W.set(X*X*J.x+2*X*K*zQ.x+K*K*$.x,X*X*J.y+2*X*K*zQ.y+K*K*$.y,X*X*J.z+2*X*K*zQ.z+K*K*$.z)}function pR(J){return J<F9[0]?h6(Math.min(1,J/(F9[0]*0.85))):J<F9[3]?1:1-h6(Math.min(1,(J-F9[3])/((F9[4]-F9[3])*0.85)))}var yU=new S,vU=new S,fU=new S;function mR(J,$){let Q=J.bebida,Z=J.brazos[1].mano;if($<F9[0]||$>=F9[3]){bU(Q);return}Z.getWorldQuaternion(A8),Z.getWorldPosition(MK),yU.set(0,0,1).applyQuaternion(A8),vU.set(0,1,0).applyQuaternion(A8);let K=$<F9[1]?h6(($-F9[0])/(F9[1]-F9[0])):$<F9[2]?1:1-h6(($-F9[2])/(F9[3]-F9[2]));Q.group.quaternion.setFromAxisAngle(b6,-Q.inclina*K),fU.set(0,1,0).applyQuaternion(Q.group.quaternion),Q.group.position.copy(MK).addScaledVector(yU,Q.radio+0.015).addScaledVector(vU,JY).addScaledVector(fU,-Q.alto);let W=Math.min(1,($-F9[0])/0.2,(F9[3]-$)/0.2);if(W<1){let X=h6(Math.max(0,W));Q.group.position.lerpVectors(Q.home,Q.group.position,X),Q.group.quaternion.slerpQuaternions(lR.identity(),Q.group.quaternion,X)}}var lR=new K9;function uR(J,$,Q){let Z=J.cara;if(!Z)return 0;if(J.proxParpadeo==null)J.proxParpadeo=$+1+Math.random()*4;if($>=J.proxParpadeo)J.parpadeoT0=$,J.proxParpadeo=$+(Math.random()<0.15?0.32:2+Math.random()*4);let K=$-(J.parpadeoT0??-9),W=K<0?0:K<0.06?K/0.06:K<0.09?1:K<0.16?1-(K-0.09)/0.07:0;if(J.caraFija){let U=J.caraFija,G=Z.mesh.morphTargetInfluences;if(G)G[Z.iP]=U.p*0.85,G[Z.iS]=U.s;return J.parpadeo=U.p,U.p}let X=J.index,Y=0;if(Q?.fin&&Q.fin.team!=null&&$-Q.fin.t<5&&$>=Q.fin.t)Y=X%2===Q.fin.team?0.95:-0.7;else if(Q?.habla?.has(X))Y=Q.hablaTipo?.get(X)==="win"?0.85:0.2;else{if(J.casual==null)J.casual=$+8+Math.random()*30;if($>J.casual+2.5)J.casual=$+15+Math.random()*45;if($>=J.casual)Y=0.45}J.sonrisa=(J.sonrisa??0)+(Y-(J.sonrisa??0))*(1-Math.exp(-(Q?.dt||0.016)*3.5));let H=Z.mesh.morphTargetInfluences;if(H)H[Z.iP]=W*0.85,H[Z.iS]=J.sonrisa;return J.parpadeo=W,W}function dR(J,$){let Q=J.index,Z=0.23+Q%4*0.012,K=$*Z*Math.PI*2+Q*1.9,W=Math.sin(K);return{b:W>0?W:W*0.7,balanceo:Math.sin($*0.11+Q*2.3)*0.022+Math.sin($*0.29+Q)*0.008,ladeo:Math.sin($*0.07+Q*1.3)*0.014}}var tX=new S,OK=new S,U8=new S,T7=new S,_8=new S,m6=new K9,RK=(J)=>{let $=Math.sin(J*127.1+311.7)*43758.5453;return $-Math.floor($)};function cR(J,$,Q,Z){let K=J.index;if(K>=4||!Q)return Q?.foco&&$-Q.foco.t<2.5?Z.copy(Q.foco.p):Z.set(0,C0.surfaceY,0);if(Q.fin&&$-Q.fin.t<5){if(Q.fin.team!=null&&K%2===Q.fin.team&&Q.cabezas[(K+2)%4])return Z.copy(Q.cabezas[(K+2)%4]);return eX(J,0,C0.surfaceY,C0.seatDistance-C0.rackRadius,Z)}if(J.trago&&J.bebida){let Y=J.trago.fijo??$-J.trago.t0;if(Y<F9[0]+0.1||Y>F9[2]+0.5&&Y<F9[3]+0.1)return Z.copy(J.bebida.home);if(Y<=3.4)return J.head.getWorldPosition(Z),Z.addScaledVector(N8,1).addScaledVector(z8,-0.15)}{let Y=Q.saludo;if(Y&&(Y.seat===K||Y.e<(Y.seat==null?3:1.6)))return Z.copy(Y.p)}if(Q.foco&&$-Q.foco.t<1.4)return Z.copy(Q.foco.p);for(let Y of Q.habla)if(Y!==K&&Q.cabezas[Y])return Z.copy(Q.cabezas[Y]);if(Q.jugando&&Q.turno===K){let Y=Math.floor($/1.3);return eX(J,(RK(Y+K*9)-0.5)*0.12,C0.surfaceY+0.02,C0.seatDistance-C0.rackRadius+0.02,Z)}let W=Math.floor(($+K*1.37)/(2.2+K*0.35)),X=RK(W*4+K);if(Q.jugando&&X<0.45&&Q.cabezas[Q.turno]&&Q.turno!==K)return Z.copy(Q.cabezas[Q.turno]);if(X<0.62&&Q.cabezas[(K+2)%4])return Z.copy(Q.cabezas[(K+2)%4]);if(!Q.jugando&&X<0.85&&Q.cabezas[(K+1+W%2*2)%4])return Z.copy(Q.cabezas[(K+1+W%2*2)%4]);return Z.set((RK(W+7)-0.5)*0.2,C0.surfaceY,(RK(W+3)-0.5)*0.2)}function nR(J,$,Q){let{head:Z,neck:K,front:W}=J;if(!Z||!W)return;if(cR(J,$,Q,tX),!J.mirada||!Q?.dt)J.mirada=(J.mirada||new S).copy(tX);else J.mirada.lerp(tX,1-Math.exp(-Q.dt*5.5));for(let[X,Y]of[[K,0.4],[Z,1]]){if(!X)continue;if(Z.getWorldPosition(OK),W.getWorldPosition(U8),U8.sub(OK),U8.lengthSq()<0.0000000001)return;if(U8.normalize(),T7.subVectors(J.mirada,OK),T7.lengthSq()<0.00000001)return;T7.normalize();let H=RJ(Math.atan2(U8.z*T7.x-U8.x*T7.z,U8.x*T7.x+U8.z*T7.z),-1.25,1.25)*Y;if(Y6(X,OJ.setFromAxisAngle(z8,H)),W.getWorldPosition(U8),U8.sub(OK).normalize(),_8.crossVectors(U8,z8),_8.lengthSq()<0.00000001)continue;_8.normalize();let U=RJ(Math.asin(_Q(T7.y))-Math.asin(_Q(U8.y)),-0.75,0.55)*Y;Y6(X,OJ.setFromAxisAngle(_8,U))}}var sR=0.23,iR=[["lomo",0.4],["spine",0.34],["chest",0.26]],CD=new K9;function oR(J,$,Q=0){if(!J.spine||!J.spine.parent)return;if(_8.copy(b6),J.hips&&J.lomo)for(let[Z,K]of iR){let W=J[Z];if(!W)continue;Y6(W,m6.setFromAxisAngle(_8,$*K))}else Y6(J.spine,m6.setFromAxisAngle(_8,$));if(Q)Y6(J.spine,m6.setFromAxisAngle(z8,Q))}var LK=new S,VK=new S,AQ=new S,MK=new S;function CK(J,$,Q=!1,Z=null){for(let O of J.pose)O.bone.position.copy(O.position),O.bone.quaternion.copy(O.quaternion),O.bone.scale.copy(O.scale);J.holder.updateMatrixWorld(!0),PR(J);let K=AU(J.index,$,Q);if(J.spine)J.spine.quaternion.multiply(oX.setFromAxisAngle(_U,K.breath));let W=!Q,X=W?dR(J,$):{b:0,balanceo:0,ladeo:0},Y=J.index,H=Y<4&&J.brazos,U=0,G=0;if(H&&Z?.fin&&Z.fin.team!=null){let O=$-Z.fin.t;if(O>=0&&O<5)G=Math.sin(Math.min(1,O/0.5)*Math.PI/2)*(O>4?5-O:1),U+=(Y%2===Z.fin.team?-0.1:0.07)*G}if(H&&Z?.jugando&&Z.turno===Y)U+=0.04;let F=H&&W&&J.front?gR(J,$,Z):null,N=[];if(H)for(let O of J.brazos){let B=wR.copy(SR(J,O,$)),R=O.lado==="Right"?xR(J,$,B):null,E=!!R,P=null;if(!R&&F!=null&&O.lado==="Right")R=DK.set(0,0,0),P=jU(J,F,B,R).clone();if(R=(R||B).clone(),!E&&W&&Z?.habla?.has(Y)&&O.lado==="Left"&&!J.clipHabla)J.gesto=Math.min(1,(J.gesto||0)+(Z.dt||0)*3);else if(O.lado==="Left")J.gesto=Math.max(0,(J.gesto||0)-(Z?.dt||1)*2);if(O.lado==="Left"&&J.gesto>0){let k=h6(J.gesto);R.addScaledVector(N8,0.06*k).addScaledVector(b6,-0.07*k),R.y+=0.07*k+Math.sin($*5.2)*0.012*k}if(O.lado==="Right"&&!E&&G&&Y%2===Z.fin.team){let k=$-Z.fin.t;if(k<1.1)R.y+=Math.max(0,Math.sin(Math.min(1,k/0.9)*Math.PI))*0.13}N.push({brazo:O,o:R,jugando:E,dedos:P,reposo:B.clone()})}let q=0;if(H){let O=N.find((B)=>B.jugando);if(O&&O.brazo.brazo){J.holder.worldToLocal(AQ.copy(O.o));let B=Math.hypot(AQ.x,AQ.z-0.12);U+=RJ((B-0.42)/0.55,0,0.34),q=RJ(Math.atan2(AQ.x,AQ.z)*0.3,-0.3,0.3)}}if(oR(J,sR*(J.brazos?1:0.6)+U,q),F!=null){let O=(R,E)=>Math.max(0,1-Math.abs(F-R)/E),B=h6(Math.max(O(F9[0],0.9),O(F9[3],0.9)));if(J.spine)Y6(J.spine,m6.setFromAxisAngle(N8,0.16*B))}if(W){if(J.spine)Y6(J.spine,m6.setFromAxisAngle(z8,X.balanceo));if(J.spine)Y6(J.spine,m6.setFromAxisAngle(N8,X.ladeo));if(J.chest)Y6(J.chest,m6.setFromAxisAngle(b6,-0.018*X.b));if(J.hombros){for(let[O,B]of J.hombros)if(B)Y6(B,m6.setFromAxisAngle(N8,O*0.03*(X.b+0.3)))}}if(nR(J,$,Z),uR(J,$,Z),J.head)J.head.quaternion.multiply(oX.setFromAxisAngle(z8,K.headYaw*0.5)),J.head.quaternion.multiply(oX.setFromAxisAngle(_U,K.headNod)),J.head.updateMatrixWorld(!0);if(W&&J.head){if(Z?.habla?.has(Y)){let O=0.035*(0.6+0.4*Math.sin($*1.7));Y6(J.head,m6.setFromAxisAngle(b6,Math.sin($*6.1)*O*0.5+Math.sin($*3.3)*O*0.5))}if(G&&Y%2!==Z.fin.team){let O=$-Z.fin.t;if(O>0.6&&O<2.6)Y6(J.head,m6.setFromAxisAngle(z8,Math.sin((O-0.6)*Math.PI*2.4)*0.16*(2.6-O)/2))}}if(F!=null&&F>F9[1]-0.2&&F<F9[2]+0.2&&J.head){let O=Math.sin(Math.min(1,(F-F9[1]+0.2)/(F9[2]-F9[1]+0.4))*Math.PI);Y6(J.head,m6.setFromAxisAngle(b6,-0.3*O))}if(W&&J.reaction&&J.head){let O=$-J.reaction.time;if(O>=0&&O<1.2){let B=Math.sin(O/1.2*Math.PI)*0.035;Y6(J.head,m6.setFromAxisAngle(b6,B))}}for(let{brazo:O,o:B,jugando:R,dedos:E,reposo:P}of N){if(E)E.copy(jU(J,F,P,B));let k=O.lado==="Left"?1:-1;O.brazo.getWorldPosition(LK);let V=E?pR(F):0;if(V>0)LK.add(aX(k*0.32,-0.75,-0.6,VK).lerp(aX(k*0.45,-0.85,0.25,DK),V));else LK.add(aX(k*(R?0.55:0.32),-0.75,R?-0.15:-0.6,VK));if(zR(O,B,LK),O.antebrazo.getWorldPosition(I8),O.mano.getWorldPosition(MK),l6.subVectors(MK,I8),l6.y=0,l6.lengthSq()<0.00000001)l6.copy(N8);if(l6.normalize(),l6.addScaledVector(b6,-k*(R?0:0.12)).normalize(),l6.y=R?-0.55:-0.3,R$.set(0,-1,0).addScaledVector(b6,-k*0.22),O.lado==="Left"&&J.gesto>0){let A=h6(J.gesto);R$.lerp(VK.copy(b6).multiplyScalar(-1).add(DK.set(0,0.4,0)),A*0.8),l6.y+=0.4*A}if(E)l6.lerp(E,V).normalize(),R$.lerp(VK.copy(b6).addScaledVector(z8,-0.15),V).normalize();if(_R(O,l6,R$),E)mR(J,F);if(W&&!R&&!E&&O.lado==="Right"&&J.toque&&$-J.toque.t0<0.7){let A=$-J.toque.t0;O.mano.getWorldQuaternion(A8),_8.set(1,0,0).applyQuaternion(A8),Y6(O.mano,m6.setFromAxisAngle(_8,-0.5*Math.max(0,Math.sin(A/0.7*Math.PI*4))))}else if(W&&!R&&!E&&O.lado==="Right"&&!(Z?.turno===Y&&Z?.jugando)){let A=4.6+Y*0.9,w=($+Y*1.3)%A;if(w<0.55)O.mano.getWorldQuaternion(A8),_8.set(1,0,0).applyQuaternion(A8),Y6(O.mano,m6.setFromAxisAngle(_8,-0.22*Math.max(0,Math.sin(w/0.55*Math.PI*4))))}}if(W)JL(J,$,Z,F);J.holder.updateMatrixWorld(!0)}var aR=["LeftShoulder","LeftArm","LeftForeArm","LeftHand","RightShoulder","RightArm","RightForeArm","RightHand"],rR=["Spine01","Spine","neck","Head"],A6=new K9,tR=new K9,eR=new K9;function JL(J,$,Q,Z){let K=J.clipHabla;if(!K||!J.brazos)return;let W=!!(Q?.habla?.has(J.index)&&!J.jugada&&Z==null),X=Q?.dt||0;J.wHabla=Math.max(0,Math.min(1,(J.wHabla||0)+(W?X/0.5:-X/0.3)));let Y=h6(J.wHabla);if(Y<=0)return;if(!J.pistasHabla){J.pistasHabla=[];for(let U of K.tracks){let[G,F]=U.name.split("."),N=aR.includes(G);if(F!=="quaternion"||!(N||rR.includes(G)))continue;let q=J.root.getObjectByName(G),O=U.createInterpolant();if(!q)continue;let B=new K9(0,0,0,0),R=16;for(let E=0;E<R;E++){if(A6.fromArray(O.evaluate(K.duration*E/R)),B.x*A6.x+B.y*A6.y+B.z*A6.z+B.w*A6.w<0)A6.set(-A6.x,-A6.y,-A6.z,-A6.w);B.set(B.x+A6.x,B.y+A6.y,B.z+A6.z,B.w+A6.w)}J.pistasHabla.push({bone:q,it:O,abs:N,ref:B.normalize().invert()})}}let H=($+J.index*1.7)%K.duration;for(let U of J.pistasHabla)if(A6.fromArray(U.it.evaluate(H)),U.abs)U.bone.quaternion.slerp(A6,Y);else U.bone.quaternion.multiply(eR.identity().slerp(tR.copy(U.ref).multiply(A6),Y))}function hU({scene:J,texture:$,mat:Q,box:Z,cylinder:K,random:W,teal:X,wood:Y,storeSign:H}){let U=$((D,L,M)=>{D.fillStyle="#e0d3b4",D.fillRect(0,0,L,M);let s=D.createLinearGradient(0,0,0,M);s.addColorStop(0,"#cac09b18"),s.addColorStop(0.7,"#14382d00"),s.addColorStop(1,"#162d2566"),D.fillStyle=s,D.fillRect(0,0,L,M);for(let b=0;b<7000;b++)D.fillStyle=b%3?"#b4ad8618":"#142d2924",D.fillRect(W()*L,W()*M,1+W()*3,1+W()*2);for(let b=0;b<70;b++){let u=W()*L,e=b<50?M*(0.72+W()*0.28):W()*M,v=5+W()*14;D.fillStyle=b%3?"rgba(160,145,112,.35)":"rgba(120,110,90,.25)",D.beginPath();for(let j=0;j<8;j++){let g=j*Math.PI/4,f=v*(0.6+W()*0.5);D.lineTo(u+Math.cos(g)*f,e+Math.sin(g)*f*0.65)}D.fill()}D.strokeStyle="#1b372e24";for(let b=48;b<M;b+=57)D.beginPath(),D.moveTo(0,b),D.lineTo(L,b),D.stroke()},1024,1024);X.map=U,X.color.set("#f2ecde"),X.needsUpdate=!0,Y.color.set("#bca98a"),Y.roughness=0.84;let G=()=>{H.material.map=$((D,L,M)=>{D.fillStyle="#efe3c4",D.fillRect(0,0,L,M);for(let u=0;u<2600;u++)D.fillStyle=u%2?"rgba(120,100,70,.07)":"rgba(255,250,235,.08)",D.fillRect(W()*L,W()*M,2+W()*14,1+W()*2);let s=document.fonts?.check?.("64px Shrikhand")?"Shrikhand":"Georgia",b=s==="Shrikhand"?M*0.66:M*0.56;D.font=`${b}px ${s}`,D.textAlign="center",D.textBaseline="middle",D.fillStyle="#c8402f",D.fillText("Colmado La Esquina",L/2+b*0.06,M/2+b*0.1),D.fillStyle="#24518a",D.fillText("Colmado La Esquina",L/2,M/2+b*0.04),D.strokeStyle="#3d938e",D.lineWidth=12,D.strokeRect(6,6,L-12,M-12);for(let u=0;u<1400;u++)D.fillStyle="rgba(239,227,196,.35)",D.fillRect(W()*L,W()*M,1+W()*3,1+W()*2)},2048,162),H.material.emissiveMap=H.material.map,H.material.needsUpdate=!0};H.material=new o0({roughness:0.9,emissive:"#ffffff",emissiveIntensity:0.1}),G(),document.fonts?.load?.("64px Shrikhand").then(G).catch(()=>{});for(let[D,L]of[[-2.7,-3.5],[2.4,-3.3]])Z(D,0.18,L,0.51,0.35,0.4,"#897052"),Z(D+0.05,0.47,L-0.04,0.4,0.23,0.32,"#a68c62");let F=(D,L,M)=>{let s=document.createElement("canvas");s.width=D,s.height=L;let b=new a6(s);b.colorSpace=W6,b.anisotropy=4;let u=()=>{let e=s.getContext("2d"),v=document.fonts?.check?.("64px Shrikhand"),j=document.fonts?.check?.('700 40px "DM Sans"')?'"DM Sans",':"";e.fillStyle="#233a2d",e.fillRect(0,0,D,L);for(let g=0;g<70;g++)e.fillStyle=`rgba(225,225,195,${0.015+W()*0.03})`,e.beginPath(),e.ellipse(W()*D,W()*L,D*(0.04+W()*0.14),L*(0.015+W()*0.045),W()*3,0,Math.PI*2),e.fill();e.textAlign="center",e.textBaseline="middle",e.lineCap="round";for(let[g,f,o,p,r]of M){if(g==="—"){e.strokeStyle="rgba(225,225,195,.45)",e.lineWidth=6,e.beginPath(),e.moveTo(D*0.17,f+3),e.quadraticCurveTo(D/2,f-5,D*0.83,f+1),e.stroke();continue}e.font=p==="titulo"?v?`${o}px Shrikhand`:`bold ${o*0.95}px Georgia`:`${p} ${o}px ${j}sans-serif`;let X0=e.measureText(g).width,M0=D*0.84;if(e.save(),e.translate(D/2,f),X0>M0)e.scale(M0/X0,1);e.fillStyle=r;for(let y=0;y<3;y++)e.globalAlpha=y?0.4:0.75,e.fillText(g,(W()-0.5)*3,(W()-0.5)*3);e.restore()}for(let g=0;g<D*L/40;g++)e.fillStyle="rgba(35,58,45,.5)",e.fillRect(W()*D,W()*L,1+W()*2,1+W());e.strokeStyle="#9c8c62",e.lineWidth=D*0.04,e.strokeRect(D*0.02,D*0.02,D-D*0.04,L-D*0.04),e.strokeStyle="rgba(60,40,20,.35)",e.lineWidth=4,e.strokeRect(D*0.04,D*0.04,D-D*0.08,L-D*0.08),b.needsUpdate=!0};return u(),Promise.all([document.fonts?.load?.("64px Shrikhand"),document.fonts?.load?.('700 40px "DM Sans"')]).then(u).catch(()=>{}),new o0({roughness:1,map:b,emissive:"#ffffff",emissiveMap:b,emissiveIntensity:0.06})},N="#ece7cc",q="#e9b35a",O="#a9d3dd";{let D=new _0(new B9(0.72,0.69),F(768,736,[["HOY HAY",110,74,"titulo",N],["CAFÉ",262,78,800,N],["HIELO · PAN",388,66,800,"#dcd9b8"],["—",478],["REFRESCOS",572,60,700,O]]));D.position.set(-3.43,1.6,-2.33),D.rotation.z=0.025,J.add(D),Z(-3.43,1.245,-2.315,0.66,0.018,0.05,"#8a7a55"),Z(-3.28,1.262,-2.31,0.06,0.016,0.016,"#efeadb")}{let D=document.documentElement.lang==="en",L=new S9,M=Q("#6b4a2e",0.8);L.position.set(-2,0,-2.1),L.rotation.y=0.5,J.add(L);let u=new _0(new B9(0.56,0.72),F(560,720,[[D?"COMING":"YA",96,92,"titulo",q],[D?"SOON":"VIENE",206,92,"titulo",q],["—",282],[D?"1 vs 1":"1 contra 1",372,80,800,N],[D?"Online":"En línea",478,80,800,N],[D?"your people,":"tu gente,",576,50,600,O],[D?"from anywhere":"de donde sea",636,50,600,O]])),e=new S9;e.rotation.x=-0.2,L.add(e),u.position.set(0,0.44,0.012),e.add(u);{let j=new _0(new w9(0.56,0.72,0.012),M);j.position.set(0,0.44,0),e.add(j)}for(let[j,g,f,o]of[[-0.29,0.42000000000000004,0.035,0.88],[0.29,0.42000000000000004,0.035,0.88],[0,0.8500000000000001,0.62,0.035],[0,0.03,0.62,0.035]]){let p=new _0(new w9(f,o,0.022),M);p.position.set(j,g,0),e.add(p)}let v=new S9;v.position.z=-0.32,v.rotation.x=0.2,L.add(v);for(let j of[-0.27,0.27]){let g=new _0(new w9(0.03,0.8600000000000001,0.02),M);g.position.set(j,0.43000000000000005,-0.02),v.add(g)}L.traverse((j)=>{if(j.isMesh)j.castShadow=!0,j.receiveShadow=!0})}let B=[],R=z6.tope,E=z6.z;Z(-1.12,R+0.11,E+0.24,0.42,0.21,0.31,"#677761"),Z(-1.12,R+0.13,E+0.404,0.34,0.1,0.016,"#414b3d"),Z(-0.38,R+0.02,E+0.26,0.3,0.018,0.22,"#c5b887");for(let[D,L,M]of[[0.7,E+0.21,"#8b7747"],[0.98,E+0.17,"#637751"],[1.29,E+0.22,"#a88b50"]])K(D,R+0.12,L,0.07,0.075,0.25,M,14),K(D,R+0.259,L,0.077,0.077,0.028,"#aaa386",12);Z(0.2,R+0.03,E+0.23,0.4,0.07,0.28,"#6c5838");for(let D=0;D<4;D++){let L=new _0(new D6(1,10,6),Q(D%2?"#bca276":"#a98e61"));L.scale.set(0.055,0.035,0.115),L.position.set(0.07+D*0.085,R+0.09,E+0.24),L.rotation.y=(D-1.5)*0.13,J.add(L)}let P=new p9({transparent:!0,depthWrite:!1,map:$((D,L,M)=>{for(let s=0;s<90;s++)D.fillStyle=s%2?"#152c2110":"#3036230a",D.beginPath(),D.ellipse(L/2+(W()-0.5)*L*0.45,M/2+(W()-0.5)*M*0.45,W()*L*0.24,W()*M*0.18,W()*Math.PI,0,Math.PI*2),D.fill()},256,256)});for(let[D,L,M,s]of[[-2.4,-2.2,1.1,0.9],[2.5,-2.5,1.3,0.8],[0,-3.25,2,0.6]]){let b=new _0(new B9(M,s),P);b.rotation.x=-Math.PI/2,b.position.set(D,0.008,L),J.add(b)}for(let[D,L]of[[-3,-0.9],[3.3,-1.5]]){K(D,0.18,L,0.18,0.13,0.34,"#87553c",14),K(D,0.354,L,0.16,0.16,0.012,"#3f422d",12);let M=new S9;M.position.set(D,0.36,L),J.add(M);for(let s=0;s<7;s++){let b=new NQ;b.moveTo(0,0),b.quadraticCurveTo(-0.09,0.23,0,0.55+W()*0.12),b.quadraticCurveTo(0.09,0.23,0,0);let u=new _0(new FQ(b,5),new o0({color:s%2?"#597d4f":"#3c603e",roughness:1,side:i9}));u.rotation.set(0.3+W()*0.4,s*Math.PI*2/7,0),M.add(u)}B.push(M)}let k=new B9(0.55,1.3,5,9),V=new _0(k,new o0({color:"#b2a27c",roughness:1,side:i9}));V.position.set(-2.85,1.75,-3.05),J.add(V);let A=k.attributes.position,w=A.array.slice();return{update(D){B.forEach((L,M)=>L.rotation.z=Math.sin(D*0.53+M*2.1)*0.015);for(let L=0;L<A.count;L++){let M=w[L*3+1];A.setZ(L,Math.sin(D*1.17+M*3)*0.025*(0.65-M)/1.3)}A.needsUpdate=!0}}}function xU({scene:J,texture:$,mat:Q,box:Z,cylinder:K,staticGeo:W,random:X}){let Y=(I=0,x=0,d=0)=>new S(I,x,d),H=(I,x,d,K0,t,D0,R0=5000)=>{I.fillStyle=K0,I.fillRect(0,0,x,d);for(let P0=0;P0<R0;P0++)I.fillStyle=X()>0.5?t:D0,I.fillRect(X()*x,X()*d,1+X()*4,1+X()*3)},U=[];function G(I,{w:x=1024,h:d=256,fondo:K0="#efe3c4",tinta:t="#24518a",sombra:D0="#c8402f",borde:R0=null,px:P0=0.62}={}){let L0=document.createElement("canvas");L0.width=x,L0.height=d;let l0=new a6(L0);l0.colorSpace=W6;let W9=()=>{let t0=L0.getContext("2d"),X9=document.fonts?.check?.("64px Shrikhand")?"Shrikhand":"Georgia";if(K0){t0.fillStyle=K0,t0.fillRect(0,0,x,d);for(let m9=0;m9<x*1.2;m9++)t0.fillStyle=m9%2?"rgba(120,100,70,.07)":"rgba(255,250,235,.08)",t0.fillRect(Math.random()*x,Math.random()*d,2+Math.random()*12,1+Math.random()*2)}else t0.clearRect(0,0,x,d);let k9=d*P0;t0.font=`${k9}px ${X9}`;let L9=t0.measureText(I).width;if(L9>x*0.9)k9*=x*0.9/L9,t0.font=`${k9}px ${X9}`;t0.textAlign="center",t0.textBaseline="middle";let m=k9*0.06;if(D0)t0.fillStyle=D0,t0.fillText(I,x/2+m,d/2+m+k9*0.04);if(t0.fillStyle=t,t0.fillText(I,x/2,d/2+k9*0.04),R0)t0.strokeStyle=R0,t0.lineWidth=d*0.07,t0.strokeRect(t0.lineWidth/2,t0.lineWidth/2,x-t0.lineWidth,d-t0.lineWidth);for(let m9=0;m9<x*0.5;m9++)t0.fillStyle=K0?"rgba(239,227,196,.3)":"rgba(0,0,0,0)",t0.fillRect(Math.random()*x,Math.random()*d,1+Math.random()*3,1+Math.random()*2);l0.needsUpdate=!0};return W9(),U.push(W9),l0}document.fonts?.load?.("64px Shrikhand").then(()=>U.forEach((I)=>I())).catch(()=>{});let F=new o0({roughness:0.93,map:$((I,x,d)=>{H(I,x,d,"#e3d6b8","rgba(255,250,236,.10)","rgba(120,100,70,.08)");let K0=I.createLinearGradient(0,0,0,d);K0.addColorStop(0,"rgba(90,70,50,.12)"),K0.addColorStop(0.18,"rgba(90,70,50,0)"),K0.addColorStop(0.8,"rgba(90,70,50,0)"),K0.addColorStop(1,"rgba(90,70,50,.2)"),I.fillStyle=K0,I.fillRect(0,0,x,d);for(let t=0;t<22;t++){let D0=X()*x,R0=d*(0.08+X()*0.3),P0=I.createLinearGradient(0,0,0,R0);P0.addColorStop(0,"rgba(80,70,55,.2)"),P0.addColorStop(1,"rgba(80,70,55,0)"),I.fillStyle=P0,I.fillRect(D0,0,3+X()*8,R0)}},512,512)}),N=new o0({roughness:0.9,map:$((I,x,d)=>{H(I,x,d,"#3f9a96","rgba(200,240,230,.10)","rgba(20,50,50,.10)");for(let K0=0;K0<50;K0++)I.fillStyle="rgba(225,218,195,.55)",I.beginPath(),I.ellipse(X()*x,X()*d,2+X()*9,1+X()*5,X()*3,0,Math.PI*2),I.fill()},256,256)});Z(-3.48,0.625,-2.355,0.702,1.25,0.012,N),Z(3.45,0.625,-2.355,0.802,1.25,0.012,N),Z(-3.906,0.625,-3.85,0.012,1.25,2.72,N),Z(3.906,0.625,-3.85,0.012,1.25,2.72,N);let q=22,O="#3d8a5c",B="#e8dfc8",R=$((I,x,d)=>{for(let t=0;t<q;t++)I.fillStyle=t%2?B:O,I.fillRect(t*x/q,0,Math.ceil(x/q),d);for(let t=0;t<2500;t++)I.fillStyle=X()>0.5?"rgba(255,250,235,.06)":"rgba(20,30,20,.07)",I.fillRect(X()*x,X()*d,2,2);let K0=I.createLinearGradient(0,0,0,d);K0.addColorStop(0,"rgba(0,0,0,.14)"),K0.addColorStop(1,"rgba(40,30,20,0)"),I.fillStyle=K0,I.fillRect(0,0,x,d)},1024,128);W(new B9(7.3,0.86),new o0({map:R,roughness:0.95,side:i9}),[0,2.59,-1.955],[-1.237,0,0]);let E=$((I,x,d)=>{let K0=x/q;for(let t=0;t<q;t++)I.fillStyle=t%2?B:O,I.fillRect(t*K0,0,Math.ceil(K0),d*0.5),I.beginPath(),I.arc(t*K0+K0/2,d*0.5,K0/2-0.5,0,Math.PI),I.fill()},1024,64);W(new B9(7.3,0.2),new o0({map:E,roughness:0.95,side:i9,alphaTest:0.5}),[0,2.35,-1.548]);{let I=new o0({roughness:0.8,map:$((d,K0,t)=>{d.fillStyle="#2a3332",d.fillRect(0,0,K0,t);let D0=d.createLinearGradient(0,0,0,t);D0.addColorStop(0,"#cfe8e0"),D0.addColorStop(1,"#8fb3aa"),d.fillStyle=D0,d.fillRect(14,14,K0-28,t-28),d.strokeStyle="#1f2525",d.lineWidth=7;for(let R0=30;R0<K0-20;R0+=26)d.beginPath(),d.moveTo(R0,14),d.lineTo(R0,t-14),d.stroke();for(let R0 of[t*0.33,t*0.66])d.beginPath(),d.moveTo(14,R0),d.lineTo(K0-14,R0),d.stroke();d.strokeStyle="#e8e0cc",d.lineWidth=12,d.strokeRect(6,6,K0-12,t-12)},256,256),emissive:"#ffffff",emissiveIntensity:0.12});I.emissiveMap=I.map,W(new B9(1.1,1),I,[3.915,1.75,-4.3],[0,Math.PI/2,0]);let x=new _0(new B9(2.2,0.36),new o0({map:G("Víveres · Bebidas · Hielo",{w:1536,h:252,fondo:null,tinta:"#24518a",sombra:"#c8402f"}),transparent:!0,roughness:0.9}));x.position.set(3.915,2.55,-3.75),x.rotation.y=Math.PI/2,J.add(x)}let P=3.3,k=2.75,V=-2.7,A=P+k;Z(0,P+k/2,-5.2,8.2,k,0.2,F),Z(-4,P+k/2,-3.95,0.2,k,2.7,F),Z(4,P+k/2,-3.95,0.2,k,2.7,F),Z(0,P+k/2,V,8.2,k,0.2,F),Z(0,A-0.08,-3.95,8.44,0.16,2.95,"#d3c9b0"),Z(0,P+0.06,V+0.12,8.3,0.1,0.06,"#3d938e");let w=new o0({roughness:0.7,map:$((I,x,d)=>{I.fillStyle="#2d3a3a",I.fillRect(0,0,x,d);let K0=15,t=(d-24)/K0;for(let D0=0;D0<K0;D0++){let R0=12+D0*t;I.fillStyle="#7aa39d",I.fillRect(12,R0,x-24,t*0.72),I.fillStyle="rgba(0,0,0,.25)",I.fillRect(12,R0+t*0.62,x-24,t*0.1)}I.strokeStyle="#e8e0cc",I.lineWidth=12,I.strokeRect(6,6,x-12,d-12)},256,256)});W(new B9(1.2,1.25),w,[-2.5,4.6,V+0.107]);let D=new o0({roughness:0.7,map:w.map,emissive:"#8fb0ff",emissiveMap:w.map,emissiveIntensity:0.25}),L=new _0(new B9(1.2,1.25),D);L.position.set(2.5,4.6,V+0.107),J.add(L);let M=new o0({roughness:0.8,emissive:"#ffffff",emissiveIntensity:0.55,map:$((I,x,d)=>{let K0=I.createLinearGradient(0,0,0,d);K0.addColorStop(0,"#f0c27f"),K0.addColorStop(1,"#b87a44"),I.fillStyle=K0,I.fillRect(0,0,x,d),I.strokeStyle="#1d2222",I.lineWidth=6;for(let t=18;t<x;t+=22)I.beginPath(),I.moveTo(t,0),I.lineTo(t,d),I.stroke();for(let t=d*0.2;t<d;t+=d*0.2)I.beginPath(),I.moveTo(0,t),I.lineTo(x,t),I.stroke();I.lineWidth=5;for(let t=0;t<4;t++)I.beginPath(),I.arc(x/2,d*0.1+t*d*0.2,18,0,Math.PI*2),I.stroke();I.strokeStyle="#e8e0cc",I.lineWidth=14,I.strokeRect(7,7,x-14,d-14)},128,256)});M.emissiveMap=M.map,W(new B9(1,2.1),M,[0,P+1.08,V+0.107]);let s="#262c2b";for(let I of[3.38,4.22])Z(0,I,-1.56,8,0.04,0.04,s);for(let I=-3.94;I<=3.95;I+=0.14)Z(I,3.8,-1.56,0.018,0.84,0.018,s);for(let I of[-3.97,3.97]){for(let x of[3.38,4.22])Z(I,x,-2.08,0.04,0.04,1.04,s);for(let x=-2.55;x<=-1.6;x+=0.14)Z(I,3.8,x,0.018,0.84,0.018,s)}for(let[I,x]of[[-3.3,-1.8],[3.25,-1.85],[1.5,-1.78]]){K(I,3.46,x,0.13,0.1,0.24,"#9a5a3c",12);for(let d=0;d<4;d++)W(new D6(1,8,6),Q(d%2?"#5b7f4f":"#44663e",0.95),[I+(d-1.5)*0.06,3.66+d%2*0.05,x+(d%3-1)*0.04],[0,0,0],[0.12,0.14,0.1])}K(2.5,A+0.52,-4.3,0.5,0.55,1,"#1f2322",18),K(2.5,A+1.06,-4.3,0.2,0.22,0.08,"#2b302f",12),K(-1.8,A+0.35,-4.6,0.035,0.035,0.7,"#8d8f89",8);for(let[I,x]of[[-3.95,-2.75],[3.95,-2.75],[-3.95,-5.15],[3.95,-5.15]])for(let[d,K0]of[[-0.05,-0.05],[0.05,-0.05],[-0.05,0.05],[0.05,0.05]])K(I+d,A+0.42,x+K0,0.007,0.007,0.84,"#6b4a35",4);let b=Q("#8a6a48",0.8),u=Q("#4f7f55",0.85);for(let I of[0.55,1,1.45,1.9,2.35,2.8])Z(-3.53,I,-3.85,0.34,0.04,2.2,u);for(let I of[-4.94,-2.76])Z(-3.53,1.65,I,0.34,2.3,0.04,u);let e=$((I,x,d)=>{I.fillStyle="#bdbdbd",I.fillRect(0,0,x,d),I.fillStyle="#ffffff",I.fillRect(0,d*0.34,x,d*0.34),I.fillStyle="#6a6a6a",I.fillRect(0,d*0.33,x,d*0.02),I.fillRect(0,d*0.67,x,d*0.02)},64,64),v=new o0({map:e,roughness:0.62}),j=["#c8402f","#e3ae55","#f3eee3","#2f6fa8","#3f8a5a","#e07a2e","#d65a7a","#f1d24a","#6fb7c9","#8a3b3b","#ffffff","#1f5f9e"],g=[],f=[],o=(I,x,d,K0,t,D0)=>{let R0=I;while(R0<x){let P0=0.07+X()*0.12,L0=0.12+X()*0.17,l0=Math.min(t,0.1+X()*0.12),W9=X()<0.35,t0=new b0(j[Math.floor(X()*j.length)]).multiplyScalar(0.7+X()*0.22);if(R0+P0>x)break;let X9=D0==="x"?Y(R0+P0/2,d+L0/2,K0):Y(K0,d+L0/2,R0+P0/2);(W9?f:g).push({pos:X9,s:W9?Y(P0*0.85,L0*0.8,P0*0.85):D0==="x"?Y(P0,L0,l0):Y(l0,L0,P0),col:t0}),R0+=P0+0.012}};for(let I of[1.6125,2.5725])o(-3.4,2.2,I,-4.8,0.3,"x");for(let I of[0.57,1.02,1.47,1.92,2.37,2.82])o(-4.9,-2.8,I,-3.55,0.28,"z");for(let[I,x]of[[new w9(1,1,1),g],[new P9(0.5,0.5,1,10),f]]){let d=new h8(I,v,x.length),K0=new y9;x.forEach((t,D0)=>{K0.position.copy(t.pos),K0.scale.copy(t.s),K0.rotation.set(0,(X()-0.5)*0.12,0),K0.updateMatrix(),d.setMatrixAt(D0,K0.matrix),d.setColorAt(D0,t.col)}),d.frustumCulled=!1,J.add(d)}{let x=Math.round(1024*(z6.tope-0.1)/z6.ancho),d=[[0.05,0.47],[0.53,0.95]],K0=(L0,l0)=>{if(L0.fillStyle=l0?"#000":"#5b3b24",L0.fillRect(0,0,1024,x),!l0){for(let W9=0;W9<500;W9++)L0.fillStyle=W9%2?"rgba(150,100,60,.25)":"rgba(30,18,10,.25)",L0.fillRect(Math.random()*1024,Math.random()*x,20+Math.random()*80,1+Math.random()*2);L0.fillStyle="#3a2616",L0.fillRect(0,x*0.88,1024,x*0.12)}for(let[W9,t0]of d){let X9=W9*1024,k9=t0*1024,L9=x*0.12,m=x*0.82;L0.fillStyle=l0?"#6e6a60":"#d9d3c1",L0.fillRect(X9,L9,k9-X9,m-L9);for(let m9=0;m9<2;m9++){let z9=L9+(m9+0.5)*(m-L9)/2;L0.fillStyle=l0?"#6f6a60":"#b9b3a2",L0.fillRect(X9,z9+(m-L9)*0.2,k9-X9,4);let A9=z9+(m-L9)*0.2;L0.globalAlpha=l0?0.7:1;for(let T=X9+10;T<k9-60;){let C=Math.random()<0.3,l=j[Math.floor(Math.random()*j.length)];if(C){let Q0=18+Math.random()*6;L0.fillStyle=l0?"#9a9a9a":"rgba(235,240,240,.9)",L0.fillRect(T,A9-Q0*2.4,Q0*2,Q0*2.4),L0.fillStyle=l;for(let V0=0;V0<7;V0++)L0.beginPath(),L0.arc(T+5+Math.random()*(Q0*2-10),A9-6-Math.random()*Q0*1.8,5,0,Math.PI*2),L0.fill();L0.fillStyle="#c8402f",L0.fillRect(T-2,A9-Q0*2.4-8,Q0*2+4,9),T+=Q0*2+8}else{let Q0=46+Math.random()*34,V0=(m-L9)*(0.2+Math.random()*0.1);L0.fillStyle=l,L0.beginPath(),L0.moveTo(T,A9),L0.lineTo(T+3,A9-V0);for(let I0=0;I0<=6;I0++)L0.lineTo(T+3+I0*(Q0-6)/6,A9-V0-(I0%2?5:0));L0.lineTo(T+Q0,A9),L0.closePath(),L0.fill(),L0.fillStyle="rgba(255,255,255,.7)",L0.fillRect(T+Q0*0.2,A9-V0*0.62,Q0*0.6,V0*0.22),L0.fillStyle="rgba(255,255,255,.25)",L0.fillRect(T+4,A9-V0+8,5,V0-14),T+=Q0+5}}L0.globalAlpha=1}if(!l0)L0.fillStyle="rgba(255,255,255,.22)",L0.beginPath(),L0.moveTo(X9+20,L9),L0.lineTo(X9+70,L9),L0.lineTo(X9+20,m),L0.lineTo(X9-10+20,m),L0.fill(),L0.strokeStyle="#3a2616",L0.lineWidth=10,L0.strokeRect(X9,L9,k9-X9,m-L9)}},t=(L0)=>$((l0)=>K0(l0,L0),1024,x),D0=new o0({map:t(!1),emissive:"#fff4de",emissiveMap:t(!0),emissiveIntensity:0.2,roughness:0.55}),R0=z6.tope-0.1,P0=new _0(new B9(z6.ancho,R0),D0);P0.position.set(0,R0/2,z6.z+z6.fondo/2+0.006),J.add(P0)}let p=$((I,x,d)=>{let t=d/7;I.fillStyle="#8a7a5a",I.fillRect(x/2-2,0,4,d);for(let D0=0;D0<7;D0++){let R0=D0*t+4;I.fillStyle=j[(D0*5+3)%j.length],I.fillRect(6,R0,x-12,t-8),I.fillStyle="rgba(255,255,255,.3)",I.fillRect(10,R0+6,x*0.16,t-20),I.fillStyle="rgba(255,255,255,.75)",I.fillRect(x*0.3,R0+t*0.36,x*0.4,t*0.16)}},64,448),r=new o0({map:p,roughness:0.45,alphaTest:0.5,side:i9});for(let I of[-1.74,-1.52,1.52,1.74])W(new B9(0.15,0.86),r,[I,2.66,-3.86],[0,(X()-0.5)*0.5,0]);let X0=new _0(new B9(0.8,1.5),new p9({color:new b0(1.05,1.08,1.1),map:$((I,x,d)=>{I.fillStyle="#dcecef",I.fillRect(0,0,x,d);let K0=5;for(let D0=0;D0<K0;D0++){let R0=d/K0,P0=D0*R0;I.fillStyle="rgba(140,160,165,.9)",I.fillRect(0,P0+R0*0.88,x,5);for(let L0=0;L0<8;L0++){let l0=(x-20)/8,W9=10+L0*l0;I.fillStyle=["#c8402f","#2c7a3f","#e3ae55","#7a3a1c","#2f6fa8","#f3eee3","#e07a2e"][(L0+D0*3)%7],I.fillRect(W9+l0*0.15,P0+R0*0.3,l0*0.7,R0*0.56),I.fillRect(W9+l0*0.36,P0+R0*0.12,l0*0.28,R0*0.2)}}let t=I.createLinearGradient(0,0,x,0);t.addColorStop(0,"rgba(255,255,255,.3)"),t.addColorStop(0.35,"rgba(255,255,255,0)"),I.fillStyle=t,I.fillRect(0,0,x,d),I.strokeStyle="#9aa8aa",I.lineWidth=10,I.strokeRect(0,0,x,d)},256,480)}));X0.position.set(2.95,1.12,-4.09),J.add(X0);let M0=new _0(new B9(0.9,0.2),new p9({map:G("Bien fría",{w:720,h:160,fondo:"#b8372b",tinta:"#f3eee3",sombra:null,px:0.62}),color:new b0(1.1,1.1,1.1)}));M0.position.set(2.95,2.17,-4.14),J.add(M0),Z(2.45,0.4,-1.86,1,0.8,0.6,"#e7ebe8"),Z(2.45,0.83,-1.86,1.04,0.06,0.64,"#d4dad8"),Z(2.45,0.12,-1.555,0.96,0.1,0.012,"#b9c0bd");{let I=new _0(new B9(0.62,0.19),new o0({map:G("HIELO",{w:640,h:196,fondo:null,tinta:"#1f5f9e",sombra:"#c8402f",px:0.7}),transparent:!0,roughness:0.8}));I.position.set(2.45,0.55,-1.553),J.add(I)}{let I=Q("#2d63a8",0.5),x=new o0({color:"#8cc0e6",roughness:0.12,transparent:!0,opacity:0.84});for(let t=0;t<2;t++)for(let D0=0;D0<3;D0++){let R0=3.15+t*0.4,P0=0.21+D0*0.4;W(new P9(0.155,0.155,0.4,16),x,[R0,P0,-2],[Math.PI/2,0,0]),W(new P9(0.05,0.05,0.1,10),x,[R0,P0,-2.25],[Math.PI/2,0,0])}for(let t of[0,0.4,0.8,1.2])Z(3.35,t+0.012,-2,0.84,0.024,0.46,I);for(let t of[2.94,3.35,3.7600000000000002])Z(t,0.61,-2,0.03,1.22,0.46,I)}let y=(I,x,d,K0,t)=>{let D0=Q(t,0.5),R0=(P0,L0,l0,W9,t0=0)=>{P0.rotateX(t0);let X9=Y(L0,l0,W9).applyAxisAngle(Y(0,1,0),K0);W(P0,D0,[I+X9.x,x+X9.y,d+X9.z],[0,K0,0])};R0(new f6(0.46,0.035,0.43,2,0.015),0,0.43,0),R0(new f6(0.44,0.42,0.03,2,0.012),0,0.71,-0.22,-0.16);for(let P0 of[-0.2,0.2])R0(new P9(0.018,0.024,0.43,6),P0,0.215,0.17,0.12),R0(new P9(0.018,0.024,0.45,6),P0,0.22,-0.19,-0.14),R0(new w9(0.03,0.18,0.3),P0*1.1,0.54,-0.02)};for(let I=0;I<4;I++)y(-3.42,I*0.075,-1.32-I*0.012,0.3,"#ecece6");y(3.55,0,0.55,-1.9,"#ecece6");{let K0=(L0,l0,W9,t0,X9,k9=0,L9=0)=>{L0.rotateX(k9),L0.rotateZ(L9);let m=Y(W9,t0,X9).applyAxisAngle(Y(0,1,0),0.3);W(L0,l0,[-3.25+m.x,m.y,2.85+m.z],[0,0.3,0])},t=Q("#171b1b",0.8),D0=Q("#9aa3a0",0.35,0.6),R0=Q("#a8382c",0.45,0.1),P0=Q("#1e2222",0.7);for(let L0 of[-0.52,0.5])K0(new x8(0.26,0.055,8,18),t,L0,0.3,0),K0(new P9(0.09,0.09,0.08,10),D0,L0,0.3,0,Math.PI/2);K0(new f6(0.6,0.22,0.24,2,0.05),R0,-0.02,0.53,0,0,-0.08),K0(new f6(0.55,0.08,0.26,2,0.03),P0,-0.28,0.68,0),K0(new f6(0.28,0.34,0.2,2,0.05),R0,0.37,0.64,0,0,-0.35),K0(new P9(0.018,0.018,0.62,6),D0,0.44,0.92,0,Math.PI/2),K0(new P9(0.02,0.02,0.62,6),D0,0.47,0.6,0,0,0.35),K0(new P9(0.03,0.035,0.45,8),D0,-0.35,0.3,0.13,0,Math.PI/2+0.1),K0(new f6(0.3,0.03,0.22,1,0.01),D0,-0.6,0.73,0)}for(let I=-9;I<4.4;I+=2)Z(I+0.5,-0.074,3.45,1,0.152,0.202,"#d6b24e");Z(8.3,-0.2,-4.575,7.4,0.1,15.85,"#2b3133"),Z(4.6,-0.075,-4.575,0.2,0.15,15.85,"#a8a391"),Z(12.3,-0.07,-4.575,1.2,0.16,15.85,"#8a8578");for(let I=-11;I<3;I+=1.8)Z(8.3,-0.146,I,0.06,0.008,0.7,"#b9ad83");{let I=new o0({color:"#ffd08a",emissive:"#ffb35a",emissiveIntensity:2.2}),x=Q("#2a3436",0.8),d=["#d8a25a","#8fb8a8","#e0d2b0","#c9897d","#b9c47a"],K0=-12,t=0;while(K0<2.4){let D0=3+X()*1.6,R0=3+X()*2.6,P0=d[t++%d.length];Z(14.4,R0/2,K0+D0/2,3,R0,D0,P0),Z(14.4,R0+0.08,K0+D0/2,3.1,0.16,D0+0.1,"#ddd4bf");let L0=Math.max(1,Math.floor(D0/1.5));for(let l0=0;l0<L0;l0++){let W9=K0+(l0+0.5)*D0/L0;if(W(new B9(0.75,0.95),X()<0.4?I:x,[12.885,1.55,W9],[0,-Math.PI/2,0]),R0>4.2)W(new B9(0.7,0.8),X()<0.35?I:x,[12.885,R0-1.1,W9],[0,-Math.PI/2,0])}K0+=D0+0.15}}{let I=new o0({roughness:0.6,metalness:0.3,map:$((d,K0,t)=>{d.fillStyle="#8f9a94",d.fillRect(0,0,K0,t);for(let D0=0;D0<t;D0+=8)d.fillStyle="rgba(40,45,44,.35)",d.fillRect(0,D0,K0,2),d.fillStyle="rgba(230,235,230,.18)",d.fillRect(0,D0+3,K0,2);for(let D0=0;D0<40;D0++)d.fillStyle="rgba(120,70,40,.18)",d.fillRect(X()*K0,X()*t,4+X()*20,2+X()*10)},256,256)});W(new B9(2.3,2.1),I,[-7,1.05,-1.365]),Z(-7,2.2,-1.33,2.45,0.2,0.1,"#6d7571");let x=new _0(new B9(1.7,0.42),new o0({map:G("Banca La Suerte",{w:1024,h:252,fondo:"#2f7a4d",tinta:"#f3eee3",sombra:"#1b2c22",borde:"#e3ae55",px:0.52}),roughness:0.85,emissive:"#ffffff",emissiveIntensity:0.08}));x.material.emissiveMap=x.material.map,x.position.set(-10.5,2.72,-1.36),J.add(x)}let a=Y(4.3,0,3);K(a.x,3.9,a.z,0.11,0.16,7.8,"#8e8a80",10),Z(a.x,7.25,a.z,0.1,0.1,1.7,"#5c574c"),K(a.x+0.28,6.3,a.z,0.2,0.2,0.62,"#6d7470",12);let U0=(I,x,d,K0="#141819",t=0.011)=>{let D0=I.clone().lerp(x,0.5);D0.y-=d*2,W(new g6(new r6(I,D0,x),22,t,4,!1),Q(K0),[0,0,0])};for(let I of[-0.6,0,0.6])U0(Y(a.x,7.3,a.z+I),Y(6,6.6,9.2+I*0.4),0.25);for(let I of[-0.5,0.5])U0(Y(a.x,7.3,a.z+I),Y(-5,4.2,-1+I*0.6),0.55);U0(Y(a.x,6.4,a.z),Y(3.95,5.7,-2.72),0.35),U0(Y(a.x,6.2,a.z),Y(3.95,5.5,-2.72),0.5,"#1d2121",0.008),U0(Y(a.x,5.9,a.z),Y(4.35,5.4,-9),0.4,"#1d2121",0.009),U0(Y(a.x,5.7,a.z),Y(4.35,5.2,-9),0.6,"#20241f",0.007);{let I=new $7(Array.from({length:14},(x,d)=>{let K0=d/13*Math.PI*4;return Y(a.x+0.16+Math.cos(K0)*0.14,5.2-d*0.018+Math.sin(K0)*0.14,a.z+Math.sin(K0)*0.05)}));W(new g6(I,60,0.008,4,!1),Q("#141819"),[0,0,0])}let h=0;return{update(I){if(I>h)h=I+0.25+Math.random()*1.4,D.emissiveIntensity=0.12+Math.random()*0.45,D.emissive.setHSL(0.58+Math.random()*0.08,0.5,0.55+Math.random()*0.2)}}}function gU({scene:J,random:$=Math.random}){let Q=$,Z=[],K=[],W=[],X=new b0,Y=(j,g,f=Z)=>{X.set(g);let o=j.attributes.position.count,p=new Float32Array(o*3);for(let r=0;r<o;r++)p[r*3]=X.r,p[r*3+1]=X.g,p[r*3+2]=X.b;return j.setAttribute("color",new t9(p,3)),j.deleteAttribute("uv"),f.push(j),j},H=(j,g,f,o,p,r,X0,M0=0,y)=>{let a=new w9(o,p,r);if(M0)a.rotateY(M0);return a.translate(j,g,f),Y(a,X0,y)},U=(j,g,f,o,p,r,X0=8)=>{let M0=new P9(o,o,p,X0);return M0.translate(j,g,f),Y(M0,r)},G=(j,g,f,o,p,r,X0,M0)=>{let y=new B9(o,p);return y.rotateY(r),y.translate(j,g,f),Y(y,X0,M0)},F=(j)=>j[Math.floor(Q()*j.length)],N=["#c98a64","#d8b46a","#6fa9a0","#c48d95","#a3b777","#dca16a","#86a3bf","#e2d3b0","#b7a4c9","#e0a58f","#9ec3b0"],q=["#9a968c","#8d8a80","#a39d90"],O="#8a8578",B="#a8a391",R="#2b3133",E="#b9ad83",P="#1b2224",k="#232c2e",V=(j)=>"#"+new b0(j).multiplyScalar(0.85).getHexString();function A(j,g,f,o,p,r,{lejos:X0=!1}={}){let y=r*2.9+0.3,a=Q()<0.18?F(q):V(F(N)),U0=new S(Math.sin(f),0,Math.cos(f)),h=new S(U0.z,0,-U0.x),I=(t,D0,R0)=>new S(j,D0,g).addScaledVector(h,t).addScaledVector(U0,R0),x=I(0,y/2,-p/2);H(x.x,x.y,x.z,o,y,p,a,f);let d=I(0,y+0.09,-p/2);H(d.x,d.y,d.z,o+0.12,0.18,p+0.12,"#d9d2bf",f);let K0=Math.max(1,Math.floor(o/1.6));for(let t=0;t<r;t++)for(let D0=0;D0<K0;D0++){let R0=-o/2+(D0+0.5)*o/K0,P0=t*2.9+1.55,L0=I(R0,P0,X0?0.04:0.012),l0=Q()<(X0?0.3:0.38);if(t===0&&D0===Math.floor(K0/2)&&!X0){let W9=I(R0,1.05,0.012);G(W9.x,W9.y,W9.z,0.95,2.1,f,Q()<0.3?"#7c8680":"#232c2e");continue}if(l0)G(L0.x,L0.y,L0.z,0.72,0.9,f,Q()<0.22?"#9fc3ff":F(["#ffd08a","#ffc27a","#ffe0a8"]),K);else G(L0.x,L0.y,L0.z,0.72,0.9,f,"#232c2e")}if(X0){w(I,y,o,p);return}if(Q()<0.5){let t=I(0,0.5,0.55);H(t.x,1,t.z,o-0.1,0.05,0.05,"#1b2224",f);for(let R0 of[-0.5,-0.25,0,0.25,0.5]){let P0=I(R0*(o-0.1),0.5,0.55);H(P0.x,0.5,P0.z,0.05,1,0.05,"#1b2224",f)}let D0=I(0,2.75,0.6);H(D0.x,D0.y,D0.z,o,0.12,1.2,"#cfc6b2",f)}if(r>1&&Q()<0.6){let t=I(0,2.9499999999999997,0.45);H(t.x,t.y,t.z,o*0.7,0.12,0.9,"#cfc6b2",f);let D0=I(0,3.45,0.88);H(D0.x,D0.y,D0.z,o*0.7,0.05,0.05,"#1b2224",f);for(let R0=0;R0<=6;R0++){let P0=I((R0/6-0.5)*o*0.7,3.23,0.88);H(P0.x,P0.y,P0.z,0.03,0.5,0.03,"#1b2224",f)}}w(I,y,o,p)}function w(j,g,f,o){if(Q()<0.45){let p=j((Q()-0.5)*f*0.5,g+0.7,-o*(0.3+Q()*0.4));U(p.x,p.y,p.z,0.55,1.1,"#1f2324",10)}if(Q()<0.22)for(let p=0;p<4;p++){let r=j((p%2-0.5)*(f-0.4),g+0.5,-(p<2?0.3:o-0.3));H(r.x,r.y,r.z,0.04,1+Q()*0.4,0.04,"#5a4a3c")}if(Q()<0.15){let p=j(f*0.3,g+1.1,-o*0.5);H(p.x,p.y,p.z,0.03,2,0.03,"#3a3f40"),H(p.x,p.y+0.6,p.z,0.9,0.03,0.03,"#3a3f40")}}function D({eje:j,desde:g,hasta:f,fachada:o,ry:p,fondo:r=[6,9],pisos:X0=[1,3]}){let M0=g;while(M0<f-2){let y=Math.min(3.4+Q()*3.4,f-M0),a=M0+y/2,U0=o+(Q()-0.5)*0.5,h=X0[0]+Math.floor(Q()*(X0[1]-X0[0]+1));if(j==="x")A(a,U0,p,y,r[0]+Q()*(r[1]-r[0]),h);else A(U0,a,p,y,r[0]+Q()*(r[1]-r[0]),h);M0+=y+0.12+(Q()<0.12?0.9+Q()*1.5:0)}}{let j=new B9(460,460);j.rotateX(-Math.PI/2),j.translate(0,-0.26,0),Y(j,"#35363a")}for(let[j,g]of[[-86,-20],[20,86]]){let f=(j+g)/2,o=g-j;H(f,-0.2,6.05,o,0.1,5.4,"#2b3133"),H(f,0.08,9.6,o,0.16,1.8,"#8a8578");for(let p=j+1;p<g;p+=3.6)H(p,-0.146,6.3,1.4,0.008,0.1,"#b9ad83")}H(-51,-0.1,0.97,70,0.2,4.76,"#8a8578"),H(-51,-0.075,3.45,70,0.15,0.2,"#a8a391"),H(49.45,-0.1,2.18,73.1,0.2,2.36,"#8a8578"),H(49.45,-0.075,3.45,73.1,0.15,0.2,"#a8a391"),D({eje:"x",desde:-84,hasta:-20.3,fachada:10.6,ry:Math.PI}),D({eje:"x",desde:20.3,hasta:84,fachada:10.6,ry:Math.PI}),D({eje:"x",desde:-84,hasta:-22.8,fachada:-1.4,ry:0}),D({eje:"x",desde:16.1,hasta:84,fachada:1,ry:0}),H(8.3,-0.2,-49.25,7.4,0.1,73.5,"#2b3133"),H(4.25,-0.1,-49.25,0.7,0.2,73.5,"#8a8578"),H(12.3,-0.07,-49.25,1.2,0.16,73.5,"#8a8578");for(let j=-13;j>-85;j-=3.6)H(8.3,-0.146,j,0.1,0.008,1.4,"#b9ad83");D({eje:"z",desde:-84,hasta:-5.5,fachada:3.9,ry:Math.PI/2,fondo:[7,9]}),D({eje:"z",desde:-84,hasta:-12.2,fachada:12.9,ry:-Math.PI/2,fondo:[7,9]});let L=(j,g,f)=>{let o=j.clone().lerp(g,0.5);o.y-=f*2;let p=new g6(new r6(j,o,g),14,0.014,3,!1);Y(p,"#101517")},M=(j,g)=>{U(j,3.5,g,0.1,7,"#6b6457",6),H(j,6.6,g,1.6,0.08,0.08,"#4f4a40")},s=(j,g,f)=>{H(j+f.x*0.55,6,g+f.z*0.55,Math.abs(f.x)?1.1:0.06,0.06,Math.abs(f.z)?1.1:0.06,"#4f4a40");let o=new D6(0.16,8,6);o.translate(j+f.x*1.1,5.9,g+f.z*1.1),Y(o,"#ffb866",W)};for(let j of[-1,1]){let g=j<0?-14:16;for(let f=1;f<=5;f++){let o=j<0?-14-f*12:16+f*12;if(M(o,9.2),f%2===0)s(o,9.2,new S(0,0,-1));for(let p of[0,-0.25,0.3])L(new S(g,6.6+p,9.2),new S(o,6.6+p,9.2),0.5);g=o}}{let j=-9;for(let g=1;g<=6;g++){let f=-9-g*12;if(M(12.4,f),g%2===1)s(12.4,f,new S(-1,0,0));for(let o of[0,0.3])L(new S(12.4,6.6+o,j),new S(12.4,6.6+o,f),0.5);j=f}}let b=(j,g,f)=>{let o=F(["#8b2f2a","#c9c6bd","#2f4a6b","#3b3f42","#b58a3a","#e2dfd6","#556b4f"]),p=new S(Math.sin(f),0,Math.cos(f));H(j,0.55,g,1.75,0.62,4.1,o,f);let r=p.clone().multiplyScalar(-0.3);H(j+r.x,1.1,g+r.z,1.55,0.52,2.1,"#2a3236",f);let X0=new S(p.z,0,-p.x);for(let[M0,y]of[[-0.8,1.3],[0.8,1.3],[-0.8,-1.3],[0.8,-1.3]]){let a=new P9(0.32,0.32,0.22,10);a.rotateZ(Math.PI/2),a.rotateY(f);let U0=new S(j,0.32,g).addScaledVector(X0,M0).addScaledVector(p,y);a.translate(U0.x,U0.y,U0.z),Y(a,"#141718")}};for(let[j,g,f]of[[-31,4.4,Math.PI/2],[-47,4.4,Math.PI/2],[-72,4.4,-Math.PI/2],[27,4.4,Math.PI/2],[55,4.4,-Math.PI/2],[-58,7.9,Math.PI/2],[38,7.9,-Math.PI/2],[5.6,-24,0],[5.6,-41,Math.PI],[10.8,-31,0],[10.8,-62,Math.PI]])b(j,g,f);let u=(j,g)=>Math.abs(j)<30&&g>-22&&g<24||g>-14&&g<20||g<-10&&j>-12&&j<30;for(let j=-78;j<=78;j+=13)for(let g=-78;g<=78;g+=13){let f=j+(Q()-0.5)*6,o=g+(Q()-0.5)*6;if(u(f,o)||Math.hypot(f,o)>80)continue;let p=Math.hypot(f,o),r=p>45&&Q()<0.07,X0=Math.atan2(-f,-o),M0=Math.round(X0/(Math.PI/2))*(Math.PI/2),y=r?5+Math.floor(Q()*5):1+Math.floor(Q()*(o>0?2:3));if(A(f,o,M0,6+Q()*6,6+Q()*5,y,{lejos:!0}),Q()<0.35){let a=F(["#3f5a3c","#4a6443","#35503a"]),U0=f+(Q()-0.5)*8,h=o+(Q()-0.5)*8,I=2+Q()*2.5,x=new GQ(I,0);x.scale(1,0.8,1),x.translate(U0,I*0.6+2.5,h),Y(x,a),U(U0,1.4,h,0.25,2.8,"#4d4234",5)}}for(let j=0;j<14;j++){let g=Q()*Math.PI*2,f=32+Q()*44,o=Math.cos(g)*f,p=Math.sin(g)*f;if(u(o,p))continue;let r=9+Q()*5,X0=new P9(0.14,0.22,r,5);X0.translate(o,r/2,p),Y(X0,"#5d5445");for(let M0=0;M0<8;M0++){let y=new WJ(0.3,3,3,1);y.rotateZ(Math.PI/2+0.5),y.translate(1.5,0,0),y.rotateY(M0/8*Math.PI*2),y.translate(o,r,p),Y(y,"#34503a")}}{let g=[],f=[];for(let p=0;p<=240;p++){let r=p/240*Math.PI*2,X0=86+Math.sin(r*3.1)*1.5,M0=6+7*(0.5+0.5*Math.sin(r*2.3+0.7))+3.5*Math.sin(r*5.1+1)**2+1.2*Math.sin(r*13.7+2)+0.5*Math.sin(r*31.3);if(g.push(Math.cos(r)*X0,-1,Math.sin(r)*X0,Math.cos(r)*X0,Math.max(5,M0),Math.sin(r)*X0),p<240){let y=p*2;f.push(y,y+2,y+1,y+1,y+2,y+3)}}let o=new g9;o.setAttribute("position",new H9(g,3)),o.setIndex(f),o.computeVertexNormals(),Y(o,"#3d4552")}let e=[],v=(j,g)=>{if(!j.length)return;let f=j.map((r)=>r.index?r.toNonIndexed():r),o=E$(f,!1);if(f.forEach((r)=>r.dispose()),j.forEach((r)=>r.dispose()),!o)return;let p=new _0(o,g);p.matrixAutoUpdate=!1,J.add(p),e.push(p)};return v(Z,new o0({vertexColors:!0,roughness:0.92,side:i9})),v(K,new p9({vertexColors:!0,color:new b0(1.9,1.9,1.9)})),v(W,new p9({vertexColors:!0,color:new b0(5,5,5)})),{mallas:e}}var $L=["cafe","morir","presidente","presidente"];function QL(){let J=document.createElement("canvas");J.width=256,J.height=128;let $=J.getContext("2d");$.fillStyle="#f1ece0",$.fillRect(0,0,256,128),$.fillStyle="#b3262d",$.fillRect(0,10,256,14),$.fillRect(0,104,256,14),$.fillStyle="#1f5a36",$.beginPath(),$.ellipse(128,64,54,28,0,0,Math.PI*2),$.fill(),$.fillStyle="#f1ece0",$.beginPath(),$.ellipse(128,64,46,21,0,0,Math.PI*2),$.fill(),$.fillStyle="#b3262d",$.fillRect(92,58,72,12);let Q=new a6(J);return Q.colorSpace=W6,Q}function ZL(){let J=new S9,$=(H,U)=>new O0(H,U),Q=[$(0,0),$(0.034,0),$(0.037,0.006),$(0.037,0.165),$(0.034,0.188),$(0.022,0.222),$(0.0145,0.252),$(0.0138,0.274),$(0.0158,0.279),$(0.0158,0.29),$(0.0112,0.29),$(0.0106,0.268),$(0.0112,0.24)],Z=new o0({color:"#2d5a26",roughness:0.18,metalness:0.05,envMapIntensity:1.4});J.add(new _0(new M7(Q,20),Z));let K=new _0(new M7(Q.slice(1,5).map((H)=>$(H.x+0.0006,H.y)),20),new o0({color:"#e8f0e4",roughness:0.9,transparent:!0,opacity:0.22,depthWrite:!1}));J.add(K);let W=new _0(new P9(0.0376,0.0376,0.075,24,1,!0),new o0({map:QL(),roughness:0.6}));W.position.y=0.095,J.add(W);let X=new _0(new P9(0.0149,0.0152,0.02,16,1,!0),new o0({color:"#b3262d",roughness:0.5}));X.position.y=0.262,J.add(X);let Y=new _0(new J7(0.0112,16),new p9({color:"#0d160c"}));return Y.rotation.x=-Math.PI/2,Y.position.y=0.245,J.add(Y),{g:J,alto:0.11,radio:0.037,inclina:1.25,boca:0.18}}function KL(){let J=new S9,$=new _0(new P9(0.034,0.029,0.14,24,1,!0),new o0({color:"#dfe9ec",roughness:0.08,transparent:!0,opacity:0.28,depthWrite:!1,side:i9}));$.position.y=0.07,$.renderOrder=2,J.add($);let Q=new _0(new P9(0.029,0.029,0.008,24),new o0({color:"#dfe9ec",roughness:0.1,transparent:!0,opacity:0.5}));Q.position.y=0.004,J.add(Q);let Z=new _0(new P9(0.0318,0.0285,0.112,24),new o0({color:"#f2bf86",roughness:0.45}));Z.position.y=0.064,J.add(Z);for(let[W,X,Y]of[[0.01,0.006,0.4],[-0.009,-0.008,1.1],[0.002,-0.012,2]]){let H=new _0(new w9(0.016,0.013,0.016),new o0({color:"#f6f3ec",roughness:0.15,transparent:!0,opacity:0.8}));H.position.set(W,0.121,X),H.rotation.set(Y,Y*0.7,0),J.add(H)}let K=new _0(new P9(0.0028,0.0028,0.19,8),new o0({color:"#c8392e",roughness:0.5}));return K.position.set(0.012,0.11,0.004),K.rotation.z=-0.16,J.add(K),{g:J,alto:0.06,radio:0.034,inclina:0.85,boca:0.09}}function WL(){let J=new S9,$=new o0({color:"#efe9da",roughness:0.22}),Q=new _0(new P9(0.053,0.047,0.008,28),$);Q.position.y=0.004,J.add(Q);let Z=new o0({color:"#efe9da",roughness:0.22,side:i9}),K=new _0(new P9(0.034,0.025,0.056,24,1,!0),Z),W=new _0(new J7(0.025,20),$);W.rotation.x=-Math.PI/2,W.position.y=0.0085,J.add(W),K.position.y=0.036,J.add(K);let X=new _0(new J7(0.0318,24),new o0({color:"#2a160c",roughness:0.15}));X.rotation.x=-Math.PI/2,X.position.y=0.056,J.add(X);let Y=new _0(new x8(0.014,0.004,6,12,Math.PI*1.3),$);return Y.position.set(0.036,0.038,0),Y.rotation.z=-Math.PI*0.65,J.add(Y),J.remove(Q),{g:J,alto:0.034,radio:0.034,inclina:0.9,boca:0.034,plato:Q}}function pU(J){let $=[];for(let Q=0;Q<4;Q++){let Z=$L[Q],K=Z==="presidente"?ZL():Z==="morir"?KL():WL(),[W,X,Y]=C8[Q],H=C0.tableWidth/2-0.055,U=C0.tableCenterY+C0.tableThickness/2,G=new S(-H,0,C0.seatDistance-H).applyAxisAngle(new S(0,1,0),Y).add(new S(W,0,X));if(G.y=U,K.g.traverse((F)=>{if(F.isMesh)F.castShadow=!0,F.receiveShadow=!0}),K.plato)G.y+=0.008;if(K.g.position.copy(G),J.add(K.g),K.plato)K.plato.position.copy(G),K.plato.position.y=U+0.004,K.plato.traverse((F)=>{if(F.isMesh)F.receiveShadow=!0}),J.add(K.plato);$.push({group:K.g,home:G,index:Q,tipo:Z,alto:K.alto,radio:K.radio,inclina:K.inclina,boca:K.boca})}return $}var L$={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}_getCompositeMaterial(J){return new J6({defines:{NUM_MIPS:J},uniforms:{blurTexture1:{value:null},blurTexture2:{value:null},blurTexture3:{value:null},blurTexture4:{value:null},blurTexture5:{value:null},bloomStrength:{value:1},bloomFactors:{value:null},bloomTintColors:{value:null},bloomRadius:{value:0}},vertexShader:`
				...
				}`})}}VJ.BlurDirectionX=new O0(1,0);VJ.BlurDirectionY=new O0(0,1);var SQ={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
   ...
   void main(){vec3 d=normalize(vP);float h=d.y;
    ...
    #include <tonemapping_fragment>
    #include <colorspace_fragment>
   }`}));Q.renderOrder=-10,$.add(Q);let Z=220,K=new Float32Array(Z*3),W=new Float32Array(Z*3);for(let U=0;U<Z;U++){let G=j6(),F=j6()*Math.PI*2,N=0.45+G*0.55,q=Math.sqrt(1-N*N),O=0.25+0.55*j6()*N;K.set([Math.cos(F)*q*75,N*75,Math.sin(F)*q*75],U*3),W.set([O*0.85,O*0.9,O],U*3)}let X=new g9;X.setAttribute("position",new t9(K,3)),X.setAttribute("color",new t9(W,3)),$.add(new X$(X,new ZJ({size:1.3,sizeAttenuation:!1,vertexColors:!0,fog:!1,depthWrite:!1,transparent:!0,opacity:0.45})));let Y=new _0(new J7(2.1,40),new p9({color:"#f6e7cc",fog:!1}));Y.position.set(26,11,58),Y.lookAt(0,1,0),$.add(Y);let H=new K$(new $J({map:uU("255,226,200"),fog:!1,transparent:!0,opacity:0.28,depthWrite:!1,blending:y8}));return H.scale.setScalar(13),H.position.copy(Y.position),$.add(H),J.add($),$}function UL(J){let $=new Map,Q=(F,N=0,q=0)=>{let O=F+N+q;if(!$.has(O))$.set(O,{m:new o0({color:N?F:new b0(F).multiplyScalar(0.85),roughness:0.9,emissive:N||"#000",emissiveIntensity:q}),g:[]});return $.get(O)},Z=(F,N,q,O,B,R=0)=>{F.rotateY(R),F.translate(q,O,B),N.g.push(F)},K=["#c98a64","#d8b46a","#6fa9a0","#c48d95","#a3b777","#dca16a","#86a3bf","#e2d3b0"],W=-20;while(W<20){let F=3.4+j6()*2.6,N=3+j6()*2.8,q=10.5+j6()*0.8,O=K[Math.floor(j6()*K.length)];Z(new w9(F,N,2.4),Q(O),W+F/2,N/2,q+1.2),Z(new w9(F+0.12,0.18,2.6),Q("#d9d2bf"),W+F/2,N+0.09,q+1.2);let B=Math.max(1,Math.floor(F/1.5));for(let R=0;R<B;R++){let E=W+(R+0.5)*F/B,P=j6()<0.4,k=j6()<0.2,V=P?Q(k?"#9fc3ff":"#ffd08a",k?"#6f9cff":"#ffb35a",k?1.6:2.2):Q("#2a3436");if(Z(new B9(0.75,0.95),V,E,1.55,q-0.005,Math.PI),N>4.2)Z(new B9(0.7,0.8),j6()<0.35?Q("#ffd08a","#ffb35a",1.5):Q("#2a3436"),E,N-1.1,q-0.005,Math.PI);Z(new w9(0.9,0.06,0.12),Q("#2c3432"),E,2.08,q-0.06)}for(let R=0;R<Math.floor(F/0.22);R++)Z(new w9(0.018,0.9,0.018),Q("#1b2224"),W+0.11+R*0.22,0.45,q-0.55);Z(new w9(F,0.04,0.04),Q("#1b2224"),W+F/2,0.9,q-0.55),W+=F+0.15}Z(new w9(44,0.16,1.8),Q("#8a8578"),0,0.08,9.6);let X=[-14,-4,6,16];for(let F of X)Z(new P9(0.09,0.12,7,8),Q("#6b6457"),F,3.5,9.2),Z(new w9(1.6,0.08,0.08),Q("#4f4a40"),F,6.6,9.2);for(let F=0;F<X.length-1;F++)for(let N of[0,-0.25,0.3]){let q=new S(X[F],6.6+N,9.2),O=new S(X[F+1],6.6+N,9.2),B=q.clone().lerp(O,0.5);B.y-=0.55,Z(new g6(new r6(q,B,O),16,0.012,4),Q("#101517"),0,0,0)}for(let[F,N,q]of[[-9,12.8,7.5],[11,13.1,8.4],[2.5,13.4,6.4]]){let O=new $7([new S(F,0,N),new S(F+0.3,q*0.5,N),new S(F+0.8,q,N-0.2)]);Z(new g6(O,12,0.16,6),Q("#5d5445"),0,0,0);for(let B=0;B<9;B++){let R=B/9*Math.PI*2,E=new WJ(0.28,2.6,4,1);E.rotateZ(Math.PI/2+0.55),E.translate(1.3,0,0),E.rotateY(R),Z(E,Q("#34503a"),F+0.8,q,N-0.2)}}let Y=[];for(let{m:F,g:N}of $.values()){let q=E$(N,!1);if(N.forEach((B)=>B.dispose()),!q)continue;let O=new _0(q,F);O.receiveShadow=!0,J.add(O),Y.push(O)}let H=new W7("#ffa35c",6,14,1.8);H.position.set(6,5.9,8.6),J.add(H);let U=new _0(new D6(0.14,12,8),new o0({color:"#ffcf94",emissive:"#ff9a45",emissiveIntensity:5}));U.position.copy(H.position),J.add(U);let G=new _0(new P9(0.03,0.03,1.3,6),new o0({color:"#4f4a40"}));return G.rotation.z=Math.PI/2,G.position.set(6,6.05,8.9),J.add(G),{merged:Y,farol:H}}function NL(J,$){let Q=new S9;Q.position.copy($),J.add(Q);let Z=new _0(new D6(0.038,16,12),new o0({color:"#fff4d6",emissive:"#ffd08a",emissiveIntensity:9}));Z.scale.y=1.25,Q.add(Z);let K=new _0(new P9(0.018,0.02,0.05,10),new o0({color:"#2b2a26",roughness:0.6}));K.position.y=0.065,Q.add(K);let W=new _0(new P9(0.004,0.004,1.1,5),new o0({color:"#15181a"}));W.position.y=0.64,Q.add(W);let X=new K$(new $J({map:uU(),transparent:!0,opacity:0.55,depthWrite:!1,blending:y8}));X.scale.setScalar(0.75),Q.add(X);let Y=[],H=new $J({color:"#3b3026",transparent:!0,opacity:0.85,depthWrite:!1});for(let U=0;U<6;U++){let G=new K$(H);G.scale.setScalar(0.012+j6()*0.008),Q.add(G),Y.push({s:G,r:0.07+j6()*0.12,w:2+j6()*4,f:j6()*6,y:0.05+j6()*0.08,k:1.3+j6()})}return{g:Q,halo:X,polillas:Y}}function GL(){let J=new Q$;J.add(new _0(new D6(10,24,12),new J6({side:I6,uniforms:{uSol:{value:dU}},vertexShader:"varying vec3 vP;void main(){vP=normalize(position);gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}",fragmentShader:"varying vec3 vP;uniform vec3 uSol;void main(){float l=dot(normalize(vP.xz+vec2(1e-4)),normalize(uSol.xz))*.5+.5;vec3 hor=mix(vec3(.3,.25,.36),vec3(.85,.45,.25),pow(l,2.5));gl_FragColor=vec4(mix(hor,vec3(.05,.07,.17),smoothstep(-.05,.7,vP.y))*mix(.35,1.,smoothstep(-.3,0.,vP.y)),1.);}"})));let $=(Q,Z,K,W,X,Y)=>{let H=new _0(new B9(K,W),new p9({color:new b0(Q).multiplyScalar(Z),side:i9}));H.position.set(...X),H.lookAt(...Y),J.add(H)};return $("#ffcf94",6,1.2,1.2,[0,6,0],[0,0,0]),$("#dff3ea",2,5,2,[0,2.5,-8],[0,1,0]),J}function cU({scene:J,renderer:$,camera:Q,controls:Z,software:K,bulbLight:W}){function X(){let v=new kQ($),j=GL(),g=v.fromScene(j,0.02);J.environment?.dispose?.(),J.environment=g.texture,J.environmentIntensity=0.75,v.dispose(),j.traverse((f)=>{f.geometry?.dispose(),f.material?.dispose()})}X(),J.background=new b0("#2a2d4a"),J.fog=new JJ("#5a5670",0.017);let Y=HL(J),H=UL(J),U=new S(0,C0.surfaceY+1.3,0),G=NL(J,U),F=XY((v,j,g)=>{let f=v.createRadialGradient(j/2,g*0.62,0,j/2,g*0.62,j/2);f.addColorStop(0,"rgba(255,196,110,.95)"),f.addColorStop(0.45,"rgba(255,170,80,.35)"),f.addColorStop(1,"rgba(255,150,60,0)"),v.fillStyle=f,v.fillRect(0,0,j,g)},256,128),N=new _0(new B9(0.62,0.26),new p9({map:F,transparent:!0,opacity:0,depthWrite:!1,blending:y8,toneMapped:!1}));N.rotation.x=-Math.PI/2,N.position.y=C0.surfaceY+0.0012,N.renderOrder=3,J.add(N);let q={i:-1,ang:0,alfa:0,objetivo:0,pos:new S},O=(v)=>XY((j,g,f)=>{j.strokeStyle=`rgba(${v},1)`,j.lineWidth=g*0.09,j.beginPath(),j.arc(g/2,f/2,g*0.36,0,Math.PI*2),j.stroke();let o=j.createRadialGradient(g/2,f/2,0,g/2,f/2,g/2);o.addColorStop(0,`rgba(${v},.5)`),o.addColorStop(1,`rgba(${v},0)`),j.fillStyle=o,j.fillRect(0,0,g,f)},128,128),B=["227,174,85","111,183,201"].map((v)=>{let j=new _0(new B9(0.036,0.036),new p9({map:O(v),transparent:!0,opacity:0,depthWrite:!1,blending:y8,toneMapped:!1}));return j.rotation.x=-Math.PI/2,j.position.y=C0.surfaceY+0.0015,j.renderOrder=3,J.add(j),j}),R=null,E=Q.clone(),P=new S,k=new S,V=null,A=null,w=null,D=!1;function L(){if(V)return;let v=$.getDrawingBufferSize(new O0),j=new X6(v.x,v.y,{type:B6,samples:4});V=new ZY($,j),V.addPass(new KY(J,E)),A=new VJ(new O0(v.x/2,v.y/2),0.4,0.5,3.2),w=new TQ({uniforms:{tDiffuse:{value:null},uTiempo:{value:0},uVineta:{value:0.34},uGrano:{value:0.018}},vertexShader:"varying vec2 vUv;void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}",fragmentShader:`uniform sampler2D tDiffuse;uniform float uTiempo,uVineta,uGrano;varying vec2 vUv;
    ...
    void main(){vec4 c=texture2D(tDiffuse,vUv);
     ...
     gl_FragColor=c;}`}),V.addPass(w),V.addPass(new WY)}function M(v){if(D=!K&&v==="high",D)L();G.halo.visible=!0,H.farol.visible=v==="high"}function s(v,j){if(V)V.setPixelRatio($.getPixelRatio()),V.setSize(v,j);E.aspect=Q.aspect,E.updateProjectionMatrix()}function b(v,j,{reduced:g,view:f,ends:o,temblor:p=0}){if(E.copy(Q),!g){if(P.set(Math.sin(v*0.11)*0.012+Math.sin(v*0.037)*0.008,Math.sin(v*0.083+1)*0.007,Math.cos(v*0.097)*0.01),p)P.add(k.set(Math.sin(v*97)*p,Math.sin(v*113)*p*0.6,Math.cos(v*89)*p));E.position.add(P),k.copy(Z.target).addScaledVector(P,0.35),E.lookAt(k)}if(E.updateMatrixWorld(),G.halo.material.opacity=0.5+0.05*Math.sin(v*23)*Math.sin(v*1.7)+(g?0:0.03*Math.sin(v*3.1)),!g)for(let X0 of G.polillas){let M0=v*X0.w+X0.f;X0.s.position.set(Math.cos(M0)*X0.r,X0.y+Math.sin(M0*X0.k)*0.05,Math.sin(M0*1.3)*X0.r)}let r=f?.phase==="playing";if(r&&f.turn!=null){let[X0,M0,y]=C8[f.turn],a=C0.boardLimit+0.075;if(q.i!==f.turn)q.i=f.turn,q.destino=new S(X0*a/C0.seatDistance,0,M0*a/C0.seatDistance),q.angDestino=y;q.pos.lerp(q.destino,1-Math.exp(-j*6));let U0=q.angDestino-q.ang;U0=Math.atan2(Math.sin(U0),Math.cos(U0)),q.ang+=U0*(1-Math.exp(-j*6)),q.objetivo=0.55+(g?0:0.08*Math.sin(v*2.2))}else q.objetivo=0;q.alfa+=(q.objetivo-q.alfa)*(1-Math.exp(-j*4)),N.material.opacity=q.alfa,N.visible=q.alfa>0.01,N.position.set(q.pos.x,C0.surfaceY+0.0012,q.pos.z),N.rotation.set(-Math.PI/2,0,q.ang);for(let X0=0;X0<2;X0++){let M0=B[X0],y=r&&o?o[X0]:null;if(!y){M0.material.opacity=Math.max(0,M0.material.opacity-j*3),M0.visible=M0.material.opacity>0.01;continue}M0.visible=!0,M0.position.set(y.x,C0.surfaceY+0.0015,y.z);let a=g?1:1+0.12*Math.sin(v*3.4+X0*1.3);M0.scale.setScalar(a),M0.material.opacity=Math.min(0.7,M0.material.opacity+j*3)}if(w)w.uniforms.uTiempo.value=v%100}function u(){if(D&&V)V.render();else $.render(J,E)}function e(){V?.dispose()}return{vista:E,frame:b,render:u,resize:s,calidad:M,dispose:e,bulbPos:U,entorno:X}}class EY extends K7{constructor(J){super(J);this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function($){return new eU($)}),this.register(function($){return new JN($)}),this.register(function($){return new UN($)}),this.register(function($){return new NN($)}),this.register(function($){return new GN($)}),this.register(function($){return new QN($)}),this.register(function($){return new ZN($)}),this.register(function($){return new KN($)}),this.register(function($){return new WN($)}),this.register(function($){return new tU($)}),this.register(function($){return new XN($)}),this.register(function($){return new $N($)}),this.register(function($){return new HN($)}),this.register(function($){return new YN($)}),this.register(function($){return new aU($)}),this.register(function($){return new NY($,I9.EXT_MESHOPT_COMPRESSION)}),this.register(function($){return new NY($,I9.KHR_MESHOPT_COMPRESSION)}),this.register(function($){return new FN($)})}load(J,$,Q,Z){let K=this,W;if(this.resourcePath!=="")W=this.resourcePath;else if(this.path!==""){let H=A7.extractUrlBase(J);W=A7.resolveURL(H,this.path)}else W=A7.extractUrlBase(J);this.manager.itemStart(J);let X=function(H){if(Z)Z(H);else console.error(H);K.manager.itemError(J),K.manager.itemEnd(J)},Y=new qQ(this.manager);Y.setPath(this.path),Y.setResponseType("arraybuffer"),Y.setRequestHeader(this.requestHeader),Y.setWithCredentials(this.withCredentials),Y.load(J,function(H){try{K.parse(H,W,function(U){$(U),K.manager.itemEnd(J)},X)}catch(U){X(U)}},Q,X)}setDRACOLoader(J){return this.dracoLoader=J,this}setKTX2Loader(J){return this.ktx2Loader=J,this}setMeshoptDecoder(J){return this.meshoptDecoder=J,this}register(J){if(this.pluginCallbacks.indexOf(J)===-1)this.pluginCallbacks.push(J);return this}unregister(J){if(this.pluginCallbacks.indexOf(J)!==-1)this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(J),1);return this}parse(J,$,Q,Z){let K,W={},X={},Y=new TextDecoder;if(typeof J==="string")K=JSON.parse(J);else if(J instanceof ArrayBuffer)if(Y.decode(new Uint8Array(J,0,4))===EN){try{W[I9.KHR_BINARY_GLTF]=new qN(J)}catch(G){if(Z)Z(G);return}K=JSON.parse(W[I9.KHR_BINARY_GLTF].content)}else K=JSON.parse(Y.decode(J));else K=J;if(K.asset===void 0||K.asset.version[0]<2){if(Z)Z(Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}let H=new BN(K,{path:$||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});H.fileLoader.setRequestHeader(this.requestHeader);for(let U=0;U<this.pluginCallbacks.length;U++){let G=this.pluginCallbacks[U](H);if(!G.name)console.error("THREE.GLTFLoader: Invalid plugin found: missing name");X[G.name]=G,W[G.name]=!0}if(K.extensionsUsed)for(let U=0;U<K.extensionsUsed.length;++U){let G=K.extensionsUsed[U],F=K.extensionsRequired||[];switch(G){case I9.KHR_MATERIALS_UNLIT:W[G]=new rU;break;case I9.KHR_DRACO_MESH_COMPRESSION:W[G]=new ON(K,this.dracoLoader);break;case I9.KHR_TEXTURE_TRANSFORM:W[G]=new RN;break;case I9.KHR_MESH_QUANTIZATION:W[G]=new LN;break;default:if(F.indexOf(G)>=0&&X[G]===void 0)console.warn('THREE.GLTFLoader: Unknown extension "'+G+'".')}}H.setExtensions(W),H.setPlugins(X),H.parse(Q,Z)}parseAsync(J,$){let Q=this;return new Promise(function(Z,K){Q.parse(J,$,Z,K)})}}function FL(){let J={};return{get:function($){return J[$]},add:function($,Q){J[$]=Q},remove:function($){delete J[$]},removeAll:function(){J={}}}}function H6(J,$,Q){let Z=J.json.materials[$];if(Z.extensions&&Z.extensions[Q])return Z.extensions[Q];return null}var I9={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_DISPERSION:"KHR_materials_dispersion",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_MATERIALS_BUMP:"EXT_materials_bump",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",KHR_MESHOPT_COMPRESSION:"KHR_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"};class aU{constructor(J){this.parser=J,this.name=I9.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let J=this.parser,$=this.parser.json.nodes||[];for(let Q=0,Z=$.length;Q<Z;Q++){let K=$[Q];if(K.extensions&&K.extensions[this.name]&&K.extensions[this.name].light!==void 0)J._addNodeRef(this.cache,K.extensions[this.name].light)}}_loadLight(J){let $=this.parser,Q="light:"+J,Z=$.cache.get(Q);if(Z)return Z;let K=$.json,Y=((K.extensions&&K.extensions[this.name]||{}).lights||[])[J],H,U=new b0(16777215);if(Y.color!==void 0)U.setRGB(Y.color[0],Y.color[1],Y.color[2],o6);let G=Y.range!==void 0?Y.range:0;switch(Y.type){case"directional":H=new U$(U),H.target.position.set(0,0,-1),H.add(H.target);break;case"point":H=new W7(U),H.distance=G;break;case"spot":H=new H$(U),H.distance=G,Y.spot=Y.spot||{},Y.spot.innerConeAngle=Y.spot.innerConeAngle!==void 0?Y.spot.innerConeAngle:0,Y.spot.outerConeAngle=Y.spot.outerConeAngle!==void 0?Y.spot.outerConeAngle:Math.PI/4,H.angle=Y.spot.outerConeAngle,H.penumbra=1-Y.spot.innerConeAngle/Y.spot.outerConeAngle,H.target.position.set(0,0,-1),H.add(H.target);break;default:throw Error("THREE.GLTFLoader: Unexpected light type: "+Y.type)}if(H.position.set(0,0,0),u8(H,Y),Y.intensity!==void 0)H.intensity=Y.intensity;return H.name=$.createUniqueName(Y.name||"light_"+J),Z=Promise.resolve(H),$.cache.add(Q,Z),Z}getDependency(J,$){if(J!=="light")return;return this._loadLight($)}createNodeAttachment(J){let $=this,Q=this.parser,K=Q.json.nodes[J],X=(K.extensions&&K.extensions[this.name]||{}).light;if(X===void 0)return null;return this._loadLight(X).then(function(Y){return Q._getNodeRef($.cache,X,Y)})}}class rU{constructor(){this.name=I9.KHR_MATERIALS_UNLIT}getMaterialType(){return p9}extendParams(J,$,Q){let Z=[];J.color=new b0(1,1,1),J.opacity=1;let K=$.pbrMetallicRoughness;if(K){if(Array.isArray(K.baseColorFactor)){let W=K.baseColorFactor;J.color.setRGB(W[0],W[1],W[2],o6),J.opacity=W[3]}if(K.baseColorTexture!==void 0)Z.push(Q.assignTexture(J,"map",K.baseColorTexture,W6))}return Promise.all(Z)}}class tU{constructor(J){this.parser=J,this.name=I9.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(J,$){let Q=H6(this.parser,J,this.name);if(Q===null)return Promise.resolve();if(Q.emissiveStrength!==void 0)$.emissiveIntensity=Q.emissiveStrength;return Promise.resolve()}}class eU{constructor(J){this.parser=J,this.name=I9.KHR_MATERIALS_CLEARCOAT}getMaterialType(J){return H6(this.parser,J,this.name)!==null?k6:null}extendMaterialParams(J,$){let Q=H6(this.parser,J,this.name);if(Q===null)return Promise.resolve();let Z=[];if(Q.clearcoatFactor!==void 0)$.clearcoat=Q.clearcoatFactor;if(Q.clearcoatTexture!==void 0)Z.push(this.parser.assignTexture($,"clearcoatMap",Q.clearcoatTexture));if(Q.clearcoatRoughnessFactor!==void 0)$.clearcoatRoughness=Q.clearcoatRoughnessFactor;if(Q.clearcoatRoughnessTexture!==void 0)Z.push(this.parser.assignTexture($,"clearcoatRoughnessMap",Q.clearcoatRoughnessTexture));if(Q.clearcoatNormalTexture!==void 0){if(Z.push(this.parser.assignTexture($,"clearcoatNormalMap",Q.clearcoatNormalTexture)),Q.clearcoatNormalTexture.scale!==void 0){let K=Q.clearcoatNormalTexture.scale;$.clearcoatNormalScale=new O0(K,K)}}return Promise.all(Z)}}class JN{constructor(J){this.parser=J,this.name=I9.KHR_MATERIALS_DISPERSION}getMaterialType(J){return H6(this.parser,J,this.name)!==null?k6:null}extendMaterialParams(J,$){let Q=H6(this.parser,J,this.name);if(Q===null)return Promise.resolve();return $.dispersion=Q.dispersion!==void 0?Q.dispersion:0,Promise.resolve()}}class $N{constructor(J){this.parser=J,this.name=I9.KHR_MATERIALS_IRIDESCENCE}getMaterialType(J){return H6(this.parser,J,this.name)!==null?k6:null}extendMaterialParams(J,$){let Q=H6(this.parser,J,this.name);if(Q===null)return Promise.resolve();let Z=[];if(Q.iridescenceFactor!==void 0)$.iridescence=Q.iridescenceFactor;if(Q.iridescenceTexture!==void 0)Z.push(this.parser.assignTexture($,"iridescenceMap",Q.iridescenceTexture));if(Q.iridescenceIor!==void 0)$.iridescenceIOR=Q.iridescenceIor;if($.iridescenceThicknessRange===void 0)$.iridescenceThicknessRange=[100,400];if(Q.iridescenceThicknessMinimum!==void 0)$.iridescenceThicknessRange[0]=Q.iridescenceThicknessMinimum;if(Q.iridescenceThicknessMaximum!==void 0)$.iridescenceThicknessRange[1]=Q.iridescenceThicknessMaximum;if(Q.iridescenceThicknessTexture!==void 0)Z.push(this.parser.assignTexture($,"iridescenceThicknessMap",Q.iridescenceThicknessTexture));return Promise.all(Z)}}class QN{constructor(J){this.parser=J,this.name=I9.KHR_MATERIALS_SHEEN}getMaterialType(J){return H6(this.parser,J,this.name)!==null?k6:null}extendMaterialParams(J,$){let Q=H6(this.parser,J,this.name);if(Q===null)return Promise.resolve();let Z=[];if($.sheenColor=new b0(0,0,0),$.sheenRoughness=0,$.sheen=1,Q.sheenColorFactor!==void 0){let K=Q.sheenColorFactor;$.sheenColor.setRGB(K[0],K[1],K[2],o6)}if(Q.sheenRoughnessFactor!==void 0)$.sheenRoughness=Q.sheenRoughnessFactor;if(Q.sheenColorTexture!==void 0)Z.push(this.parser.assignTexture($,"sheenColorMap",Q.sheenColorTexture,W6));if(Q.sheenRoughnessTexture!==void 0)Z.push(this.parser.assignTexture($,"sheenRoughnessMap",Q.sheenRoughnessTexture));return Promise.all(Z)}}class ZN{constructor(J){this.parser=J,this.name=I9.KHR_MATERIALS_TRANSMISSION}getMaterialType(J){return H6(this.parser,J,this.name)!==null?k6:null}extendMaterialParams(J,$){let Q=H6(this.parser,J,this.name);if(Q===null)return Promise.resolve();let Z=[];if(Q.transmissionFactor!==void 0)$.transmission=Q.transmissionFactor;if(Q.transmissionTexture!==void 0)Z.push(this.parser.assignTexture($,"transmissionMap",Q.transmissionTexture));return Promise.all(Z)}}class KN{constructor(J){this.parser=J,this.name=I9.KHR_MATERIALS_VOLUME}getMaterialType(J){return H6(this.parser,J,this.name)!==null?k6:null}extendMaterialParams(J,$){let Q=H6(this.parser,J,this.name);if(Q===null)return Promise.resolve();let Z=[];if($.thickness=Q.thicknessFactor!==void 0?Q.thicknessFactor:0,Q.thicknessTexture!==void 0)Z.push(this.parser.assignTexture($,"thicknessMap",Q.thicknessTexture));$.attenuationDistance=Q.attenuationDistance||1/0;let K=Q.attenuationColor||[1,1,1];return $.attenuationColor=new b0().setRGB(K[0],K[1],K[2],o6),Promise.all(Z)}}class WN{constructor(J){this.parser=J,this.name=I9.KHR_MATERIALS_IOR}getMaterialType(J){return H6(this.parser,J,this.name)!==null?k6:null}extendMaterialParams(J,$){let Q=H6(this.parser,J,this.name);if(Q===null)return Promise.resolve();if($.ior=Q.ior!==void 0?Q.ior:1.5,$.ior===0)$.ior=1000;return Promise.resolve()}}class XN{constructor(J){this.parser=J,this.name=I9.KHR_MATERIALS_SPECULAR}getMaterialType(J){return H6(this.parser,J,this.name)!==null?k6:null}extendMaterialParams(J,$){let Q=H6(this.parser,J,this.name);if(Q===null)return Promise.resolve();let Z=[];if($.specularIntensity=Q.specularFactor!==void 0?Q.specularFactor:1,Q.specularTexture!==void 0)Z.push(this.parser.assignTexture($,"specularIntensityMap",Q.specularTexture));let K=Q.specularColorFactor||[1,1,1];if($.specularColor=new b0().setRGB(K[0],K[1],K[2],o6),Q.specularColorTexture!==void 0)Z.push(this.parser.assignTexture($,"specularColorMap",Q.specularColorTexture,W6));return Promise.all(Z)}}class YN{constructor(J){this.parser=J,this.name=I9.EXT_MATERIALS_BUMP}getMaterialType(J){return H6(this.parser,J,this.name)!==null?k6:null}extendMaterialParams(J,$){let Q=H6(this.parser,J,this.name);if(Q===null)return Promise.resolve();let Z=[];if($.bumpScale=Q.bumpFactor!==void 0?Q.bumpFactor:1,Q.bumpTexture!==void 0)Z.push(this.parser.assignTexture($,"bumpMap",Q.bumpTexture));return Promise.all(Z)}}class HN{constructor(J){this.parser=J,this.name=I9.KHR_MATERIALS_ANISOTROPY}getMaterialType(J){return H6(this.parser,J,this.name)!==null?k6:null}extendMaterialParams(J,$){let Q=H6(this.parser,J,this.name);if(Q===null)return Promise.resolve();let Z=[];if(Q.anisotropyStrength!==void 0)$.anisotropy=Q.anisotropyStrength;if(Q.anisotropyRotation!==void 0)$.anisotropyRotation=Q.anisotropyRotation;if(Q.anisotropyTexture!==void 0)Z.push(this.parser.assignTexture($,"anisotropyMap",Q.anisotropyTexture));return Promise.all(Z)}}class UN{constructor(J){this.parser=J,this.name=I9.KHR_TEXTURE_BASISU}loadTexture(J){let $=this.parser,Q=$.json,Z=Q.textures[J];if(!Z.extensions||!Z.extensions[this.name])return null;let K=Z.extensions[this.name],W=$.options.ktx2Loader;if(!W)if(Q.extensionsRequired&&Q.extensionsRequired.indexOf(this.name)>=0)throw Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");else return null;return $.loadTextureImage(J,K.source,W)}}class NN{constructor(J){this.parser=J,this.name=I9.EXT_TEXTURE_WEBP}loadTexture(J){let $=this.name,Q=this.parser,Z=Q.json,K=Z.textures[J];if(!K.extensions||!K.extensions[$])return null;let W=K.extensions[$],X=Z.images[W.source],Y=Q.textureLoader;if(X.uri){let H=Q.options.manager.getHandler(X.uri);if(H!==null)Y=H}return Q.loadTextureImage(J,W.source,Y)}}class GN{constructor(J){this.parser=J,this.name=I9.EXT_TEXTURE_AVIF}loadTexture(J){let $=this.name,Q=this.parser,Z=Q.json,K=Z.textures[J];if(!K.extensions||!K.extensions[$])return null;let W=K.extensions[$],X=Z.images[W.source],Y=Q.textureLoader;if(X.uri){let H=Q.options.manager.getHandler(X.uri);if(H!==null)Y=H}return Q.loadTextureImage(J,W.source,Y)}}class NY{constructor(J,$){this.name=$,this.parser=J}loadBufferView(J){let $=this.parser.json,Q=$.bufferViews[J];if(Q.extensions&&Q.extensions[this.name]){let Z=Q.extensions[this.name],K=this.parser.getDependency("buffer",Z.buffer),W=this.parser.options.meshoptDecoder;if(!W||!W.supported)if($.extensionsRequired&&$.extensionsRequired.indexOf(this.name)>=0)throw Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");else return null;return K.then(function(X){let Y=Z.byteOffset||0,H=Z.byteLength||0,U=Z.count,G=Z.byteStride,F=new Uint8Array(X,Y,H);if(W.decodeGltfBufferAsync)return W.decodeGltfBufferAsync(U,G,F,Z.mode,Z.filter).then(function(N){return N.buffer});else return W.ready.then(function(){let N=new ArrayBuffer(U*G);return W.decodeGltfBuffer(new Uint8Array(N),U,G,F,Z.mode,Z.filter),N})})}else return null}}class FN{constructor(J){this.name=I9.EXT_MESH_GPU_INSTANCING,this.parser=J}createNodeMesh(J){let $=this.parser.json,Q=$.nodes[J];if(!Q.extensions||!Q.extensions[this.name]||Q.mesh===void 0)return null;let Z=$.meshes[Q.mesh];for(let H of Z.primitives)if(H.mode!==F8.TRIANGLES&&H.mode!==F8.TRIANGLE_STRIP&&H.mode!==F8.TRIANGLE_FAN&&H.mode!==void 0)return null;let W=Q.extensions[this.name].attributes,X=[],Y={};for(let H in W)X.push(this.parser.getDependency("accessor",W[H]).then((U)=>{return Y[H]=U,Y[H]}));if(X.length<1)return null;return X.push(this.parser.createNodeMesh(J)),Promise.all(X).then((H)=>{let U=H.pop(),G=U.isGroup?U.children:[U],F=H[0].count,N=[];for(let q of G){let O=new $9,B=new S,R=new K9,E=new S(1,1,1),P=new h8(q.geometry,q.material,F);for(let V=0;V<F;V++){if(Y.TRANSLATION)B.fromBufferAttribute(Y.TRANSLATION,V);if(Y.ROTATION)R.fromBufferAttribute(Y.ROTATION,V);if(Y.SCALE)E.fromBufferAttribute(Y.SCALE,V);P.setMatrixAt(V,O.compose(B,R,E))}let k=null;for(let V in Y)if(V==="_COLOR_0"){let A=Y[V];P.instanceColor=new O7(A.array,A.itemSize,A.normalized)}else if(V!=="TRANSLATION"&&V!=="ROTATION"&&V!=="SCALE"){if(k===null){let w=P.geometry;k=new g9,k.name=w.name;for(let D in w.attributes)k.setAttribute(D,w.attributes[D]);for(let D in w.morphAttributes)k.morphAttributes[D]=w.morphAttributes[D];if(w.index!==null)k.setIndex(w.index);k.morphTargetsRelative=w.morphTargetsRelative;for(let D of w.groups)k.addGroup(D.start,D.count,D.materialIndex);if(w.boundingBox!==null)k.boundingBox=w.boundingBox.clone();if(w.boundingSphere!==null)k.boundingSphere=w.boundingSphere.clone();k.drawRange.start=w.drawRange.start,k.drawRange.count=w.drawRange.count,k.userData=Object.assign({},w.userData),P.geometry=k}let A=Y[V];k.setAttribute(V,new O7(A.array,A.itemSize,A.normalized))}y9.prototype.copy.call(P,q),this.parser.assignFinalMaterial(P),N.push(P)}if(U.isGroup)return U.clear(),U.add(...N),U;return N[0]})}}var EN="glTF",wQ=12,nU={JSON:1313821514,BIN:5130562};class qN{constructor(J){this.name=I9.KHR_BINARY_GLTF,this.content=null,this.body=null;let $=new DataView(J,0,wQ),Q=new TextDecoder;if(this.header={magic:Q.decode(new Uint8Array(J.slice(0,4))),version:$.getUint32(4,!0),length:$.getUint32(8,!0)},this.header.magic!==EN)throw Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");else if(this.header.version<2)throw Error("THREE.GLTFLoader: Legacy binary file detected.");let Z=this.header.length-wQ,K=new DataView(J,wQ),W=0;while(W<Z){let X=K.getUint32(W,!0);W+=4;let Y=K.getUint32(W,!0);if(W+=4,Y===nU.JSON){let H=new Uint8Array(J,wQ+W,X);this.content=Q.decode(H)}else if(Y===nU.BIN){let H=wQ+W;this.body=J.slice(H,H+X)}W+=X}if(this.content===null)throw Error("THREE.GLTFLoader: JSON content not found.")}}class ON{constructor(J,$){if(!$)throw Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=I9.KHR_DRACO_MESH_COMPRESSION,this.json=J,this.dracoLoader=$,this.dracoLoader.preload()}decodePrimitive(J,$){let Q=this.json,Z=this.dracoLoader,K=J.extensions[this.name].bufferView,W=J.extensions[this.name].attributes,X={},Y={},H={};for(let U in W){let G=GY[U]||U.toLowerCase();X[G]=W[U]}for(let U in J.attributes){let G=GY[U]||U.toLowerCase();if(W[U]!==void 0){let F=Q.accessors[J.attributes[U]],N=V$[F.componentType];H[G]=N.name,Y[G]=F.normalized===!0}}return $.getDependency("bufferView",K).then(function(U){return new Promise(function(G,F){Z.decodeDracoFile(U,function(N){for(let q in N.attributes){let O=N.attributes[q],B=Y[q];if(B!==void 0)O.normalized=B}G(N)},X,H,o6,F)})})}}class RN{constructor(){this.name=I9.KHR_TEXTURE_TRANSFORM}extendTexture(J,$){if(($.texCoord===void 0||$.texCoord===J.channel)&&$.offset===void 0&&$.rotation===void 0&&$.scale===void 0)return J;if(J=J.clone(),$.texCoord!==void 0)J.channel=$.texCoord;if($.offset!==void 0)J.offset.fromArray($.offset);if($.rotation!==void 0)J.rotation=$.rotation;if($.scale!==void 0)J.repeat.fromArray($.scale);if($.rotation!==void 0){let Q=Math.cos(J.rotation),Z=Math.sin(J.rotation);J.matrix.set(J.repeat.x*Q,J.repeat.y*Z,J.offset.x,-J.repeat.x*Z,J.repeat.y*Q,J.offset.y,0,0,1),J.matrixAutoUpdate=!1}return J.needsUpdate=!0,J}}class LN{constructor(){this.name=I9.KHR_MESH_QUANTIZATION}}class qY extends Z7{constructor(J,$,Q,Z){super(J,$,Q,Z)}copySampleValue_(J){let $=this.resultBuffer,Q=this.sampleValues,Z=this.valueSize,K=J*Z*3+Z;for(let W=0;W!==Z;W++)$[W]=Q[K+W];return $}interpolate_(J,$,Q,Z){let K=this.resultBuffer,W=this.sampleValues,X=this.valueSize,Y=X*2,H=X*3,U=Z-$,G=(Q-$)/U,F=G*G,N=F*G,q=J*H,O=q-H,B=-2*N+3*F,R=N-F,E=1-B,P=R-F+G;for(let k=0;k!==X;k++){let V=W[O+k+X],A=W[O+k+Y]*U,w=W[q+k+X],D=W[q+k]*U;K[k]=E*V+P*A+B*w+R*D}return K}}var EL=new K9;class VN extends qY{interpolate_(J,$,Q,Z){let K=super.interpolate_(J,$,Q,Z);return EL.fromArray(K).normalize().toArray(K),K}}var F8={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},V$={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},sU={9728:D8,9729:V6,9984:TZ,9985:eJ,9986:o7,9987:v8},iU={33071:tJ,33648:_Z,10497:B7},YY={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},GY={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},S7={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},qL={CUBICSPLINE:void 0,LINEAR:bZ,STEP:eW},HY={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function OL(J){if(J.DefaultMaterial===void 0)J.DefaultMaterial=new o0({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:V7});return J.DefaultMaterial}function BJ(J,$,Q){for(let Z in Q.extensions)if(J[Z]===void 0)$.userData.gltfExtensions=$.userData.gltfExtensions||{},$.userData.gltfExtensions[Z]=Q.extensions[Z]}function u8(J,$){if($.extras!==void 0)if(typeof $.extras==="object")Object.assign(J.userData,$.extras);else console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+$.extras)}function RL(J,$,Q){let Z=!1,K=!1,W=!1;for(let U=0,G=$.length;U<G;U++){let F=$[U];if(F.POSITION!==void 0)Z=!0;if(F.NORMAL!==void 0)K=!0;if(F.COLOR_0!==void 0)W=!0;if(Z&&K&&W)break}if(!Z&&!K&&!W)return Promise.resolve(J);let X=[],Y=[],H=[];for(let U=0,G=$.length;U<G;U++){let F=$[U];if(Z){let N=F.POSITION!==void 0?Q.getDependency("accessor",F.POSITION):J.attributes.position;X.push(N)}if(K){let N=F.NORMAL!==void 0?Q.getDependency("accessor",F.NORMAL):J.attributes.normal;Y.push(N)}if(W){let N=F.COLOR_0!==void 0?Q.getDependency("accessor",F.COLOR_0):J.attributes.color;H.push(N)}}return Promise.all([Promise.all(X),Promise.all(Y),Promise.all(H)]).then(function(U){let G=U[0],F=U[1],N=U[2];if(Z)J.morphAttributes.position=G;if(K)J.morphAttributes.normal=F;if(W)J.morphAttributes.color=N;return J.morphTargetsRelative=!0,J})}function LL(J,$){if(J.updateMorphTargets(),$.weights!==void 0)for(let Q=0,Z=$.weights.length;Q<Z;Q++)J.morphTargetInfluences[Q]=$.weights[Q];if($.extras&&Array.isArray($.extras.targetNames)){let Q=$.extras.targetNames;if(J.morphTargetInfluences.length===Q.length){J.morphTargetDictionary={};for(let Z=0,K=Q.length;Z<K;Z++)J.morphTargetDictionary[Q[Z]]=Z}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function VL(J){let $,Q=J.extensions&&J.extensions[I9.KHR_DRACO_MESH_COMPRESSION];if(Q)$="draco:"+Q.bufferView+":"+Q.indices+":"+UY(Q.attributes);else $=J.indices+":"+UY(J.attributes)+":"+J.mode;if(J.targets!==void 0)for(let Z=0,K=J.targets.length;Z<K;Z++)$+=":"+UY(J.targets[Z]);return $}function UY(J){let $="",Q=Object.keys(J).sort();for(let Z=0,K=Q.length;Z<K;Z++)$+=Q[Z]+":"+J[Q[Z]]+";";return $}function FY(J){switch(J){case Int8Array:return 0.007874015748031496;case Uint8Array:return 0.00392156862745098;case Int16Array:return 0.00003051850947599719;case Uint16Array:return 0.000015259021896696422;default:throw Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function BL(J){if(J.search(/\.jpe?g($|\?)/i)>0||J.search(/^data\:image\/jpeg/)===0)return"image/jpeg";if(J.search(/\.webp($|\?)/i)>0||J.search(/^data\:image\/webp/)===0)return"image/webp";if(J.search(/\.ktx2($|\?)/i)>0||J.search(/^data\:image\/ktx2/)===0)return"image/ktx2";return"image/png"}var DL=new $9;class BN{constructor(J={},$={}){this.json=J,this.extensions={},this.plugins={},this.options=$,this.cache=new FL,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let Q=!1,Z=-1,K=!1,W=-1;if(typeof navigator<"u"&&typeof navigator.userAgent<"u"){let X=navigator.userAgent;Q=/^((?!chrome|android).)*safari/i.test(X)===!0;let Y=X.match(/Version\/(\d+)/);Z=Q&&Y?parseInt(Y[1],10):-1,K=X.indexOf("Firefox")>-1,W=K?X.match(/Firefox\/([0-9]+)\./)[1]:-1}if(typeof createImageBitmap>"u"||Q&&Z<17||K&&W<98)this.textureLoader=new $K(this.options.manager);else this.textureLoader=new KK(this.options.manager);if(this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new qQ(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials")this.fileLoader.setWithCredentials(!0)}setExtensions(J){this.extensions=J}setPlugins(J){this.plugins=J}parse(J,$){let Q=this,Z=this.json,K=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(W){return W._markDefs&&W._markDefs()}),Promise.all(this._invokeAll(function(W){return W.beforeRoot&&W.beforeRoot()})).then(function(){return Promise.all([Q.getDependencies("scene"),Q.getDependencies("animation"),Q.getDependencies("camera")])}).then(function(W){let X={scene:W[0][Z.scene||0],scenes:W[0],animations:W[1],cameras:W[2],asset:Z.asset,parser:Q,userData:{}};return BJ(K,X,Z),u8(X,Z),Promise.all(Q._invokeAll(function(Y){return Y.afterRoot&&Y.afterRoot(X)})).then(function(){for(let Y of X.scenes)Y.updateMatrixWorld();J(X)})}).catch($)}_markDefs(){let J=this.json.nodes||[],$=this.json.skins||[],Q=this.json.meshes||[];for(let Z=0,K=$.length;Z<K;Z++){let W=$[Z].joints;for(let X=0,Y=W.length;X<Y;X++)J[W[X]].isBone=!0}for(let Z=0,K=J.length;Z<K;Z++){let W=J[Z];if(W.mesh!==void 0){if(this._addNodeRef(this.meshCache,W.mesh),W.skin!==void 0)Q[W.mesh].isSkinnedMesh=!0}if(W.camera!==void 0)this._addNodeRef(this.cameraCache,W.camera)}}_addNodeRef(J,$){if($===void 0)return;if(J.refs[$]===void 0)J.refs[$]=J.uses[$]=0;J.refs[$]++}_getNodeRef(J,$,Q){if(J.refs[$]<=1)return Q;let Z=Q.clone(),K=(W,X)=>{let Y=this.associations.get(W);if(Y!=null)this.associations.set(X,Y);for(let[H,U]of W.children.entries())K(U,X.children[H])};return K(Q,Z),Z.name+="_instance_"+J.uses[$]++,Z}_invokeOne(J){let $=Object.values(this.plugins);$.push(this);for(let Q=0;Q<$.length;Q++){let Z=J($[Q]);if(Z)return Z}return null}_invokeAll(J){let $=Object.values(this.plugins);$.unshift(this);let Q=[];for(let Z=0;Z<$.length;Z++){let K=J($[Z]);if(K)Q.push(K)}return Q}getDependency(J,$){let Q=J+":"+$,Z=this.cache.get(Q);if(!Z){switch(J){case"scene":Z=this.loadScene($);break;case"node":Z=this._invokeOne(function(K){return K.loadNode&&K.loadNode($)});break;case"mesh":Z=this._invokeOne(function(K){return K.loadMesh&&K.loadMesh($)});break;case"accessor":Z=this.loadAccessor($);break;case"bufferView":Z=this._invokeOne(function(K){return K.loadBufferView&&K.loadBufferView($)});break;case"buffer":Z=this.loadBuffer($);break;case"material":Z=this._invokeOne(function(K){return K.loadMaterial&&K.loadMaterial($)});break;case"texture":Z=this._invokeOne(function(K){return K.loadTexture&&K.loadTexture($)});break;case"skin":Z=this.loadSkin($);break;case"animation":Z=this._invokeOne(function(K){return K.loadAnimation&&K.loadAnimation($)});break;case"camera":Z=this.loadCamera($);break;default:if(Z=this._invokeOne(function(K){return K!=this&&K.getDependency&&K.getDependency(J,$)}),!Z)throw Error("Unknown type: "+J);break}this.cache.add(Q,Z)}return Z}getDependencies(J){let $=this.cache.get(J);if(!$){let Q=this,Z=this.json[J+(J==="mesh"?"es":"s")]||[];$=Promise.all(Z.map(function(K,W){return Q.getDependency(J,W)})),this.cache.add(J,$)}return $}loadBuffer(J){let $=this.json.buffers[J],Q=this.fileLoader;if($.type&&$.type!=="arraybuffer")throw Error("THREE.GLTFLoader: "+$.type+" buffer type is not supported.");if($.uri===void 0&&J===0)return Promise.resolve(this.extensions[I9.KHR_BINARY_GLTF].body);let Z=this.options;return new Promise(function(K,W){Q.load(A7.resolveURL($.uri,Z.path),K,void 0,function(){W(Error('THREE.GLTFLoader: Failed to load buffer "'+$.uri+'".'))})})}loadBufferView(J){let $=this.json.bufferViews[J];return this.getDependency("buffer",$.buffer).then(function(Q){let Z=$.byteLength||0,K=$.byteOffset||0;return Q.slice(K,K+Z)})}loadAccessor(J){let $=this,Q=this.json,Z=this.json.accessors[J];if(Z.bufferView===void 0&&Z.sparse===void 0){let W=YY[Z.type],X=V$[Z.componentType],Y=Z.normalized===!0,H=new X(Z.count*W);return Promise.resolve(new t9(H,W,Y))}let K=[];if(Z.bufferView!==void 0)K.push(this.getDependency("bufferView",Z.bufferView));else K.push(null);if(Z.sparse!==void 0)K.push(this.getDependency("bufferView",Z.sparse.indices.bufferView)),K.push(this.getDependency("bufferView",Z.sparse.values.bufferView));return Promise.all(K).then(function(W){let X=W[0],Y=YY[Z.type],H=V$[Z.componentType],U=H.BYTES_PER_ELEMENT,G=U*Y,F=Z.byteOffset||0,N=Z.bufferView!==void 0?Q.bufferViews[Z.bufferView].byteStride:void 0,q=Z.normalized===!0,O,B;if(N&&N!==G){let R=Math.floor(F/N),E="InterleavedBuffer:"+Z.bufferView+":"+Z.componentType+":"+R+":"+Z.count,P=$.cache.get(E);if(!P)O=new H(X,R*N,Z.count*N/U),P=new Z$(O,N/U),$.cache.add(E,P);B=new q7(P,Y,F%N/U,q)}else{if(X===null)O=new H(Z.count*Y);else O=new H(X,F,Z.count*Y);B=new t9(O,Y,q)}if(Z.sparse!==void 0){let R=YY.SCALAR,E=V$[Z.sparse.indices.componentType],P=Z.sparse.indices.byteOffset||0,k=Z.sparse.values.byteOffset||0,V=new E(W[1],P,Z.sparse.count*R),A=new H(W[2],k,Z.sparse.count*Y);if(X!==null)B=new t9(B.array.slice(),B.itemSize,B.normalized);B.normalized=!1;for(let w=0,D=V.length;w<D;w++){let L=V[w];if(B.setX(L,A[w*Y]),Y>=2)B.setY(L,A[w*Y+1]);if(Y>=3)B.setZ(L,A[w*Y+2]);if(Y>=4)B.setW(L,A[w*Y+3]);if(Y>=5)throw Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}B.normalized=q}return B})}loadTexture(J){let $=this.json,Q=this.options,K=$.textures[J].source,W=$.images[K],X=this.textureLoader;if(W.uri){let Y=Q.manager.getHandler(W.uri);if(Y!==null)X=Y}return this.loadTextureImage(J,K,X)}loadTextureImage(J,$,Q){let Z=this,K=this.json,W=K.textures[J],X=K.images[$],Y=(X.uri||X.bufferView)+":"+W.sampler;if(this.textureCache[Y])return this.textureCache[Y];let H=this.loadImageSource($,Q).then(function(U){if(U.flipY=!1,U.name=W.name||X.name||"",U.name===""&&typeof X.uri==="string"&&X.uri.startsWith("data:image/")===!1)U.name=X.uri;let F=(K.samplers||{})[W.sampler]||{};return U.magFilter=sU[F.magFilter]||V6,U.minFilter=sU[F.minFilter]||v8,U.wrapS=iU[F.wrapS]||B7,U.wrapT=iU[F.wrapT]||B7,U.generateMipmaps=!U.isCompressedTexture&&U.minFilter!==D8&&U.minFilter!==V6,Z.associations.set(U,{textures:J}),U}).catch(function(){return null});return this.textureCache[Y]=H,H}loadImageSource(J,$){let Q=this,Z=this.json,K=this.options;if(this.sourceCache[J]!==void 0)return this.sourceCache[J].then((G)=>G.clone());let W=Z.images[J],X=self.URL||self.webkitURL,Y=W.uri||"",H=!1;if(W.bufferView!==void 0)Y=Q.getDependency("bufferView",W.bufferView).then(function(G){H=!0;let F=new Blob([G],{type:W.mimeType});return Y=X.createObjectURL(F),Y});else if(W.uri===void 0)throw Error("THREE.GLTFLoader: Image "+J+" is missing URI and bufferView");let U=Promise.resolve(Y).then(function(G){return new Promise(function(F,N){let q=F;if($.isImageBitmapLoader===!0)q=function(O){let B=new K6(O);B.needsUpdate=!0,F(B)};$.load(A7.resolveURL(G,K.path),q,void 0,N)})}).then(function(G){if(H===!0)X.revokeObjectURL(Y);return u8(G,W),G.userData.mimeType=W.mimeType||BL(W.uri),G}).catch(function(G){throw console.error("THREE.GLTFLoader: Couldn't load texture",Y),G});return this.sourceCache[J]=U,U}assignTexture(J,$,Q,Z){let K=this;return this.getDependency("texture",Q.index).then(function(W){if(!W)return null;if(Q.texCoord!==void 0&&Q.texCoord>0)W=W.clone(),W.channel=Q.texCoord;if(K.extensions[I9.KHR_TEXTURE_TRANSFORM]){let X=Q.extensions!==void 0?Q.extensions[I9.KHR_TEXTURE_TRANSFORM]:void 0;if(X){let Y=K.associations.get(W);W=K.extensions[I9.KHR_TEXTURE_TRANSFORM].extendTexture(W,X),K.associations.set(W,Y)}}if(Z!==void 0)W.colorSpace=Z;return J[$]=W,W})}assignFinalMaterial(J){let{geometry:$,material:Q}=J,Z=$.attributes.tangent===void 0,K=$.attributes.color!==void 0,W=$.attributes.normal===void 0;if(J.isPoints){let X="PointsMaterial:"+Q.uuid,Y=this.cache.get(X);if(!Y)Y=new ZJ,x6.prototype.copy.call(Y,Q),Y.color.copy(Q.color),Y.map=Q.map,Y.sizeAttenuation=!1,this.cache.add(X,Y);Q=Y}else if(J.isLine){let X="LineBasicMaterial:"+Q.uuid,Y=this.cache.get(X);if(!Y)Y=new HQ,x6.prototype.copy.call(Y,Q),Y.color.copy(Q.color),Y.map=Q.map,this.cache.add(X,Y);Q=Y}if(Z||K||W){let X="ClonedMaterial:"+Q.uuid+":";if(Z)X+="derivative-tangents:";if(K)X+="vertex-colors:";if(W)X+="flat-shading:";let Y=this.cache.get(X);if(!Y){if(Y=Q.clone(),K)Y.vertexColors=!0;if(W)Y.flatShading=!0;if(Z){if(Y.normalScale)Y.normalScale.y*=-1;if(Y.clearcoatNormalScale)Y.clearcoatNormalScale.y*=-1}this.cache.add(X,Y),this.associations.set(Y,this.associations.get(Q))}Q=Y}J.material=Q}getMaterialType(){return o0}loadMaterial(J){let $=this,Q=this.json,Z=this.extensions,K=Q.materials[J],W,X={},Y=K.extensions||{},H=[];if(Y[I9.KHR_MATERIALS_UNLIT]){let G=Z[I9.KHR_MATERIALS_UNLIT];W=G.getMaterialType(),H.push(G.extendParams(X,K,$))}else{let G=K.pbrMetallicRoughness||{};if(X.color=new b0(1,1,1),X.opacity=1,Array.isArray(G.baseColorFactor)){let F=G.baseColorFactor;X.color.setRGB(F[0],F[1],F[2],o6),X.opacity=F[3]}if(G.baseColorTexture!==void 0)H.push($.assignTexture(X,"map",G.baseColorTexture,W6));if(X.metalness=G.metallicFactor!==void 0?G.metallicFactor:1,X.roughness=G.roughnessFactor!==void 0?G.roughnessFactor:1,G.metallicRoughnessTexture!==void 0)H.push($.assignTexture(X,"metalnessMap",G.metallicRoughnessTexture)),H.push($.assignTexture(X,"roughnessMap",G.metallicRoughnessTexture));W=this._invokeOne(function(F){return F.getMaterialType&&F.getMaterialType(J)}),H.push(Promise.all(this._invokeAll(function(F){return F.extendMaterialParams&&F.extendMaterialParams(J,X)})))}if(K.doubleSided===!0)X.side=i9;let U=K.alphaMode||HY.OPAQUE;if(U===HY.BLEND)X.transparent=!0,X.depthWrite=!1;else if(X.transparent=!1,U===HY.MASK)X.alphaTest=K.alphaCutoff!==void 0?K.alphaCutoff:0.5;if(K.normalTexture!==void 0&&W!==p9){if(H.push($.assignTexture(X,"normalMap",K.normalTexture)),X.normalScale=new O0(1,1),K.normalTexture.scale!==void 0){let G=K.normalTexture.scale;X.normalScale.set(G,G)}}if(K.occlusionTexture!==void 0&&W!==p9){if(H.push($.assignTexture(X,"aoMap",K.occlusionTexture)),K.occlusionTexture.strength!==void 0)X.aoMapIntensity=K.occlusionTexture.strength}if(K.emissiveFactor!==void 0&&W!==p9){let G=K.emissiveFactor;X.emissive=new b0().setRGB(G[0],G[1],G[2],o6)}if(K.emissiveTexture!==void 0&&W!==p9)H.push($.assignTexture(X,"emissiveMap",K.emissiveTexture,W6));return Promise.all(H).then(function(){let G=new W(X);if(K.name)G.name=K.name;if(u8(G,K),$.associations.set(G,{materials:J}),K.extensions)BJ(Z,G,K);return G})}createUniqueName(J){let $=x9.sanitizeNodeName(J||"");if($ in this.nodeNamesUsed)return $+"_"+ ++this.nodeNamesUsed[$];else return this.nodeNamesUsed[$]=0,$}loadGeometries(J){let $=this,Q=this.extensions,Z=this.primitiveCache;function K(X){return Q[I9.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(X,$).then(function(Y){return oU(Y,X,$)})}let W=[];for(let X=0,Y=J.length;X<Y;X++){let H=J[X],U=VL(H),G=Z[U];if(G)W.push(G.promise);else{let F;if(H.extensions&&H.extensions[I9.KHR_DRACO_MESH_COMPRESSION])F=K(H);else F=oU(new g9,H,$);if(H.mode===F8.TRIANGLE_STRIP)F=F.then((N)=>cX(N,QQ));else if(H.mode===F8.TRIANGLE_FAN)F=F.then((N)=>cX(N,$$));Z[U]={primitive:H,promise:F},W.push(F)}}return Promise.all(W)}loadMesh(J){let $=this,Q=this.json,Z=this.extensions,K=Q.meshes[J],W=K.primitives,X=[];for(let Y=0,H=W.length;Y<H;Y++){let U=W[Y].material===void 0?OL(this.cache):this.getDependency("material",W[Y].material);X.push(U)}return X.push($.loadGeometries(W)),Promise.all(X).then(async function(Y){let H=Y.slice(0,Y.length-1),U=Y[Y.length-1],G=[];for(let N=0,q=U.length;N<q;N++){let O=U[N],B=W[N],R,E=H[N];if(B.mode===F8.TRIANGLES||B.mode===F8.TRIANGLE_STRIP||B.mode===F8.TRIANGLE_FAN||B.mode===void 0){let P=K.isSkinnedMesh===!0,k=O.hasAttribute("skinIndex")&&O.hasAttribute("skinWeight");if(P&&k===!1)console.warn("THREE.GLTFLoader: Missing skinIndex or skinWeight attributes. Skinning disabled.");if(R=P&&k?new uZ(O,E):new _0(O,E),R.isSkinnedMesh===!0)R.normalizeSkinWeights()}else if(B.mode===F8.LINES)R=new dZ(O,E);else if(B.mode===F8.LINE_STRIP)R=new W$(O,E);else if(B.mode===F8.LINE_LOOP)R=new cZ(O,E);else if(B.mode===F8.POINTS)R=new X$(O,E);else throw Error("THREE.GLTFLoader: Primitive mode unsupported: "+B.mode);if(Object.keys(R.geometry.morphAttributes).length>0)LL(R,K);if(R.name=$.createUniqueName(K.name||"mesh_"+J),u8(R,K),B.extensions)BJ(Z,R,B);$.assignFinalMaterial(R),G.push(R)}for(let N=0,q=G.length;N<q;N++)$.associations.set(G[N],{meshes:J,primitives:N});if(G.length===1){if(K.extensions)BJ(Z,G[0],K);return G[0]}let F=new S9;if(K.extensions)BJ(Z,F,K);$.associations.set(F,{meshes:J});for(let N=0,q=G.length;N<q;N++)F.add(G[N]);return F})}loadCamera(J){let $,Q=this.json.cameras[J],Z=Q[Q.type];if(!Z){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}if(Q.type==="perspective")$=new G6(b8.radToDeg(Z.yfov),Z.aspectRatio||1,Z.znear||1,Z.zfar||2000000);else if(Q.type==="orthographic")$=new X7(-Z.xmag,Z.xmag,Z.ymag,-Z.ymag,Z.znear,Z.zfar);if(Q.name)$.name=this.createUniqueName(Q.name);return u8($,Q),Promise.resolve($)}loadSkin(J){let $=this.json.skins[J],Q=[];for(let Z=0,K=$.joints.length;Z<K;Z++)Q.push(this._loadNodeShallow($.joints[Z]));if($.inverseBindMatrices!==void 0)Q.push(this.getDependency("accessor",$.inverseBindMatrices));else Q.push(null);return Promise.all(Q).then(function(Z){let K=Z.pop(),W=Z,X=[],Y=[];for(let H=0,U=W.length;H<U;H++){let G=W[H];if(G){X.push(G);let F=new $9;if(K!==null)F.fromArray(K.array,H*16);Y.push(F)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',$.joints[H])}return new YQ(X,Y)})}loadAnimation(J){let $=this.json,Q=this,Z=$.animations[J],K=Z.name?Z.name:"animation_"+J,W=[],X=[],Y=[],H=[],U=[];for(let G=0,F=Z.channels.length;G<F;G++){let N=Z.channels[G],q=Z.samplers[N.sampler],O=N.target,B=O.node,R=Z.parameters!==void 0?Z.parameters[q.input]:q.input,E=Z.parameters!==void 0?Z.parameters[q.output]:q.output;if(O.node===void 0)continue;W.push(this.getDependency("node",B)),X.push(this.getDependency("accessor",R)),Y.push(this.getDependency("accessor",E)),H.push(q),U.push(O)}return Promise.all([Promise.all(W),Promise.all(X),Promise.all(Y),Promise.all(H),Promise.all(U)]).then(function(G){let F=G[0],N=G[1],q=G[2],O=G[3],B=G[4],R=[];for(let P=0,k=F.length;P<k;P++){let V=F[P],A=N[P],w=q[P],D=O[P],L=B[P];if(V===void 0)continue;if(V.updateMatrix)V.updateMatrix();let M=Q._createAnimationTracks(V,A,w,D,L);if(M)for(let s=0;s<M.length;s++)R.push(M[s])}let E=new iJ(K,void 0,R);return u8(E,Z),E})}createNodeMesh(J){let $=this.json,Q=this,Z=$.nodes[J];if(Z.mesh===void 0)return null;return Q.getDependency("mesh",Z.mesh).then(function(K){let W=Q._getNodeRef(Q.meshCache,Z.mesh,K);if(Z.weights!==void 0)W.traverse(function(X){if(!X.isMesh)return;for(let Y=0,H=Z.weights.length;Y<H;Y++)X.morphTargetInfluences[Y]=Z.weights[Y]});return W})}loadNode(J){let $=this.json,Q=this,Z=$.nodes[J],K=Q._loadNodeShallow(J),W=[],X=Z.children||[];for(let H=0,U=X.length;H<U;H++)W.push(Q.getDependency("node",X[H]));let Y=Z.skin===void 0?Promise.resolve(null):Q.getDependency("skin",Z.skin);return Promise.all([K,Promise.all(W),Y]).then(function(H){let U=H[0],G=H[1],F=H[2];if(F!==null)U.traverse(function(N){if(!N.isSkinnedMesh)return;N.bind(F,DL)});for(let N=0,q=G.length;N<q;N++)U.add(G[N]);if(U.userData.pivot!==void 0&&G.length>0){let N=U.userData.pivot,q=G[0];U.pivot=new S().fromArray(N),U.position.x-=N[0],U.position.y-=N[1],U.position.z-=N[2],q.position.set(0,0,0),delete U.userData.pivot}return U})}_loadNodeShallow(J){let $=this.json,Q=this.extensions,Z=this;if(this.nodeCache[J]!==void 0)return this.nodeCache[J];let K=$.nodes[J],W=K.name?Z.createUniqueName(K.name):"",X=[],Y=Z._invokeOne(function(H){return H.createNodeMesh&&H.createNodeMesh(J)});if(Y)X.push(Y);if(K.camera!==void 0)X.push(Z.getDependency("camera",K.camera).then(function(H){return Z._getNodeRef(Z.cameraCache,K.camera,H)}));return Z._invokeAll(function(H){return H.createNodeAttachment&&H.createNodeAttachment(J)}).forEach(function(H){X.push(H)}),this.nodeCache[J]=Promise.all(X).then(function(H){let U;if(K.isBone===!0)U=new WQ;else if(H.length>1)U=new S9;else if(H.length===1)U=H[0];else U=new y9;if(U!==H[0])for(let G=0,F=H.length;G<F;G++)U.add(H[G]);if(K.name)U.userData.name=K.name,U.name=W;if(u8(U,K),K.extensions)BJ(Q,U,K);if(K.matrix!==void 0){let G=new $9;G.fromArray(K.matrix),U.applyMatrix4(G)}else{if(K.translation!==void 0)U.position.fromArray(K.translation);if(K.rotation!==void 0)U.quaternion.fromArray(K.rotation);if(K.scale!==void 0)U.scale.fromArray(K.scale)}if(!Z.associations.has(U))Z.associations.set(U,{});else if(K.mesh!==void 0&&Z.meshCache.refs[K.mesh]>1){let G=Z.associations.get(U);Z.associations.set(U,{...G})}return Z.associations.get(U).nodes=J,U}),this.nodeCache[J]}loadScene(J){let $=this.extensions,Q=this.json.scenes[J],Z=this,K=new S9;if(Q.name)K.name=Z.createUniqueName(Q.name);if(u8(K,Q),Q.extensions)BJ($,K,Q);let W=Q.nodes||[],X=[];for(let Y=0,H=W.length;Y<H;Y++)X.push(Z.getDependency("node",W[Y]));return Promise.all(X).then(function(Y){for(let U=0,G=Y.length;U<G;U++){let F=Y[U];if(F.parent!==null)K.add(NJ(F));else K.add(F)}let H=(U)=>{let G=new Map;for(let[F,N]of Z.associations)if(F instanceof x6||F instanceof K6)G.set(F,N);return U.traverse((F)=>{let N=Z.associations.get(F);if(N!=null)G.set(F,N)}),G};return Z.associations=H(K),K})}_createAnimationTracks(J,$,Q,Z,K){let W=[],X=J.name?J.name:J.uuid,Y=[];function H(N){if(N.morphTargetInfluences)Y.push(N.name?N.name:N.uuid)}if(S7[K.path]===S7.weights){if(H(J),J.isGroup)J.children.forEach(H)}else Y.push(X);let U;switch(S7[K.path]){case S7.weights:U=P7;break;case S7.rotation:U=I7;break;case S7.translation:case S7.scale:U=YJ;break;default:switch(Q.itemSize){case 1:U=P7;break;case 2:case 3:default:U=YJ;break}break}let G=Z.interpolation!==void 0?qL[Z.interpolation]:bZ,F=this._getArrayFromAccessor(Q);for(let N=0,q=Y.length;N<q;N++){let O=new U(Y[N]+"."+S7[K.path],$.array,F,G);if(Z.interpolation==="CUBICSPLINE")this._createCubicSplineTrackInterpolant(O);W.push(O)}return W}_getArrayFromAccessor(J){let $=J.array;if(J.normalized){let Q=FY($.constructor),Z=new Float32Array($.length);for(let K=0,W=$.length;K<W;K++)Z[K]=$[K]*Q;$=Z}return $}_createCubicSplineTrackInterpolant(J){J.createInterpolant=function(Q){return new(this instanceof I7?VN:qY)(this.times,this.values,this.getValueSize()/3,Q)},J.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}}function kL(J,$,Q){let Z=$.attributes,K=new S6;if(Z.POSITION!==void 0){let Y=Q.json.accessors[Z.POSITION],H=Y.min,U=Y.max;if(H!==void 0&&U!==void 0){if(K.set(new S(H[0],H[1],H[2]),new S(U[0],U[1],U[2])),Y.normalized){let G=FY(V$[Y.componentType]);K.min.multiplyScalar(G),K.max.multiplyScalar(G)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;let W=$.targets;if(W!==void 0){let Y=new S,H=new S;for(let U=0,G=W.length;U<G;U++){let F=W[U];if(F.POSITION!==void 0){let N=Q.json.accessors[F.POSITION],q=N.min,O=N.max;if(q!==void 0&&O!==void 0){if(H.setX(Math.max(Math.abs(q[0]),Math.abs(O[0]))),H.setY(Math.max(Math.abs(q[1]),Math.abs(O[1]))),H.setZ(Math.max(Math.abs(q[2]),Math.abs(O[2]))),N.normalized){let B=FY(V$[N.componentType]);H.multiplyScalar(B)}Y.max(H)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}K.expandByVector(Y)}J.boundingBox=K;let X=new v6;K.getCenter(X.center),X.radius=K.min.distanceTo(K.max)/2,J.boundingSphere=X}function oU(J,$,Q){let Z=$.attributes,K=[];function W(X,Y){return Q.getDependency("accessor",X).then(function(H){J.setAttribute(Y,H)})}for(let X in Z){let Y=GY[X]||X.toLowerCase();if(Y in J.attributes)continue;K.push(W(Z[X],Y))}if($.indices!==void 0&&!J.index){let X=Q.getDependency("accessor",$.indices).then(function(Y){J.setIndex(Y)});K.push(X)}if(R9.workingColorSpace!==o6&&"COLOR_0"in Z)console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${R9.workingColorSpace}" not supported.`);return u8(J,$),kL(J,$,Q),Promise.all(K).then(function(){return $.targets!==void 0?RL(J,$.targets,Q):J})}var OY={carmen:{Caminar:{duracion:1.3667,paso:0.995,cadera:0.9398},Esperar:{duracion:2.5333,paso:0.0068,cadera:0.9398},Saludar:{duracion:4.1333,paso:0.0016,cadera:0.9398},Conversar:{duracion:5.2,paso:0.0189,cadera:0.9398},SentadoHabla:{duracion:2.9667,paso:0,cadera:0.9398}},chela:{Caminar:{duracion:1.3667,paso:0.9454,cadera:0.8981},Esperar:{duracion:2.5333,paso:0.0057,cadera:0.8981},Saludar:{duracion:4.1333,paso:0.0021,cadera:0.8981},Conversar:{duracion:5.2,paso:0.0335,cadera:0.8981},SentadoHabla:{duracion:2.9667,paso:0,cadera:0.8981}},colmadero:{Caminar:{duracion:1.3667,paso:1.0021,cadera:0.9489},Esperar:{duracion:2.5333,paso:0.0045,cadera:0.9489},Saludar:{duracion:4.1333,paso:0.0023,cadera:0.9489},Conversar:{duracion:5.2,paso:0.0211,cadera:0.9489},Dar:{duracion:2.0333,paso:0.0057,cadera:0.9489},Recoger:{duracion:0.8667,paso:0.0278,cadera:0.9489}},"luis-upright":{Caminar:{duracion:1.3667,paso:0.9576,cadera:0.9064},Esperar:{duracion:2.5333,paso:0.0068,cadera:0.9064},Saludar:{duracion:4.1333,paso:0.0027,cadera:0.9064},Conversar:{duracion:5.2,paso:0.0373,cadera:0.9064},SentadoHabla:{duracion:2.9667,paso:0,cadera:0.9064}},marisol:{Caminar:{duracion:1.3667,paso:0.9726,cadera:0.9197},Esperar:{duracion:2.5333,paso:0.0066,cadera:0.9197},Saludar:{duracion:4.1333,paso:0.0015,cadera:0.9197},Conversar:{duracion:5.2,paso:0.0117,cadera:0.9197},SentadoHabla:{duracion:2.9667,paso:0.0001,cadera:0.9197}},nando:{Caminar:{duracion:4.2333,paso:3.015,cadera:0.9658},Esperar:{duracion:2.5333,paso:0.0064,cadera:0.9658},Saludar:{duracion:4.1333,paso:0.0015,cadera:0.9658},Conversar:{duracion:5.2,paso:0.0148,cadera:0.9658},SentadoHabla:{duracion:2.9667,paso:0,cadera:0.9658},Sentado:{duracion:0.0667,paso:0,cadera:0.9658}},papo:{Caminar:{duracion:1.3667,paso:1.0477,cadera:0.97},Esperar:{duracion:2.5333,paso:0.0077,cadera:0.97},Saludar:{duracion:4.1333,paso:0.0026,cadera:0.97},Conversar:{duracion:5.2,paso:0.0285,cadera:0.97},SentadoHabla:{duracion:2.9667,paso:0,cadera:0.97},Sentado:{duracion:0.0667,paso:0,cadera:0.97}},"rafa-upright":{Caminar:{duracion:4.2333,paso:2.7635,cadera:0.8817},Esperar:{duracion:2.5333,paso:0.0053,cadera:0.8817},Saludar:{duracion:4.1333,paso:0.0021,cadera:0.8817},Conversar:{duracion:5.2,paso:0.0259,cadera:0.8817},SentadoHabla:{duracion:2.9667,paso:0,cadera:0.8817}},tata:{Caminar:{duracion:1.3667,paso:0.8709,cadera:0.7855},Esperar:{duracion:2.5333,paso:0.0083,cadera:0.7855},Saludar:{duracion:4.1333,paso:0.0015,cadera:0.7855},Conversar:{duracion:5.2,paso:0.0495,cadera:0.7855},SentadoHabla:{duracion:2.9667,paso:0.0005,cadera:0.7855}},yari:{Caminar:{duracion:1.3667,paso:1.0157,cadera:0.9658},Esperar:{duracion:2.5333,paso:0.0066,cadera:0.9658},Saludar:{duracion:4.1333,paso:0.0017,cadera:0.9658},Conversar:{duracion:5.2,paso:0.0187,cadera:0.9658},SentadoHabla:{duracion:2.9667,paso:0,cadera:0.9658}},yuni:{Caminar:{duracion:1.3667,paso:0.9767,cadera:0.9424},Esperar:{duracion:2.5333,paso:0.0055,cadera:0.9424},Saludar:{duracion:4.1333,paso:0.0039,cadera:0.9424},Conversar:{duracion:5.2,paso:0.0794,cadera:0.9424},SentadoHabla:{duracion:2.9667,paso:0,cadera:0.9424},Sentado:{duracion:0.0667,paso:0,cadera:0.9424}}};var B$=[{id:"rafa",nombre:"Don Rafa",modelo:"rafa-upright",sexo:"m",mayor:!0},{id:"marisol",nombre:"Marisol",modelo:"marisol",sexo:"f"},{id:"luis",nombre:"Luis",modelo:"luis-upright",sexo:"m"},{id:"carmen",nombre:"Carmen",modelo:"carmen",sexo:"f",mayor:!0},{id:"yuni",nombre:"Yuni",modelo:"yuni",sexo:"m"},{id:"tata",nombre:"Doña Tata",modelo:"tata",sexo:"f",mayor:!0},{id:"papo",nombre:"Papo",modelo:"papo",sexo:"m"},{id:"yari",nombre:"Yari",modelo:"yari",sexo:"f"},{id:"nando",nombre:"Nando",modelo:"nando",sexo:"m"},{id:"chela",nombre:"Chela",modelo:"chela",sexo:"f"}],IK={id:"colmadero",nombre:"Kiko",modelo:"colmadero",sexo:"m"},RY=["rafa","marisol","luis","carmen"],jQ=0.3,CL=new Map([...B$,IK].map((J)=>[J.id,J])),DN=(J)=>CL.get(J)||null,yQ=(J)=>!!(J&&OY[J.modelo]?.Caminar),kN=(J)=>OY[J?.modelo]||{};function LY(J){return Array.isArray(J)&&J.length===4&&new Set(J).size===4&&J.every(($)=>B$.some((Q)=>Q.id===$))?J:RY.slice()}var o9=(J=0,$=0,Q=0)=>new S(J,$,Q),CY=(J)=>J<=0?0:J>=1?1:J*J*(3-2*J),zK=(J,$,Q)=>CY((J-$+Q)/(2*Q)),$6=(J,$)=>J+Math.random()*($-J),VY=(J)=>J[Math.floor(Math.random()*J.length)];function MN(J,$){if($>3.3)return-0.15*zK($,3.5,0.12)+0.31*zK($,8.7,0.12);return-0.15*zK(J,4.65,0.12)+0.16*zK(J,11.7,0.12)}var CN=new EY,AK=new Map;function xQ(J){if(!AK.has(J.modelo))AK.set(J.modelo,Promise.all([CN.loadAsync(`/models/${J.modelo}.glb`),CN.loadAsync(`/models/anim/${J.modelo}.glb`)]).then(([$,Q])=>{let Z={};for(let K of Q.animations){K.tracks=K.tracks.filter((X)=>X.name.endsWith(".quaternion")||X.name==="Hips.position"),Z[K.name]=K;let W=K.name!=="Caminar"&&K.tracks.find((X)=>X.name==="Hips.position");if(W){let X=W.values;for(let Y=3;Y<X.length;Y+=3)X[Y]=X[0],X[Y+2]=X[2]}}return{p:J,gltf:$,acciones:Z,datos:kN(J)}}).catch(($)=>{throw AK.delete(J.modelo),$}));return AK.get(J.modelo)}var vQ=o9(),TK=o9(),fQ=o9(),bQ=o9(),PN=o9(),IN=o9(),yN=new K9,vN=new K9,zN=new K9,AN=new K9,BY=new K9;function fN(J,$){J.matrixWorld.decompose(PN,zN,IN),J.parent.matrixWorld.decompose(PN,AN,IN),J.quaternion.copy(AN.invert()).multiply($).multiply(zN),J.updateMatrixWorld(!0)}function _N(J,$,Q,Z){vQ.setFromMatrixPosition(J.matrixWorld),TK.setFromMatrixPosition($.matrixWorld),fQ.subVectors(TK,vQ).normalize(),fN(J,vN.identity().slerp(yN.setFromUnitVectors(fQ,Q),Z))}function PL(J,$){let Q=J.h;if(!Q.Head||!Q.headfront||$<=0)return;for(let[Z,K]of[[Q.neck,0.45],[Q.Head,1]]){if(!Z)continue;vQ.setFromMatrixPosition(Q.Head.matrixWorld),TK.setFromMatrixPosition(Q.headfront.matrixWorld),fQ.subVectors(TK,vQ).normalize(),bQ.subVectors(J.mirar,vQ).normalize();let W=fQ.angleTo(bQ);if(W<0.001)continue;fN(Z,vN.identity().slerp(yN.setFromUnitVectors(fQ,bQ),$*K*Math.min(W,1.1)/W))}}var TN=new Set(["Saludar","Dar","Recoger"]),IL=1;function zL(J){let $=CY(J.alcanza),Q=J.alcanzaAlto||0,Z=J.h;if($<=0||!Z.RightArm)return;J.holder.getWorldQuaternion(BY),_N(Z.RightArm,Z.RightForeArm,bQ.set(-0.16,-0.3+0.85*Q,0.9).normalize().applyQuaternion(BY),$),_N(Z.RightForeArm,Z.RightHand,bQ.set(-0.06,-0.05+0.75*Q,1).normalize().applyQuaternion(BY),$)}var w7=(...J)=>J.map(([$,Q])=>o9($,0,Q)),DY=w7([10,-0.25],[6.5,-0.3],[4.6,-0.4],[3.3,-0.62],[2.25,-1.1],[1.2,-1.8]),AL=w7([1.2,-1.8],[0.35,-2.15],[-0.6,-2.05],[-1.35,-1.65]),kY=w7([-1.35,-1.65],[-2.35,-1],[-2.65,0.2],[-4.5,0.95],[-9,1.15],[-17,1.2]),_L=z6.z+0.04-(z6.fondo+0.16)/2,bN=z6.z+0.04+(z6.fondo+0.16)/2,_K=o9(-0.6,0,_L-0.19),hQ=o9(-0.6,0,bN+0.42),SN=w7([1.2,-1.8],[0.45,-2.4],[-0.2,hQ.z+0.2],[hQ.x,hQ.z]),wN=w7([hQ.x,hQ.z],[-1,-2.62],[-1.28,-2.1],[-1.35,-1.65]),MY=(...J)=>J.reduce(($,Q)=>$.concat($.length?Q.slice(1):Q),[]),DJ=(J)=>J.slice().reverse(),jN={enfrente:()=>{let J=$6(9.45,10.05),$=w7([-34,J],[-12,J+$6(-0.1,0.1)],[12,J+$6(-0.1,0.1)],[34,J]);return Math.random()<0.5?$:DJ($)},lateral:()=>{let J=$6(12.15,12.45),$=w7([J,-36],[J,-10],[J,1.2],[J+1.2,2.25],[20,2.3],[36,2.4]);return Math.random()<0.5?$:DJ($)}};function hN({scene:J,camera:$,enMesa:Q=()=>[],pocos:Z=!1}){let K=[],W=new Map,X=new QJ,Y=new $9,H=new v6(o9(),1.3),U=null,G=0,F=0,N=$6(8,16),q=$6(20,35),O=-1e9,B=null,R=!1,E=!1,P=!1;function k(y){let a=NJ(y.gltf.scene),U0=new S9;U0.add(a);let h={},I=null;if(a.traverse((P0)=>{if(P0.isBone)h[P0.name]=P0;if(P0.isSkinnedMesh)I=P0}),!I||!h.Hips)return null;I.material=I.material.clone(),I.material.roughness=0.83,I.material.specularIntensity=0.25,I.material.emissiveIntensity=jQ,I.castShadow=!1,I.receiveShadow=!0,I.morphTargetInfluences?.fill(0),U0.updateMatrixWorld(!0),I.computeBoundingBox();let x=I.boundingBox.clone().applyMatrix4(I.matrixWorld),d=o9().setFromMatrixPosition(h.Hips.matrixWorld);a.position.set(-d.x,-x.min.y,-d.z),U0.updateMatrixWorld(!0),I.computeBoundingSphere(),I.boundingSphere.radius*=1.3;let K0=new HJ(a),t={};for(let[P0,L0]of Object.entries(y.acciones))t[P0]=K0.clipAction(L0);let D0=y.datos.Caminar,R0=D0?D0.paso/D0.duracion:1.1;return{t:y,p:y.p,root:a,holder:U0,h,malla:I,mixer:K0,acc:t,actual:null,vClip:R0,marcha:0,t:0,alcanza:0,alcanzaAlto:0,mirar:o9(0,1.4,5),mira:0,yaw:0}}function V(y,a,U0=0.4){if(y.actual===a)return;let h=y.acc[a]||y.acc.Esperar;if(!h)return;if(h.reset(),h.setEffectiveTimeScale(1),h.setEffectiveWeight(1),TN.has(a))h.setLoop(tW,1),h.clampWhenFinished=!0;h.fadeIn(U0).play();let I=y.actual&&y.acc[y.actual];if(I&&I!==h)I.fadeOut(U0);y.actual=a}function A(){let y=new Set(Q()),a=new Set(K.map((U0)=>U0.p.id));return B$.filter((U0)=>yQ(U0)&&!y.has(U0.id)&&!a.has(U0.id))}function w(){let y=A(),a=y.filter((h)=>W.has(h.modelo)),U0=y.filter((h)=>!W.has(h.modelo));if(U0.length&&!P){P=!0;let h=VY(U0);xQ(h).then((I)=>W.set(h.modelo,I)).catch((I)=>console.warn("Transeúnte sin cargar",h.id,I)).finally(()=>{P=!1})}return a.length?W.get(VY(a).modelo):null}function D(){let y=w();if(!y)return null;let a=k(y);if(!a)return null;return a.velocidad=a.vClip*(a.p.mayor?$6(0.8,0.9):$6(0.95,1.08)),J.add(a.holder),a}function L(y){J.remove(y.holder),y.mixer.stopAllAction();let a=K.indexOf(y);if(a>=0)K.splice(a,1)}function M(y){let a=new $7(y,!1,"centripetal",0.5);return{tipo:"ruta",curva:a,largo:a.getLength(),d:0}}function s(y,a,U0){y.guion=a,y.i=0,y.zona=U0,y.malla.castShadow=U0==="patio";let h=a[0].curva,I=h.getPointAt(0),x=h.getTangentAt(0);y.yaw=Math.atan2(x.x,x.z),y.holder.position.set(I.x,MN(I.x,I.z),I.z),y.holder.rotation.y=y.yaw,V(y,"Caminar",0),y.acc.Caminar?.setEffectiveTimeScale(y.velocidad/y.vClip),K.push(y)}let b=(y,a,U0,h=2.6)=>{let I=a-y.yaw;return I=Math.atan2(Math.sin(I),Math.cos(I)),y.yaw+=Math.max(-h*U0,Math.min(h*U0,I)),y.holder.rotation.y=y.yaw,Math.abs(I)};function u(y,a,U0){let h=y.guion[y.i];if(!h){if(!y.fijo){L(y);return}y.guion=y===U?g():[j()],y.i=0,h=y.guion[0],h.t0=y.t}if(y.t+=a,h.tipo==="ruta"){let I=y.guion[y.i+1],x=I&&I.tipo!=="ruta",d=h.largo-h.d,K0=x?Math.min(1,d/0.6):1;y.marcha+=(K0-y.marcha)*Math.min(1,a*(K0<y.marcha?5:2.2));let t=y.velocidad*Math.max(y.marcha,x?0.15:0.25);h.d=Math.min(h.largo,h.d+t*a),V(y,"Caminar",0.35),y.acc.Caminar?.setEffectiveTimeScale(Math.max(0.3,t/y.vClip));let D0=h.d/h.largo,R0=h.curva.getPointAt(D0),P0=h.curva.getTangentAt(D0);if(y.holder.position.set(R0.x,MN(R0.x,R0.z),R0.z),b(y,Math.atan2(P0.x,P0.z),a),y.mira=Math.max(0,y.mira-a*2),h.d>=h.largo-0.001){if(y.i++,y.guion[y.i])y.guion[y.i].t0=y.t}}else if(h.tipo==="quieto"){y.marcha=0;let I=y.t-(h.t0??y.t);if(h.saludo)e(y,h,I,U0);if(!h.empezo){if(h.empezo=!0,TN.has(h.clip)&&y.actual===h.clip)y.actual=null}if(V(y,h.clip||"Esperar",0.45),h.yaw!=null)b(y,h.yaw,a,2);if(h.miraA?.h?.Head)h.mira=h.miraA.h.Head.getWorldPosition(h.mira||o9());else if(h.vigila)h.mira=f(h,U0);if(h.mira)y.mirar.lerp(h.mira,1-Math.exp(-a*3)),y.mira=Math.min(1,y.mira+a*2);else y.mira=Math.max(0,y.mira-a*2);if(h.atender&&!h.pedido){if(h.pedido=!0,U)o(U,y)}if(h.brazo){let d=Math.min(1,I/0.6,(h.dur-I)/0.6);y.alcanza=Math.max(0,d),y.alcanzaAlto=h.brazo.alto;let K0=h.brazo.entrega;if(K0&&K.includes(K0))K0.alcanza=y.alcanza,K0.alcanzaAlto=0.1}let x=h.recibe;if(x&&K.includes(x))x.alcanza=Math.max(0,1-Math.abs(I-IL)/0.55),x.alcanzaAlto=0.1;if(I>=h.dur){if(y.i++,y.guion[y.i])y.guion[y.i].t0=y.t;if(h.brazo){if(y.alcanza=0,h.brazo.entrega)h.brazo.entrega.alcanza=0}if(x)x.alcanza=0}}}function e(y,a,U0,h){if(!a.decidido){a.decidido=!0;let I=h?.view,x=I&&(I.phase==="lobby"||I.phase==="playing")&&(E||!h.habla?.size&&F>60&&F-O>240);if(E=!1,!x){a.dur=0;return}let d=[0,1,2,3].filter((D0)=>I.bots?.[D0]),K0=d.length&&Math.random()<0.8?VY(d):null;a.seat=K0,O=F;let t=K0==null?o9(0,1.2,0):h.cabezas?.[K0]?.clone()||o9(0,1.2,0);a.mira=t.clone(),a.yaw=Math.atan2(t.x-y.holder.position.x,t.z-y.holder.position.z),a.clip="Saludar"}if(a.dur===0)return;if(!a.dicho&&U0>0.5){a.dicho=!0;let I=y.h.Head.getWorldPosition(o9());B={seat:a.seat,p:I,t0:F,hasta:F+5},dispatchEvent(new CustomEvent("mesa:saludo",{detail:{seat:a.seat,voz:y.p.sexo,pos:I.toArray()}}))}}function v(y){let a=k(y);if(!a)return;a.fijo=!0,a.zona="colmado",U=a,a.malla.castShadow=!0,a.holder.position.copy(_K),a.yaw=0,a.holder.rotation.y=0,a.mirar.set(0,0.8,0),a.guion=g(),a.i=0,a.guion[0].t0=0,V(a,"Esperar",0),J.add(a.holder)}function j(){return{tipo:"quieto",dur:1e9,yaw:0,vigila:!0}}function g(){let y=(x,d)=>({tipo:"quieto",dur:x,...d}),a=Math.PI,U0=o9(_K.x+$6(-0.6,0.6),$6(1.2,1.6),-4.8),h=Math.random(),I=y($6(6,14),{yaw:0,vigila:!0});if(h<0.4)return[I,y(0.9,{yaw:a,mira:U0}),y(2.1,{yaw:a,mira:U0,clip:"Dar"}),y(1,{yaw:a+$6(-0.35,0.35),mira:U0}),y(2.1,{yaw:a,mira:U0,clip:"Dar"}),y(0.9,{yaw:0})];if(h<0.75)return[I,y(0.9,{yaw:a,mira:o9(U0.x,0.8,-4.8)}),y(1.3,{yaw:a,mira:o9(U0.x,0.8,-4.8),clip:"Recoger"}),y(0.9,{yaw:0}),y(2.1,{yaw:0,mira:o9(_K.x+$6(-0.5,0.5),1.1,bN),clip:"Dar"})];return[I,y($6(4,8),{yaw:$6(-0.4,0.4),vigila:!0})]}function f(y,a){if(y.cambio&&F<y.cambio)return y.mira;y.cambio=F+$6(3,6.5);let U0=a?.view,h=Math.random(),I=a?.cabezas,x=K.find((d)=>d.zona==="patio");if(x&&h<0.25)return x.h.Head.getWorldPosition(o9());if(U0?.phase==="playing"&&h<0.55&&I?.[U0.turn])return I[U0.turn].clone();if(h<0.8)return o9($6(-0.3,0.3),0.8,$6(-0.3,0.3));return o9($6(-4,4),1.5,6)}function o(y,a){let U0=(x,d)=>({tipo:"quieto",dur:x,...d}),h=o9(_K.x+$6(-0.5,0.5),1.4,-4.8),I=y.acc.Dar?U0(2.1,{yaw:0,miraA:a,clip:"Dar",recibe:a}):U0(2.4,{yaw:0,miraA:a,brazo:{alto:0.15,entrega:a}});y.guion=[U0(1.4,{yaw:0,miraA:a}),U0(0.9,{yaw:Math.PI,mira:h}),y.acc.Dar?U0(2.1,{yaw:Math.PI,mira:h,clip:"Dar"}):U0(2.2,{yaw:Math.PI,mira:h,brazo:{alto:1}}),U0(0.9,{yaw:0,miraA:a}),I,U0(4,{yaw:0,miraA:a,clip:"Conversar"})],y.i=0,y.guion[0].t0=y.t}function p(){let y=Math.random()<0.6,a=Math.random()<0.5,U0=[];if(U0.push(M(y?DY:DJ(kY))),a)U0.push({tipo:"quieto",dur:3.6,saludo:!0});if(U0.push(M(y?SN:DJ(wN))),U0.push({tipo:"quieto",dur:$6(14,24),yaw:Math.PI,clip:"Conversar",...U?{miraA:U,atender:!0}:{mira:o9(-0.6,1.35,-4.6)}}),Math.random()<0.6)U0.push(M(MY(wN,kY)));else U0.push(M(MY(DJ(SN),DJ(DY))));return U0}function r(y=!1){let a=Math.random()<0.3333333333333333?jN.lateral():jN.enfrente();if(!y&&!(F>60&&F-O>240&&Math.random()<0.5))return[M(a)];if(a.length===4)a.splice(2,0,o9(0,0,(a[1].z+a[2].z)/2));let U0=1,h=1e9;for(let I=1;I<a.length-1;I++){let x=a[I].x**2+a[I].z**2;if(x<h)h=x,U0=I}return[M(a.slice(0,U0+1)),{tipo:"quieto",dur:3.6,saludo:!0},M(a.slice(U0))]}function X0(){let y=MY(DY,AL,kY);return[M(Math.random()<0.5?y:DJ(y))]}setTimeout(()=>{if(!R&&yQ(IK))xQ(IK).then((y)=>{if(!R)v(y)}).catch((y)=>console.warn("Sin colmadero",y))},4000);function M0(y,a){if(R)return;if(y*=window.mesaPrisa||1,F+=y,B){if(B.e=F-B.t0,F>B.hasta)B=null}let U0=document.documentElement.classList.contains("reduced");if(!U0&&!Z&&F>N){if(N=F+$6(14,32),K.filter((I)=>I.zona==="calle").length<2){let I=D();if(I)s(I,r(),"calle")}}if(!U0&&F>q&&!K.some((I)=>I.zona==="patio")){let I=D();if(I)q=F+$6(50,110),s(I,Math.random()<0.65?p():X0(),"patio");else q=F+3}$.updateMatrixWorld(),X.setFromProjectionMatrix(Y.multiplyMatrices($.projectionMatrix,$.matrixWorldInverse));let h=performance.now();for(let I of U?[U,...K]:K.slice()){if(u(I,y,a),!I.fijo&&!K.includes(I))continue;if(I.mixer.update(y),H.center.copy(I.holder.position).y+=0.9,X.intersectsSphere(H))I.holder.updateMatrixWorld(!0),PL(I,CY(I.mira)),zL(I)}G+=(performance.now()-h-G)*0.05}return window.mesaTranseunte=(y="cliente",a,U0)=>{let h=D();if(!h)return!1;if(y==="posa"){let[x,d,K0=0]=U0;return s(h,[M(w7([x-Math.sin(K0)*0.3,d-Math.cos(K0)*0.3],[x,d])),{tipo:"quieto",dur:1e4}],"patio"),!0}let I=y==="calle"||y==="calle-saluda"?r(y==="calle-saluda"):y==="cruza"?X0():p();if(y==="saluda"){if(!I.some((x)=>x.saludo))I.splice(1,0,{tipo:"quieto",dur:3.6,saludo:!0});E=!0}if(y==="calle-saluda")E=!0;return s(h,I,y.startsWith("calle")?"calle":"patio"),!0},window.mesaServir=()=>{let y=K[K.length-1];if(!U||!y)return!1;return o(U,y),!0},window.mesaKiko=()=>U&&{clip:U.actual,tramo:U.i},window.mesaGente=()=>K.map((y)=>({quien:y.p.id,pos:y.holder.position.toArray().map((a)=>+a.toFixed(2)),clip:y.actual,marcha:+y.marcha.toFixed(2),tramo:y.i})),{update:M0,get saludo(){return B},get ms(){return G},andando:()=>K.map((y)=>y.p.id),dispose(){R=!0;for(let y of K.slice())L(y);if(U)J.remove(U.holder)}}}var kJ=Math.PI*2,Q9=(J=0,$=0,Q=0)=>new S(J,$,Q),TL=[[],[4],[0,8],[0,4,8],[0,2,6,8],[0,2,4,6,8],[0,2,3,5,6,8]];async function mk(J,{onProgress:$=()=>{},cast:Q=RY}={}){let Z=new Q$;Z.background=new b0("#2a2d4a"),Z.fog=new JJ("#5a5670",0.017);let K=new G6(42,innerWidth/innerHeight,0.08,90);K.position.set(3.1,2.65,4.2);let W;try{W=new mX({antialias:!0,alpha:!1,powerPreference:"high-performance"})}catch{throw Error("This device could not start WebGL. Try a recent desktop browser.")}let X=new URLSearchParams(location.search).has("hq"),Y=!X&&/SwiftShader|llvmpipe|Software/i.test((()=>{let _=W.getContext(),n=_.getExtension("WEBGL_debug_renderer_info");return n?_.getParameter(n.UNMASKED_RENDERER_WEBGL):""})());W.setSize(innerWidth,innerHeight),W.setPixelRatio(Y?0.65:Math.min(devicePixelRatio,1.5,1920/innerWidth)),W.outputColorSpace=W6,W.toneMapping=s7,W.toneMappingExposure=1.24,W.shadowMap.enabled=!Y,W.shadowMap.type=n7,W.info.autoReset=!1,J.appendChild(W.domElement);let H=new dX(K,W.domElement);H.target.set(0,0.8,-0.15),H.enableDamping=!0,H.dampingFactor=0.065,H.enablePan=!1,H.minDistance=0.8,H.maxDistance=4.6,H.minPolarAngle=0.25,H.maxPolarAngle=Math.PI*0.48,H.update();let U=0.5,G=new QK("#a3a8d8","#6a4e3c",U);Z.add(G);let F=new U$("#ffa06a",0.55);F.position.set(-6,2.6,-9),Z.add(F);let N=new H$("#ffc98a",5.2,7,Math.PI*0.32,0.6,2);N.position.set(0,C0.surfaceY+1.26,0),N.target.position.set(0,0,0);let q=new W7("#ffc07a",0.45,3.2,2);q.position.set(0,C0.surfaceY+1.2,0),Z.add(q),N.castShadow=!0,N.shadow.mapSize.set(Y?1024:2048,Y?1024:2048),N.shadow.focus=0.52,N.shadow.bias=-0.0002,N.shadow.normalBias=0.004,N.shadow.radius=3,N.shadow.camera.near=0.2,N.shadow.camera.far=4,Z.add(N,N.target);let O=new W7("#cfeee0",13,9,2);O.position.set(0,2.5,-3.5),Z.add(O);{let _=new _0(new w9(1.2,0.03,0.03),new o0({color:"#e6fff4",emissive:"#e6fff4",emissiveIntensity:4}));_.position.set(0,3.12,-3.6),Z.add(_)}let B=new Map,R=new Map;function E(_,n=0.85,W0=0){let $0=_+","+n+","+W0;if(!B.has($0))B.set($0,new o0({color:_,roughness:n,metalness:W0}));return B.get($0)}function P(_,n,W0,$0=[0,0,0],B0=[1,1,1]){let G0=n.uuid;if(!R.has(G0))R.set(G0,{material:n,geos:[]});let q0=new $9().compose(Q9(...W0),new K9().setFromEuler(new V8(...$0)),Q9(...B0));_.applyMatrix4(q0),R.get(G0).geos.push(_)}function k(_,n,W0,$0,B0,G0,q0,j0=0){P(new w9($0,B0,G0),typeof q0==="string"?E(q0):q0,[_,n,W0],[0,j0,0])}function V(_,n,W0,$0,B0,G0,q0,j0=10,n0=[0,0,0]){P(new P9($0,B0,G0,j0),typeof q0==="string"?E(q0):q0,[_,n,W0],n0)}function A(_,n=512,W0=512){let $0=document.createElement("canvas");$0.width=n,$0.height=W0,_($0.getContext("2d"),n,W0);let B0=new a6($0);return B0.colorSpace=W6,B0.anisotropy=Math.min(8,W.capabilities.getMaxAnisotropy()),B0}let w=191,D=()=>{return w=Math.imul(w,1664525)+1013904223>>>0,w/4294967296},L=A((_,n,W0)=>{_.fillStyle="#65432b",_.fillRect(0,0,n,W0);for(let $0=0;$0<700;$0++){_.strokeStyle=`rgba(${D()>0.5?"170,122,70":"35,22,14"},${0.08+D()*0.2})`,_.lineWidth=0.3+D()*2,_.beginPath();let B0=D()*W0;_.moveTo(0,B0);for(let G0=0;G0<n;G0+=20)_.lineTo(G0,B0+Math.sin(G0*0.013+$0)*3);_.stroke()}}),M=new o0({map:L,roughness:0.65,color:"#e7bc8c"}),s=E("#4c3022",0.75),b=E("#287770"),u=E("#d2c5a2"),e=E("#3d938e"),v=A((_,n,W0)=>{let $0=n/2;for(let n0=0;n0<2;n0++)for(let F0=0;F0<2;F0++){let T0=F0*$0,e0=n0*$0;_.save(),_.beginPath(),_.rect(T0,e0,$0,$0),_.clip(),_.fillStyle="#c4b99f",_.fillRect(T0,e0,$0,$0);for(let[G9,Q6]of[[T0,e0],[T0+$0,e0],[T0,e0+$0],[T0+$0,e0+$0]])_.strokeStyle="#8d6450",_.lineWidth=$0*0.04,_.beginPath(),_.arc(G9,Q6,$0*0.42,0,Math.PI*2),_.stroke(),_.fillStyle="#4f6763",_.beginPath(),_.arc(G9,Q6,$0*0.13,0,Math.PI*2),_.fill(),_.strokeStyle="#c4b99f",_.lineWidth=$0*0.02,_.beginPath(),_.arc(G9,Q6,$0*0.11,0,Math.PI*2),_.stroke();let q9=T0+$0/2,E9=e0+$0/2,T9=(G9,Q6)=>{_.fillStyle=Q6,_.beginPath(),_.moveTo(q9,E9-G9),_.lineTo(q9+G9,E9),_.lineTo(q9,E9+G9),_.lineTo(q9-G9,E9),_.closePath(),_.fill()};T9($0*0.2,"#8d6450"),T9($0*0.13,"#c4b99f"),T9($0*0.07,"#3a3630"),_.restore(),_.strokeStyle="#7e7563",_.lineWidth=3,_.strokeRect(T0+1.5,e0+1.5,$0-3,$0-3)}for(let n0=0;n0<9000;n0++)_.fillStyle=D()>0.5?"rgba(235,228,205,.07)":"rgba(30,28,24,.09)",_.fillRect(D()*n,D()*W0,1+D()*2,1+D()*2);for(let n0=0;n0<40;n0++){let F0=_.createRadialGradient(0,0,0,0,0,1),T0=D()*n,e0=D()*W0,q9=20+D()*90;_.save(),_.translate(T0,e0),_.scale(q9,q9),F0.addColorStop(0,"rgba(40,34,26,.10)"),F0.addColorStop(1,"rgba(40,34,26,0)"),_.fillStyle=F0,_.fillRect(-1,-1,2,2),_.restore()}},1024,1024);v.wrapS=v.wrapT=B7,v.repeat.set(22.88888888888889,27.77777777777778),k(-5.7,-0.1,-4.575,20.6,0.2,15.85,new o0({map:v,roughness:0.86,color:"#9d937f"})),k(0,-0.2,8.5,40,0.1,10.3,"#2b3133"),k(0,-0.075,3.45,40,0.15,0.2,"#a8a391");for(let _=-10;_<11;_++)k(_*1.8,-0.146,6.3,0.7,0.008,0.06,"#b9ad83");k(0,1.6,-5.1,7.5,3.4,0.2,b),k(-3.8,1.6,-3.85,0.2,3.4,2.7,b),k(3.8,1.6,-3.85,0.2,3.4,2.7,b),k(-3.48,1.1,-2.52,0.7,2.3,0.32,b),k(3.45,1.1,-2.52,0.8,2.3,0.32,b),k(0,2.95,-2.52,7.5,0.42,0.35,e),k(0,3.24,-3.7,8,0.12,4.4,"#435451");for(let _=0;_<30;_++)k(-4+_*0.276,3.15,-3.7,0.028,0.055,4.6,"#82928a");{let _=z6,n=_.tope-0.1;k(0,n/2,_.z,_.ancho,n,_.fondo,M),k(0,_.tope-0.05,_.z+0.04,_.ancho+0.18,0.1,_.fondo+0.16,M)}for(let _=0;_<3;_++)k(-0.6,1.58+_*0.48,-4.78,5.8,0.065,0.38,M),k(-0.6,1.84+_*0.48,-4.98,5.8,0.48,0.065,"#443e30");k(2.95,1.02,-4.55,1.02,2.1,0.8,"#d0ceb8"),k(2.95,1.12,-4.11,0.84,1.55,0.035,"#254c51");let j=[];for(let _=0;_<29;_++)j.push({pos:[-3.18+_*0.182,2.095,-4.69],scale:0.7+_%5*0.07,color:["#566641","#b0762a","#2e5a45","#7a3024","#c9b36a","#3b4f7a"][_*7%6]});let g=new M7([new O0(0,0),new O0(0.036,0),new O0(0.043,0.025),new O0(0.043,0.17),new O0(0.019,0.205),new O0(0.017,0.285),new O0(0.021,0.29),new O0(0.021,0.305),new O0(0,0.31)],12);j.forEach((_)=>P(g.clone(),E(_.color,0.3),_.pos,[0,0,0],[_.scale,_.scale,_.scale]));for(let[_,n,W0]of[[-3.1,-1.9,"#a8483a"]])for(let $0=0;$0<3;$0++){k(_,0.19+$0*0.34,n,0.52,0.3,0.4,W0);for(let B0=0;B0<5;B0++)k(_-0.2+B0*0.1,0.18+$0*0.34,n+0.204,0.055,0.16,0.015,"#2c3025")}for(let _=0;_<5;_++){let n=-7-_*3.5;k(n,1.5,-3,3.1,3,3.2,["#d9a35c","#7fb1a4","#d8c7a2","#c98d7c","#a6bf8e"][_]),k(n,2.2,-1.38,1,0.8,0.045,"#b59961"),k(n,2.2,-1.35,0.045,0.86,0.055,"#273e37"),k(n,0.98,-1.38,0.9,1.9,0.04,"#354e49")}for(let _=0;_<4;_++)V(-5-_*5,2.3,-1,0.08,0.09,4.6,"#665443"),k(-5-_*5,4.2,-1,1.8,0.09,0.09,"#514b3d");function f(_,n,W0,$0="#202d28"){let B0=new r6(Q9(..._),Q9(...W0),Q9(...n));P(new g6(B0,20,0.008,4,!1),E($0),[0,0,0])}let o=[];for(let _ of[-1.95,1.95])V(_,1.45,2.55,0.035,0.045,2.9,"#5b4a38",8);for(let[_,n,W0]of[[[-2.7,2.9,-2.45],[-1.95,2.85,2.55],0.5],[[2.7,2.9,-2.45],[1.95,2.85,2.55],0.5],[[-1.95,2.85,2.55],[1.95,2.85,2.55],0.32]]){let $0=Q9(..._),B0=Q9(...n),G0=$0.clone().lerp(B0,0.5);G0.y-=W0*2;let q0=new r6($0,G0,B0);P(new g6(q0,24,0.006,4,!1),E("#1c2320"),[0,0,0]);let j0=Math.round($0.distanceTo(B0)/0.42);for(let n0=1;n0<j0;n0++){let F0=q0.getPointAt(n0/j0);o.push(F0.setY(F0.y-0.035))}}{let _=new D6(0.022,10,8);_.scale(1,1.3,1);let n=["#ffd89a","#ffc27a","#ffe3a8"],W0=new h8(_,new p9({color:new b0(4.5,4.5,4.5)}),o.length),$0=new y9;o.forEach((B0,G0)=>{$0.position.copy(B0),$0.updateMatrix(),W0.setMatrixAt(G0,$0.matrix),W0.setColorAt(G0,new b0(n[G0%n.length]))}),Z.add(W0)}f([0,3.22,-1.6],[0,3.19,0],[0,3.02,-0.8]);let p=new S9;p.position.set(4.3,0,-1.7),Z.add(p);let r=new _0(new P9(0.1,0.15,4.5,9),E("#696047"));r.position.y=2.25,p.add(r);for(let _=0;_<9;_++){let n=new _0(new D6(1,10,5),E(_%2?"#4a654c":"#344e3d"));n.scale.set(0.27,0.075,1.5),n.position.set(Math.sin(_*kJ/9)*0.72,4.35,Math.cos(_*kJ/9)*0.72),n.rotation.set(0.23,_*kJ/9,0),p.add(n)}let X0=new k6({map:L,color:"#d9a877",roughness:0.5,clearcoat:0.55,clearcoatRoughness:0.28}),M0=new _0(new f6(C0.tableWidth,C0.tableThickness,C0.tableWidth,3,0.035),X0);M0.position.y=C0.tableCenterY,M0.castShadow=!0,M0.receiveShadow=!0,Z.add(M0);let y=A((_,n,W0)=>{_.fillStyle="#2f5b47",_.fillRect(0,0,n,W0);for(let B0=0;B0<W0;B0+=2)for(let G0=0;G0<n;G0+=2){let q0=(D()-0.5)*14,j0=((G0>>1)+(B0>>1))%2?4:-4;_.fillStyle=`rgb(${47+q0+j0},${91+q0+j0},${71+q0+j0})`,_.fillRect(G0,B0,2,2)}for(let B0=0;B0<4;B0++){let G0=B0*Math.PI/2,q0=n/2+Math.sin(G0)*n*0.36,j0=W0/2+Math.cos(G0)*W0*0.36,n0=_.createRadialGradient(q0,j0,0,q0,j0,n*0.2);n0.addColorStop(0,"rgba(120,150,120,.16)"),n0.addColorStop(1,"rgba(120,150,120,0)"),_.fillStyle=n0,_.fillRect(0,0,n,W0)}let $0=_.createRadialGradient(n/2,W0/2,n*0.1,n/2,W0/2,n*0.62);$0.addColorStop(0,"rgba(0,0,0,0)"),$0.addColorStop(1,"rgba(0,0,0,.28)"),_.fillStyle=$0,_.fillRect(0,0,n,W0)},512,512),a=new _0(new f6(C0.feltWidth,0.012,C0.feltWidth,2,0.02),new k6({map:y,roughness:0.97,sheen:0.8,sheenRoughness:0.55,sheenColor:new b0("#9fc7a8")}));a.position.y=C0.feltCenterY,a.receiveShadow=!0,Z.add(a);let U0=C0.tableWidth/2-0.07;for(let _ of[-U0,U0])for(let n of[-U0,U0])k(_,0.35,n,0.075,0.68,0.075,s);let h=["#C8402F","#6FB7C9"];for(let _=0;_<4;_++){let[n,W0,$0]=C8[_],B0=C0.feltWidth/2-0.012,G0=new _0(new B9(C0.feltWidth*0.72,0.009),new o0({color:h[_%2],roughness:0.9}));G0.rotation.set(-Math.PI/2,0,$0),G0.position.set(n*B0/C0.seatDistance,C0.surfaceY+0.0006,W0*B0/C0.seatDistance),G0.receiveShadow=!0,Z.add(G0)}let I=new o0({roughness:0.92,map:A((_,n,W0)=>{_.fillStyle="#8f7446",_.fillRect(0,0,n,W0);let $0=12,B0=n/$0;for(let G0=0;G0<$0;G0++)for(let q0=0;q0<$0;q0++){let j0=(q0+G0)%2===0;for(let n0=0;n0<3;n0++){let F0=150+D()*45|0;_.fillStyle=`rgb(${F0+30},${F0+8},${F0-45})`;let T0=n0*B0/3+B0*0.04,e0=B0/3-B0*0.08;if(j0)_.fillRect(q0*B0+1,G0*B0+T0,B0-2,e0);else _.fillRect(q0*B0+T0,G0*B0+1,e0,B0-2)}}_.fillStyle="rgba(40,28,14,.18)";for(let G0=0;G0<=$0;G0++)_.fillRect(G0*B0-1,0,2,W0),_.fillRect(0,G0*B0-1,n,2)},256,256)});for(let _=0;_<4;_++){let[n,W0,$0]=C8[_],B0=new S9;B0.position.set(n,0,W0),B0.rotation.y=$0,Z.add(B0);let G0=E(_%2?"#5e9fb2":"#b53f2e",0.62),q0=(j0,n0,F0,T0,e0,q9,E9=G0,T9=0.008)=>{let G9=Q9(T0,e0,q9).applyAxisAngle(Q9(0,1,0),$0).add(Q9(n,0,W0));P(new f6(j0,n0,F0,2,T9),E9,G9.toArray(),[0,$0,0])};q0(C0.chairSeatWidth-0.04,0.035,0.5,0,C0.chairSeatY,0,I,0.01);for(let j0 of[-1,1])q0(0.04,0.05,0.54,j0*(C0.chairSeatWidth/2-0.02),C0.chairSeatY-0.005,0);for(let j0 of[-1,1])q0(C0.chairSeatWidth,0.05,0.04,0,C0.chairSeatY-0.005,j0*0.25);for(let j0 of[-0.24,0.24])for(let n0 of[-0.21,0.21])q0(0.04,C0.chairSeatY,0.04,j0,C0.chairSeatY/2,n0);for(let j0 of[-0.24,0.24])q0(0.024,0.024,0.42,j0,0.15,0);q0(0.48,0.024,0.024,0,0.15,0.21);for(let j0 of[-0.24,0.24])q0(0.04,0.52,0.04,j0,C0.chairSeatY+0.26,-0.23);for(let j0 of[0.2,0.33,0.46])q0(0.46,j0===0.46?0.07:0.045,0.022,0,C0.chairSeatY+j0,-0.23)}function x(_,n,W0,$0,B0,G0=60){let q0=A((j0,n0,F0)=>{j0.fillStyle=$0,j0.fillRect(0,0,n0,F0),j0.fillStyle=B0,j0.textAlign="center",j0.textBaseline="middle",j0.font=`bold ${G0}px Georgia`,j0.fillText(_,n0/2,F0/2)},1024,256);return new _0(new B9(n,W0),new p9({map:q0}))}let d=x("COLMADO  LA ESQUINA",4.8,0.38,"#a05d42","#f8e8b9",64);d.position.set(0,2.94,-2.33),Z.add(d);let K0=x("MESA",0.11,0.029,"#284e3e","#81906b",77);{let _=document.createElement("canvas");_.width=512,_.height=136;let n=new a6(_);n.colorSpace=W6;let W0=()=>{let $0=_.getContext("2d");$0.clearRect(0,0,512,136),$0.font=`96px ${document.fonts?.check?.("96px Shrikhand")?"Shrikhand":"Georgia"}`,$0.textAlign="center",$0.textBaseline="middle",$0.fillStyle="rgba(170,205,170,.42)",$0.fillText("Mesa",256,72),n.needsUpdate=!0};W0(),document.fonts?.load?.("96px Shrikhand").then(W0).catch(()=>{}),K0.material=new o0({map:n,transparent:!0,depthWrite:!1,roughness:1})}K0.rotation.x=-Math.PI/2,K0.position.set(0,C0.surfaceY+0.001,0.3),Z.add(K0);let t=new S9;t.position.set(-0.9,2.62,-3.45),t.rotation.x=-Math.PI/2,Z.add(t),V(-0.9,2.9,-3.45,0.015,0.015,0.56,"#777a68",8),V(-0.9,3.16,-3.45,0.075,0.075,0.025,"#767763",12);let D0=new _0(new D6(0.075,12,8),E("#41493d"));t.add(D0);for(let _=0;_<5;_++){let n=new _0(new w9(0.13,0.5,0.025),E("#85856e",0.88,0.05));n.position.set(Math.sin(_*kJ/5)*0.285,Math.cos(_*kJ/5)*0.285,0),n.rotation.z=-_*kJ/5,t.add(n)}let R0=new S9;R0.position.set(-12,0.05,5.2),Z.add(R0);for(let _ of[-0.36,0.36]){let n=new _0(new x8(0.19,0.038,7,14),E("#182221"));n.position.set(_,0.2,0),R0.add(n)}let P0=new _0(new f6(0.65,0.17,0.2,2,0.04),E("#823e2f",0.45,0.25));P0.position.y=0.49,R0.add(P0);let L0=new _0(new w9(0.35,0.06,0.22),E("#202725"));L0.position.set(-0.08,0.61,0),R0.add(L0);let l0=new _0(new P9(0.015,0.015,0.45,6),E("#8c9c96",0.4,0.5));l0.position.set(0.32,0.59,0),l0.rotation.z=-0.3,R0.add(l0);let W9=hU({scene:Z,texture:A,mat:E,box:k,cylinder:V,random:D,teal:b,wood:M,storeSign:d}),t0=xU({scene:Z,texture:A,mat:E,box:k,cylinder:V,staticGeo:P,random:D,renderer:W});gU({scene:Z,random:D});for(let{material:_,geos:n}of R.values()){let W0=E$(n.some(($0)=>!$0.index)?n.map(($0)=>$0.index?$0.toNonIndexed():$0):n,!1);if(W0){let $0=new _0(W0,_);$0.receiveShadow=!0,W0.computeBoundingBox(),$0.castShadow=W0.boundingBox.distanceToPoint(Q9(0,0.8,0))<1.6&&W0.boundingBox.getSize(Q9()).length()<8,Z.add($0)}n.forEach(($0)=>$0.dispose())}let X9=new S9,k9=new S9;Z.add(X9,k9);let L9=new f6(C0.tileLength,C0.tileThickness,C0.tileWidth,3,0.0024),m=new k6({color:"#ede5d2",roughness:0.5,clearcoat:0.3,clearcoatRoughness:0.4}),m9=new k6({color:"#e2dac6",roughness:0.42,clearcoat:0.7,clearcoatRoughness:0.3}),z9=new o0({color:"#b98b3e",roughness:0.28,metalness:1}),A9=new P9(0.0019,0.0019,0.0009,12),T=new o0({color:"#0b0a09",roughness:0.55}),C=new o0({color:"#2a2622",roughness:0.6}),l=new P9(C0.pipRadius,C0.pipRadius,0.0007,14),Q0=new w9(0.0014,0.0005,C0.tileWidth*0.8),V0=new Set([L9,l,Q0,A9]),I0=new Set([m,m9,T,C,z9]),v0=[X0,a.material,m,m9].map((_)=>[_,{clearcoat:_.clearcoat,sheen:_.sheen}]);function H0(_,n,W0=!1){let $0=new S9,B0=new _0(L9,W0?m9:m);if(B0.castShadow=!0,B0.receiveShadow=!0,$0.add(B0),!W0){let G0=[];if([_,n].forEach((n0,F0)=>TL[n0].forEach((T0)=>G0.push(Q9((F0===0?-1:1)*C0.tileLength/4+(T0%3-1)*C0.pipColumnSpacing,C0.tileThickness/2+0.0005,(Math.floor(T0/3)-1)*C0.pipRowSpacing)))),G0.length){let n0=new h8(l,T,G0.length),F0=new $9;G0.forEach((T0,e0)=>n0.setMatrixAt(e0,F0.makeTranslation(T0.x,T0.y,T0.z))),$0.add(n0)}let q0=new _0(Q0,C);q0.position.y=C0.tileThickness/2+0.0002,$0.add(q0);let j0=new _0(A9,z9);j0.position.y=C0.tileThickness/2+0.0004,$0.add(j0)}return $0}function E0(_){return Q9(_.x,C0.surfaceY+C0.tileThickness/2+0.001,_.z)}let h0=new _0(new x8(0.2,0.006,5,38),new p9({color:"#e8bf70",transparent:!0,opacity:0.7}));h0.rotation.x=-Math.PI/2,h0.position.y=0.027,Z.add(h0);let y0=[],z0=[],A0=[],a0=0,J9=4,_9=[];A0.push(...pU(Z));let i=Q9(),S0=Q9(),N0=Q9(),w0=Q9(),u0=new $9,k0=Q9(),f0=Q9();function Y9(_){let n=null;if(_.root.traverse((q9)=>{if(q9.isSkinnedMesh&&q9.morphTargetDictionary&&!n)n=q9}),!n||n.morphTargetDictionary.parpadeo==null)return;_.cara={mesh:n,iP:n.morphTargetDictionary.parpadeo,iS:n.morphTargetDictionary.sonrisa};let W0=n.geometry.attributes.position,$0=n.userData?.boca;if($0){let q9=1e9,E9=0;for(let T9=0;T9<W0.count;T9++){let G9=(W0.getX(T9)-$0[0])**2+(W0.getY(T9)-$0[1])**2+(W0.getZ(T9)-$0[2])**2;if(G9<q9)q9=G9,E9=T9}_.bocaMundo=(T9)=>{return n.skeleton.update(),n.getVertexPosition(E9,T9).applyMatrix4(n.matrixWorld)}}let B0=n.userData?.ojos,G0=n.userData?.parpado;if(!B0||!G0)return;let q0=n.geometry.attributes.position,j0=(q9)=>{let E9=1e9,T9=0;for(let G9=0;G9<q0.count;G9++){let Q6=(q0.getX(G9)-q9[0])**2+(q0.getY(G9)-q9[1])**2+(q0.getZ(G9)-q9[2])**2;if(Q6<E9)E9=Q6,T9=G9}return T9},n0=new B9(0.027,0.0125,8,4);n0.translate(0,-0.00625,0);let F0=n0.attributes.position,T0=[];for(let q9=0;q9<F0.count;q9++){let E9=F0.getX(q9)/0.0135,T9=-F0.getY(q9)/0.0125;F0.setZ(q9,0.0032*Math.cos(E9*Math.PI/2)*(0.5+0.5*T9));let G9=T9>0.85?0.45:1;T0.push(G9,G9,G9)}n0.setAttribute("color",new H9(T0,3)),n0.computeVertexNormals();let e0=new o0({color:new b0().setRGB(...G0,W6),roughness:0.7,vertexColors:!0});_.parpados=B0.map((q9)=>{let E9=new _0(n0,e0);return E9.visible=!1,E9.frustumCulled=!1,Z.add(E9),{m:E9,k:j0(q9)}})}function s9(_){let n=_.parpados;if(!n||!_.cara)return;let W0=_.parpadeo||0;if(W0<0.03){for(let q0 of n)q0.m.visible=!1;return}let $0=_.cara.mesh;$0.skeleton.update();let B0=$0.getVertexPosition(n[0].k,i).applyMatrix4($0.matrixWorld).clone(),G0=$0.getVertexPosition(n[1].k,i).applyMatrix4($0.matrixWorld).clone();if(_.head.getWorldPosition(k0),_.front.getWorldPosition(f0),w0.subVectors(f0,k0).normalize(),S0.subVectors(G0,B0).normalize(),N0.crossVectors(w0,S0).normalize(),N0.y<0)N0.negate();S0.crossVectors(N0,w0).normalize(),u0.makeBasis(S0,N0,w0);for(let[q0,j0]of[[n[0],B0],[n[1],G0]])q0.m.visible=!0,q0.m.quaternion.setFromRotationMatrix(u0),q0.m.position.copy(j0).addScaledVector(N0,0.0052).addScaledVector(w0,0.0024),q0.m.scale.set(1,W0,1)}let j9=0.605,M6=LY(Q),u6=0;async function gQ(_,n,W0){let $0=DN(n);try{if(W0===0)$(`Seating ${$0.nombre}…`,a0/J9);let B0=await xQ($0);if(W0!==u6||I$)return;let G0=B0.gltf,q0=NJ(G0.scene),j0=new S9;j0.add(q0);let n0=new HJ(q0),F0=B0.acciones.Sentado||G0.animations.find((C9)=>C9.name==="Seated")||G0.animations[0];if(F0)n0.clipAction(F0).play();n0.setTime(C0.neutralPoseTime),q0.updateMatrixWorld(!0),q0.traverse((C9)=>{if(C9.isSkinnedMesh)C9.computeBoundingBox();if(C9.isMesh)C9.castShadow=!0,C9.receiveShadow=!0,C9.frustumCulled=!1,C9.material.roughness=0.83,C9.material.specularIntensity=0.25,C9.material.emissiveIntensity=jQ});let T0=new S6().setFromObject(q0),e0=q0.getObjectByName("Hips"),q9=e0?.getWorldPosition(Q9())||T0.getCenter(Q9());q0.position.set(-q9.x,Math.max(-T0.min.y,j9-q9.y),-q9.z);let[E9,T9,G9]=C8[_];j0.position.set(E9,0,T9),j0.rotation.y=G9;let Q6=y0[_];if(Q6){Z.remove(Q6.holder);for(let C9 of Q6.parpados||[])Z.remove(C9.m),C9.m.geometry.dispose(),C9.m.material.dispose()}if(Z.add(j0),y0[_]={id:n,clipHabla:B0.acciones.SentadoHabla||null,root:q0,holder:j0,index:_,pose:$Y(q0),head:q0.getObjectByName("Head"),neck:q0.getObjectByName("neck"),front:q0.getObjectByName("headfront"),chest:q0.getObjectByName("Spine"),hips:e0,lomo:q0.getObjectByName("Spine02"),muslos:[q0.getObjectByName("LeftUpLeg"),q0.getObjectByName("RightUpLeg")],hombros:[[1,q0.getObjectByName("LeftShoulder")],[-1,q0.getObjectByName("RightShoulder")]],spine:q0.getObjectByName("Spine01"),reaction:null,brazos:["Left","Right"].map((C9)=>({lado:C9,hombro:q0.getObjectByName(C9+"Shoulder"),brazo:q0.getObjectByName(C9+"Arm"),antebrazo:q0.getObjectByName(C9+"ForeArm"),mano:q0.getObjectByName(C9+"Hand")}))},y0[_].bebida=A0.find((C9)=>C9.index===_),Y9(y0[_]),W0===0)a0++,$(a0===4?"The table is ready.":`${a0} of 4 seats ready`,a0/J9)}catch(B0){if(_9.push(n),console.error("Character load failed",n,B0),W0===0)$(`Could not load ${$0?.nombre||n}. Reload to retry.`,a0/J9)}}let D$=Promise.all(M6.map((_,n)=>gQ(n,_,0)));function MJ(_){if(_=LY(_),_.join()===M6.join())return;M6=_;let n=++u6;for(let W0 of z0.splice(0))Z.remove(W0.holder);Promise.all(_.map((W0,$0)=>y0[$0]?.id===W0?null:gQ($0,W0,n))).then(()=>{if(n===u6&&E8)J0(E8,!0)})}let e6=null;D$.then(()=>{if(!I$){if(e6=hN({scene:Z,camera:K,pocos:Y,enMesa:()=>[...M6,...z0.map((_)=>_.id)]}),E8)J0(E8,!0)}});let k$=null,CJ=null,T8="",j7=null,C6=cU({scene:Z,renderer:W,camera:K,controls:H,software:Y,bulbLight:N});C6.calidad("high");let y7=new Set,v7=new Map,pQ=[0,1,2,3].map(()=>Q9()),f7=(_)=>{let n=_.detail||{};if(n.active)y7.add(n.seat),v7.set(n.seat,n.type);else y7.delete(n.seat)};window.addEventListener("mesa:botvoice",f7);let b7=null,E8=0,PY="",mQ=0,SK="attract",N6=null,J8=[],z=0,c=0;function Y0(_){while(_.children.length){let n=_.children.pop();n.parent=null,n.traverse((W0)=>{if(W0.isMesh&&!V0.has(W0.geometry))W0.geometry.dispose();if(W0.isMesh&&!I0.has(W0.material))W0.material.dispose()})}}let Z0=0;function J0(_,n=!1){if(_===E8&&!n)return;E8=_;let W0=++Z0,$0=Math.min(3,_);while(z0.length>$0)Z.remove(z0.pop().holder);if(!e6)return;let B0=new Set([...M6,...z0.map((q0)=>q0.id),...e6.andando()]),G0=B$.filter((q0)=>yQ(q0)&&!B0.has(q0.id)).slice(0,$0-z0.length);for(let q0 of G0)xQ(q0).then((j0)=>{if(W0!==Z0||I$||z0.length>=$0||z0.some((C9)=>C9.id===q0.id)||e6.andando().includes(q0.id))return;let n0=z0.length,F0=j0.gltf,T0=NJ(F0.scene),e0=new S9;e0.add(T0);let q9=new HJ(T0),E9=j0.acciones.Sentado||F0.animations.find((C9)=>C9.name==="Seated")||F0.animations[0];if(E9)q9.clipAction(E9).play();q9.setTime(C0.neutralPoseTime),T0.updateMatrixWorld(!0),T0.traverse((C9)=>{if(C9.isSkinnedMesh)C9.computeBoundingBox();if(C9.isMesh)C9.castShadow=!1,C9.frustumCulled=!1,C9.material.roughness=0.83,C9.material.specularIntensity=0.25,C9.material.emissiveIntensity=jQ});let T9=new S6().setFromObject(T0),G9=T0.getObjectByName("Hips")?.getWorldPosition(Q9())||T9.getCenter(Q9());T0.position.set(-G9.x,Math.max(-T9.min.y,j9-G9.y),-G9.z),e0.position.set(-2.5+n0*1.66,0,-2.5),e0.rotation.y=0,Z.add(e0);let Q6=new _0(new w9(0.56,0.06,0.54),u);Q6.position.set(0,C0.chairSeatY,0),e0.add(Q6),z0.push({id:q0.id,root:T0,holder:e0,pose:$Y(T0),head:T0.getObjectByName("Head"),neck:T0.getObjectByName("neck"),front:T0.getObjectByName("headfront"),chest:T0.getObjectByName("Spine"),spine:T0.getObjectByName("Spine01"),index:n0+4})}).catch((j0)=>console.warn("Mirón sin cargar",q0.id,j0))}let x0=!1,d0=Q9();function g0(){let _=K.position,n=H.target;if(d0.subVectors(_,n),d0.length()>4.6)_.copy(n).addScaledVector(d0.normalize(),4.6);_.z=Math.max(_.z,-2.1),_.x=b8.clamp(_.x,-4.9,4.9),_.y=b8.clamp(_.y,0.35,5.2)}let i0=-1,m0=null,N9=H.minDistance,V9="table",s0=!1;function v9(_,n,W0){if(document.documentElement.classList.contains("reduced"))return;let $0=Q9(1,0,1).normalize(),B0=-9;for(let[q0,j0]of[[1,1],[1,-1],[-1,1],[-1,-1]]){let n0=Q9(q0,0,j0).normalize(),F0=n0.x*_.x+n0.z*_.z;if(F0>B0)B0=F0,$0=n0}let G0=_.clone().addScaledVector($0,0.3);if(G0.x=b8.clamp(G0.x,-0.4,0.4),G0.z=b8.clamp(G0.z,-0.4,0.4),G0.y=C0.surfaceY+(W0?0.12:0.19),!m0)N9=H.minDistance;H.minDistance=0.1,s0=!0,m0={pos:m0?.pos||K.position.clone(),target:m0?.target||H.target.clone(),at:c6.elapsedTime+3.4},N6={from:K.position.clone(),to:G0,fromTarget:H.target.clone(),toTarget:_.clone().setY(_.y+0.01),t:0,dur:0.45}}function r9(_="table"){if(V9=_,s0=!1,H.minDistance=_==="seat"||_==="close"?0.3:0.7,H.minPolarAngle=_==="overhead"?0.01:0.25,K.aspect<0.95&&_==="table")_="overhead";let n,W0=Q9(0,0.8,0);if(_==="attract")n=Q9(0.75,1.3,4.4),W0=Q9(-1,1.4,-1.2);else if(_==="overhead")n=Q9(0.001,1.86,0.34),W0=Q9(0,C0.surfaceY,0.02);else if(_==="seat")n=Q9(0,1.36,0.74),W0=Q9(0,0.82,-0.12);else if(_==="close")n=Q9(0.62,1.3,1),W0=Q9(-0.03,0.85,-0.08);else n=Q9(0.8,1.89,1.24),W0=Q9(0,0.9,-0.2);if(_!=="attract"&&_!=="seat"&&K.aspect<1.3){let $0=Math.min(2.4,Math.pow(1.6/K.aspect,0.8));n=W0.clone().add(n.clone().sub(W0).multiplyScalar($0))}if(y0[0])y0[0].root.visible=_!=="seat";m0=null,H.minDistance=Math.min(H.minDistance,N9),N6={from:K.position.clone(),to:n,fromTarget:H.target.clone(),toTarget:W0,t:0}}let f9=Q9(0,1,0),l9=new K9().setFromAxisAngle(Q9(1,0,0),0.12),O6=new K9().setFromAxisAngle(f9,Math.PI/2),c0=new K9().setFromAxisAngle(Q9(0,0,1),Math.PI/2),P6=C0.tableCenterY+C0.tableThickness/2+C0.tileLength/2*Math.cos(0.12)+C0.tileThickness/2*Math.sin(0.12)+0.001;function M9(_,n,W0){let $0=C8[_][2];return W0.quaternion.setFromAxisAngle(f9,$0).multiply(l9).multiply(O6).multiply(c0),W0.position.set(n,P6,-C0.rackRadius).applyAxisAngle(f9,$0),W0}let Z6=new h8(L9,m9,28);Z6.count=0,Z6.castShadow=!0,Z6.receiveShadow=!0,Z6.frustumCulled=!1,k9.add(Z6);let d6=[[],[],[],[]],R6=new y9,d8=[0,0,0,0],b9="",a9=new Set;function S8(_){let n=0;for(let W0=0;W0<4;W0++){let $0=a9.has(W0)?0:d8[W0],B0=d6[W0];while(B0.length<$0)B0.push((B0.length-($0-1)/2)*C0.rackSpacing);B0.length=$0;for(let G0=0;G0<$0;G0++){let q0=(G0-($0-1)/2)*C0.rackSpacing;B0[G0]+=(q0-B0[G0])*(1-Math.exp(-_*10)),M9(W0,B0[G0],R6),R6.updateMatrix(),Z6.setMatrixAt(n++,R6.matrix)}}Z6.count=n,Z6.instanceMatrix.needsUpdate=!0}let h9=new S9;Z.add(h9);let $8=new Map,c8="",M$="",IY=(()=>{let _=7,n=()=>(_=_*16807%2147483647)/2147483647,W0=[],$0=0.2;for(let B0=0;B0<28;B0++){let G0=!1;for(let q0=0;q0<600&&!G0;q0++){let j0=n()*Math.PI*2,n0=Math.sqrt(n())*$0,F0=Math.cos(j0)*n0,T0=Math.sin(j0)*n0*0.82;if(W0.every((e0)=>Math.hypot(e0.x-F0,e0.z-T0)>=0.058))W0.push({x:F0,z:T0,ry:n()*Math.PI}),G0=!0}if(!G0)$0+=0.012,B0--}return W0})(),zY=C0.surfaceY+C0.tileThickness/2+0.0003;function xN(){for(let _=0;_<28;_++){let n=H0(0,0,!0),W0=IY[_];n.position.set(W0.x,zY,W0.z),n.rotation.y=W0.ry,X9.add(n)}}let h7=(_)=>_*_*(3-2*_),gN=new K9().setFromAxisAngle(Q9(1,0,0),Math.PI),pN=new K9().setFromAxisAngle(f9,-Math.PI/2);function mN(_,n){_.revealed.forEach((W0,$0)=>{let B0=W0.length,G0=C8[$0][2];W0.forEach((q0,j0)=>{let n0=(j0-(B0-1)/2)*C0.rackSpacing,F0=H0(q0.a,q0.b);M9($0,n0,R6);let T0=R6.quaternion.clone().multiply(gN),e0=R6.position.clone(),q9=Q9(n0,C0.surfaceY+C0.tileThickness/2+0.001,-C0.rackRadius+0.047).applyAxisAngle(f9,G0),E9=new K9().setFromAxisAngle(f9,G0).multiply(pN);F0.position.copy(e0),F0.quaternion.copy(T0),F0.visible=!1,X9.add(F0),J8.push({obj:F0,from:e0,to:q9,qFrom:T0,qTo:E9,elapsed:-(n+$0*0.3+j0*0.055),duration:0.42,revela:$0,ultima:j0===B0-1})})})}function AY(_,n=0){b7=_;{let G0=_&&(_.phase==="handEnd"||_.phase==="seriesEnd")&&_.result,q0=G0?_.handNo+":"+_.phase:"";if(q0&&q0!==T8)CJ={t:c6.elapsedTime+0.5,team:_.result.team??null};if(!G0)CJ=null;T8=q0}if(E8!==n)J0(n);if(_?.cast)MJ(_.cast);let W0=!_||_.phase==="lobby"?"pila":"mano"+_.handNo;if(W0!==c8){if(c8=W0,s0)r9(V9);Y0(X9),$8.clear(),J8=J8.filter((G0)=>G0.reparto);for(let G0 of y0)if(G0)G0.jugada=null;if(W0==="pila")xN()}if(_&&_.chain?.length){let G0=PU(_.chain,_.moves),q0=_.event,j0=["domino","capicua","tranque"].includes(q0?.type),n0=_.moves[_.moves.length-1],F0=q0?.type==="domino"||q0?.type==="capicua",T0=q0?.type==="play"?q0.tile:j0&&n0?.type==="play"?n0.tile:null;_.chain.forEach((e0,q9)=>{if($8.has(e0.id))return;let E9=H0(e0.x,e0.y),T9=E0(G0[q9]);if(E9.position.copy(T9),E9.rotation.y=G0[q9].yaw,E9.updateMatrix(),X9.add(E9),$8.set(e0.id,E9),e0.id!==T0||e0.seat==null)return;M9(e0.seat,0,R6);let G9={obj:E9,from:R6.position.clone(),to:T9.clone(),qFrom:R6.quaternion.clone(),qTo:E9.quaternion.clone(),elapsed:0,duration:F0?0.7:0.55,golpe:F0};if(E9.position.copy(G9.from),E9.quaternion.copy(G9.qFrom),J8.push(G9),j0)v9(T9,e0.seat,F0);z=performance.now();let Q6=y0[e0.seat];if(k$={p:T9.clone(),t:c6.elapsedTime+G9.duration},Q6)Q6.reaction={time:c6.elapsedTime},Q6.jugada={t0:c6.elapsedTime,obj:E9,anim:G9,hasta:T9.clone()}})}if(_?.phase==="playing"&&_.handNo!==mQ&&_.moves.length===0){mQ=_.handNo,Y0(h9),J8=J8.filter((G0)=>!G0.reparto),c=performance.now()+3300;for(let G0=0;G0<4;G0++)d6[G0]=Array.from({length:7},(q0,j0)=>(j0-3)*C0.rackSpacing);for(let G0=0;G0<28;G0++){let q0=G0%4,j0=Math.floor(G0/4),n0=H0(0,0,!0),F0=IY[G0],T0=Q9(F0.x,zY,F0.z);n0.position.copy(T0),n0.rotation.y=F0.ry,h9.add(n0);let e0=M9(q0,(j0-3)*C0.rackSpacing,new y9);J8.push({obj:n0,from:T0,to:e0.position.clone(),qFrom:n0.quaternion.clone(),qTo:e0.quaternion.clone(),elapsed:-G0*0.065,duration:1.1,reparto:!0})}}let $0=_?.moves?.[_.moves.length-1],B0=_?_.handNo+":"+_.moves.length:"";if($0?.type==="pass"&&M$!==B0){M$=B0;let G0=y0[$0.seat];if(G0)G0.toque={t0:c6.elapsedTime}}{let G0=_&&(_.phase==="handEnd"||_.phase==="seriesEnd")&&_.revealed,q0=G0?"r"+_.handNo:"";if(!G0)b9="",a9.clear();else if(q0!==b9){b9=q0;let j0=_.result?.type;mN(_,j0==="domino"||j0==="capicua"?3.4:j0==="tranque"?2.5:1.2)}}d8=[0,1,2,3].map((G0)=>!_||_.phase==="lobby"?0:_.counts[G0]??0),h0.visible=!1,j7=_?.phase==="playing"&&_.chain?.length?IU(_.chain,_.moves):null}let c6=new XK,C$=0,wK=0,lQ=0,P$=60,I$=!1,uQ=!1,z$=null,PJ="high",_Y=null,dQ=performance.now(),cQ=0,TY=!1,lN=new URLSearchParams(location.search).has("debug"),SY=N.intensity,x7=Q9(),uN=Q9(0,C0.surfaceY,0);function jK(){if(I$||uQ){z$=null;return}z$=requestAnimationFrame(jK);let _=c6.getDelta(),n=Math.min(_,0.06),W0=_Y??c6.elapsedTime,$0=performance.now();if(wK++,lQ+=_,lQ>1){if(P$=wK/lQ,wK=0,lQ=0,!X&&!cQ&&PJ==="high"&&$0-dQ>9000&&$0-dQ<30000&&P$<30)cQ=$0,yK.quality("low"),dispatchEvent(new CustomEvent("mesa:calidad",{detail:"low"}));else if(!X&&PJ==="low"&&!TY&&$0-(cQ||dQ)>9000&&$0-(cQ||dQ)<40000&&P$<20)TY=!0,yK.quality("min"),dispatchEvent(new CustomEvent("mesa:calidad",{detail:"min"}))}C$++,W.info.reset();let B0=document.documentElement.classList.contains("reduced");if(m0&&c6.elapsedTime>m0.at)N6={from:K.position.clone(),to:m0.pos,fromTarget:H.target.clone(),toTarget:m0.target,t:0,dur:1.2},m0=null,s0=!1,H.minDistance=N9;let G0=0;if(i0>=0){let F0=c6.elapsedTime-i0;if(F0<0.5){let T0=0.0045*Math.exp(-F0*8)*Math.sin(F0*kJ*18);X9.position.y=T0,k9.position.y=T0,G0=B0?0:0.004*Math.exp(-F0*9),N.intensity=SY*(1+0.35*Math.exp(-F0*14))}else i0=-1,X9.position.y=0,k9.position.y=0,N.intensity=SY}if(N6){N6.t=Math.min(1,N6.t+n/(N6.dur||1.1));let F0=h7(N6.t);if(K.position.lerpVectors(N6.from,N6.to,F0),H.target.lerpVectors(N6.fromTarget,N6.toTarget,F0),N6.t===1)N6=null}if(!B0)t.rotation.z=W0*3.5,p.rotation.z=Math.sin(W0*0.47)*0.009,W9.update(W0),t0.update(W0);let q0=b7,j0={dt:n,jugando:q0?.phase==="playing",turno:q0?.turn,habla:y7,hablaTipo:v7,foco:k$,fin:CJ,cabezas:y0.map((F0,T0)=>F0?.head?F0.head.getWorldPosition(pQ[T0]):null)};if(e6)e6.update(n,{view:q0,habla:y7,cabezas:j0.cabezas}),j0.saludo=e6.saludo;for(let F0 of y0){if(!F0)continue;CK(F0,W0,B0,j0),s9(F0)}for(let F0=0;F0<z0.length;F0++)if((C$+F0)%2===0)CK(z0[F0],W0,B0,j0);J8=J8.filter((F0)=>{if(F0.elapsed+=n,F0.elapsed<0)return!0;let T0=Math.min(1,F0.elapsed/F0.duration);if(F0.revela!=null){F0.obj.visible=!0,a9.add(F0.revela);let e0=h7(T0);if(F0.obj.quaternion.slerpQuaternions(F0.qFrom,F0.qTo,e0),F0.obj.position.lerpVectors(F0.from,F0.to,e0),F0.obj.position.y+=Math.sin(T0*Math.PI)*0.012,T0>=1&&F0.ultima)dispatchEvent(new CustomEvent("mesa:aterriza",{detail:{revela:!0}}));return T0<1}if(F0.reparto)return F0.obj.position.lerpVectors(F0.from,F0.to,h7(T0)),F0.obj.position.y+=Math.sin(T0*Math.PI)*0.035,F0.obj.quaternion.slerpQuaternions(F0.qFrom,F0.qTo,h7(Math.min(1,Math.max(0,(T0-0.3)/0.7)))),T0<1;if(F0.obj.quaternion.slerpQuaternions(F0.qFrom,F0.qTo,h7(Math.min(1,T0/0.4))),F0.golpe){let e0=Math.min(1,T0/0.62);F0.obj.position.lerpVectors(F0.from,F0.to,h7(e0)),F0.obj.position.y+=T0<0.62?Math.sin(e0*Math.PI/2)*0.17:0.17*(1-((T0-0.62)/0.38)**2)}else F0.obj.position.lerpVectors(F0.from,F0.to,h7(T0)),F0.obj.position.y+=Math.sin(T0*Math.PI)*0.07;if(T0>=1&&!F0.sono){if(F0.sono=!0,F0.golpe)i0=c6.elapsedTime;dispatchEvent(new CustomEvent("mesa:aterriza",{detail:{golpe:!!F0.golpe}}))}return T0<1});let n0=$0<c;if(k9.visible=!n0,!n0&&h9.children.length)Y0(h9);if(S8(n),H.update(),!N6&&!m0&&!x0)g0();if(C6.frame(W0,n,{reduced:B0,view:q0,ends:j7,temblor:G0}),C6.render(),C$%2===0)for(let F0 of document.querySelectorAll("[data-seatlabel]")){let T0=Number(F0.dataset.seatlabel),[e0,q9]=C8[T0],E9=y0[T0]?.head,T9=E9&&E9.getWorldPosition(x7).distanceTo(C6.vista.position)<uN.distanceTo(C6.vista.position)-0.2;if(T9)x7.y-=0.3;else if(E9)x7.y+=0.23;else x7.set(e0,1.45,q9);let G9=x7.project(C6.vista),Q6=!1;if(!T9&&G9.y>0.8&&E9)E9.getWorldPosition(x7).y-=0.1,G9=x7.project(C6.vista),Q6=!0;let C9=Math.min(G9.y,0.8);F0.style.transform=`translate(${(G9.x*0.5+0.5)*innerWidth}px,${(-C9*0.5+0.5)*innerHeight}px) translate(-50%,${T9?"-50%":Q6?"0":"-100%"})`,F0.style.visibility=G9.z>1||Math.abs(G9.x)>1.1||G9.y<-1.15?"hidden":"visible"}if(C$%30===0||C$===1){if(window.mesaDiagnostics={cam:K.position.toArray().map((F0)=>+F0.toFixed(2)),fps:Math.round(P$),drawCalls:W.info.render.calls,triangles:W.info.render.triangles,characters:a0,crowd:E8,gente:e6?+e6.ms.toFixed(2):null,visibleCrowd:z0.length,boardTiles:b7?.chain.length||0,quality:PJ,modelErrors:_9},lN){window.mesaRigDebug=y0.filter(Boolean).map((T0)=>({index:T0.index,head:T0.head?.getWorldPosition(Q9()).toArray(),hip:T0.hips?.getWorldPosition(Q9()).toArray(),rootScale:T0.root.scale.toArray()}));let F0=document.querySelector("#perf");if(F0)F0.textContent=`${Math.round(P$)} fps · ${W.info.render.calls} draws`}}}window.mesaCamara=(_,n)=>{N6=null,m0=null,x0=!0,H.minDistance=0.1,H.maxDistance=30,K.position.set(..._),H.target.set(...n),H.update()},window.mesaCara=(_,n,W0)=>{let $0=y0[_];if($0)$0.caraFija=n==null?null:{p:n,s:W0??0}},window.mesaBeber=(_,n)=>{let W0=y0[_];if(!W0||!W0.bebida||W0.jugada)return;if(W0.trago&&n!=null&&W0.trago.fijo!=null)W0.trago.fijo=n;else W0.trago={t0:c6.elapsedTime,fijo:n}},window.mesaSentados=()=>y0.map((_)=>{if(!_)return null;let n=_.hips.getWorldPosition(Q9()),W0=Q9(),$0=9;return _.root.traverse((B0)=>{if(!B0.isSkinnedMesh)return;B0.skeleton.update();let G0=B0.geometry.attributes.position.count;for(let q0=0;q0<G0;q0+=3)if(B0.getVertexPosition(q0,W0).applyMatrix4(B0.matrixWorld),Math.hypot(W0.x-n.x,W0.z-n.z)<0.12&&W0.y<$0)$0=W0.y}),{id:_.id,cadera:+n.y.toFixed(3),nalga:+$0.toFixed(3),pies:+new S6().setFromObject(_.root).min.y.toFixed(3)}}),window.mesaMirones=(_)=>{return J0(_),()=>z0.map((n)=>n.id)},window.mesaBrazo=(_)=>{let n=y0[_],W0=n?.brazos?.[1];if(!W0)return null;let $0=(B0)=>B0.getWorldPosition(new S).toArray();return{codo:$0(W0.antebrazo),muneca:$0(W0.mano),vaso:n.bebida?n.bebida.group.position.toArray():null}},AY(null),jK();let wY=()=>{if(K.aspect<0.95)K.setViewOffset(innerWidth,innerHeight*1.24,0,innerHeight*0.24,innerWidth,innerHeight);else K.clearViewOffset();K.updateProjectionMatrix()},jY=()=>Y?0.65:PJ==="min"?Math.min(devicePixelRatio,1)*0.55:PJ==="low"?Math.min(devicePixelRatio,1)*0.8:Math.min(devicePixelRatio,1.5,1920/innerWidth),yY=()=>{K.aspect=innerWidth/innerHeight,wY(),W.setPixelRatio(jY()),W.setSize(innerWidth,innerHeight),C6.resize(innerWidth,innerHeight)};wY(),window.addEventListener("resize",yY),H.addEventListener("start",()=>{if(N6=null,!s0)m0=null}),W.domElement.addEventListener("webglcontextrestored",()=>C6.entorno?.());let yK={update:AY,setCrowd:J0,setCamera:r9,ready:D$,sentar:MJ,get reparto(){return M6.slice()},sampleTime(_){_Y=_;for(let n of[...y0.filter(Boolean),...z0])CK(n,_,!1);C6.frame(_,0,{reduced:!1,view:b7,ends:j7}),C6.render()},setMode(_){SK=_,r9(_==="attract"?"attract":"table")},quality(_){PJ=_;let n=_!=="high";N.castShadow=!n&&!Y;for(let[W0,$0]of v0){let B0=n?0:$0.clearcoat,G0=n?0:$0.sheen;if(W0.clearcoat!==B0||W0.sheen!==G0)W0.clearcoat=B0,W0.sheen=G0,W0.needsUpdate=!0}q.visible=!n,G.intensity=n?U+0.1:U,W.setPixelRatio(jY()),C6.calidad(_),C6.resize(innerWidth,innerHeight)},pause(){uQ=!0},resume(){if(!uQ)return;if(uQ=!1,c6.getDelta(),!z$)jK()},dispose(){if(I$=!0,e6?.dispose(),C6.dispose(),window.removeEventListener("mesa:botvoice",f7),z$)cancelAnimationFrame(z$);window.removeEventListener("resize",yY),H.dispose(),W.dispose(),J.replaceChildren()}};return yK}export{mk as createWorld};
