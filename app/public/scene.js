...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:i9,depthTest:!1,depthWrite:!1})}function vE(J,Q,$){return new w9({name:"SphericalGaussianBlur",defines:{SAMPLES:_E,CUBEUV_TEXEL_WIDTH:1/Q,CUBEUV_TEXEL_HEIGHT:1/$,CUBEUV_MAX_MIP:`${J}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:l$(),fragmentShader:`
		...
		`,blending:i9,depthTest:!1,depthWrite:!1})}function xY(){return new w9({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:l$(),fragmentShader:`
		...
		`,blending:i9,depthTest:!1,depthWrite:!1})}function gY(){return new w9({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:l$(),fragmentShader:`
	...
	`}class NK extends O9{constructor(J=1,Q={}){super(J,J,Q);this.isWebGLCubeRenderTarget=!0;let $={width:J,height:J,depth:1},W=[$,$,$,$,$,$];this.texture=new C$(W),this._setTextureOptions(Q),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(J,Q){this.texture.type=Q.type,this.texture.colorSpace=Q.colorSpace,this.texture.generateMipmaps=Q.generateMipmaps,this.texture.minFilter=Q.minFilter,this.texture.magFilter=Q.magFilter;let $={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},W=new aJ(5,5,5),Z=new w9({name:"CubemapFromEquirect",uniforms:q7($.uniforms),vertexShader:$.vertexShader,fragmentShader:$.fragmentShader,side:Q9,blending:i9});Z.uniforms.tEquirect.value=Q;let K=new x0(W,Z),H=Q.minFilter;if(Q.minFilter===o9)Q.minFilter=iJ;return new oZ(1,10,this).update(J,K),Q.minFilter=H,K.geometry.dispose(),K.material.dispose(),this}clear(J,Q=!0,$=!0,W=!0){let Z=J.getRenderTarget();for(let K=0;K<6;K++)J.setRenderTarget(this,K),J.clear(Q,$,W);J.setRenderTarget(Z)}}function fE(J){let Q=new WeakMap,$=new WeakMap,W=null;function Z(G,q=!1){if(G===null||G===void 0)return null;if(q)return H(G);return K(G)}function K(G){if(G&&G.isTexture){let q=G.mapping;if(q===$$||q===W$)if(Q.has(G)){let F=Q.get(G).texture;return Y(F,G.mapping)}else{let F=G.image;if(F&&F.height>0){let B=new NK(F.height);return B.fromEquirectangularTexture(J,G),Q.set(G,B),G.addEventListener("dispose",U),Y(B.texture,G.mapping)}else return null}}return G}function H(G){if(G&&G.isTexture){let q=G.mapping,F=q===$$||q===W$,B=q===t7||q===K7;if(F||B){let R=$.get(G),O=R!==void 0?R.texture.pmremVersion:0;if(G.isRenderTargetTexture&&G.pmremVersion!==O){if(W===null)W=new RQ(J);return R=F?W.fromEquirectangular(G,R):W.fromCubemap(G,R),R.texture.pmremVersion=G.pmremVersion,$.set(G,R),R.texture}else if(R!==void 0)return R.texture;else{let P=G.image;if(F&&P&&P.height>0||B&&P&&X(P)){if(W===null)W=new RQ(J);return R=F?W.fromEquirectangular(G):W.fromCubemap(G),R.texture.pmremVersion=G.pmremVersion,$.set(G,R),G.addEventListener("dispose",N),R.texture}else return null}}}return G}function Y(G,q){if(q===$$)G.mapping=t7;else if(q===W$)G.mapping=K7;return G}function X(G){let q=0,F=6;for(let B=0;B<F;B++)if(G[B]!==void 0)q++;return q===F}function U(G){let q=G.target;q.removeEventListener("dispose",U);let F=Q.get(q);if(F!==void 0)Q.delete(q),F.dispose()}function N(G){let q=G.target;q.removeEventListener("dispose",N);let F=$.get(q);if(F!==void 0)$.delete(q),F.dispose()}function E(){if(Q=new WeakMap,$=new WeakMap,W!==null)W.dispose(),W=null}return{get:Z,dispose:E}}function hE(J){let Q={};function $(W){if(Q[W]!==void 0)return Q[W];let Z=J.getExtension(W);return Q[W]=Z,Z}return{has:function(W){return $(W)!==null},init:function(){$("EXT_color_buffer_float"),$("WEBGL_clip_cull_distance"),$("OES_texture_float_linear"),$("EXT_color_buffer_half_float"),$("WEBGL_multisampled_render_to_texture"),$("WEBGL_render_shared_exponent")},get:function(W){let Z=$(W);if(Z===null)$7("WebGLRenderer: "+W+" extension not supported.");return Z}}}function bE(J,Q,$,W){let Z={},K=new WeakMap;function H(E){let G=E.target;if(G.index!==null)Q.remove(G.index);for(let F in G.attributes)Q.remove(G.attributes[F]);G.removeEventListener("dispose",H),delete Z[G.id];let q=K.get(G);if(q)Q.remove(q),K.delete(G);if(W.releaseStatesOfGeometry(G),G.isInstancedBufferGeometry===!0)delete G._maxInstanceCount;$.memory.geometries--}function Y(E,G){if(Z[G.id]===!0)return G;return G.addEventListener("dispose",H),Z[G.id]=!0,$.memory.geometries++,G}function X(E){let G=E.attributes;for(let q in G)Q.update(G[q],J.ARRAY_BUFFER)}function U(E){let G=[],q=E.index,F=E.attributes.position,B=0;if(F===void 0)return;if(q!==null){let P=q.array;B=q.version;for(let k=0,L=P.length;k<L;k+=3){let C=P[k+0],A=P[k+1],w=P[k+2];G.push(C,A,A,w,w,C)}}else{let P=F.array;B=F.version;for(let k=0,L=P.length/3-1;k<L;k+=3){let C=k+0,A=k+1,w=k+2;G.push(C,A,A,w,w,C)}}let R=new(F.count>=65535?V$:L$)(G,1);R.version=B;let O=K.get(E);if(O)Q.remove(O);K.set(E,R)}function N(E){let G=K.get(E);if(G){let q=E.index;if(q!==null){if(G.version<q.version)U(E)}}else U(E);return K.get(E)}return{get:Y,update:X,getWireframeAttribute:N}}function xE(J,Q,$){let W;function Z(E){W=E}let K,H;function Y(E){K=E.type,H=E.bytesPerElement}function X(E,G){J.drawElements(W,G,K,E*H),$.update(G,W,1)}function U(E,G,q){if(q===0)return;J.drawElementsInstanced(W,G,K,E*H,q),$.update(G,W,q)}function N(E,G,q){if(q===0)return;Q.get("WEBGL_multi_draw").multiDrawElementsWEBGL(W,G,0,K,E,0,q);let B=0;for(let R=0;R<q;R++)B+=G[R];$.update(B,W,1)}this.setMode=Z,this.setIndex=Y,this.render=X,this.renderInstances=U,this.renderMultiDraw=N}function gE(J){let Q={geometries:0,textures:0},$={frame:0,calls:0,triangles:0,points:0,lines:0};function W(K,H,Y){switch($.calls++,H){case J.TRIANGLES:$.triangles+=Y*(K/3);break;case J.LINES:$.lines+=Y*(K/2);break;case J.LINE_STRIP:$.lines+=Y*(K-1);break;case J.LINE_LOOP:$.lines+=Y*K;break;case J.POINTS:$.points+=Y*K;break;default:c0("WebGLInfo: Unknown draw mode:",H);break}}function Z(){$.calls=0,$.triangles=0,$.points=0,$.lines=0}return{memory:Q,render:$,programs:null,autoReset:!0,reset:Z,update:W}}function pE(J,Q,$){let W=new WeakMap,Z=new LJ;function K(H,Y,X){let U=H.morphTargetInfluences,N=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,E=N!==void 0?N.length:0,G=W.get(Y);if(G===void 0||G.count!==E){let I=function(){w.dispose(),W.delete(Y),Y.removeEventListener("dispose",I)};if(G!==void 0)G.texture.dispose();let q=Y.morphAttributes.position!==void 0,F=Y.morphAttributes.normal!==void 0,B=Y.morphAttributes.color!==void 0,R=Y.morphAttributes.position||[],O=Y.morphAttributes.normal||[],P=Y.morphAttributes.color||[],k=0;if(q===!0)k=1;if(F===!0)k=2;if(B===!0)k=3;let L=Y.attributes.position.count*k,C=1;if(L>Q.maxTextureSize)C=Math.ceil(L/Q.maxTextureSize),L=Q.maxTextureSize;let A=new Float32Array(L*C*4*E),w=new O$(A,L,C,E);w.type=F8,w.needsUpdate=!0;let D=k*4;for(let m=0;m<E;m++){let f=R[m],x=O[m],o=P[m],y=L*C*4*m;for(let u=0;u<f.count;u++){let t=u*D;if(q===!0)Z.fromBufferAttribute(f,u),A[y+t+0]=Z.x,A[y+t+1]=Z.y,A[y+t+2]=Z.z,A[y+t+3]=0;if(F===!0)Z.fromBufferAttribute(x,u),A[y+t+4]=Z.x,A[y+t+5]=Z.y,A[y+t+6]=Z.z,A[y+t+7]=0;if(B===!0)Z.fromBufferAttribute(o,u),A[y+t+8]=Z.x,A[y+t+9]=Z.y,A[y+t+10]=Z.z,A[y+t+11]=o.itemSize===4?Z.w:1}}G={count:E,texture:w,size:new K0(L,C)},W.set(Y,G),Y.addEventListener("dispose",I)}if(H.isInstancedMesh===!0&&H.morphTexture!==null)X.getUniforms().setValue(J,"morphTexture",H.morphTexture,$);else{let q=0;for(let B=0;B<U.length;B++)q+=U[B];let F=Y.morphTargetsRelative?1:1-q;X.getUniforms().setValue(J,"morphTargetBaseInfluence",F),X.getUniforms().setValue(J,"morphTargetInfluences",U)}X.getUniforms().setValue(J,"morphTargetsTexture",G.texture,$),X.getUniforms().setValue(J,"morphTargetsTextureSize",G.size)}return{update:K}}function lE(J,Q,$,W,Z){let K=new WeakMap;function H(U){let N=Z.render.frame,E=U.geometry,G=Q.get(U,E);if(K.get(G)!==N)Q.update(G),K.set(G,N);if(U.isInstancedMesh){if(U.hasEventListener("dispose",X)===!1)U.addEventListener("dispose",X);if(K.get(U)!==N){if($.update(U.instanceMatrix,J.ARRAY_BUFFER),U.instanceColor!==null)$.update(U.instanceColor,J.ARRAY_BUFFER);K.set(U,N)}}if(U.isSkinnedMesh){let q=U.skeleton;if(K.get(q)!==N)q.update(),K.set(q,N)}return G}function Y(){K=new WeakMap}function X(U){let N=U.target;if(N.removeEventListener("dispose",X),W.releaseStatesOfObject(N),$.remove(N.instanceMatrix),N.instanceColor!==null)$.remove(N.instanceColor)}return{update:H,dispose:Y}}var mE={[vW]:"LINEAR_TONE_MAPPING",[fW]:"REINHARD_TONE_MAPPING",[hW]:"CINEON_TONE_MAPPING",[l6]:"ACES_FILMIC_TONE_MAPPING",[xW]:"AGX_TONE_MAPPING",[gW]:"NEUTRAL_TONE_MAPPING",[bW]:"CUSTOM_TONE_MAPPING"};function dE(J,Q,$,W,Z,K){let H=new O9(Q,$,{type:J,depthBuffer:Z,stencilBuffer:K,samples:W?4:0,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,resolveDepthBuffer:!1,resolveStencilBuffer:!1}),Y=null,X=null,U=new wJ;U.setAttribute("position",new YJ([-1,3,0,-1,-1,0,3,-1,0],3)),U.setAttribute("uv",new YJ([0,2,0,0,2,0],2));let N=new pZ({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),E=new x0(U,N),G=new O7(-1,1,1,-1,0,1),q=null,F=null,B=!1,R,O=null,P=[],k=!1;this.setSize=function(L,C){if(H.setSize(L,C),Y!==null)Y.setSize(L,C);if(X!==null)X.setSize(L,C);for(let A=0;A<P.length;A++){let w=P[A];if(w.setSize)w.setSize(L,C)}},this.setEffects=function(L){P=L,k=P.length>0&&P[0].isRenderPass===!0;let{width:C,height:A}=H;if(P.length>0&&Y===null)Y=new O9(C,A,{type:a9,depthBuffer:!1,stencilBuffer:!1}),X=new O9(C,A,{type:a9,depthBuffer:!1,stencilBuffer:!1});for(let w=0;w<P.length;w++){let D=P[w];if(D.setSize)D.setSize(C,A)}},this.begin=function(L,C){if(B)return!1;if(L.toneMapping===x9&&P.length===0)return!1;if(O=C,C!==null){let{width:A,height:w}=C;if(H.width!==A||H.height!==w)this.setSize(A,w)}if(k===!1)L.setRenderTarget(H);return R=L.toneMapping,L.toneMapping=x9,!0},this.hasRenderPass=function(){return k},this.end=function(L,C){L.toneMapping=R,B=!0;let A=H,w=Y;for(let D=0;D<P.length;D++){let I=P[D];if(I.enabled===!1)continue;if(I.render(L,w,A,C),I.needsSwap!==!1)A=w,w=w===Y?X:Y}if(q!==L.outputColorSpace||F!==L.toneMapping){if(q=L.outputColorSpace,F=L.toneMapping,N.defines={},JJ.getTransfer(q)===zJ)N.defines.SRGB_TRANSFER="";let D=mE[F];if(D)N.defines[D]="";N.needsUpdate=!0}N.uniforms.tDiffuse.value=A.texture,L.setRenderTarget(O),L.render(E,G),O=null,B=!1},this.isCompositing=function(){return B},this.dispose=function(){if(H.dispose(),Y!==null)Y.dispose();if(X!==null)X.dispose();U.dispose(),N.dispose()}}var KX=new hJ,UK=new N7(1,1),HX=new O$,YX=new SZ,XX=new C$,pY=[],lY=[],mY=new Float32Array(16),dY=new Float32Array(9),uY=new Float32Array(4);function E6(J,Q,$){let W=J[0];if(W<=0||W>0)return J;let Z=Q*$,K=pY[Z];if(K===void 0)K=new Float32Array(Z),pY[Z]=K;if(Q!==0){W.toArray(K,0);for(let H=1,Y=0;H!==Q;++H)Y+=$,J[H].toArray(K,Y)}return K}function dJ(J,Q){if(J.length!==Q.length)return!1;for(let $=0,W=J.length;$<W;$++)if(J[$]!==Q[$])return!1;return!0}function uJ(J,Q){for(let $=0,W=Q.length;$<W;$++)J[$]=Q[$]}function m$(J,Q){let $=lY[Q];if($===void 0)$=new Int32Array(Q),lY[Q]=$;for(let W=0;W!==Q;++W)$[W]=J.allocateTextureUnit();return $}function uE(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1f(this.addr,Q),$[0]=Q}function cE(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2f(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(dJ($,Q))return;J.uniform2fv(this.addr,Q),uJ($,Q)}}function nE(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3f(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else if(Q.r!==void 0){if($[0]!==Q.r||$[1]!==Q.g||$[2]!==Q.b)J.uniform3f(this.addr,Q.r,Q.g,Q.b),$[0]=Q.r,$[1]=Q.g,$[2]=Q.b}else{if(dJ($,Q))return;J.uniform3fv(this.addr,Q),uJ($,Q)}}function sE(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4f(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(dJ($,Q))return;J.uniform4fv(this.addr,Q),uJ($,Q)}}function iE(J,Q){let $=this.cache,W=Q.elements;if(W===void 0){if(dJ($,Q))return;J.uniformMatrix2fv(this.addr,!1,Q),uJ($,Q)}else{if(dJ($,W))return;uY.set(W),J.uniformMatrix2fv(this.addr,!1,uY),uJ($,W)}}function oE(J,Q){let $=this.cache,W=Q.elements;if(W===void 0){if(dJ($,Q))return;J.uniformMatrix3fv(this.addr,!1,Q),uJ($,Q)}else{if(dJ($,W))return;dY.set(W),J.uniformMatrix3fv(this.addr,!1,dY),uJ($,W)}}function aE(J,Q){let $=this.cache,W=Q.elements;if(W===void 0){if(dJ($,Q))return;J.uniformMatrix4fv(this.addr,!1,Q),uJ($,Q)}else{if(dJ($,W))return;mY.set(W),J.uniformMatrix4fv(this.addr,!1,mY),uJ($,W)}}function rE(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1i(this.addr,Q),$[0]=Q}function tE(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2i(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(dJ($,Q))return;J.uniform2iv(this.addr,Q),uJ($,Q)}}function eE(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3i(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else{if(dJ($,Q))return;J.uniform3iv(this.addr,Q),uJ($,Q)}}function Jq(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4i(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(dJ($,Q))return;J.uniform4iv(this.addr,Q),uJ($,Q)}}function Qq(J,Q){let $=this.cache;if($[0]===Q)return;J.uniform1ui(this.addr,Q),$[0]=Q}function $q(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y)J.uniform2ui(this.addr,Q.x,Q.y),$[0]=Q.x,$[1]=Q.y}else{if(dJ($,Q))return;J.uniform2uiv(this.addr,Q),uJ($,Q)}}function Wq(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z)J.uniform3ui(this.addr,Q.x,Q.y,Q.z),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z}else{if(dJ($,Q))return;J.uniform3uiv(this.addr,Q),uJ($,Q)}}function Zq(J,Q){let $=this.cache;if(Q.x!==void 0){if($[0]!==Q.x||$[1]!==Q.y||$[2]!==Q.z||$[3]!==Q.w)J.uniform4ui(this.addr,Q.x,Q.y,Q.z,Q.w),$[0]=Q.x,$[1]=Q.y,$[2]=Q.z,$[3]=Q.w}else{if(dJ($,Q))return;J.uniform4uiv(this.addr,Q),uJ($,Q)}}function Kq(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;let K;if(this.type===J.SAMPLER_2D_SHADOW)UK.compareFunction=$.isReversedDepthBuffer()?F$:q$,K=UK;else K=KX;$.setTexture2D(Q||K,Z)}function Hq(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;$.setTexture3D(Q||YX,Z)}function Yq(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;$.setTextureCube(Q||XX,Z)}function Xq(J,Q,$){let W=this.cache,Z=$.allocateTextureUnit();if(W[0]!==Z)J.uniform1i(this.addr,Z),W[0]=Z;$.setTexture2DArray(Q||HX,Z)}function Uq(J){switch(J){case 5126:return uE;case 35664:return cE;case 35665:return nE;case 35666:return sE;case 35674:return iE;case 35675:return oE;case 35676:return aE;case 5124:case 35670:return rE;case 35667:case 35671:return tE;case 35668:case 35672:return eE;case 35669:case 35673:return Jq;case 5125:return Qq;case 36294:return $q;case 36295:return Wq;case 36296:return Zq;case 35678:case 36198:case 36298:case 36306:case 35682:return Kq;case 35679:case 36299:case 36307:return Hq;case 35680:case 36300:case 36308:case 36293:return Yq;case 36289:case 36303:case 36311:case 36292:return Xq}}function Gq(J,Q){J.uniform1fv(this.addr,Q)}function Nq(J,Q){let $=E6(Q,this.size,2);J.uniform2fv(this.addr,$)}function Eq(J,Q){let $=E6(Q,this.size,3);J.uniform3fv(this.addr,$)}function qq(J,Q){let $=E6(Q,this.size,4);J.uniform4fv(this.addr,$)}function Fq(J,Q){let $=E6(Q,this.size,4);J.uniformMatrix2fv(this.addr,!1,$)}function Oq(J,Q){let $=E6(Q,this.size,9);J.uniformMatrix3fv(this.addr,!1,$)}function Rq(J,Q){let $=E6(Q,this.size,16);J.uniformMatrix4fv(this.addr,!1,$)}function Lq(J,Q){J.uniform1iv(this.addr,Q)}function Vq(J,Q){J.uniform2iv(this.addr,Q)}function Bq(J,Q){J.uniform3iv(this.addr,Q)}function kq(J,Q){J.uniform4iv(this.addr,Q)}function Dq(J,Q){J.uniform1uiv(this.addr,Q)}function Mq(J,Q){J.uniform2uiv(this.addr,Q)}function Cq(J,Q){J.uniform3uiv(this.addr,Q)}function zq(J,Q){J.uniform4uiv(this.addr,Q)}function Pq(J,Q,$){let W=this.cache,Z=Q.length,K=m$($,Z);if(!dJ(W,K))J.uniform1iv(this.addr,K),uJ(W,K);let H;if(this.type===J.SAMPLER_2D_SHADOW)H=UK;else H=KX;for(let Y=0;Y!==Z;++Y)$.setTexture2D(Q[Y]||H,K[Y])}function Iq(J,Q,$){let W=this.cache,Z=Q.length,K=m$($,Z);if(!dJ(W,K))J.uniform1iv(this.addr,K),uJ(W,K);for(let H=0;H!==Z;++H)$.setTexture3D(Q[H]||YX,K[H])}function Aq(J,Q,$){let W=this.cache,Z=Q.length,K=m$($,Z);if(!dJ(W,K))J.uniform1iv(this.addr,K),uJ(W,K);for(let H=0;H!==Z;++H)$.setTextureCube(Q[H]||XX,K[H])}function wq(J,Q,$){let W=this.cache,Z=Q.length,K=m$($,Z);if(!dJ(W,K))J.uniform1iv(this.addr,K),uJ(W,K);for(let H=0;H!==Z;++H)$.setTexture2DArray(Q[H]||HX,K[H])}function _q(J){switch(J){case 5126:return Gq;case 35664:return Nq;case 35665:return Eq;case 35666:return qq;case 35674:return Fq;case 35675:return Oq;case 35676:return Rq;case 5124:case 35670:return Lq;case 35667:case 35671:return Vq;case 35668:case 35672:return Bq;case 35669:case 35673:return kq;case 5125:return Dq;case 36294:return Mq;case 36295:return Cq;case 36296:return zq;case 35678:case 36198:case 36298:case 36306:case 35682:return Pq;case 35679:case 36299:case 36307:return Iq;case 35680:case 36300:case 36308:case 36293:return Aq;case 36289:case 36303:case 36311:case 36292:return wq}}class UX{constructor(J,Q,$){this.id=J,this.addr=$,this.cache=[],this.type=Q.type,this.setValue=Uq(Q.type)}}class GX{constructor(J,Q,$){this.id=J,this.addr=$,this.cache=[],this.type=Q.type,this.size=Q.size,this.setValue=_q(Q.type)}}class NX{constructor(J){this.id=J,this.seq=[],this.map={}}setValue(J,Q,$){let W=this.seq;for(let Z=0,K=W.length;Z!==K;++Z){let H=W[Z];H.setValue(J,Q[H.id],$)}}}var YK=/(\w+)(\])?(\[|\.)?/g;function cY(J,Q){J.seq.push(Q),J.map[Q.id]=Q}function Tq(J,Q,$){let W=J.name,Z=W.length;YK.lastIndex=0;while(!0){let K=YK.exec(W),H=YK.lastIndex,Y=K[1],X=K[2]==="]",U=K[3];if(X)Y=Y|0;if(U===void 0||U==="["&&H+2===Z){cY($,U===void 0?new UX(Y,J,Q):new GX(Y,J,Q));break}else{let E=$.map[Y];if(E===void 0)E=new NX(Y),cY($,E);$=E}}}class OQ{constructor(J,Q){this.seq=[],this.map={};let $=J.getProgramParameter(Q,J.ACTIVE_UNIFORMS);for(let K=0;K<$;++K){let H=J.getActiveUniform(Q,K),Y=J.getUniformLocation(Q,H.name);Tq(H,Y,this)}let W=[],Z=[];for(let K of this.seq)if(K.type===J.SAMPLER_2D_SHADOW||K.type===J.SAMPLER_CUBE_SHADOW||K.type===J.SAMPLER_2D_ARRAY_SHADOW)W.push(K);else Z.push(K);if(W.length>0)this.seq=W.concat(Z)}setValue(J,Q,$,W){let Z=this.map[Q];if(Z!==void 0)Z.setValue(J,$,W)}setOptional(J,Q,$){let W=Q[$];if(W!==void 0)this.setValue(J,$,W)}static upload(J,Q,$,W){for(let Z=0,K=Q.length;Z!==K;++Z){let H=Q[Z],Y=$[H.id];if(Y.needsUpdate!==!1)H.setValue(J,Y.value,W)}}static seqWithValue(J,Q){let $=[];for(let W=0,Z=J.length;W!==Z;++W){let K=J[W];if(K.id in Q)$.push(K)}return $}}function nY(J,Q,$){let W=J.createShader(Q);return J.shaderSource(W,$),J.compileShader(W),W}var Sq=37297,jq=0;function yq(J,Q){let $=J.split(`
`),W=[],Z=Math.max(Q-6,0),K=Math.min(Q+6,$.length);for(let H=Z;H<K;H++){let Y=H+1;W.push(`${Y===Q?">":" "} ${Y}: ${$[H]}`)}return W.join(`
`)}var sY=new s0;function vq(J){JJ._getMatrix(sY,JJ.workingColorSpace,J);let Q=`mat3( ${sY.elements.map(($)=>$.toFixed(4))} )`;switch(JJ.getTransfer(J)){case PZ:return[Q,"LinearTransferOETF"];case zJ:return[Q,"sRGBTransferOETF"];default:return S0("WebGLProgram: Unsupported color space: ",J),[Q,"LinearTransferOETF"]}}function iY(J,Q,$){let W=J.getShaderParameter(Q,J.COMPILE_STATUS),K=(J.getShaderInfoLog(Q)||"").trim();if(W&&K==="")return"";let H=/ERROR: 0:(\d+)/.exec(K);if(H){let Y=parseInt(H[1]);return $.toUpperCase()+`

`+K+`

`+yq(J.getShaderSource(Q),Y)}else return K}function fq(J,Q){let $=vq(Q);return[`vec4 ${J}( vec4 value ) {`,`	return ${$[1]}( vec4( value.rgb * ${$[0]}, value.a ) );`,"}"].join(`
`)}var hq={[vW]:"Linear",[fW]:"Reinhard",[hW]:"Cineon",[l6]:"ACESFilmic",[xW]:"AgX",[gW]:"Neutral",[bW]:"Custom"};function bq(J,Q){let $=hq[Q];if($===void 0)return S0("WebGLProgram: Unsupported toneMapping:",Q),"vec3 "+J+"( vec3 color ) { return LinearToneMapping( color ); }";return"vec3 "+J+"( vec3 color ) { return "+$+"ToneMapping( color ); }"}var p$=new _;function xq(){JJ.getLuminanceCoefficients(p$);let J=p$.x.toFixed(4),Q=p$.y.toFixed(4),$=p$.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${J}, ${Q}, ${$} );`,"\treturn dot( weights, rgb );","}"].join(`
`)}function gq(J){return[J.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",J.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(FQ).join(`
`)}function pq(J){let Q=[];for(let $ in J){let W=J[$];if(W===!1)continue;Q.push("#define "+$+" "+W)}return Q.join(`
`)}function lq(J,Q){let $={},W=J.getProgramParameter(Q,J.ACTIVE_ATTRIBUTES);for(let Z=0;Z<W;Z++){let K=J.getActiveAttrib(Q,Z),H=K.name,Y=1;if(K.type===J.FLOAT_MAT2)Y=2;if(K.type===J.FLOAT_MAT3)Y=3;if(K.type===J.FLOAT_MAT4)Y=4;$[H]={type:K.type,location:J.getAttribLocation(Q,H),locationSize:Y}}return $}function FQ(J){return J!==""}function oY(J,Q){let $=Q.numSpotLightShadows+Q.numSpotLightMaps-Q.numSpotLightShadowsWithMaps;return J.replace(/NUM_SUN_LIGHTS/g,Q.numSunLights).replace(/NUM_DIR_LIGHTS/g,Q.numDirLights).replace(/NUM_SPOT_LIGHTS/g,Q.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,Q.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,$).replace(/NUM_RECT_AREA_LIGHTS/g,Q.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,Q.numPointLights).replace(/NUM_HEMI_LIGHTS/g,Q.numHemiLights).replace(/NUM_SUN_LIGHT_SHADOWS/g,Q.numSunLightShadows).replace(/NUM_DIR_LIGHT_SHADOWS/g,Q.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,Q.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,Q.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,Q.numPointLightShadows)}function aY(J,Q){return J.replace(/NUM_CLIPPING_PLANES/g,Q.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,Q.numClippingPlanes-Q.numClipIntersection)}var mq=/^[ \t]*#include +<([\w\d./]+)>/gm;function GK(J){return J.replace(mq,uq)}var dq=new Map;function uq(J,Q){let $=t0[Q];if($===void 0){let W=dq.get(Q);if(W!==void 0)$=t0[W],S0('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',Q,W);else throw Error("THREE.WebGLProgram: Can not resolve #include <"+Q+">")}return GK($)}var cq=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function rY(J){return J.replace(cq,nq)}function nq(J,Q,$,W){let Z="";for(let K=parseInt(Q);K<parseInt($);K++)Z+=W.replace(/\[\s*i\s*\]/g,"[ "+K+" ]").replace(/UNROLLED_LOOP_INDEX/g,K);return Z}function tY(J){let Q=`precision ${J.precision} float;
...
#define LOW_PRECISION`;return Q}var sq={[g6]:"SHADOWMAP_TYPE_PCF",[a7]:"SHADOWMAP_TYPE_VSM"};function iq(J){return sq[J.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var oq={[t7]:"ENVMAP_TYPE_CUBE",[K7]:"ENVMAP_TYPE_CUBE",[m6]:"ENVMAP_TYPE_CUBE_UV"};function aq(J){if(J.envMap===!1)return"ENVMAP_TYPE_CUBE";return oq[J.envMapMode]||"ENVMAP_TYPE_CUBE"}var rq={[K7]:"ENVMAP_MODE_REFRACTION"};function tq(J){if(J.envMap===!1)return"ENVMAP_MODE_REFLECTION";return rq[J.envMapMode]||"ENVMAP_MODE_REFLECTION"}var eq={[QY]:"ENVMAP_BLENDING_MULTIPLY",[$Y]:"ENVMAP_BLENDING_MIX",[WY]:"ENVMAP_BLENDING_ADD"};function J1(J){if(J.envMap===!1)return"ENVMAP_BLENDING_NONE";return eq[J.combine]||"ENVMAP_BLENDING_NONE"}function Q1(J){let Q=J.envMapCubeUVHeight;if(Q===null)return null;let $=Math.log2(Q)-2,W=1/Q;return{texelWidth:1/(3*Math.max(Math.pow(2,$),112)),texelHeight:W,maxMip:$}}function $1(J,Q,$,W){let Z=J.getContext(),K=$.defines,H=$.vertexShader,Y=$.fragmentShader,X=iq($),U=aq($),N=tq($),E=J1($),G=Q1($),q=gq($),F=pq(K),B=Z.createProgram(),R,O,P=$.glslVersion?"#version "+$.glslVersion+`
