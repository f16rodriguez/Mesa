...
const CACHE='mesa-pano-v1';
const FILES=['/','/index.html','/client.js','/mesa.css','/fonts/fonts.css','/fonts/dm-sans-var.woff2','/fonts/shrikhand-400.woff2','/fonts/plex-mono-500.woff2','/textos.js','/sonidos.js','/bot.js','/bot-rhythm.js','/bot-chatter.js','/ambiente.js','/proximity-voice.js','/rules.js','/qr.js','/scene.js','/telemetria.js','/icono.svg','/manifest.webmanifest','/marca/mesa-logo-horizontal-transparent.svg','/marca/mesa-logo-stacked-transparent.svg','/marca/mesa-logo-horizontal-notag-transparent.svg','/marca/three-thirteen-horizontal-light-on-dark.svg','/marca/three-thirteen-logo-light-on-dark.svg','/marca/three-thirteen-splash.mp4'];
