...
const ES={
 ...
 enLaFila:'En la fila',eresElProximo:'Eres el próximo',vasN:'Vas {n} en la fila',filaCuando:'Entras cuando se pare el que pierda la serie, o antes si se libera una silla.',delante:'Antes que tú: {nombres}.',salirFila:'Salir de la fila',
 anotame:'Anótame',anotateTxt:'Aquí se para el que pierde: anótate y entras cuando termine la serie.',yaHay:'Hay {n} en la fila.',enLaFilaEtq:'EN LA FILA',enLaFilaN:'En la fila: {nombres}.',
 seParaUno:'Se para {nombres}.',seParan:'Se paran {nombres}.',entraUno:'Entra {nombres}.',entran:'Entran {nombres}.',tePararas:'Te paras: entra {nombre}. Te anotamos al final de la fila.',
 escenaNoCargo:'La mesa en 3D no cargó: se cortó la descarga. Prueba otra vez; la partida sigue donde iba.',
 modoMesa:'Cómo se juega esta mesa',dosContraDos:'2 contra 2',unoContraUno:'1 contra 1',unoContraUnoNota:'Cada quien por su cuenta: 7 fichas y el resto al pozo. Quien no lleva, roba.',unoContraUnoSinPozo:'Cada quien por su cuenta: 7 fichas y las otras 14 duermen.',
 robar:'Robar',quedanPozo:'Quedan {n} en el pozo.',pozoN:'Pozo · {n}',robo3:'{nombre} robó',roboN:'{nombre} robó {n}',contraX:'contra {nombre}',ganaste:'¡Ganaste!',perdiste:'Esta se fue.',
 ganaUno:'Gana {a}',ganasteSerie:'¡Ganaste la serie!',ganoSerieUno:'{a} gana la serie',cambiarMesa:'Cambiar la mesa',seRoba:'Se roba del pozo (si no, las 14 que sobran duermen)',
 unoContraUnoTxt:'Dos jugadores, 7 fichas cada uno y 14 en el pozo. Quien no lleva roba hasta que le pegue; con el pozo vacío, pasa. La primera mano la sale el doble más alto que haya en mano.',
 enLineaTit:'En línea',enLineaTxt:'Tu gente, desde donde esté: 1 contra 1 y 2 contra 2, con voz.',proximamente:'Próximamente',ligaTit:'Liga',ligaTxt:'Tu historial, las repeticiones de cada mano y consejos para jugar mejor.',
 ligaBoton:'Apúntame',ligaModal:'La Liga de Mesa',ligaCopia:'Cuando abra la Liga, te mandamos un correo. Uno solo.',ligaListo:'Listo. Estás en la lista de la Liga.',yaEnLista:'Ya estás en la lista',
...
const EN={
 ...
 enLaFila:'In line',eresElProximo:'You’re next',vasN:'You’re {n} in line',filaCuando:'You’re in when the losing side of the series gets up, or sooner if a seat frees up.',delante:'Ahead of you: {nombres}.',salirFila:'Leave the line',
 anotame:'Sign me up',anotateTxt:'Losers get up here: sign up and you’re in when the series ends.',yaHay:'{n} in line.',enLaFilaEtq:'IN LINE',enLaFilaN:'In line: {nombres}.',
 seParaUno:'{nombres} gets up.',seParan:'{nombres} get up.',entraUno:'{nombres} sits in.',entran:'{nombres} sit in.',tePararas:'You get up: {nombre} sits in. You’re at the back of the line.',
 escenaNoCargo:'The 3D table didn’t load: the download was cut off. Try again; the game picks up where it was.',
 modoMesa:'How this table plays',dosContraDos:'2 vs 2',unoContraUno:'1 vs 1',unoContraUnoNota:'Everyone for themselves: 7 tiles each, the rest in the boneyard. No tile, you draw.',unoContraUnoSinPozo:'Everyone for themselves: 7 tiles each, the other 14 sleep.',
 robar:'Draw',quedanPozo:'{n} left in the boneyard.',pozoN:'Boneyard · {n}',robo3:'{nombre} drew',roboN:'{nombre} drew {n}',contraX:'vs {nombre}',ganaste:'You won!',perdiste:'Not this one.',
 ganaUno:'{a} takes it',ganasteSerie:'You won the series!',ganoSerieUno:'{a} wins the series',cambiarMesa:'Change the table',seRoba:'Draw from the boneyard (otherwise the 14 extra tiles sleep)',
 unoContraUnoTxt:'Two players, 7 tiles each and 14 in the boneyard. No tile that fits, you draw until one does; with the boneyard empty, you pass. The highest double in hand opens the first hand.',
 enLineaTit:'Online',enLineaTxt:'Your people, wherever they are: 1 vs 1 and 2 vs 2, with voice.',proximamente:'Coming soon',ligaTit:'Liga',ligaTxt:'Your record, replays of every hand and tips to play better.',
 ligaBoton:'Count me in',ligaModal:'The Mesa Liga',ligaCopia:'When the Liga opens, we send you one email. Just the one.',ligaListo:'Done. You’re on the Liga list.',yaEnLista:'You’re on the list',
...
const ERRORES={
 ...
 'All seats are taken. You can still watch.':'Todas las sillas están ocupadas. Puedes mirar.',
 'You already have a seat.':'Ya tienes silla.',
 'Only two fit at one against one. Someone has to get up first.':'En 1 contra 1 caben dos. Que alguien se pare primero.',
 'Draw from the boneyard first.':'Primero roba del pozo.','This table plays without drawing.':'En esta mesa no se roba.','You have a legal tile. Play it instead of drawing.':'Tienes ficha que pega: no puedes robar.','The boneyard is empty.':'El pozo está vacío.',
