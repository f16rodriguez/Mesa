...
export async function createWorld(container,{onProgress=()=>{}}={}){
 ...
 box(0,.85,-4.24,3.9,1.1,.62,wood);box(0,1.43,-4.2,4.08,.10,.78,wood);
 ...
 let currentView=null,currentCrowd=0,boardKey='',rackKey='',lastHand=0,mode='attract',camTween=null,animations=[],lastMove=0,dealUntil=0;
