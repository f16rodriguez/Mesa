 ...
 */
export const NOMBRES=['portada','mesa_abierta','telefono_entro','espectador_entro','practica','reparto','serie_fin','error','calidad_baja','fps','bloqueo','cuenta_creada','desbloquear','pago','lista'] as const;
